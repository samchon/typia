...
const random = /* @__PURE__ */ ((generator) => {
  ...
  const __random = /* @__PURE__ */ (() => {
    ...
    const __length = (schema, fallback) => {
      ...
      const min = Math.max(0, __int((schema == null ? void 0 : schema.minItems) ?? (schema == null ? void 0 : schema.minLength), 0));
      const rawMax = (schema == null ? void 0 : schema.maxItems) ?? (schema == null ? void 0 : schema.maxLength);
    ...
    const __patternQuantifier = (pattern, index) => {
      ...
      const head = ((_a = body.split(",")[0]) == null ? void 0 : _a.trim()) ?? "";
    ...
    const __string = (generator2, schema) => {
      ...
      const patterned = __patternString(schema == null ? void 0 : schema.pattern);
    ...
    const __bigint = (generator2, schema) => {
      if (typeof (generator2 == null ? void 0 : generator2.bigint) === "function") {
        const value2 = generator2.bigint(schema);
        if (typeof value2 === "bigint") return value2;
      }
      let value = __bigintValue(schema == null ? void 0 : schema.minimum, 0n);
      const exclusiveMinimum = schema == null ? void 0 : schema.exclusiveMinimum;
      if (exclusiveMinimum !== void 0) {
        const min = __bigintValue(exclusiveMinimum, value);
        if (min >= value) value = min + 1n;
      }
      const maximum = schema == null ? void 0 : schema.maximum;
      if (maximum !== void 0) {
    ...
    const __resolve = (schema, components) => {
      ...
      if (typeof schema.$ref === "string") {
        ...
        const resolved = key && (components == null ? void 0 : components[key]) ? __resolve(components[key], components) : {};
    ...
    const __random2 = (schema, components, generator2, depth) => {
      ...
      if (Array.isArray(current.oneOf) && current.oneOf.length > 0) {
        ...
        if (choice === void 0) {
          choice = current.oneOf.find((candidate) => {
            const resolved = __resolve(candidate, components);
            return (resolved == null ? void 0 : resolved.type) !== "null";
          }) ?? current.oneOf[0];
        }
