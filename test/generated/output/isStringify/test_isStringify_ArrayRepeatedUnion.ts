...
export const test_isStringify_ArrayRepeatedUnion = _test_isStringify("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input) => ((input: number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>): string | null => { const is = (input: any): input is number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D> => {
    const $ip0 = (input: any) => {
        const array = input;
        const top = input[0];
        if (0 === input.length)
...
}; return is(input) ? stringify(input) : null; })(input), ArrayRepeatedUnion.SPOILERS);
