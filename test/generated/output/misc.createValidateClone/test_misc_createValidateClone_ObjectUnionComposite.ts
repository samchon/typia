...
export const test_misc_createValidateClone_ObjectUnionComposite =
  _test_misc_validateClone("ObjectUnionComposite")<ObjectUnionComposite>(
    ObjectUnionComposite,
  )((input: any): typia.IValidation<typia.Resolved<ObjectUnionComposite>> => {
    const validate = (input: any): typia.IValidation<ObjectUnionComposite> => {
      const errors = [] as any[];
          ...
          const $vo5 = (
            ...
            [
              ((("object" === typeof input.outer && null !== input.outer) ||
                ...
                $vo4(input.outer, _path + ".outer", true && _exceptionable)) ||
                $report(_exceptionable, {
                  path: _path + ".outer",
                  expected: "ObjectUnionComposite.IPolyline",
                  value: input.outer,
          ...
          const $vo6 = (
            ...
            [
              ...
              ((("object" === typeof input.inner && null !== input.inner) ||
                ...
                $vo0(input.inner, _path + ".inner", true && _exceptionable)) ||
                $report(_exceptionable, {
                  path: _path + ".inner",
                  expected: "ObjectUnionComposite.IPoint",
                  value: input.inner,
