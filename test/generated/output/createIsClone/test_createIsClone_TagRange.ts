...
export const test_createIsClone_TagRange = _test_isClone("TagRange", TagRange.generate, (input: any): typia.Primitive<TagRange> | null => { const is = (input: any): input is TagRange => {
    ...
    return null; const output = clone(input); return output; }, TagRange.SPOILERS);
