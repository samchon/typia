...
export const test_createEquals_ToJsonUndefined = _test_equals("ToJsonUndefined", ToJsonUndefined.generate, (input: any, _exceptionable: boolean): input is ToJsonUndefined => {
