...
export const test_validatePrune_TagBigInt = _test_validatePrune("TagBigInt", TagBigInt.generate, (input) => ((input: any): typia.IValidation<TagBigInt> => { const validate = (input: any): typia.IValidation<TagBigInt> => {
    ...
    prune(input); return output; })(input), TagBigInt.SPOILERS);
