...
export const test_functional_validateFunctionAsync_CommentTagInfinite =
  _test_functional_validateFunctionAsync("CommentTagInfinite")(
    CommentTagInfinite,
  )(
    (p: (input: CommentTagInfinite) => Promise<CommentTagInfinite>) =>
      async (
        input: CommentTagInfinite,
      ): Promise<import("typia").IValidation<CommentTagInfinite>> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<CommentTagInfinite> => {
          const errors = [] as any[];
          const __is = (input: any): input is CommentTagInfinite => {
            return (
              "object" === typeof input &&
