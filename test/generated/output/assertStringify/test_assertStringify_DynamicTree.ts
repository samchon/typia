...
export const test_assertStringify_DynamicTree = _test_assertStringify("DynamicTree", DynamicTree.generate, (input) => ((input: any): string => { const assert = (input: any): DynamicTree => {
