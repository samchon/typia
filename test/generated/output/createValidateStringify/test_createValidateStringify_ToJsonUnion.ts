...
export const test_createValidateStringify_ToJsonUnion = _test_validateStringify("ToJsonUnion", ToJsonUnion.generate, (input: ToJsonUnion): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ToJsonUnion> => {
    const errors = [] as any[];
