...
export const test_assertClone_ObjectLiteralProperty = _test_assertClone("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: any): typia.Primitive<ObjectLiteralProperty.ISomething> => { const assert = (input: any): ObjectLiteralProperty.ISomething => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectLiteralProperty.SPOILERS);
