...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
    <Tab>
```typescript filename="examples/src/validate.ts" showLineNumbers {3-7, 9}
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
    <Tab>
```typescript filename="examples/src/validateEquals.ts" showLineNumbers {3-8, 10}
import typia from "typia";
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
    <Tab>
```typescript filename="examples/src/createValidate.ts" showLineNumbers {3}
import typia from "typia";
