...
export const test_validateClone_TemplateConstant = _test_validateClone("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<TemplateConstant.Type>>> => { const validate = (input: any): typia.IValidation<Array<TemplateConstant.Type>> => {
...
}; const clone = (input: Array<TemplateConstant.Type>): typia.Primitive<Array<TemplateConstant.Type>> => {
    ...
    output.data = clone(input); return output; })(input), TemplateConstant.SPOILERS);
