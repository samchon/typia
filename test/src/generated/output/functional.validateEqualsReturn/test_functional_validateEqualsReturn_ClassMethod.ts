...
export const test_functional_validateEqualsReturn_ClassMethod =
  _test_functional_validateEqualsReturn("ClassMethod")(ClassMethod)(
    (p: (input: ClassMethod) => ClassMethod) =>
      (input: ClassMethod): import("typia").IValidation<ClassMethod> => {
