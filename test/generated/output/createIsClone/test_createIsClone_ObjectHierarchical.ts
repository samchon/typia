...
export const test_createIsClone_ObjectHierarchical = _test_isClone("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.Primitive<ObjectHierarchical> | null => { const is = (input: any): input is ObjectHierarchical => {
    ...
    return null; const output = clone(input); return output; }, ObjectHierarchical.SPOILERS);
