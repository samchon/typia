...
export const test_createIsParse_ObjectSimple = _test_isParse("ObjectSimple", ObjectSimple.generate, (input: any): typia.Primitive<IBox3D> => { const is = (input: any): input is IBox3D => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; }, ObjectSimple.SPOILERS);
