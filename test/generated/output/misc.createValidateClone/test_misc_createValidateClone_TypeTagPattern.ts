...
export const test_misc_createValidateClone_TypeTagPattern =
    _test_misc_validateClone("TypeTagPattern")<TypeTagPattern>(TypeTagPattern)(
        (input: any): typia.IValidation<typia.Resolved<TypeTagPattern>> => {
            const validate = (
                input: any,
