...
export const test_llm_json_parse_lenient_identifier_keywords = (): void => {
  ...
  if (!r1.success) {
    TestValidator.equals("TRUE-errors-len", r1.errors.length, 1);
    TestValidator.equals(
      "TRUE-errors-expected",
      r1.errors[0]?.expected,
  ...
  if (!r2.success) {
    TestValidator.equals("FALSE-errors-len", r2.errors.length, 1);
    TestValidator.equals(
      "FALSE-errors-expected",
      r2.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r3.success) {
    TestValidator.equals("NULL-errors-len", r3.errors.length, 1);
    TestValidator.equals(
      "NULL-errors-expected",
      r3.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r4.success) {
    TestValidator.equals("NaN-errors-len", r4.errors.length, 1);
    TestValidator.equals(
      "NaN-errors-expected",
      r4.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r5.success) {
    TestValidator.equals("Infinity-errors-len", r5.errors.length, 1);
    TestValidator.equals(
      "Infinity-errors-expected",
      r5.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r6.success) {
    ...
    TestValidator.equals("neg-Infinity-errors-len", r6.errors.length, 1);
    TestValidator.equals(
      "neg-Infinity-errors-expected",
      r6.errors[0]?.expected,
      "':'",
    );
  }
  ...
  if (!r7.success) {
    TestValidator.equals("undefined-errors-len", r7.errors.length, 1);
    TestValidator.equals(
      "undefined-errors-expected",
      r7.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r8.success) {
    TestValidator.equals("True-errors-len", r8.errors.length, 1);
    TestValidator.equals(
      "True-errors-expected",
      r8.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r9.success) {
    TestValidator.equals("False-errors-len", r9.errors.length, 1);
    TestValidator.equals(
      "False-errors-expected",
      r9.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r10.success) {
    TestValidator.equals("Null-errors-len", r10.errors.length, 1);
    TestValidator.equals(
      "Null-errors-expected",
      r10.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r16.success) {
    TestValidator.equals("trueish-errors-len", r16.errors.length, 1);
    TestValidator.equals(
      "trueish-errors-expected",
      r16.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r17.success) {
    TestValidator.equals("nullify-errors-len", r17.errors.length, 1);
    TestValidator.equals(
      "nullify-errors-expected",
      r17.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r18.success) {
    ...
    TestValidator.equals("missing-open-quote-errors-len", r18.errors.length, 1);
    TestValidator.equals(
      "missing-open-quote-errors-expected",
      r18.errors[0]?.expected,
      "quoted string",
    );
  }
  ...
  if (!r19.success) {
    ...
    TestValidator.equals("recovery-eof-arr-errors-len", r19.errors.length, 1);
    TestValidator.equals(
      "recovery-eof-arr-errors-expected",
      r19.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r20.success) {
    ...
    TestValidator.equals("recovery-eof-obj-errors-len", r20.errors.length, 1);
    TestValidator.equals(
      "recovery-eof-obj-errors-expected",
      r20.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
  ...
  if (!r21.success) {
    TestValidator.equals("recovery-eof-multi-errors-len", r21.errors.length, 1);
    TestValidator.equals(
      "recovery-eof-multi-errors-expected",
      r21.errors[0]?.expected,
      "JSON value (string, number, boolean, null, object, or array)",
    );
  }
