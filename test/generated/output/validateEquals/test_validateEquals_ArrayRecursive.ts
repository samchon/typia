...
export const test_validateEquals_ArrayRecursive = _test_validateEquals("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): typia.IValidation<ICategory> => {
    const errors = [] as any[];
