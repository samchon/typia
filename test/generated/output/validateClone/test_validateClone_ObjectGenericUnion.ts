...
export const test_validateClone_ObjectGenericUnion = _test_validateClone("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ISaleEntireArticle>> => { const validate = (input: any): typia.IValidation<ISaleEntireArticle> => {
    const errors = [] as any[];
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is ISaleEntireArticle => {
        const $vo0 = (input: any, _path: string, _exceptionable: boolean) => ["string" === typeof input.writer || $report(_exceptionable, {
                ...
                expected: "string",
                value: input.id
            }), "number" === typeof input.hit && !Number.isNaN(input.hit) || $report(_exceptionable, {
                path: _path + ".hit",
                expected: "number",
                value: input.hit
        ...
        const $vo5 = (input: any, _path: string, _exceptionable: boolean) => ["number" === typeof input.score && !Number.isNaN(input.score) || $report(_exceptionable, {
                path: _path + ".score",
                expected: "number",
                value: input.score
            }), "string" === typeof input.id || $report(_exceptionable, {
