...
export const test_validate_AtomicSimple = _test_validate("AtomicSimple", AtomicSimple.generate, (input) => ((input: any): typia.IValidation<[boolean, number, string]> => {
