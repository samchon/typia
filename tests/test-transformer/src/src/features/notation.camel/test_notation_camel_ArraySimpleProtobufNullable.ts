...
export const test_notation_validateCamel_ArraySimpleProtobufNullable = (): void =>
    ...
    convert: (input) => typia.notations.validateCamel<ArraySimpleProtobufNullable>(input),
