...
export const test_createValidateClone_ObjectUnionNonPredictable = _test_validateClone("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input: any): typia.IValidation<typia.Primitive<ObjectUnionNonPredictable>> => { const validate = (input: any): typia.IValidation<ObjectUnionNonPredictable> => {
    ...
    output.data = clone(input); return output; }, ObjectUnionNonPredictable.SPOILERS);
