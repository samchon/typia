...
export const test_validateStringify_ToJsonArray = _test_validateStringify("ToJsonArray", ToJsonArray.generate, (input) => ((input: ToJsonArray): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ToJsonArray> => {
    const errors = [] as any[];
