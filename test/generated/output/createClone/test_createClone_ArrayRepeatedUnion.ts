...
export const test_createClone_ArrayRepeatedUnion = _test_clone("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input: ArrayRepeatedUnion): typia.Primitive<ArrayRepeatedUnion> => {
