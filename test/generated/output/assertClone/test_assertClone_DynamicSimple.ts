...
export const test_assertClone_DynamicSimple = _test_assertClone("DynamicSimple", DynamicSimple.generate, (input) => ((input: any): typia.Primitive<DynamicSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* DynamicSimple */; return output as DynamicSimple; })(input), DynamicSimple.SPOILERS);
