...
export const test_isStringify_ArraySimple = _test_isStringify("ArraySimple", ArraySimple.generate, (input) => ((input: ArraySimple): string | null => { const is = (input: any): input is ArraySimple => {
