...
export const test_equals_ObjectNullable = _test_equals("ObjectNullable", ObjectNullable.generate, (input) => ((input: any, _exceptionable: boolean): input is ObjectNullable => {
