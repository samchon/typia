...
export const test_createAssertParse_ArrayAtomicAlias = _test_assertParse("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input: string): typia.Primitive<ArrayAtomicAlias> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, ArrayAtomicAlias.SPOILERS);
