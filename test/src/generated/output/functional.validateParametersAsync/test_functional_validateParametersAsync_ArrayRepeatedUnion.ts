...
export const test_functional_validateParametersAsync_ArrayRepeatedUnion =
  _test_functional_validateParametersAsync("ArrayRepeatedUnion")(
    ArrayRepeatedUnion,
  )(
    (p: (input: ArrayRepeatedUnion) => Promise<ArrayRepeatedUnion>) =>
      async (
        input: ArrayRepeatedUnion,
      ): Promise<import("typia").IValidation<ArrayRepeatedUnion>> => {
        const paramResults = [
