...
export const test_createValidateStringify_ObjectHierarchical = _test_validateStringify("ObjectHierarchical", ObjectHierarchical.generate, (input: ObjectHierarchical): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectHierarchical> => {
    ...
    output.data = stringify(input); return output; }, ObjectHierarchical.SPOILERS);
