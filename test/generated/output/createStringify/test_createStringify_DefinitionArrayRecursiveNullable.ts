...
export const test_createStringify_DefinitionArrayRecursiveNullable = _test_stringify("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input: DefinitionArrayRecursiveNullable): string => {
