...
export const test_createValidatePrune_TupleRestArray = _test_validatePrune("TupleRestArray", TupleRestArray.generate, (input: any): typia.IValidation<TupleRestArray> => { const validate = (input: any): typia.IValidation<TupleRestArray> => {
    ...
    prune(input); return output; }, TupleRestArray.SPOILERS);
