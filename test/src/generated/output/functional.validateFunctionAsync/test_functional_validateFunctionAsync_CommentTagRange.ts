...
export const test_functional_validateFunctionAsync_CommentTagRange =
  _test_functional_validateFunctionAsync("CommentTagRange")(CommentTagRange)(
    (p: (input: CommentTagRange) => Promise<CommentTagRange>) =>
      async (
        input: CommentTagRange,
      ): Promise<import("typia").IValidation<CommentTagRange>> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<CommentTagRange> => {
          const errors = [] as any[];
          const __is = (input: any): input is CommentTagRange => {
            const $io0 = (input: any): boolean =>
              Array.isArray(input.value) &&
