...
export const test_equals_ObjectGeneric = _test_equals("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any, _exceptionable: boolean = true): input is [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
