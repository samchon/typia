...
export const test_isClone_ObjectHierarchical = _test_isClone("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): typia.Primitive<ObjectHierarchical.ICustomer> | null => { const is = (input: any): input is ObjectHierarchical.ICustomer => {
    ...
    return null; const output = clone(input); return output; })(input), ObjectHierarchical.SPOILERS);
