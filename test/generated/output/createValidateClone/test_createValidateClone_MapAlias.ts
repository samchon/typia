...
export const test_createValidateClone_MapAlias = _test_validateClone("MapAlias", MapAlias.generate, (input: any): typia.IValidation<typia.Primitive<MapAlias>> => { const validate = (input: any): typia.IValidation<MapAlias> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, MapAlias.SPOILERS);
