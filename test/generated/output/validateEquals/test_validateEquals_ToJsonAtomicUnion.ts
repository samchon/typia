...
export const test_validateEquals_ToJsonAtomicUnion = _test_validateEquals("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input) => ((input: any): typia.IValidation<ToJsonAtomicUnion> => {
    const errors = [] as any[];
