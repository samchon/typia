...
export const test_createAssertStringify_DynamicNever = _test_assertStringify("DynamicNever", DynamicNever.generate, (input: DynamicNever): string => { const assert = (input: any) => {
