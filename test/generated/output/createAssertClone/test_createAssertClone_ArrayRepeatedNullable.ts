...
export const test_createAssertClone_ArrayRepeatedNullable = _test_assertClone("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input: any): typia.Primitive<ArrayRepeatedNullable> => { const assert = (input: any): ArrayRepeatedNullable => {
...
}; assert(input); const output = clone(input); return output; }, ArrayRepeatedNullable.SPOILERS);
