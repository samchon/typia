...
export const test_validateClone_TagCustom = _test_validateClone("TagCustom", TagCustom.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<TagCustom>> => { const validate = (input: any): typia.IValidation<TagCustom> => {
    ...
    output.data = clone(input); return output; })(input), TagCustom.SPOILERS);
