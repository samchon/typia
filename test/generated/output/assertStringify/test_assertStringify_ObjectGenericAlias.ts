...
export const test_assertStringify_ObjectGenericAlias = _test_assertStringify("ObjectGenericAlias", ObjectGenericAlias.generate, (input) => ((input: any): string => { const assert = (input: any): ObjectGenericAlias.ISomething<string> => {
