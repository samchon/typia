...
export const test_isStringify_TagStep = _test_isStringify("TagStep", TagStep.generate, (input) => ((input: Array<TagStep.Type>): string | null => { const is = (input: any): input is Array<TagStep.Type> => {
