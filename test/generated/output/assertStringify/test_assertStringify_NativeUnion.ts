...
export const test_assertStringify_NativeUnion = _test_assertStringify("NativeUnion", NativeUnion.generate, (input) => ((input: any): string => { const assert = (input: any): Array<NativeUnion.Union> => {
