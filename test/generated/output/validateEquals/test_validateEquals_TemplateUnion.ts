...
export const test_validateEquals_TemplateUnion = _test_validateEquals("TemplateUnion", TemplateUnion.generate, (input) => ((input: any): typia.IValidation<TemplateUnion> => {
    const errors = [] as any[];
