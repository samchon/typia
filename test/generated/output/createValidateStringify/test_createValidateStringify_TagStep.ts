...
export const test_createValidateStringify_TagStep = _test_validateStringify("TagStep", TagStep.generate, (input: TagStep): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TagStep> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, TagStep.SPOILERS);
