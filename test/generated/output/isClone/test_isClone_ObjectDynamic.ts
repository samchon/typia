...
export const test_isClone_ObjectDynamic = _test_isClone("ObjectDynamic", ObjectDynamic.generate, (input) => ((input: any): typia.Primitive<ObjectDynamic> | null => { const is = (input: any): input is ObjectDynamic => {
    ...
    return null; const output = clone(input); return output; })(input), ObjectDynamic.SPOILERS);
