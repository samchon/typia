...
export const test_createEquals_FunctionalTupleUnion = _test_equals("FunctionalTupleUnion", FunctionalTupleUnion.generate, (input: any, _exceptionable: boolean): input is FunctionalTupleUnion => {
