...
export const test_createValidateStringify_SetSimple = _test_validateStringify("SetSimple", SetSimple.generate, (input: SetSimple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<SetSimple> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, SetSimple.SPOILERS);
