...
export const test_assertPrune_ObjectPrimitive = _test_assertPrune("ObjectPrimitive", ObjectPrimitive.generate, (input) => ((input: any): Primitive<IArticle> => { const assert = (input: any) => {
