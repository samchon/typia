...
export const test_validate_FunctionalArrayUnion = _test_validate("FunctionalArrayUnion", FunctionalArrayUnion.generate, (input) => ((input: any): typia.IValidation<FunctionalArrayUnion> => {
    const errors = [] as any[];
