...
export const test_validateParse_TagCustom = _test_validateParse("TagCustom", TagCustom.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<TagCustom>> => { const validate = (input: any): typia.IValidation<TagCustom> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), TagCustom.SPOILERS);
