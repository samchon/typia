...
export const test_validateEquals_ObjectGenericUnion = _test_validateEquals("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.IValidation<ISaleQuestion | ISaleReview> => {
