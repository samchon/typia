...
export const test_createClone_ObjectGenericUnion = _test_clone("ObjectGenericUnion", ObjectGenericUnion.generate, (input: ObjectGenericUnion): typia.Primitive<ObjectGenericUnion> => {
