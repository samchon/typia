...
export const test_functional_equalsParametersAsync_CommentTagFormat =
  _test_functional_equalsParametersAsync("CommentTagFormat")(CommentTagFormat)(
    (p: (input: CommentTagFormat) => Promise<CommentTagFormat>) =>
      async (input: CommentTagFormat): Promise<CommentTagFormat | null> => {
        if (
          false ===
          ((
            input: any,
