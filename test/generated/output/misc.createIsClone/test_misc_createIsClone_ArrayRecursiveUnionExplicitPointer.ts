...
export const test_misc_isClone_ArrayRecursiveUnionExplicitPointer =
    _test_misc_isClone<ArrayRecursiveUnionExplicitPointer>(
        ArrayRecursiveUnionExplicitPointer,
    )(
        (
            input: any,
        ): typia.Primitive<ArrayRecursiveUnionExplicitPointer> | null => {
            const is = (
                input: any,
            ...
            const clone = (
                ...
                const $cu0 = (input: any): any =>
                    (() => {
                        ...
                        if ("jpg" === input.extension) return $co3(input);
                        if ("txt" === input.extension) return $co4(input);
                        if ("zip" === input.extension) return $co5(input);
                        if ("lnk" === input.extension) return $co6(input);
                        $throws({
                            expected:
