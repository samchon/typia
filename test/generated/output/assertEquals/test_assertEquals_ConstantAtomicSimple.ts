...
export const test_assertEquals_ConstantAtomicSimple = _test_assertEquals("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input) => ((input: any): [false, true, 2, 'three'] => {
