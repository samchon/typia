...
export const test_functional_validateEqualsFunctionAsync_CommentTagArray =
  _test_functional_validateEqualsFunctionAsync("CommentTagArray")(
    CommentTagArray,
  )(
    (p: (input: CommentTagArray) => Promise<CommentTagArray>) =>
      async (
        input: CommentTagArray,
      ): Promise<import("typia").IValidation<CommentTagArray>> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<CommentTagArray> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
