...
export const test_createIsClone_ObjectUnionImplicit = _test_isClone("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: any): typia.Primitive<ObjectUnionImplicit> | null => { const is = (input: any): input is ObjectUnionImplicit => {
    ...
    return null; const output = clone(input); return output; }, ObjectUnionImplicit.SPOILERS);
