...
export const test_validateParse_TemplateConstant = _test_validateParse("TemplateConstant", TemplateConstant.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<TemplateConstant>> => { const validate = (input: any): typia.IValidation<TemplateConstant> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), TemplateConstant.SPOILERS);
