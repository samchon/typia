...
export const test_isClone_TupleRestObject = _test_isClone("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): typia.Primitive<[boolean, number, ...TupleRestObject.IObject[]]> | null => { const is = (input: any): input is [boolean, number, ...TupleRestObject.IObject[]] => {
    ...
    return null; const output = clone(input); return output; })(input), TupleRestObject.SPOILERS);
