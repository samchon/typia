...
export const test_createAssertClone_ToJsonDouble = _test_assertClone("ToJsonDouble", ToJsonDouble.generate, (input: any): typia.Primitive<Parent> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ToJsonDouble.Parent */; return output as Parent; });
