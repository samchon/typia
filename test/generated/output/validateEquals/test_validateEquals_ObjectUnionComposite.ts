...
export const test_validateEquals_ObjectUnionComposite = _test_validateEquals("ObjectUnionComposite", ObjectUnionComposite.generate, (input) => ((input: any): typia.IValidation<ObjectUnionComposite> => {
    const errors = [] as any[];
