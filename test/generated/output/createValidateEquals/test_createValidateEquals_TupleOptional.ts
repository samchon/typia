...
export const test_createValidateEquals_TupleOptional = _test_validateEquals("TupleOptional", TupleOptional.generate, (input: any): typia.IValidation<TupleOptional> => {
    const __is = (input: any, _exceptionable: boolean = true): input is TupleOptional => {
