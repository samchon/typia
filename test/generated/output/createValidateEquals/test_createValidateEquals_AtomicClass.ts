...
export const test_createValidateEquals_AtomicClass = _test_validateEquals("AtomicClass", AtomicClass.generate, (input: any): typia.IValidation<AtomicClass> => {
    const __is = (input: any, _exceptionable: boolean = true): input is AtomicClass => {
