...
export const test_createAssertClone_TagObjectUnion = _test_assertClone("TagObjectUnion", TagObjectUnion.generate, (input: any): typia.Primitive<TagObjectUnion> => { const assert = (input: any): TagObjectUnion => {
...
}; assert(input); const output = clone(input); return output; }, TagObjectUnion.SPOILERS);
