...
export const test_functional_isFunction_TypeTagPattern =
  _test_functional_isFunction("TypeTagPattern")(TypeTagPattern)(
    (p: (input: TypeTagPattern) => TypeTagPattern) =>
      (input: TypeTagPattern): TypeTagPattern | null => {
        if (
          false ===
          ((input: any): input is TypeTagPattern => {
            return (
              "object" === typeof input &&
              null !== input &&
        ...
        return ((input: any): input is TypeTagPattern => {
          return (
            "object" === typeof input &&
            null !== input &&
            "string" === typeof (input as any).uuid &&
