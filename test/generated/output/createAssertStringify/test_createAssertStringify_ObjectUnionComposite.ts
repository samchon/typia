...
export const test_createAssertStringify_ObjectUnionComposite = _test_assertStringify("ObjectUnionComposite", ObjectUnionComposite.generate, (input: ObjectUnionComposite): string => { const assert = (input: any) => {
