...
export const test_validatePrune_TagObjectUnion = _test_validatePrune("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): typia.IValidation<TagObjectUnion> => { const validate = (input: any): typia.IValidation<TagObjectUnion> => {
    const errors = [] as any[];
