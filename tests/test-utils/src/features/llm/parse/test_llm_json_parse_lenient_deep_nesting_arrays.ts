...
export const test_llm_json_parse_lenient_deep_nesting_arrays = (): void => {
  ...
  if (r6.success)
    TestValidator.equals("10-deep-data", r6.data, [[[[[[[[[[42]]]]]]]]]]);
};
