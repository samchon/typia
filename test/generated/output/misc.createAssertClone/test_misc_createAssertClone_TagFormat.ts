...
export const test_misc_assertClone_TagFormat =
    _test_misc_assertClone<TagFormat>(TagFormat)(
        (input: any): typia.Primitive<TagFormat> => {
            const assert = (input: any): TagFormat => {
                const __is = (input: any): input is TagFormat => {
                    const $is_uuid = (typia.misc.createAssertClone as any)
                        .is_uuid;
                    const $is_email = (typia.misc.createAssertClone as any)
                        .is_email;
                    const $is_url = (typia.misc.createAssertClone as any)
                        .is_url;
                    const $is_ipv4 = (typia.misc.createAssertClone as any)
                        .is_ipv4;
                    const $is_ipv6 = (typia.misc.createAssertClone as any)
                        .is_ipv6;
                    const $is_date = (typia.misc.createAssertClone as any)
                        .is_date;
                    const $is_datetime = (typia.misc.createAssertClone as any)
                        .is_datetime;
                ...
                if (false === __is(input))
                    ((
                        ...
                        const $is_date = (typia.misc.createAssertClone as any)
                            .is_date;
                        const $is_datetime = (
                            typia.misc.createAssertClone as any
                        ).is_datetime;
                        const $ao0 = (
                            input: any,
                            _path: string,
            ...
            const clone = (input: TagFormat): typia.Primitive<TagFormat> => {
                ...
                const $is_ipv4 = (typia.misc.createAssertClone as any).is_ipv4;
                const $is_ipv6 = (typia.misc.createAssertClone as any).is_ipv6;
                const $is_date = (typia.misc.createAssertClone as any).is_date;
                const $is_datetime = (typia.misc.createAssertClone as any)
                    .is_datetime;
