...
export const test_isStringify_ObjectTuple = _test_isStringify("ObjectTuple", ObjectTuple.generate, (input) => ((input: ObjectTuple): string | null => { const is = (input: any): input is ObjectTuple => {
