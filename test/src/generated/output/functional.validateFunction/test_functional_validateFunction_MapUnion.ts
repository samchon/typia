...
export const test_functional_validateFunction_MapUnion =
  _test_functional_validateFunction("MapUnion")(MapUnion)(
    (p: (input: MapUnion) => MapUnion) =>
      (input: MapUnion): import("typia").IValidation<MapUnion> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<MapUnion> => {
          const errors = [] as any[];
          const __is = (input: any): input is MapUnion => {
            const $io0 = (input: any): boolean =>
              "string" === typeof input.id &&
