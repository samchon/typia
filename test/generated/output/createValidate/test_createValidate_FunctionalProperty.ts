...
export const test_createValidate_FunctionalProperty = _test_validate("FunctionalProperty", FunctionalProperty.generate, (input: any): typia.IValidation<FunctionalProperty> => {
    const errors = [] as any[];
