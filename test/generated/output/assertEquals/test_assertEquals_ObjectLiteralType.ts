...
export const test_assertEquals_ObjectLiteralType = _test_assertEquals("ObjectLiteralType", ObjectLiteralType.generate, (input) => ((input: any): {    id: string;    name: string;    age: number;} => {
