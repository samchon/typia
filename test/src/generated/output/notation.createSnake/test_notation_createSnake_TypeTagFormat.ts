...
export const test_notation_createValidateSnake_TypeTagFormat =
  _test_notation_validateGeneral("TypeTagFormat")<TypeTagFormat>(TypeTagFormat)<
    typia.SnakeCase<TypeTagFormat>
  >({
    convert: (
      input: any,
    ): typia.IValidation<typia.SnakeCase<TypeTagFormat>> => {
    ...
    assert: (input: any): typia.SnakeCase<TypeTagFormat> => {
      const __is = (input: any): input is typia.SnakeCase<TypeTagFormat> => {
        return (
          "object" === typeof input &&
          null !== input &&
          "string" === typeof (input as any).uuid &&
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.SnakeCase<TypeTagFormat> => {
