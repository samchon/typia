...
export const test_equals_FunctionalPropertyUnion = _test_equals("FunctionalPropertyUnion", FunctionalPropertyUnion.generate, (input) => ((input: any, _exceptionable: boolean = true): input is Array<FunctionalPropertyUnion.IUnion> => {
