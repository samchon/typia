...
export const test_validateClone_ToJsonUnion = _test_validateClone("ToJsonUnion", ToJsonUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ToJsonUnion>> => { const validate = (input: any): typia.IValidation<ToJsonUnion> => {
    const errors = [] as any[];
