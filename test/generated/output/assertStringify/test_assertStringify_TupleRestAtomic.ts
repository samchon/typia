...
export const test_assertStringify_TupleRestAtomic = _test_assertStringify("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: any): string => { const assert = (input: any): [boolean, number, ...string[]] => {
...
}; return stringify(assert(input)); })(input), TupleRestAtomic.SPOILERS);
