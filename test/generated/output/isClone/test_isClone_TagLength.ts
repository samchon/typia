...
export const test_isClone_TagLength = _test_isClone("TagLength", TagLength.generate, (input) => ((input: any): typia.Primitive<Array<TagLength.Type>> | null => { const is = (input: any): input is Array<TagLength.Type> => {
