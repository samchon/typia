...
export const test_validatePrune_ObjectUnionDouble = _test_validatePrune("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): typia.IValidation<Array<ObjectUnionDouble.Union>> => { const validate = (input: any): typia.IValidation<Array<ObjectUnionDouble.Union>> => {
