...
export const test_isClone_TemplateUnion = _test_isClone("TemplateUnion", TemplateUnion.generate, (input) => ((input: any): typia.Primitive<Array<TemplateUnion.Type>> | null => { const is = (input: any): input is Array<TemplateUnion.Type> => {
