...
export const test_equals_ToJsonAtomicUnion = _test_equals("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input) => ((input: any, _exceptionable: boolean = true): input is Array<ToJsonAtomicUnion.IToJson> => {
