...
func TestLlmSchemaProgrammerCoverage(t *testing.T) {
	...
	if llmProgrammer_import_type(nativecontext.ITypiaContext{}, nativecontext.ImportProgrammer_TypeProps{Name: nodeName}) != nodeName {
	...
	if llmProgrammer_import_type(nativecontext.ITypiaContext{}, nativecontext.ImportProgrammer_TypeProps{
		Name:      "GenericName",
