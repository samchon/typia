...
export const test_assertClone_ObjectSimple = _test_assertClone("ObjectSimple", ObjectSimple.generate, (input) => ((input: any): typia.Primitive<IBox3D> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectSimple.IBox3D */; return output as IBox3D; })(input), ObjectSimple.SPOILERS);
