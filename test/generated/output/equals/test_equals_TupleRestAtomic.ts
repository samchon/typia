...
export const test_equals_TupleRestAtomic = _test_equals("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: any, _exceptionable: boolean = true): input is [boolean, number, ...string[]] => {
