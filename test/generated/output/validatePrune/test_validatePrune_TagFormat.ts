...
export const test_validatePrune_TagFormat = _test_validatePrune("TagFormat", TagFormat.generate, (input) => ((input: any): typia.IValidation<TagFormat> => { const validate = (input: any): typia.IValidation<TagFormat> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), TagFormat.SPOILERS);
