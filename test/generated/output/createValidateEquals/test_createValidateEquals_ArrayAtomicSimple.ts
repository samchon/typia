...
export const test_createValidateEquals_ArrayAtomicSimple = _test_validateEquals("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: any): typia.IValidation<ArrayAtomicSimple> => {
    const __is = (input: any, _exceptionable: boolean = true): input is ArrayAtomicSimple => {
