...
export const test_createAssertStringify_DynamicTemplate = _test_assertStringify("DynamicTemplate", DynamicTemplate.generate, (input: any): string => { const assert = (input: any): DynamicTemplate => {
