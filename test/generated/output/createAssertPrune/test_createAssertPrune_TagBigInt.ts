...
export const test_createAssertPrune_TagBigInt = _test_assertPrune("TagBigInt", TagBigInt.generate, (input: any): TagBigInt => { const assert = (input: any): TagBigInt => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, TagBigInt.SPOILERS);
