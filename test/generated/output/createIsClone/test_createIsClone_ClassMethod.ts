...
export const test_createIsClone_ClassMethod = _test_isClone("ClassMethod", ClassMethod.generate, (input: any): typia.Primitive<ClassMethod> | null => { const is = (input: any): input is ClassMethod => {
