...
export const test_validatePrune_ArrayRecursive = _test_validatePrune("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): typia.IValidation<ArrayRecursive.ICategory> => { const validate = (input: any): typia.IValidation<ArrayRecursive.ICategory> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ArrayRecursive.SPOILERS);
