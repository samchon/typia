...
export const test_assertStringify_TupleRestArray = _test_assertStringify("TupleRestArray", TupleRestArray.generate, (input) => ((input: TupleRestArray): string => { const assert = (input: any) => {
