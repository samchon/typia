...
export const test_validate_ToJsonAtomicSimple = _test_validate("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input) => ((input: any): typia.IValidation<ToJsonAtomicSimple> => {
    const errors = [] as any[];
