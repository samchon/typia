...
export const test_createValidateClone_SetUnion = _test_validateClone("SetUnion", SetUnion.generate, (input: any): typia.IValidation<typia.Primitive<SetUnion>> => { const validate = (input: any): typia.IValidation<SetUnion> => {
    ...
    output.data = clone(input); return output; }, SetUnion.SPOILERS);
