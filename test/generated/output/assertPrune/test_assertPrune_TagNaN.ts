...
export const test_assertPrune_TagNaN = _test_assertPrune("TagNaN", TagNaN.generate, (input) => ((input: any): TagNaN => { const assert = (input: any): TagNaN => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), TagNaN.SPOILERS);
