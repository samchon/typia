...
export const test_createAssertPrune_TupleOptional = _test_assertPrune("TupleOptional", TupleOptional.generate, (input: any): TupleOptional => { const assert = (input: any): TupleOptional => {
...
}; assert(input); prune(input); return input; }, TupleOptional.SPOILERS);
