...
export const test_isPrune_ObjectUnionComposite = _test_isPrune("ObjectUnionComposite", ObjectUnionComposite.generate, (input) => ((input: any): input is ObjectUnionComposite => { const is = (input: any): input is ObjectUnionComposite => {
