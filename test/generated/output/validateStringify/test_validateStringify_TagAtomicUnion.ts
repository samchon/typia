...
export const test_validateStringify_TagAtomicUnion = _test_validateStringify("TagAtomicUnion", TagAtomicUnion.generate, (input) => ((input: Array<TagAtomicUnion.Type>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<TagAtomicUnion.Type>> => {
    ...
    output.data = stringify(input); return output; })(input), TagAtomicUnion.SPOILERS);
