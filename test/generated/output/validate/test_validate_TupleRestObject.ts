...
export const test_validate_TupleRestObject = _test_validate("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): typia.IValidation<[boolean, number, ...TupleRestObject.IObject[]]> => {
