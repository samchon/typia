...
export const test_createAssertClone_SetSimple = _test_assertClone("SetSimple", SetSimple.generate, (input: any): typia.Primitive<SetSimple> => { const assert = (input: any): SetSimple => {
...
}; assert(input); const output = clone(input); return output; }, SetSimple.SPOILERS);
