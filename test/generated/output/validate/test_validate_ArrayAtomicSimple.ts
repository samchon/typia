...
export const test_validate_ArrayAtomicSimple = _test_validate("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.IValidation<ArrayAtomicSimple> => {
    const errors = [] as any[];
