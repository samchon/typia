...
export const test_validateClone_ObjectUnionDouble = _test_validateClone("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<ObjectUnionDouble.Union>>> => { const validate = (input: any): typia.IValidation<Array<ObjectUnionDouble.Union>> => {
...
}; const clone = (input: Array<ObjectUnionDouble.Union>): typia.Primitive<Array<ObjectUnionDouble.Union>> => {
    ...
    output.data = clone(input); return output; })(input), ObjectUnionDouble.SPOILERS);
