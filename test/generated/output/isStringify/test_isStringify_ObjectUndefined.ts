...
export const test_isStringify_ObjectUndefined = _test_isStringify("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: ObjectUndefined): string | null => { const is = (input: any): input is ObjectUndefined => {
