...
export const test_createAssertStringify_DynamicArray = _test_assertStringify("DynamicArray", DynamicArray.generate, (input: any): string => { const assert = (input: any): DynamicArray => {
