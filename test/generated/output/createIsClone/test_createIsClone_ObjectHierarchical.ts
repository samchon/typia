...
export const test_createIsClone_ObjectHierarchical = _test_isClone("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.Primitive<ICustomer> | null => { const is = (input: any): input is ICustomer => {
