...
export const test_assertEquals_ObjectGeneric = _test_assertEquals("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
    const __is = (input: any, _exceptionable: boolean = true): input is [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
        const $io0 = (input: any, _exceptionable: boolean = true): boolean => "boolean" === typeof input.value && ("object" === typeof input.child && null !== input.child && $io1(input.child, true && _exceptionable)) && (Array.isArray(input.elements) && input.elements.every((elem: any, _index1: number) => "object" === typeof elem && null !== elem && $io1(elem, true && _exceptionable))) && (3 === Object.keys(input).length || Object.keys(input).every((key: any) => {
            if (["value", "child", "elements"].some((prop: any) => key === prop))
                return true;
        ...
        const $io1 = (input: any, _exceptionable: boolean = true): boolean => "boolean" === typeof input.child_value && "boolean" === typeof input.child_next && (2 === Object.keys(input).length || Object.keys(input).every((key: any) => {
        ...
        const $io3 = (input: any, _exceptionable: boolean = true): boolean => "number" === typeof input.child_value && Number.isFinite(input.child_value) && ("number" === typeof input.child_next && Number.isFinite(input.child_next)) && (2 === Object.keys(input).length || Object.keys(input).every((key: any) => {
            if (["child_value", "child_next"].some((prop: any) => key === prop))
                return true;
            const value = input[key];
            if (undefined === value)
        ...
        const $io5 = (input: any, _exceptionable: boolean = true): boolean => "string" === typeof input.child_value && "string" === typeof input.child_next && (2 === Object.keys(input).length || Object.keys(input).every((key: any) => {
            if (["child_value", "child_next"].some((prop: any) => key === prop))
                return true;
            const value = input[key];
            if (undefined === value)
