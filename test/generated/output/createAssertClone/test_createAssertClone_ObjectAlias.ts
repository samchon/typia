...
export const test_createAssertClone_ObjectAlias = _test_assertClone("ObjectAlias", ObjectAlias.generate, (input: any): typia.Primitive<ObjectAlias> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as ObjectAlias; }, ObjectAlias.SPOILERS);
