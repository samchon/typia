...
export const test_createRandom_ArrayRepeatedUnion = _test_random("ArrayRepeatedUnion", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ArrayRepeatedUnion> => {
    ...
    const __is = (input: any): input is typia.Primitive<ArrayRepeatedUnion> => {
        const $ip0 = (input: any) => {
            const array = input;
            const top = input[0];
            if (0 === input.length)
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ArrayRepeatedUnion> => {
                ...
                const arrayPredicators = [
                    ...
                    [
                        (top: any): any => null !== top && undefined !== top && ("number" === typeof top && Number.isFinite(top) || "boolean" === typeof top || Array.isArray(top) && ($ap0(top, _path + "[0]", false && _exceptionable) || $guard(_exceptionable, {
                            path: _path + "[0]",
                            expected: "Array<string> | Array<number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | ... 3 more ... | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[]> | Array<__type>",
                            value: top
                        }))),
                        (entire: any[]): any => $aa0(entire, _path, true && _exceptionable) || $guard(_exceptionable, {
                            path: _path,
                            expected: "Array<number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | ... 3 more ... | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[]>",
                            value: entire
                        })
                    ],
                    [
            ...
            const $aa0 = (input: any, _path: string, _exceptionable: boolean = true): any => input.every((elem: any, _index3: number) => (null !== elem || $guard(_exceptionable, {
                path: _path + "[" + _index3 + "]",
                expected: "(Array<__type> | Array<number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | boolean | string[] | (number | ... 3 more ... | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[])[] | { ...; }[]> | Array<string> | boolean | number)",
                value: elem
