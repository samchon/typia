...
export const test_assertStringify_AtomicUnion = _test_assertStringify("AtomicUnion", AtomicUnion.generate, (input) => ((input: any): string => { const assert = (input: any): Array<AtomicUnion.Union> => {
...
}; return stringify(assert(input)); })(input), AtomicUnion.SPOILERS);
