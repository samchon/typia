...
export const test_createAssertStringify_ArrayRepeatedRequired = _test_assertStringify("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input: any): string => { const assert = (input: any): ArrayRepeatedRequired => {
...
}; return stringify(assert(input)); }, ArrayRepeatedRequired.SPOILERS);
