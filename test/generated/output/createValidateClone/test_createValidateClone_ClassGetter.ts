...
export const test_createValidateClone_ClassGetter = _test_validateClone("ClassGetter", ClassGetter.generate, (input: any): typia.IValidation<typia.Primitive<ClassGetter>> => { const validate = (input: any): typia.IValidation<ClassGetter> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ClassGetter.SPOILERS);
