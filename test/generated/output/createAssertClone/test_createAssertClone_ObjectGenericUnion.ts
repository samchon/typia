...
export const test_createAssertClone_ObjectGenericUnion = _test_assertClone("ObjectGenericUnion", ObjectGenericUnion.generate, (input: any): typia.Primitive<ObjectGenericUnion> => { const assert = (input: any): ObjectGenericUnion => {
    ...
    const $cp0 = (input: any) => input.map((elem: any) => "object" === typeof elem && null !== elem ? $co2(elem) : elem as any);
    ...
    const $co0 = (input: any): any => ({
        ...
        contents: Array.isArray(input.contents) ? $cp0(input.contents) : input.contents as any,
    ...
    const $co2 = (input: any): any => ({
        ...
        files: Array.isArray(input.files) ? $cp1(input.files) : input.files as any
    });
    ...
    const $co4 = (input: any): any => ({
        ...
        id: input.id as any,
        hit: input.hit as any,
        contents: Array.isArray(input.contents) ? $cp2(input.contents) : input.contents as any,
        created_at: input.created_at as any
    });
...
}; assert(input); const output = clone(input); return output; }, ObjectGenericUnion.SPOILERS);
