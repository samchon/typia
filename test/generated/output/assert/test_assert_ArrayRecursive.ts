...
export const test_assert_ArrayRecursive = _test_assert("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): ArrayRecursive.ICategory => {
