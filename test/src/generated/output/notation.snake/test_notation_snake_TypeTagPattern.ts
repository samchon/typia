...
export const test_notation_validateSnake_TypeTagPattern =
  _test_notation_validateGeneral("TypeTagPattern")<TypeTagPattern>(
    ...
    convert: (input) =>
      ((input: any): typia.IValidation<typia.SnakeCase<TypeTagPattern>> => {
    ...
    assert: (input: any): typia.SnakeCase<TypeTagPattern> => {
      const __is = (input: any): input is typia.SnakeCase<TypeTagPattern> => {
        return (
          "object" === typeof input &&
          null !== input &&
          "string" === typeof (input as any).uuid &&
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.SnakeCase<TypeTagPattern> => {
