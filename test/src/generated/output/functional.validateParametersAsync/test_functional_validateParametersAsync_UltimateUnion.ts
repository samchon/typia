...
export const test_functional_validateParametersAsync_UltimateUnion =
  _test_functional_validateParametersAsync("UltimateUnion")(UltimateUnion)(
    (p: (input: UltimateUnion) => Promise<UltimateUnion>) =>
      async (
        input: UltimateUnion,
      ): Promise<import("typia").IValidation<UltimateUnion>> => {
        const paramResults = [
