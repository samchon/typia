...
export const test_functional_isParametersAsync_ArraySimpleProtobufNullable =
  _test_functional_isParametersAsync("ArraySimpleProtobufNullable")(
    ...
    (
      ...
      async (
        ...
        if (
          false ===
          ((input: any): input is ArraySimpleProtobufNullable => {
