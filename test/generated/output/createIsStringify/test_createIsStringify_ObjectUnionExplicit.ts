...
export const test_createIsStringify_ObjectUnionExplicit = _test_isStringify("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: ObjectUnionExplicit): string | null => { const is = (input: any): input is ObjectUnionExplicit => {
...
}; return is(input) ? stringify(input) : null; }, ObjectUnionExplicit.SPOILERS);
