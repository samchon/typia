...
export const test_isStringify_ObjectPrimitive = _test_isStringify("ObjectPrimitive", ObjectPrimitive.generate, (input) => ((input: ObjectPrimitive.IArticle): string | null => { const is = (input: any): input is ObjectPrimitive.IArticle => {
