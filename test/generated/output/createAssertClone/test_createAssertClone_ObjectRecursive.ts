...
export const test_createAssertClone_ObjectRecursive = _test_assertClone("ObjectRecursive", ObjectRecursive.generate, (input: any): typia.Primitive<ObjectRecursive> => { const assert = (input: any): ObjectRecursive => {
...
}; assert(input); const output = clone(input); return output; }, ObjectRecursive.SPOILERS);
