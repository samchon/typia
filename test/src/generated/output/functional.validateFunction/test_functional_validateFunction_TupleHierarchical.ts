...
export const test_functional_validateFunction_TupleHierarchical =
  _test_functional_validateFunction("TupleHierarchical")(TupleHierarchical)(
    (p: (input: TupleHierarchical) => TupleHierarchical) =>
      (
        input: TupleHierarchical,
      ): import("typia").IValidation<TupleHierarchical> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<TupleHierarchical> => {
          const errors = [] as any[];
          const __is = (input: any): input is TupleHierarchical => {
            return (
              Array.isArray(input) &&
