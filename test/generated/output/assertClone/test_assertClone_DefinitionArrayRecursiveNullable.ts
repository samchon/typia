...
export const test_assertClone_DefinitionArrayRecursiveNullable = _test_assertClone("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input) => ((input: any): typia.Primitive<string | number | Array<DefinitionArrayRecursiveNullable> | null> => { const assert = (input: any): string | number | Array<DefinitionArrayRecursiveNullable> | null => {
...
}; assert(input); const output = clone(input); return output; })(input), DefinitionArrayRecursiveNullable.SPOILERS);
