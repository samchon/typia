...
export const test_createAssertPrune_ObjectRecursive = _test_assertPrune("ObjectRecursive", ObjectRecursive.generate, (input: any): ObjectRecursive => { const assert = (input: any): ObjectRecursive => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, ObjectRecursive.SPOILERS);
