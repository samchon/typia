...
export const test_createValidate_ToJsonAtomicUnion = _test_validate("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input: any): typia.IValidation<ToJsonAtomicUnion> => {
    const errors = [] as any[];
