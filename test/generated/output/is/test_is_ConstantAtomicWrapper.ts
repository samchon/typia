...
export const test_is_ConstantAtomicWrapper = _test_is("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input) => ((input: any): input is ConstantAtomicWrapper => {
