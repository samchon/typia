...
export const test_isStringify_NativeAlias = _test_isStringify("NativeAlias", NativeAlias.generate, (input) => ((input: NativeAlias): string | null => { const is = (input: any): input is NativeAlias => {
