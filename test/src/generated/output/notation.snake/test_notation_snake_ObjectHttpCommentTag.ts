...
export const test_notation_validateSnake_ObjectHttpCommentTag =
  _test_notation_validateGeneral("ObjectHttpCommentTag")<ObjectHttpCommentTag>(
    ...
    convert: (input) =>
      ((
        input: any,
      ): typia.IValidation<typia.SnakeCase<ObjectHttpCommentTag>> => {
        const validate = (
          input: any,
    ...
    assert: (input: any): typia.SnakeCase<ObjectHttpCommentTag> => {
      const __is = (
        input: any,
      ): input is typia.SnakeCase<ObjectHttpCommentTag> => {
        const $io0 = (input: any): boolean =>
          "number" === typeof input.int &&
          Math.floor(input.int) === input.int &&
          -2147483648 <= input.int &&
