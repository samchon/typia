...
export const test_assertParse_ArraySimple = _test_assertParse("ArraySimple", ArraySimple.generate, (input) => ((input: string): typia.Primitive<ArraySimple> => { const assert = (input: any): ArraySimple => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; })(input), ArraySimple.SPOILERS);
