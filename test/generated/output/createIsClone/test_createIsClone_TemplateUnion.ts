...
export const test_createIsClone_TemplateUnion = _test_isClone("TemplateUnion", TemplateUnion.generate, (input: any): typia.Primitive<TemplateUnion> | null => { const is = (input: any): input is TemplateUnion => {
    ...
    return null; const output = clone(input); return output; }, TemplateUnion.SPOILERS);
