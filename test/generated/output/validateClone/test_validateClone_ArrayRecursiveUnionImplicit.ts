...
export const test_validateClone_ArrayRecursiveUnionImplicit = _test_validateClone("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<ArrayRecursiveUnionImplicit.IBucket>>> => { const validate = (input: any): typia.IValidation<Array<ArrayRecursiveUnionImplicit.IBucket>> => {
...
}; const clone = (input: Array<ArrayRecursiveUnionImplicit.IBucket>): typia.Primitive<Array<ArrayRecursiveUnionImplicit.IBucket>> => {
    ...
    output.data = clone(input); return output; })(input), ArrayRecursiveUnionImplicit.SPOILERS);
