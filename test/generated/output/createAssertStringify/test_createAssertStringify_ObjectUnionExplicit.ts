...
export const test_createAssertStringify_ObjectUnionExplicit = _test_assertStringify("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: ObjectUnionExplicit): string => { const assert = (input: any) => {
