...
export const test_createIsParse_ArrayRecursiveUnionExplicit = _test_isParse("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input: any): typia.Primitive<ArrayRecursiveUnionExplicit> => { const is = (input: any): input is ArrayRecursiveUnionExplicit => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; }, ArrayRecursiveUnionExplicit.SPOILERS);
