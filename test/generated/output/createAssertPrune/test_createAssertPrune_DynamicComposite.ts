...
export const test_createAssertPrune_DynamicComposite = _test_assertPrune("DynamicComposite", DynamicComposite.generate, (input: any): DynamicComposite => { const assert = (input: any): DynamicComposite => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, DynamicComposite.SPOILERS);
