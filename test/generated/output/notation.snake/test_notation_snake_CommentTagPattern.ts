...
export const test_notation_validateSnake_CommentTagPattern =
  _test_notation_validateGeneral("CommentTagPattern")<CommentTagPattern>(
    ...
    convert: (input) =>
      ((input: any): typia.IValidation<typia.SnakeCase<CommentTagPattern>> => {
    ...
    assert: (input: any): typia.SnakeCase<CommentTagPattern> => {
      const __is = (
        input: any,
      ): input is typia.SnakeCase<CommentTagPattern> => {
        return (
          "object" === typeof input &&
          null !== input &&
          "string" === typeof (input as any).uuid &&
