...
export const test_createAssertClone_ArrayRecursiveUnionExplicit = _test_assertClone("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input: any): typia.Primitive<ArrayRecursiveUnionExplicit> => { const assert = (input: any): ArrayRecursiveUnionExplicit => {
...
}; assert(input); const output = clone(input); return output; }, ArrayRecursiveUnionExplicit.SPOILERS);
