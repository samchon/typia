...
export const test_createAssertClone_ToJsonAtomicSimple = _test_assertClone("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input: any): typia.Primitive<ToJsonAtomicSimple> => { const assert = (input: any): ToJsonAtomicSimple => {
