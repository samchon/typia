...
func callExpressionTransformer_createFunctors() map[string]map[string]callExpressionTransformerFunctor {
  return map[string]map[string]callExpressionTransformerFunctor{
    "module": {
      ...
      "isLikely": func() callExpressionTransformerTask {
        return nativefeatures.IsLikelyTransformer.Transform(nativeprogrammers.IsProgrammer_IConfig{Equals: false})
      },
      ...
      "createIsLikely": func() callExpressionTransformerTask {
        return nativefeatures.CreateIsLikelyTransformer.Transform(nativeprogrammers.IsProgrammer_IConfig{Equals: false})
      },
