...
export const test_createValidateStringify_ArrayHierarchical = _test_validateStringify("ArrayHierarchical", ArrayHierarchical.generate, (input: ArrayHierarchical): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayHierarchical> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ArrayHierarchical.SPOILERS);
