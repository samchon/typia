...
export const test_createIsPrune_ObjectHierarchical = _test_isPrune("ObjectHierarchical", ObjectHierarchical.generate, (input: any): input is ICustomer => { const is = (input: any): input is ICustomer => {
