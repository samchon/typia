...
export const test_createAssertEquals_ArrayMatrix = _test_assertEquals("ArrayMatrix", ArrayMatrix.generate, (input: any): ArrayMatrix => {
    const __is = (input: any, _exceptionable: boolean = true): input is ArrayMatrix => {
