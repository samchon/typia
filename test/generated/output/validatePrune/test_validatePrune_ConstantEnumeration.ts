...
export const test_validatePrune_ConstantEnumeration = _test_validatePrune("ConstantEnumeration", ConstantEnumeration.generate, (input) => ((input: any): typia.IValidation<ConstantEnumeration> => { const validate = (input: any): typia.IValidation<ConstantEnumeration> => {
    const errors = [] as any[];
