...
export const test_validateEquals_FunctionalPropertyUnion = _test_validateEquals("FunctionalPropertyUnion", FunctionalPropertyUnion.generate, (input) => ((input: any): typia.IValidation<Array<FunctionalPropertyUnion.IUnion>> => {
    const __is = (input: any, _exceptionable: boolean = true): input is Array<FunctionalPropertyUnion.IUnion> => {
