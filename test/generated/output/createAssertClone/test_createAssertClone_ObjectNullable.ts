...
export const test_createAssertClone_ObjectNullable = _test_assertClone("ObjectNullable", ObjectNullable.generate, (input: any): typia.Primitive<ObjectNullable> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectNullable */; return output as ObjectNullable; }, ObjectNullable.SPOILERS);
