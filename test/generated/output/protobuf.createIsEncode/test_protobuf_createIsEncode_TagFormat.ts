...
export const test_protobuf_isEncode_TagFormat =
    _test_protobuf_isEncode<TagFormat>(TagFormat)({
        isEncode: (input: TagFormat): Uint8Array | null => {
            const is = (input: any): input is TagFormat => {
                const $is_uuid = (typia.protobuf.createIsEncode as any).is_uuid;
                const $is_email = (typia.protobuf.createIsEncode as any)
                    .is_email;
                const $is_url = (typia.protobuf.createIsEncode as any).is_url;
                const $is_ipv4 = (typia.protobuf.createIsEncode as any).is_ipv4;
                const $is_ipv6 = (typia.protobuf.createIsEncode as any).is_ipv6;
                const $is_date = (typia.protobuf.createIsEncode as any).is_date;
                const $is_datetime = (typia.protobuf.createIsEncode as any)
                    .is_datetime;
                return (
                    "object" === typeof input &&
                    null !== input &&
