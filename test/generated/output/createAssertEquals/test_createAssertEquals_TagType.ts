...
export const test_createAssertEquals_TagType = _test_assertEquals("TagType", TagType.generate, (input: any): TagType => {
    const __is = (input: any, _exceptionable: boolean = true): input is TagType => {
