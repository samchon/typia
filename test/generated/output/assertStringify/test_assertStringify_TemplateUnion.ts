...
export const test_assertStringify_TemplateUnion = _test_assertStringify("TemplateUnion", TemplateUnion.generate, (input) => ((input: any): string => { const assert = (input: any): Array<TemplateUnion.Type> => {
