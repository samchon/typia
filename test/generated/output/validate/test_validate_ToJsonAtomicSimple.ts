...
export const test_validate_ToJsonAtomicSimple = _test_validate("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input) => ((input: any): typia.IValidation<[ToJsonAtomicSimple.IToJson<boolean>, ToJsonAtomicSimple.IToJson<number>, ToJsonAtomicSimple.IToJson<string>]> => {
    const errors = [] as any[];
