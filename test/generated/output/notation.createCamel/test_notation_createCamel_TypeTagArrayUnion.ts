...
export const test_notation_createValidateCamel_TypeTagArrayUnion =
    _test_notation_validateGeneral("TypeTagArrayUnion")<TypeTagArrayUnion>(
        ...
        convert: (
            input: any,
        ): typia.IValidation<typia.CamelCase<TypeTagArrayUnion>> => {
            const validate = (
                input: any,
            ): typia.IValidation<TypeTagArrayUnion> => {
                const errors = [] as any[];
        ...
        assert: (input: any): typia.CamelCase<TypeTagArrayUnion> => {
            const __is = (
                input: any,
            ): input is typia.CamelCase<TypeTagArrayUnion> => {
                const $io0 = (input: any): boolean =>
                    Array.isArray(input.items) &&
                    3 <= input.items.length &&
                    input.items.length <= 3 &&
