...
export const test_validateClone_TagType = _test_validateClone("TagType", TagType.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<TagType>> => { const validate = (input: any): typia.IValidation<TagType> => {
    const errors = [] as any[];
