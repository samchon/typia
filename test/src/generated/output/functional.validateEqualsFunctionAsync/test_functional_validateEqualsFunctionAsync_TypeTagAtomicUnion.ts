...
export const test_functional_validateEqualsFunctionAsync_TypeTagAtomicUnion =
  _test_functional_validateEqualsFunctionAsync("TypeTagAtomicUnion")(
    TypeTagAtomicUnion,
  )(
    (p: (input: TypeTagAtomicUnion) => Promise<TypeTagAtomicUnion>) =>
      async (
        input: TypeTagAtomicUnion,
      ): Promise<import("typia").IValidation<TypeTagAtomicUnion>> => {
        const paramResults = [
