...
export const test_createAssertClone_DynamicTemplate = _test_assertClone("DynamicTemplate", DynamicTemplate.generate, (input: any): typia.Primitive<DynamicTemplate> => { const assert = (input: any): DynamicTemplate => {
...
}; assert(input); const output = clone(input); return output; }, DynamicTemplate.SPOILERS);
