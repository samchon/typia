...
export const test_createAssertPrune_TupleRestObject = _test_assertPrune("TupleRestObject", TupleRestObject.generate, (input: any): TupleRestObject => { const assert = (input: any) => {
