...
export const test_createAssertStringify_ToJsonAtomicSimple = _test_assertStringify("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input: any): string => { const assert = (input: any): ToJsonAtomicSimple => {
