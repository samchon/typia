...
export const test_is_ArrayAtomicSimple = _test_is("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): input is [Array<boolean>, Array<number>, Array<string>] => {
