...
export const test_notation_validateCamel_ArraySimpleProtobuf =
    _test_notation_validateGeneral("ArraySimpleProtobuf")<ArraySimpleProtobuf>(
        ...
        convert: (input) =>
            ((
                input: any,
            ): typia.IValidation<typia.CamelCase<ArraySimpleProtobuf>> => {
                const validate = (
                    input: any,
        ...
        assert: (input: any): typia.CamelCase<ArraySimpleProtobuf> => {
            const __is = (
                input: any,
            ): input is typia.CamelCase<ArraySimpleProtobuf> => {
                const $io0 = (input: any): boolean =>
                    Array.isArray(input.boolean) &&
                    input.boolean.every(
                        (elem: any) => "boolean" === typeof elem,
