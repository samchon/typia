...
export const test_llm_applicationEquals_chatgpt_ObjectUnionNonPredictable = (): void =>
  _test_llm_applicationEquals({
    model: "chatgpt",
    name: "ObjectUnionNonPredictable",
    factory: ObjectUnionNonPredictable
  })(
    typia.llm.application<ObjectUnionNonPredictableApplication, "chatgpt", { equals: true }>(),
  );
