...
export const test_createValidateEquals_AtomicSimple = _test_validateEquals("AtomicSimple", AtomicSimple.generate, (input: any): typia.IValidation<AtomicSimple> => {
    const __is = (input: any, _exceptionable: boolean = true): input is AtomicSimple => {
