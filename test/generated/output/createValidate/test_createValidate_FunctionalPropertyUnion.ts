...
export const test_createValidate_FunctionalPropertyUnion = _test_validate("FunctionalPropertyUnion", FunctionalPropertyUnion.generate, (input: any): typia.IValidation<FunctionalPropertyUnion> => {
    const errors = [] as any[];
