...
export const test_assertPrune_TagStep = _test_assertPrune("TagStep", TagStep.generate, (input) => ((input: any): Array<TagStep.Type> => { const assert = (input: any): Array<TagStep.Type> => {
...
}; assert(input); prune(input); return input; })(input), TagStep.SPOILERS);
