...
export const test_equals_TupleRestObject = _test_equals("TupleRestObject", TupleRestObject.generate, (input) => ((input: any, _exceptionable: boolean = true): input is [boolean, number, ...TupleRestObject.IObject[]] => {
