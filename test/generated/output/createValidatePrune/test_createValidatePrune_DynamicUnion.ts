...
export const test_createValidatePrune_DynamicUnion = _test_validatePrune("DynamicUnion", DynamicUnion.generate, (input: any): typia.IValidation<DynamicUnion> => { const validate = (input: any): typia.IValidation<DynamicUnion> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, DynamicUnion.SPOILERS);
