...
export const test_createAssertPrune_ObjectOptional = _test_assertPrune("ObjectOptional", ObjectOptional.generate, (input: any): ObjectOptional => { const assert = (input: any): ObjectOptional => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, ObjectOptional.SPOILERS);
