...
export const test_isClone_AtomicUnion = _test_isClone("AtomicUnion", AtomicUnion.generate, (input) => ((input: any): typia.Primitive<Array<AtomicUnion.Union>> | null => { const is = (input: any): input is Array<AtomicUnion.Union> => {
