...
export const test_createValidateStringify_ArrayRepeatedUnionWithTuple = _test_validateStringify("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input: ArrayRepeatedUnionWithTuple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayRepeatedUnionWithTuple> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ArrayRepeatedUnionWithTuple.SPOILERS);
