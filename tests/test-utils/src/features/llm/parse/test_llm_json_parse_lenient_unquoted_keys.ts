...
export const test_llm_json_parse_lenient_unquoted_keys = (): void => {
  ...
  if (r1.success)
    TestValidator.equals("simple-unquoted-data", r1.data, { name: "John" });

  // Mixed quoted and unquoted
  const r2 = LlmJson.parse('{"age": 30, name: "John"}');
  TestValidator.equals("mixed-keys-success", r2.success, true);
  if (r2.success)
    TestValidator.equals("mixed-keys-data", r2.data, { age: 30, name: "John" });
  ...
  if (r3.success)
    TestValidator.equals("underscore-key-data", r3.data, { user_name: "test" });
  ...
  if (r10.success)
    TestValidator.equals("unquoted-with-comment-data", r10.data, {
      name: "John",
    });
};
