...
export const test_isClone_ConstantAtomicUnion = _test_isClone("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input) => ((input: any): typia.Primitive<ConstantAtomicUnion> | null => { const is = (input: any): input is ConstantAtomicUnion => {
