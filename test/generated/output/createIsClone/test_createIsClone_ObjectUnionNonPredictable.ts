...
export const test_createIsClone_ObjectUnionNonPredictable = _test_isClone("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input: any): typia.Primitive<ObjectUnionNonPredictable> | null => { const is = (input: any): input is ObjectUnionNonPredictable => {
    ...
    return null; const output = clone(input); return output; }, ObjectUnionNonPredictable.SPOILERS);
