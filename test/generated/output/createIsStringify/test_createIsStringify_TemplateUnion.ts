...
export const test_createIsStringify_TemplateUnion = _test_isStringify("TemplateUnion", TemplateUnion.generate, (input: TemplateUnion): string | null => { const is = (input: any): input is TemplateUnion => {
...
}; return is(input) ? stringify(input) : null; }, TemplateUnion.SPOILERS);
