...
export const test_functional_validateFunction_ObjectGeneric =
  _test_functional_validateFunction("ObjectGeneric")(ObjectGeneric)(
    (p: (input: ObjectGeneric) => ObjectGeneric) =>
      (input: ObjectGeneric): import("typia").IValidation<ObjectGeneric> => {
        const paramResults = [
