...
export const test_assertClone_DynamicTemplate = _test_assertClone("DynamicTemplate", DynamicTemplate.generate, (input) => ((input: any): typia.Primitive<DynamicTemplate> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* DynamicTemplate */; return output as DynamicTemplate; })(input), DynamicTemplate.SPOILERS);
