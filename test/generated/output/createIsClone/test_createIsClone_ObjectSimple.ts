...
export const test_createIsClone_ObjectSimple = _test_isClone("ObjectSimple", ObjectSimple.generate, (input: any): typia.Primitive<ObjectSimple> | null => { const is = (input: any): input is ObjectSimple => {
    ...
    return null; const output = clone(input); return output; }, ObjectSimple.SPOILERS);
