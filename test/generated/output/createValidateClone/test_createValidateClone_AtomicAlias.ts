...
export const test_createValidateClone_AtomicAlias = _test_validateClone("AtomicAlias", AtomicAlias.generate, (input: any): typia.IValidation<typia.Primitive<AtomicAlias>> => { const validate = (input: any): typia.IValidation<AtomicAlias> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, AtomicAlias.SPOILERS);
