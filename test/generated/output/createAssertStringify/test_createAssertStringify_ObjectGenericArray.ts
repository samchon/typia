...
export const test_createAssertStringify_ObjectGenericArray = _test_assertStringify("ObjectGenericArray", ObjectGenericArray.generate, (input: any): string => { const assert = (input: any): ObjectGenericArray => {
    ...
    return $so0(input);
}; return stringify(assert(input)); }, ObjectGenericArray.SPOILERS);
