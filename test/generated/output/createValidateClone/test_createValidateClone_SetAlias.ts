...
export const test_createValidateClone_SetAlias = _test_validateClone("SetAlias", SetAlias.generate, (input: any): typia.IValidation<typia.Primitive<SetAlias>> => { const validate = (input: any): typia.IValidation<SetAlias> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, SetAlias.SPOILERS);
