...
export const test_createAssertStringify_NativeSimple = _test_assertStringify("NativeSimple", NativeSimple.generate, (input: any): string => { const assert = (input: any): NativeSimple => {
