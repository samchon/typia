...
export const test_createValidatePrune_TupleOptional = _test_validatePrune("TupleOptional", TupleOptional.generate, (input: any): typia.IValidation<TupleOptional> => { const validate = (input: any): typia.IValidation<TupleOptional> => {
    ...
    prune(input); return output; }, TupleOptional.SPOILERS);
