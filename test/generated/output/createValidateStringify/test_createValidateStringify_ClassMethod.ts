...
export const test_createValidateStringify_ClassMethod = _test_validateStringify("ClassMethod", ClassMethod.generate, (input: Animal): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Animal> => {
    const errors = [] as any[];
