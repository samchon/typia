...
export const test_assertPrune_ObjectTuple = _test_assertPrune("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): [ObjectTuple.ISection, ObjectTuple.ICitizen] => { const assert = (input: any): [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
    ...
    return input;
}; const prune = (input: [ObjectTuple.ISection, ObjectTuple.ICitizen]): void => {
    const $io0 = (input: any): boolean => "string" === typeof input.id && "string" === typeof input.code && "string" === typeof input.name;
    const $io1 = (input: any): boolean => "string" === typeof input.id && "string" === typeof input.mobile && "string" === typeof input.name;
...
}; assert(input); prune(input); return input; })(input), ObjectTuple.SPOILERS);
