...
export const test_createIsClone_TagTuple = _test_isClone("TagTuple", TagTuple.generate, (input: any): typia.Primitive<TagTuple> | null => { const is = (input: any): input is TagTuple => {
    ...
    return null; const output = clone(input); return output; }, TagTuple.SPOILERS);
