...
export const test_validateClone_ObjectDynamic = _test_validateClone("ObjectDynamic", ObjectDynamic.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectDynamic>> => { const validate = (input: any): typia.IValidation<ObjectDynamic> => {
    ...
    output.data = clone(input); return output; })(input), ObjectDynamic.SPOILERS);
