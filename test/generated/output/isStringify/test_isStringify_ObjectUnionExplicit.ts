...
export const test_isStringify_ObjectUnionExplicit = _test_isStringify("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input) => ((input: ObjectUnionExplicit): string | null => { const is = (input: any): input is ObjectUnionExplicit => {
