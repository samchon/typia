...
export const test_clone_ObjectNullable = _test_clone("ObjectNullable", ObjectNullable.generate, (input) => ((input: [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]): typia.Primitive<[ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]> => {
