...
export const test_validateStringify_ConstantConstEnumeration = _test_validateStringify("ConstantConstEnumeration", ConstantConstEnumeration.generate, (input) => ((input: Array<ConstantConstEnumeration.Enumeration>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<ConstantConstEnumeration.Enumeration>> => {
    const __is = (input: any): input is Array<ConstantConstEnumeration.Enumeration> => {
...
}; const stringify = (input: Array<ConstantConstEnumeration.Enumeration>): string => {
