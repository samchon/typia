...
export const test_isParse_ObjectGenericUnion = _test_isParse("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.Primitive<ObjectGenericUnion> => { const is = (input: any): input is ObjectGenericUnion => {
