...
export const test_notation_createValidateCamel_ObjectDescription =
  _test_notation_validateGeneral("ObjectDescription")<ObjectDescription>(
    ObjectDescription,
  )<typia.CamelCase<ObjectDescription>>({
    convert: (
      input: any,
    ): typia.IValidation<typia.CamelCase<ObjectDescription>> => {
    ...
    assert: (input: any): typia.CamelCase<ObjectDescription> => {
      const __is = (
        input: any,
