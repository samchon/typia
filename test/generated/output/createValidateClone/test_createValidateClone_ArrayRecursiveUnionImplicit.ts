...
export const test_createValidateClone_ArrayRecursiveUnionImplicit = _test_validateClone("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input: any): typia.IValidation<typia.Primitive<ArrayRecursiveUnionImplicit>> => { const validate = (input: any): typia.IValidation<ArrayRecursiveUnionImplicit> => {
    ...
    output.data = clone(input); return output; }, ArrayRecursiveUnionImplicit.SPOILERS);
