...
export const test_createAssertStringify_NativeUnion = _test_assertStringify("NativeUnion", NativeUnion.generate, (input: NativeUnion): string => { const assert = (input: any) => {
