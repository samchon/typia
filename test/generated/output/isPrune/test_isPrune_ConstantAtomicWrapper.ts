...
export const test_isPrune_ConstantAtomicWrapper = _test_isPrune("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input) => ((input: any): input is ConstantAtomicWrapper => { const is = (input: any): input is ConstantAtomicWrapper => {
