...
export const test_is_ToJsonArray = _test_is("ToJsonArray", ToJsonArray.generate, (input) => ((input: any): input is [ToJsonArray.IArray<boolean>, ToJsonArray.IArray<number>, ToJsonArray.IArray<string>, ToJsonArray.IArray<ToJsonArray.IObject>] => {
