...
export const test_validateClone_ArrayAtomicAlias = _test_validateClone("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ArrayAtomicAlias>> => { const validate = (input: any): typia.IValidation<ArrayAtomicAlias> => {
    const errors = [] as any[];
