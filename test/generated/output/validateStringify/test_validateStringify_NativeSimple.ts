...
export const test_validateStringify_NativeSimple = _test_validateStringify("NativeSimple", NativeSimple.generate, (input) => ((input: NativeSimple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<NativeSimple> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), NativeSimple.SPOILERS);
