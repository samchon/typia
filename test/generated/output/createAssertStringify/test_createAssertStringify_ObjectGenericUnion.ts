...
export const test_createAssertStringify_ObjectGenericUnion = _test_assertStringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input: any): string => { const assert = (input: any): ObjectGenericUnion => {
    ...
    return $su0(input);
}; return stringify(assert(input)); }, ObjectGenericUnion.SPOILERS);
