...
export const test_functional_validateFunction_ArrayAtomicAlias =
  _test_functional_validateFunction("ArrayAtomicAlias")(ArrayAtomicAlias)(
    (p: (input: ArrayAtomicAlias) => ArrayAtomicAlias) =>
      (
        input: ArrayAtomicAlias,
      ): import("typia").IValidation<ArrayAtomicAlias> => {
        const paramResults = [
