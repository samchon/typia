...
export const test_notation_createValidateCamel_ArraySimpleProtobufNullable =
  ...
  >({
    convert: (
      input: any,
    ): typia.IValidation<typia.CamelCase<ArraySimpleProtobufNullable>> => {
      const validate = (
        input: any,
    ...
    assert: (input: any): typia.CamelCase<ArraySimpleProtobufNullable> => {
      const __is = (
        input: any,
      ): input is typia.CamelCase<ArraySimpleProtobufNullable> => {
        const $io0 = (input: any): boolean =>
          (null === input.boolean ||
            (Array.isArray(input.boolean) &&
              input.boolean.every((elem: any) => "boolean" === typeof elem))) &&
