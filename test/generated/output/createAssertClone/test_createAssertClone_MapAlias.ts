...
export const test_createAssertClone_MapAlias = _test_assertClone("MapAlias", MapAlias.generate, (input: any): typia.Primitive<MapAlias> => { const assert = (input: any) => {
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is MapAlias => {
        const $ao0 = (input: any, _path: string, _exceptionable: boolean) => (input.boolean instanceof Map || $guard(_exceptionable, {
            ...
            value: elem[0]
        })) && elem[0].every((elem: any, _index5: number) => "number" === typeof elem || $guard(_exceptionable, {
            ...
            value: elem[0]
        })) && $ao1(elem[0], _path + ".objects[" + _index6 + "][0]", true && _exceptionable)) && ("number" === typeof elem[1] || $guard(_exceptionable, {
...
}; assert(input); const output = clone(input); /* MapAlias */; return output as MapAlias; }, MapAlias.SPOILERS);
