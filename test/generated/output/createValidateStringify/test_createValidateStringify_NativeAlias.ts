...
export const test_createValidateStringify_NativeAlias = _test_validateStringify("NativeAlias", NativeAlias.generate, (input: NativeAlias): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<NativeAlias> => {
    const errors = [] as any[];
    const $report = (typia.createValidateStringify as any).report(errors);
    ((input: any, _path: string, _exceptionable: boolean): input is NativeAlias => {
    ...
    } as typia.IValidation<NativeAlias>;
}; const stringify = (input: NativeAlias): string => {
    const $string = (typia.createValidateStringify as any).string;
    const $throws = (typia.createValidateStringify as any).throws;
    const $so0 = (input: any) => `{"date":${$string(input.date.toJSON())},"uint8Array":{},"uint8ClampedArray":{},"uint16Array":{},"uint32Array":{},"bigUint64Array":{},"int8Array":{},"int16Array":{},"int32Array":{},"bigInt64Array":{},"float32Array":{},"float64Array":{},"buffer":${$so1(input.buffer.toJSON())},"arrayBuffer":{},"sharedArrayBuffer":{},"dataView":{},"weakSet":{},"weakMap":{}}`;
    ...
    output.data = stringify(input); return output; }, NativeAlias.SPOILERS);
