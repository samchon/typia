...
export const test_assertClone_ArrayRecursive = _test_assertClone("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): typia.Primitive<ICategory> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ArrayRecursive.ICategory */; return output as ICategory; })(input), ArrayRecursive.SPOILERS);
