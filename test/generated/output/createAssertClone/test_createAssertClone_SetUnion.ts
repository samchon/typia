...
export const test_createAssertClone_SetUnion = _test_assertClone("SetUnion", SetUnion.generate, (input: any): typia.Primitive<SetUnion> => { const assert = (input: any): SetUnion => {
...
}; assert(input); const output = clone(input); return output; }, SetUnion.SPOILERS);
