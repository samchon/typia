...
export const test_isStringify_ArrayAtomicSimple = _test_isStringify("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: [Array<boolean>, Array<number>, Array<string>]): string | null => { const is = (input: any): input is [Array<boolean>, Array<number>, Array<string>] => {
