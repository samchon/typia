...
export const test_assertPrune_TagObjectUnion = _test_assertPrune("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): TagObjectUnion => { const assert = (input: any) => {
