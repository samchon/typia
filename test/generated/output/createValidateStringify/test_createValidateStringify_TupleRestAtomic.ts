...
export const test_createValidateStringify_TupleRestAtomic = _test_validateStringify("TupleRestAtomic", TupleRestAtomic.generate, (input: TupleRestAtomic): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TupleRestAtomic> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, TupleRestAtomic.SPOILERS);
