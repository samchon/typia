...
export const test_isParse_ArrayRecursive = _test_isParse("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): typia.Primitive<ICategory> => { const is = (input: any): input is ICategory => {
