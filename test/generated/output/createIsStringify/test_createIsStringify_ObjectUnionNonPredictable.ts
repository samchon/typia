...
export const test_createIsStringify_ObjectUnionNonPredictable = _test_isStringify("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input: ObjectUnionNonPredictable): string | null => { const is = (input: any): input is ObjectUnionNonPredictable => {
...
}; return is(input) ? stringify(input) : null; }, ObjectUnionNonPredictable.SPOILERS);
