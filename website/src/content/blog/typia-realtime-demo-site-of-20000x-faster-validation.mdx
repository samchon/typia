...
At first, I've made [`typia` playground website](https://typia.io/playground) through `monaco` editor. It is a web-based single-file editor, and supports TypeScript laugnage with external `node_modules`. As you can see in [`typia` playground website](https://typia.io/playground), it even supports auto-completion with type-hints like `VsCode`.
