...
export const test_assertClone_ObjectUnionNonPredictable = _test_assertClone("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: any): typia.Primitive<Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>>> => { const assert = (input: any): Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>> => {
    ...
    return input;
}; const clone = (input: Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>>): typia.Primitive<Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>>> => {
    const $io1 = (input: any): boolean => "object" === typeof input.value && null !== input.value && $iu0(input.value);
    ...
    const $co1 = (input: any): any => ({
        value: "object" === typeof input.value && null !== input.value ? $cu0(input.value) : input.value as any
    });
...
}; assert(input); const output = clone(input); return output; })(input), ObjectUnionNonPredictable.SPOILERS);
