...
export const test_assert_ArrayRecursiveUnionExplicit = _test_assert("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): Array<ArrayRecursiveUnionExplicit.IBucket> => {
