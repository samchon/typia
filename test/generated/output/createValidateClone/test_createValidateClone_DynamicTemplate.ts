...
export const test_createValidateClone_DynamicTemplate = _test_validateClone("DynamicTemplate", DynamicTemplate.generate, (input: any): typia.IValidation<typia.Primitive<DynamicTemplate>> => { const validate = (input: any): typia.IValidation<DynamicTemplate> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, DynamicTemplate.SPOILERS);
