...
export const test_createIsStringify_ObjectGenericUnion = _test_isStringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input: ObjectGenericUnion): string | null => { const is = (input: any): input is ObjectGenericUnion => {
