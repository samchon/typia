...
export const test_createAssertStringify_NativeUnion = _test_assertStringify("NativeUnion", NativeUnion.generate, (input: any): string => { const assert = (input: any): NativeUnion => {
...
}; return stringify(assert(input)); }, NativeUnion.SPOILERS);
