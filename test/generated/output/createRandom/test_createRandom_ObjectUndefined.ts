...
export const test_createRandom_ObjectUndefined = _test_random("ObjectUndefined", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectUndefined> => {
    ...
    const __is = (input: any): input is typia.Primitive<ObjectUndefined> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectUndefined> => {
