...
export const test_isPrune_TagLength = _test_isPrune("TagLength", TagLength.generate, (input) => ((input: any): input is Array<TagLength.Type> => { const is = (input: any): input is Array<TagLength.Type> => {
    ...
    return false; prune(input); return true; })(input), TagLength.SPOILERS);
