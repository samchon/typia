...
export const test_isStringify_TagRange = _test_isStringify("TagRange", TagRange.generate, (input) => ((input: Array<TagRange.Type>): string | null => { const is = (input: any): input is Array<TagRange.Type> => {
