...
export const test_createAssertClone_TagStep = _test_assertClone("TagStep", TagStep.generate, (input: any): typia.Primitive<TagStep> => { const assert = (input: any): TagStep => {
...
}; assert(input); const output = clone(input); return output; }, TagStep.SPOILERS);
