...
export const test_createValidateParse_AtomicClass = _test_validateParse("AtomicClass", AtomicClass.generate, (input: string): typia.IValidation<typia.Primitive<AtomicClass>> => { const validate = (input: any): typia.IValidation<AtomicClass> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, AtomicClass.SPOILERS);
