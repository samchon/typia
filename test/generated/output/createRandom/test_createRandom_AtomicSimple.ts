...
export const test_createRandom_AtomicSimple = _test_random("AtomicSimple", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<AtomicSimple> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<AtomicSimple> => {
