...
export const test_assertClone_ObjectOptional = _test_assertClone("ObjectOptional", ObjectOptional.generate, (input) => ((input: any): typia.Primitive<ObjectOptional> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectOptional */; return output as ObjectOptional; })(input), ObjectOptional.SPOILERS);
