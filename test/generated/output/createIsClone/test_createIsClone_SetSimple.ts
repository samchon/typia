...
export const test_createIsClone_SetSimple = _test_isClone("SetSimple", SetSimple.generate, (input: any): typia.Primitive<SetSimple> | null => { const is = (input: any): input is SetSimple => {
    ...
    return null; const output = clone(input); return output; }, SetSimple.SPOILERS);
