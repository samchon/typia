...
export const test_llm_applicationEquals_gemini_ObjectUnionExplicitPointer = (): void =>
  _test_llm_applicationEquals({
    model: "gemini",
    name: "ObjectUnionExplicitPointer",
    factory: ObjectUnionExplicitPointer
  })(
    typia.llm.application<ObjectUnionExplicitPointerApplication, "gemini", { equals: true }>(),
  );
