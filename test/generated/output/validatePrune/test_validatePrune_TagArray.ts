...
export const test_validatePrune_TagArray = _test_validatePrune("TagArray", TagArray.generate, (input) => ((input: any): typia.IValidation<Array<TagArray.Type>> => { const validate = (input: any): typia.IValidation<Array<TagArray.Type>> => {
    ...
    prune(input); return output; })(input), TagArray.SPOILERS);
