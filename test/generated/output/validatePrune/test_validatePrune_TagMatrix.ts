...
export const test_validatePrune_TagMatrix = _test_validatePrune("TagMatrix", TagMatrix.generate, (input) => ((input: any): typia.IValidation<TagMatrix> => { const validate = (input: any): typia.IValidation<TagMatrix> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), TagMatrix.SPOILERS);
