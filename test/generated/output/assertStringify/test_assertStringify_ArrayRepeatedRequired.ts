...
export const test_assertStringify_ArrayRepeatedRequired = _test_assertStringify("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input) => ((input: any): string => { const assert = (input: any): string | number | Array<ArrayRepeatedRequired> => {
...
}; return stringify(assert(input)); })(input), ArrayRepeatedRequired.SPOILERS);
