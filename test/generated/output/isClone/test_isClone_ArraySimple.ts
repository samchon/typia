...
export const test_isClone_ArraySimple = _test_isClone("ArraySimple", ArraySimple.generate, (input) => ((input: any): typia.Primitive<ArraySimple> | null => { const is = (input: any): input is ArraySimple => {
