...
export const test_assertStringify_ObjectAlias = _test_assertStringify("ObjectAlias", ObjectAlias.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ObjectAlias.IMember> => {
