...
export const test_createAssertStringify_TemplateConstant = _test_assertStringify("TemplateConstant", TemplateConstant.generate, (input: TemplateConstant): string => { const assert = (input: any) => {
