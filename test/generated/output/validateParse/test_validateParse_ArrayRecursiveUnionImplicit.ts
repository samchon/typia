...
export const test_validateParse_ArrayRecursiveUnionImplicit = _test_validateParse("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ArrayRecursiveUnionImplicit>> => { const validate = (input: any): typia.IValidation<ArrayRecursiveUnionImplicit> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ArrayRecursiveUnionImplicit.SPOILERS);
