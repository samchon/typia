...
export const test_functional_validateFunctionAsync_TypeTagRange =
  _test_functional_validateFunctionAsync("TypeTagRange")(TypeTagRange)(
    (p: (input: TypeTagRange) => Promise<TypeTagRange>) =>
      async (
        input: TypeTagRange,
      ): Promise<import("typia").IValidation<TypeTagRange>> => {
        const paramResults = [
          ((input: any): typia.IValidation<TypeTagRange> => {
            const errors = [] as any[];
        ...
        const result = ((input: any): typia.IValidation<TypeTagRange> => {
          const errors = [] as any[];
          const __is = (input: any): input is TypeTagRange => {
            const $io0 = (input: any): boolean =>
              Array.isArray(input.value) &&
