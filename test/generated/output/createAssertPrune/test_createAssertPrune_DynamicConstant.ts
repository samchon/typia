...
export const test_createAssertPrune_DynamicConstant = _test_assertPrune("DynamicConstant", DynamicConstant.generate, (input: any): DynamicConstant => { const assert = (input: any): DynamicConstant => {
