...
export const test_createValidateClone_TagLength = _test_validateClone("TagLength", TagLength.generate, (input: any): typia.IValidation<typia.Primitive<TagLength>> => { const validate = (input: any): typia.IValidation<TagLength> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, TagLength.SPOILERS);
