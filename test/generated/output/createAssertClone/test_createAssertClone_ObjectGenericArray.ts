...
export const test_createAssertClone_ObjectGenericArray = _test_assertClone("ObjectGenericArray", ObjectGenericArray.generate, (input: any): typia.Primitive<ObjectGenericArray> => { const assert = (input: any): ObjectGenericArray => {
...
}; assert(input); const output = clone(input); return output; }, ObjectGenericArray.SPOILERS);
