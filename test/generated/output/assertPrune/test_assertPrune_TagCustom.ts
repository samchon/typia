...
export const test_assertPrune_TagCustom = _test_assertPrune("TagCustom", TagCustom.generate, (input) => ((input: any): TagCustom => { const assert = (input: any): TagCustom => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), TagCustom.SPOILERS);
