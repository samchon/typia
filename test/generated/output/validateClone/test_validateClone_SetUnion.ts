...
export const test_validateClone_SetUnion = _test_validateClone("SetUnion", SetUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<SetUnion.Union>>> => { const validate = (input: any): typia.IValidation<Array<SetUnion.Union>> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Array<SetUnion.Union> => {
            ...
            return (Array.isArray(input) || $report(true, {
                ...
                value: input
            })) && input.map((elem: any, _index1: number) => (elem instanceof Set || $report(true, {
                path: _path + "[" + _index1 + "]",
                ...
                if (0 === elem.size)
                    return true;
                const tupleList = [[(top: any) => "boolean" === typeof top, (top: any) => top.map((elem: any, _index2: number) => "boolean" === typeof elem || $report(true, {
                            ...
                            expected: "number",
                            value: elem
                        })).every((flag: boolean) => flag)], [(top: any) => "string" === typeof top, (top: any) => top.map((elem: any, _index2: number) => "string" === typeof elem || $report(true, {
                            path: _path + "[" + _index1 + "][" + _index2 + "]",
                            expected: "string",
                            value: elem
                        })).every((flag: boolean) => flag)], [(top: any) => Array.isArray(top) && top.map((elem: any, _index3: number) => "number" === typeof elem && Number.isFinite(elem)).every((flag: boolean) => flag), (top: any) => top.map((elem: any, _index2: number) => (Array.isArray(elem) || $report(true, {
                            path: _path + "[" + _index1 + "][" + _index2 + "]",
                            expected: "Array<number>",
                            value: elem
                        })) && elem.map((elem: any, _index4: number) => "number" === typeof elem && Number.isFinite(elem) || $report(true, {
                            ...
                            expected: "Array<number>",
                            value: elem
                        })).every((flag: boolean) => flag)], [(top: any) => "object" === typeof top && null !== top && $vo0(top, _path + "[0]", false), (top: any) => top.map((elem: any, _index2: number) => ("object" === typeof elem && null !== elem || $report(true, {
                            path: _path + "[" + _index1 + "][" + _index2 + "]",
                            expected: "SetUnion.Person",
                            value: elem
                        })) && $vo0(elem, _path + "[" + _index1 + "][" + _index2 + "]", true) || $report(true, {
                            path: _path + "[" + _index1 + "][" + _index2 + "]",
                            expected: "SetUnion.Person",
                            value: elem
                        })).every((flag: boolean) => flag)]];
...
}; const clone = (input: Array<SetUnion.Union>): typia.Primitive<Array<SetUnion.Union>> => {
    return Array.isArray(input) ? input.map((elem: any) => elem instanceof Set ? {} : elem as any) : input as any;
}; const output = validate(input) as any; if (output.success)
    output.data = clone(input); return output; })(input), SetUnion.SPOILERS);
