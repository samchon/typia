...
export const test_createValidateClone_TemplateConstant = _test_validateClone("TemplateConstant", TemplateConstant.generate, (input: any): typia.IValidation<typia.Primitive<TemplateConstant>> => { const validate = (input: any): typia.IValidation<TemplateConstant> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, TemplateConstant.SPOILERS);
