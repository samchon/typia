...
export const test_validateStringify_TagMatrix = _test_validateStringify("TagMatrix", TagMatrix.generate, (input) => ((input: TagMatrix): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TagMatrix> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), TagMatrix.SPOILERS);
