...
export const test_random_TagCustom = _test_random("TagCustom", () => ((generator?: Partial<typia.IRandomGenerator>): typia.Primitive<TagCustom> => {
    ...
    const $ro0 = (_recursive: boolean = false, _depth: number = 0): any => ({
        ...
        log: (generator?.customs ?? $generator.customs)?.number?.([
            {
                name: "powerOf",
                value: "10"
            }
    ...
    return $ro0();
})(TagCustom.RANDOM), (input: any): typia.Primitive<TagCustom> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<TagCustom> => {
