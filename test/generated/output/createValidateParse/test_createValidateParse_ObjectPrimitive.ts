...
export const test_createValidateParse_ObjectPrimitive = _test_validateParse("ObjectPrimitive", ObjectPrimitive.generate, (input: string): typia.IValidation<typia.Primitive<ObjectPrimitive>> => { const validate = (input: any): typia.IValidation<ObjectPrimitive> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, ObjectPrimitive.SPOILERS);
