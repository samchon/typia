...
export const test_validateEquals_ObjectGeneric = _test_validateEquals("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): typia.IValidation<ObjectGeneric> => {
    const errors = [] as any[];
