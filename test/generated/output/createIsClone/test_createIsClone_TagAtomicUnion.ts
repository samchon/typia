...
export const test_createIsClone_TagAtomicUnion = _test_isClone("TagAtomicUnion", TagAtomicUnion.generate, (input: any): typia.Primitive<TagAtomicUnion> | null => { const is = (input: any): input is TagAtomicUnion => {
    ...
    return null; const output = clone(input); return output; }, TagAtomicUnion.SPOILERS);
