...
export const test_validateClone_SetAlias = _test_validateClone("SetAlias", SetAlias.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<SetAlias>> => { const validate = (input: any): typia.IValidation<SetAlias> => {
