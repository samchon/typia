...
export const test_equals_ArrayAtomicSimple = _test_equals("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any, _exceptionable: boolean): input is ArrayAtomicSimple => {
