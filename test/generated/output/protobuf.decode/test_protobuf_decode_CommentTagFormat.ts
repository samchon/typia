...
export const test_protobuf_createDecode_CommentTagFormat =
    _test_protobuf_decode("CommentTagFormat")<CommentTagFormat>(
        CommentTagFormat,
    )({
        decode: (input) =>
            ((input: Uint8Array): typia.Resolved<CommentTagFormat> => {
