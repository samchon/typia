...
export const test_createAssertStringify_TemplateAtomic = _test_assertStringify("TemplateAtomic", TemplateAtomic.generate, (input: TemplateAtomic): string => { const assert = (input: any) => {
