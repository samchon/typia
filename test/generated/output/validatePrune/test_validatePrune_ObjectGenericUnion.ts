...
export const test_validatePrune_ObjectGenericUnion = _test_validatePrune("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.IValidation<ISaleEntireArticle> => { const validate = (input: any): typia.IValidation<ISaleEntireArticle> => {
    const errors = [] as any[];
