...
export const test_createAssertPrune_TemplateAtomic = _test_assertPrune("TemplateAtomic", TemplateAtomic.generate, (input: any): TemplateAtomic => { const assert = (input: any): TemplateAtomic => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, TemplateAtomic.SPOILERS);
