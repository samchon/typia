...
export const test_assertEquals_ArrayAtomicSimple = _test_assertEquals("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): [Array<boolean>, Array<number>, Array<string>] => {
