...
export const test_isPrune_TagLength = _test_isPrune("TagLength", TagLength.generate, (input) => ((input: any): input is TagLength => { const is = (input: any): input is TagLength => {
