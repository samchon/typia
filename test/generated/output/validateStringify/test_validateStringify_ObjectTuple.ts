...
export const test_validateStringify_ObjectTuple = _test_validateStringify("ObjectTuple", ObjectTuple.generate, (input) => ((input: [ObjectTuple.ISection, ObjectTuple.ICitizen]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ObjectTuple.SPOILERS);
