...
export const test_createValidateStringify_ArrayRecursive = _test_validateStringify("ArrayRecursive", ArrayRecursive.generate, (input: ICategory): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ICategory> => {
    const errors = [] as any[];
