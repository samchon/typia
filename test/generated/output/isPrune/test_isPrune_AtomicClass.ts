...
export const test_isPrune_AtomicClass = _test_isPrune("AtomicClass", AtomicClass.generate, (input) => ((input: any): input is AtomicClass => { const is = (input: any): input is AtomicClass => {
    ...
    return false; prune(input); return true; })(input), AtomicClass.SPOILERS);
