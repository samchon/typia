...
export const test_isClone_NativeUnion = _test_isClone("NativeUnion", NativeUnion.generate, (input) => ((input: any): typia.Primitive<NativeUnion> | null => { const is = (input: any): input is NativeUnion => {
