...
export const test_validateStringify_DynamicTree = _test_validateStringify("DynamicTree", DynamicTree.generate, (input) => ((input: DynamicTree): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<DynamicTree> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), DynamicTree.SPOILERS);
