...
export const test_createValidate_DynamicUndefined = _test_validate("DynamicUndefined", DynamicUndefined.generate, (input: any): typia.IValidation<DynamicUndefined> => {
    const errors = [] as any[];
