...
export const test_is_ToJsonUnion = _test_is("ToJsonUnion", ToJsonUnion.generate, (input) => ((input: any): input is Array<string | number | ToJsonUnion.ICitizen | ToJsonUnion.IWrapper<boolean> | ToJsonUnion.IWrapper<ToJsonUnion.ICitizen> | ToJsonUnion.IWrapper<ToJsonUnion.IProduct>> => {
