...
export const test_validateClone_ClassMethod = _test_validateClone("ClassMethod", ClassMethod.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Animal>> => { const validate = (input: any): typia.IValidation<Animal> => {
    const errors = [] as any[];
