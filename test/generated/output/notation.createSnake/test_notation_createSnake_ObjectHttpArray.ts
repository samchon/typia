...
export const test_notation_createValidateSnake_ObjectHttpArray =
    _test_notation_validateGeneral("ObjectHttpArray")<ObjectHttpArray>(
        ...
        convert: (
            input: any,
        ): typia.IValidation<typia.SnakeCase<ObjectHttpArray>> => {
            const validate = (
                input: any,
            ): typia.IValidation<ObjectHttpArray> => {
                const errors = [] as any[];
        ...
        assert: (input: any): typia.SnakeCase<ObjectHttpArray> => {
            const __is = (
                input: any,
            ): input is typia.SnakeCase<ObjectHttpArray> => {
                const $io0 = (input: any): boolean =>
                    Array.isArray(input.booleans) &&
                    input.booleans.every(
                        (elem: any) => "boolean" === typeof elem,
