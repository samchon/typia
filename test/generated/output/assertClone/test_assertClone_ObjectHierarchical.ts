...
export const test_assertClone_ObjectHierarchical = _test_assertClone("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): typia.Primitive<ICustomer> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectHierarchical.ICustomer */; return output as ICustomer; })(input), ObjectHierarchical.SPOILERS);
