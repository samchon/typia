...
export const test_createAssertPrune_ObjectGenericAlias = _test_assertPrune("ObjectGenericAlias", ObjectGenericAlias.generate, (input: any): ObjectGenericAlias => { const assert = (input: any): ObjectGenericAlias => {
