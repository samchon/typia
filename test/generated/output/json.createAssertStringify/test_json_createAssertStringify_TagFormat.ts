...
export const test_json_assertStringify_TagFormat = _test_json_assertStringify(
    "TagFormat",
)<TagFormat>(TagFormat)((input: any): string => {
    const assert = (input: any): TagFormat => {
        const __is = (input: any): input is TagFormat => {
            const $is_uuid = (typia.json.createAssertStringify as any).is_uuid;
            const $is_email = (typia.json.createAssertStringify as any)
                .is_email;
            const $is_url = (typia.json.createAssertStringify as any).is_url;
            const $is_ipv4 = (typia.json.createAssertStringify as any).is_ipv4;
            const $is_ipv6 = (typia.json.createAssertStringify as any).is_ipv6;
            const $is_date = (typia.json.createAssertStringify as any).is_date;
            const $is_datetime = (typia.json.createAssertStringify as any)
                .is_datetime;
            return (
                "object" === typeof input &&
                null !== input &&
        ...
        if (false === __is(input))
            ((
                ...
                const $is_email = (typia.json.createAssertStringify as any)
                    .is_email;
                const $is_url = (typia.json.createAssertStringify as any)
                    .is_url;
                const $is_ipv4 = (typia.json.createAssertStringify as any)
                    .is_ipv4;
                const $is_ipv6 = (typia.json.createAssertStringify as any)
                    .is_ipv6;
                const $is_date = (typia.json.createAssertStringify as any)
                    .is_date;
                const $is_datetime = (typia.json.createAssertStringify as any)
                    .is_datetime;
                const $ao0 = (
    ...
    const stringify = (input: TagFormat): string => {
        ...
        const $is_uuid = (typia.json.createAssertStringify as any).is_uuid;
        const $is_email = (typia.json.createAssertStringify as any).is_email;
        const $is_url = (typia.json.createAssertStringify as any).is_url;
        const $is_ipv4 = (typia.json.createAssertStringify as any).is_ipv4;
        const $is_ipv6 = (typia.json.createAssertStringify as any).is_ipv6;
        const $is_date = (typia.json.createAssertStringify as any).is_date;
