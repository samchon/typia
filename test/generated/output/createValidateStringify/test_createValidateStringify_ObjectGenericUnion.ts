...
export const test_createValidateStringify_ObjectGenericUnion = _test_validateStringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input: ISaleEntireArticle): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ISaleEntireArticle> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ObjectGenericUnion.SPOILERS);
