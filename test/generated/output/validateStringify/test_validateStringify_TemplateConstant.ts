...
export const test_validateStringify_TemplateConstant = _test_validateStringify("TemplateConstant", TemplateConstant.generate, (input) => ((input: TemplateConstant): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TemplateConstant> => {
    const errors = [] as any[];
