...
export const test_createAssertParse_ObjectUnionNonPredictable = _test_assertParse("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input: string): typia.Primitive<ObjectUnionNonPredictable> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, ObjectUnionNonPredictable.SPOILERS);
