...
export const test_functional_validateFunction_ObjectHierarchical =
  _test_functional_validateFunction("ObjectHierarchical")(ObjectHierarchical)(
    (p: (input: ObjectHierarchical) => ObjectHierarchical) =>
      (
        input: ObjectHierarchical,
      ): import("typia").IValidation<ObjectHierarchical> => {
        const paramResults = [
