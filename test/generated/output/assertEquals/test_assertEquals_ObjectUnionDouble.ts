...
export const test_assertEquals_ObjectUnionDouble = _test_assertEquals("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any) => {
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is ObjectUnionDouble => {
        ...
        const $au1 = (input: any, _path: string, _exceptionable: boolean) => (() => {
        ...
        const $au2 = (input: any, _path: string, _exceptionable: boolean) => (() => {
