...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/is.ts" 
      filename="examples/src/validators/is.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/is.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/equals.ts" 
      filename="examples/src/validators/equals.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/equals.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/createIs.ts" 
      filename="examples/src/validators/createIs.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/createIs.js" 
...
<LocalSource 
  path="website/examples/src/validators/is-cast.ts" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/is-custom-tags.ts" 
      filename="examples/src/validators/is-custom-tags.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/is-custom-tags.js" 
