...
export const test_createAssert_InstanceUnion = _test_assert(
  "InstanceUnion",
)<InstanceUnion>(InstanceUnion)((input: any): InstanceUnion => {
    ...
    ((
        ...
        const tuplePredicators = [
          ...
          [
            ...
            (entire: any[]): any =>
              ...
              (("number" === typeof entire[1] && Number.isFinite(entire[1])) ||
                $guard(_exceptionable, {
                  path: _path + "[1]",
                  expected: "number",
                  value: entire[1],
                })) &&
              (("number" === typeof entire[2] && Number.isFinite(entire[2])) ||
                $guard(_exceptionable, {
                  path: _path + "[2]",
                  expected: "number",
                  value: entire[2],
      ...
      const $ao0 = (
        ...
        (((("object" === typeof input.position && null !== input.position) ||
          ...
          $ao1(input.position, _path + ".position", true && _exceptionable)) ||
          $guard(_exceptionable, {
            path: _path + ".position",
            expected: "ObjectSimple.IPoint3D",
            value: input.position,
      ...
      const $ao10 = (
        ...
        (((("object" === typeof input.centroid && null !== input.centroid) ||
          ...
          $ao4(input.centroid, _path + ".centroid", true && _exceptionable)) ||
          $guard(_exceptionable, {
            path: _path + ".centroid",
            expected: "ObjectUnionExplicit.IPoint",
            value: input.centroid,
          })) &&
        (("number" === typeof input.radius && Number.isFinite(input.radius)) ||
          $guard(_exceptionable, {
            path: _path + ".radius",
            expected: "number",
            value: input.radius,
