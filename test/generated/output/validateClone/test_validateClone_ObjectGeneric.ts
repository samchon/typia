...
export const test_validateClone_ObjectGeneric = _test_validateClone("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<[ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]>> => { const validate = (input: any): typia.IValidation<[ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; })(input), ObjectGeneric.SPOILERS);
