...
export const test_assertPrune_AtomicClass = _test_assertPrune("AtomicClass", AtomicClass.generate, (input) => ((input: any): [Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String] => { const assert = (input: any): [Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String] => {
...
}; assert(input); prune(input); return input; })(input), AtomicClass.SPOILERS);
