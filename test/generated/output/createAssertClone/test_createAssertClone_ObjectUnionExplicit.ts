...
export const test_createAssertClone_ObjectUnionExplicit = _test_assertClone("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: any): typia.Primitive<ObjectUnionExplicit> => { const assert = (input: any): ObjectUnionExplicit => {
...
}; assert(input); const output = clone(input); return output; }, ObjectUnionExplicit.SPOILERS);
