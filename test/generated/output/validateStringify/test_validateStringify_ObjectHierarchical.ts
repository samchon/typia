...
export const test_validateStringify_ObjectHierarchical = _test_validateStringify("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: ObjectHierarchical.ICustomer): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectHierarchical.ICustomer> => {
