...
export const test_createValidateStringify_ClassMethod = _test_validateStringify("ClassMethod", ClassMethod.generate, (input: ClassMethod): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ClassMethod> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ClassMethod.SPOILERS);
