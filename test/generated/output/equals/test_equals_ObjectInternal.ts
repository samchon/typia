...
export const test_equals_ObjectInternal = _test_equals("ObjectInternal", ObjectInternal.generate, (input) => ((input: any, _exceptionable: boolean): input is ObjectInternal => {
