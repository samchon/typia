...
export const test_createValidateStringify_ObjectInternal = _test_validateStringify("ObjectInternal", ObjectInternal.generate, (input: ObjectInternal): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectInternal> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ObjectInternal.SPOILERS);
