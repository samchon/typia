...
export const test_createAssertEquals_FunctionalTupleUnion = _test_assertEquals("FunctionalTupleUnion", FunctionalTupleUnion.generate, (input: any): FunctionalTupleUnion => {
    const __is = (input: any, _exceptionable: boolean = true): input is FunctionalTupleUnion => {
