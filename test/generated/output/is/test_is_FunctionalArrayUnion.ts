...
export const test_is_FunctionalArrayUnion = _test_is("FunctionalArrayUnion", FunctionalArrayUnion.generate, (input) => ((input: any): input is Array<FunctionalArrayUnion.Union> => {
