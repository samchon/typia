...
export const test_createAssertClone_ObjectLiteralProperty = _test_assertClone("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any): typia.Primitive<ISomething> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectLiteralProperty.ISomething */; return output as ISomething; }, ObjectLiteralProperty.SPOILERS);
