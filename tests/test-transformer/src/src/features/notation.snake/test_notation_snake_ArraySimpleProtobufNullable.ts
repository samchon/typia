...
export const test_notation_validateSnake_ArraySimpleProtobufNullable = (): void =>
    ...
    convert: (input) => typia.notations.validateSnake<ArraySimpleProtobufNullable>(input),
