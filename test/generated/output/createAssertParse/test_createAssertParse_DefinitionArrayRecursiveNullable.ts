...
export const test_createAssertParse_DefinitionArrayRecursiveNullable = _test_assertParse("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input: string): typia.Primitive<DefinitionArrayRecursiveNullable> => { const assert = (input: any): DefinitionArrayRecursiveNullable => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, DefinitionArrayRecursiveNullable.SPOILERS);
