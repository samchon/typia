...
export const test_assertPrune_ArrayRecursiveUnionExplicit = _test_assertPrune("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): Array<ArrayRecursiveUnionExplicit.IBucket> => { const assert = (input: any): Array<ArrayRecursiveUnionExplicit.IBucket> => {
...
}; assert(input); prune(input); return input; })(input), ArrayRecursiveUnionExplicit.SPOILERS);
