...
export const test_createAssertStringify_TagLength = _test_assertStringify("TagLength", TagLength.generate, (input: any): string => { const assert = (input: any): TagLength => {
