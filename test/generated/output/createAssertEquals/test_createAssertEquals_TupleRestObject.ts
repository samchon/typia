...
export const test_createAssertEquals_TupleRestObject = _test_assertEquals("TupleRestObject", TupleRestObject.generate, (input: any): TupleRestObject => {
    const __is = (input: any, _exceptionable: boolean = true): input is TupleRestObject => {
