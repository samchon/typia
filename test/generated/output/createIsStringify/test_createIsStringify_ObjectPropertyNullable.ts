...
export const test_createIsStringify_ObjectPropertyNullable = _test_isStringify("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input: ObjectPropertyNullable): string | null => { const is = (input: any): input is ObjectPropertyNullable => {
...
}; return is(input) ? stringify(input) : null; }, ObjectPropertyNullable.SPOILERS);
