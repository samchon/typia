...
export const test_createValidatePrune_TagAtomicUnion = _test_validatePrune("TagAtomicUnion", TagAtomicUnion.generate, (input: any): typia.IValidation<TagAtomicUnion> => { const validate = (input: any): typia.IValidation<TagAtomicUnion> => {
    ...
    prune(input); return output; }, TagAtomicUnion.SPOILERS);
