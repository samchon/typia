...
export const test_createValidatePrune_ObjectAlias = _test_validatePrune("ObjectAlias", ObjectAlias.generate, (input: any): typia.IValidation<ObjectAlias> => { const validate = (input: any): typia.IValidation<ObjectAlias> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ObjectAlias.SPOILERS);
