...
export const test_createValidateStringify_ArrayUnion = _test_validateStringify("ArrayUnion", ArrayUnion.generate, (input: ArrayUnion): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayUnion> => {
    ...
    output.data = stringify(input); return output; }, ArrayUnion.SPOILERS);
