...
export const test_isPrune_ArrayRecursive = _test_isPrune("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): input is ArrayRecursive.ICategory => { const is = (input: any): input is ArrayRecursive.ICategory => {
    ...
    return false; prune(input); return true; })(input), ArrayRecursive.SPOILERS);
