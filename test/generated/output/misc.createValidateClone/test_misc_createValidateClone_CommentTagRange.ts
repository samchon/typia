...
export const test_misc_createValidateClone_CommentTagRange =
    _test_misc_validateClone("CommentTagRange")<CommentTagRange>(
        CommentTagRange,
    )((input: any): typia.IValidation<typia.Resolved<CommentTagRange>> => {
