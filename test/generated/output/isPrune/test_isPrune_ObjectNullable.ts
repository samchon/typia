...
export const test_isPrune_ObjectNullable = _test_isPrune("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): input is [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct] => { const is = (input: any): input is [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct] => {
