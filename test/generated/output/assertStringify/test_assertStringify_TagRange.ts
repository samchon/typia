...
export const test_assertStringify_TagRange = _test_assertStringify("TagRange", TagRange.generate, (input) => ((input: any): string => { const assert = (input: any): Array<TagRange.Type> => {
