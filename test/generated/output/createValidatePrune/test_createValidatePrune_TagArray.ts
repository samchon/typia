...
export const test_createValidatePrune_TagArray = _test_validatePrune("TagArray", TagArray.generate, (input: any): typia.IValidation<TagArray> => { const validate = (input: any): typia.IValidation<TagArray> => {
    ...
    prune(input); return output; }, TagArray.SPOILERS);
