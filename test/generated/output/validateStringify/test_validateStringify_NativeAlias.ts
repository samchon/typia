...
export const test_validateStringify_NativeAlias = _test_validateStringify("NativeAlias", NativeAlias.generate, (input) => ((input: NativeSimple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<NativeSimple> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), NativeAlias.SPOILERS);
