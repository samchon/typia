...
export const test_functional_validateEqualsFunction_ArrayRecursiveUnionExplicit =
  _test_functional_validateEqualsFunction("ArrayRecursiveUnionExplicit")(
    ArrayRecursiveUnionExplicit,
  )(
    (p: (input: ArrayRecursiveUnionExplicit) => ArrayRecursiveUnionExplicit) =>
      (
        input: ArrayRecursiveUnionExplicit,
      ): import("typia").IValidation<ArrayRecursiveUnionExplicit> => {
        const paramResults = [
