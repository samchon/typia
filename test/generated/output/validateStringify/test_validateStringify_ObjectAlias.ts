...
export const test_validateStringify_ObjectAlias = _test_validateStringify("ObjectAlias", ObjectAlias.generate, (input) => ((input: Array<ObjectAlias.IMember>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<ObjectAlias.IMember>> => {
    ...
    output.data = stringify(input); return output; })(input), ObjectAlias.SPOILERS);
