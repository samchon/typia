 ...
 */
export const generate_assert_parse = (input: string): typia.Primitive<ObjectUnionExplicit> => {
 ...
 */
export const generate_is_parse = (input: any): typia.Primitive<ObjectUnionExplicit> => {
 ...
 */
export const generate_validate_parse = (input: string): typia.IValidation<typia.Primitive<ObjectUnionExplicit>> => {
 ...
 */
export const generate_assert_stringify = (input: ObjectUnionExplicit): string => {
    const assert = (input: any) => {
 ...
 */
export const generate_is_stringify = (input: ObjectUnionExplicit): string | null => {
    const is = (input: any): input is ObjectUnionExplicit => {
 ...
 */
export const generate_validate_stringify = (input: ObjectUnionExplicit): typia.IValidation<string> => {
    const validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
        const errors = [] as any[];
 ...
 */
export const generate_assert_clone = (input: any): typia.Primitive<ObjectUnionExplicit> => {
    const assert = (input: any) => {
 ...
 */
export const generate_is_clone = (input: any): typia.Primitive<ObjectUnionExplicit> | null => {
    const is = (input: any): input is ObjectUnionExplicit => {
        const $io0 = (input: any) => "number" === typeof input.x && "number" === typeof input.y && "point" === input.type;
        const $io1 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && "number" === typeof input.p1.y) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && "number" === typeof input.p2.y)) && "line" === input.type;
        const $io2 = (input: any) => "number" === typeof input.x && "number" === typeof input.y;
 ...
 */
export const generate_validate_clone = (input: any): typia.IValidation<typia.Primitive<ObjectUnionExplicit>> => {
    const validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
        const errors = [] as any[];
 ...
 */
export const generate_validate_prune = (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
        const errors = [] as any[];
