...
export const test_notation_validateSnake_UltimateUnion =
  _test_notation_validateGeneral("UltimateUnion")<UltimateUnion>(UltimateUnion)<
    typia.SnakeCase<UltimateUnion>
  >({
    convert: (input) =>
      ((input: any): typia.IValidation<typia.SnakeCase<UltimateUnion>> => {
        ...
        const general = (
          ...
          const $co5 = (input: any): any => ({
            ...
            exclusive_minimum: input.exclusiveMinimum as any,
            exclusive_maximum: input.exclusiveMaximum as any,
            multiple_of: input.multipleOf as any,
            type: input.type as any,
            title: input.title as any,
            description: input.description as any,
            deprecated: input.deprecated as any,
          ...
          const $co7 = (input: any): any => ({
            content_media_type: input.contentMediaType as any,
            default: input["default"] as any,
            ...
            min_length: input.minLength as any,
            max_length: input.maxLength as any,
            type: input.type as any,
            title: input.title as any,
            description: input.description as any,
            deprecated: input.deprecated as any,
          ...
          const $co8 = (input: any): any => ({
            items:
              "object" === typeof input.items && null !== input.items
                ? $cu1(input.items)
                : (input.items as any),
            min_items: input.minItems as any,
            max_items: input.maxItems as any,
            type: input.type as any,
            title: input.title as any,
            description: input.description as any,
            deprecated: input.deprecated as any,
          ...
          const $co11 = (input: any): any => ({
            one_of: Array.isArray(input.oneOf)
              ? $cp3(input.oneOf)
              : (input.oneOf as any),
            title: input.title as any,
            description: input.description as any,
          ...
          const $co17 = (input: any): any => ({
            type: input.type as any,
            scheme: input.scheme as any,
            bearer_format: input.bearerFormat as any,
            description: input.description as any,
          });
          ...
          const $co20 = (input: any): any => ({
            authorization_url: input.authorizationUrl as any,
            token_url: input.tokenUrl as any,
            refresh_url: input.refreshUrl as any,
            scopes:
          ...
          const $co24 = (input: any): any => ({
            type: input.type as any,
            open_id_connect_url: input.openIdConnectUrl as any,
            description: input.description as any,
          });
    ...
    assert: (
      ...
      const __is = (input: any): input is typia.SnakeCase<UltimateUnion> => {
        const $io0 = (input: any): boolean =>
          "3.1" === input.version &&
          "object" === typeof input.components &&
          null !== input.components &&
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.SnakeCase<UltimateUnion> => {
