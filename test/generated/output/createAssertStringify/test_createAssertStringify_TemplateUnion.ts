...
export const test_createAssertStringify_TemplateUnion = _test_assertStringify("TemplateUnion", TemplateUnion.generate, (input: any): string => { const assert = (input: any): TemplateUnion => {
