...
export const test_createAssertParse_ArrayRepeatedUnionWithTuple = _test_assertParse("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input: string): typia.Primitive<ArrayRepeatedUnionWithTuple> => { const assert = (input: any): ArrayRepeatedUnionWithTuple => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, ArrayRepeatedUnionWithTuple.SPOILERS);
