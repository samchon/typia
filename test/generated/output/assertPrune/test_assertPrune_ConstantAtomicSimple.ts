...
export const test_assertPrune_ConstantAtomicSimple = _test_assertPrune("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input) => ((input: any): [false, true, 2, 'three'] => { const assert = (input: any): [false, true, 2, 'three'] => {
...
}; assert(input); prune(input); return input; })(input), ConstantAtomicSimple.SPOILERS);
