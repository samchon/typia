...
export const test_createAssertStringify_TagObjectUnion = _test_assertStringify("TagObjectUnion", TagObjectUnion.generate, (input: any): string => { const assert = (input: any): TagObjectUnion => {
