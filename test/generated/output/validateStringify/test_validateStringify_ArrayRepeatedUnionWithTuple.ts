...
export const test_validateStringify_ArrayRepeatedUnionWithTuple = _test_validateStringify("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input) => ((input: number | boolean | Array<string> | Array<ArrayRepeatedUnionWithTuple> | Array<ArrayRepeatedUnionWithTuple.IBox3D> | [string, number, boolean] | [ArrayRepeatedUnionWithTuple.IBox3D, ArrayRepeatedUnionWithTuple.IPoint3D]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<number | boolean | Array<string> | Array<ArrayRepeatedUnionWithTuple> | Array<ArrayRepeatedUnionWithTuple.IBox3D> | [string, number, boolean] | [ArrayRepeatedUnionWithTuple.IBox3D, ArrayRepeatedUnionWithTuple.IPoint3D]> => {
...
}; const stringify = (input: number | boolean | Array<string> | Array<ArrayRepeatedUnionWithTuple> | Array<ArrayRepeatedUnionWithTuple.IBox3D> | [string, number, boolean] | [ArrayRepeatedUnionWithTuple.IBox3D, ArrayRepeatedUnionWithTuple.IPoint3D]): string => {
    ...
    const $sa0 = (input: any): any => `[${input.map((elem: any) => (() => {
        ...
        if ("boolean" === typeof elem)
            return elem;
        if (Array.isArray(elem) && (elem.length === 3 && "string" === typeof elem[0] && "number" === typeof elem[1] && "boolean" === typeof elem[2]))
            return `[${$string(elem[0])},${$number(elem[1])},${elem[2]}]`;
        if (Array.isArray(elem) && (elem.length === 2 && ("object" === typeof elem[0] && null !== elem[0] && $io0(elem[0])) && ("object" === typeof elem[1] && null !== elem[1] && $io1(elem[1]))))
    ...
    return (() => {
        ...
        if (Array.isArray(input) && (input.length === 3 && "string" === typeof input[0] && "number" === typeof input[1] && "boolean" === typeof input[2]))
    ...
    output.data = stringify(input); return output; })(input), ArrayRepeatedUnionWithTuple.SPOILERS);
