...
export const test_createIsClone_ObjectPropertyNullable = _test_isClone("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input: any): typia.Primitive<ObjectPropertyNullable> | null => { const is = (input: any): input is ObjectPropertyNullable => {
    ...
    return null; const output = clone(input); return output; }, ObjectPropertyNullable.SPOILERS);
