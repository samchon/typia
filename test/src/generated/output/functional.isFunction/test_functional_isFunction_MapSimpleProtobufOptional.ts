...
export const test_functional_isFunction_MapSimpleProtobufOptional =
  _test_functional_isFunction("MapSimpleProtobufOptional")(
    MapSimpleProtobufOptional,
  )(
    (p: (input: MapSimpleProtobufOptional) => MapSimpleProtobufOptional) =>
      (input: MapSimpleProtobufOptional): MapSimpleProtobufOptional | null => {
        if (
          false ===
        ...
        return ((input: any): input is MapSimpleProtobufOptional => {
          const $io0 = (input: any): boolean =>
            (undefined === input.boolean ||
              (input.boolean instanceof Map &&
                (() =>
