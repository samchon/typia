...
export const test_isStringify_ObjectGenericArray = _test_isStringify("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: ObjectGenericArray.IPage<ObjectGenericArray.IPerson>): string | null => { const is = (input: any): input is ObjectGenericArray.IPage<ObjectGenericArray.IPerson> => {
