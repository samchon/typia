...
export const test_validateEquals_TupleRestObject = _test_validateEquals("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): typia.IValidation<TupleRestObject> => {
    const errors = [] as any[];
