...
export const test_createClone_ObjectGenericArray = _test_clone("ObjectGenericArray", ObjectGenericArray.generate, (input: ObjectGenericArray): typia.Primitive<ObjectGenericArray> => {
