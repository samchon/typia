...
export const test_createIsClone_TupleRestAtomic = _test_isClone("TupleRestAtomic", TupleRestAtomic.generate, (input: any): typia.Primitive<TupleRestAtomic> | null => { const is = (input: any): input is TupleRestAtomic => {
    ...
    return null; const output = clone(input); return output; }, TupleRestAtomic.SPOILERS);
