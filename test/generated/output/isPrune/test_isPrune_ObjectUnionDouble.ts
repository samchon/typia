...
export const test_isPrune_ObjectUnionDouble = _test_isPrune("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): input is Array<ObjectUnionDouble.Union> => { const is = (input: any): input is Array<ObjectUnionDouble.Union> => {
    ...
    return false; prune(input); return true; })(input), ObjectUnionDouble.SPOILERS);
