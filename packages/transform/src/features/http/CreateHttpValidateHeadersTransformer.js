...
(function (CreateHttpValidateHeadersTransformer) {
    CreateHttpValidateHeadersTransformer.transform = (props) => GenericTransformer_1.GenericTransformer.factory(Object.assign(Object.assign({}, props), { method: "http.createValidateHeaders", write: core_1.HttpValidateHeadersProgrammer.write }));
