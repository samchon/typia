...
export const test_createIsStringify_ObjectUnionDouble = _test_isStringify("ObjectUnionDouble", ObjectUnionDouble.generate, (input: ObjectUnionDouble): string | null => { const is = (input: any): input is ObjectUnionDouble => {
...
}; return is(input) ? stringify(input) : null; }, ObjectUnionDouble.SPOILERS);
