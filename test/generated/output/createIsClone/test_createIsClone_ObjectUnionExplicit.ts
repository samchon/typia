...
export const test_createIsClone_ObjectUnionExplicit = _test_isClone("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: any): typia.Primitive<ObjectUnionExplicit> | null => { const is = (input: any): input is ObjectUnionExplicit => {
    ...
    return null; const output = clone(input); return output; }, ObjectUnionExplicit.SPOILERS);
