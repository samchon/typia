...
export const test_assertStringify_DynamicArray = _test_assertStringify("DynamicArray", DynamicArray.generate, (input) => ((input: DynamicArray): string => { const assert = (input: any) => {
