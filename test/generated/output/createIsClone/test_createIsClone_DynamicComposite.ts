...
export const test_createIsClone_DynamicComposite = _test_isClone("DynamicComposite", DynamicComposite.generate, (input: any): typia.Primitive<DynamicComposite> | null => { const is = (input: any): input is DynamicComposite => {
    ...
    return null; const output = clone(input); return output; }, DynamicComposite.SPOILERS);
