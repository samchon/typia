...
export const test_assertStringify_TupleRestAtomic = _test_assertStringify("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: TupleRestAtomic): string => { const assert = (input: any) => {
