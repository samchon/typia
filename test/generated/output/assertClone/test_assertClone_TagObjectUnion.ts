...
export const test_assertClone_TagObjectUnion = _test_assertClone("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): typia.Primitive<TagObjectUnion> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as TagObjectUnion; })(input), TagObjectUnion.SPOILERS);
