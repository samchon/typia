...
export const test_assertPrune_TemplateAtomic = _test_assertPrune("TemplateAtomic", TemplateAtomic.generate, (input) => ((input: any): TemplateAtomic => { const assert = (input: any) => {
