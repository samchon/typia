    ...
    (input) =>
        ((input: any): typia.IValidation<TagFormat> => {
            const __is: any = (
                ...
                const $is_email: any = (typia.validateEquals as any).is_email;
                const $is_url: any = (typia.validateEquals as any).is_url;
                const $is_ipv4: any = (typia.validateEquals as any).is_ipv4;
                const $is_ipv6: any = (typia.validateEquals as any).is_ipv6;
                const $is_date: any = (typia.validateEquals as any).is_date;
                const $is_datetime: any = (typia.validateEquals as any)
                    .is_datetime;
                const $io0: any = (
                    input: any,
                    _exceptionable: boolean = true,
            ...
            const $is_ipv6: any = (typia.validateEquals as any).is_ipv6;
            const $is_date: any = (typia.validateEquals as any).is_date;
            const $is_datetime: any = (typia.validateEquals as any).is_datetime;
