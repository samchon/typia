...
export const test_createIsPrune_DynamicComposite = _test_isPrune("DynamicComposite", DynamicComposite.generate, (input: any): input is DynamicComposite => { const is = (input: any): input is DynamicComposite => {
    ...
    return false; prune(input); return true; }, DynamicComposite.SPOILERS);
