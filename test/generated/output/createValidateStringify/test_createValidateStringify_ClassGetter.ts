...
export const test_createValidateStringify_ClassGetter = _test_validateStringify("ClassGetter", ClassGetter.generate, (input: Person): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Person> => {
    const errors = [] as any[];
