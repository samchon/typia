...
export const test_createValidateStringify_TagArray = _test_validateStringify("TagArray", TagArray.generate, (input: TagArray): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TagArray> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, TagArray.SPOILERS);
