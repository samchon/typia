...
export const test_assertClone_ObjectUnionDouble = _test_assertClone("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): typia.Primitive<ObjectUnionDouble> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as ObjectUnionDouble; })(input), ObjectUnionDouble.SPOILERS);
