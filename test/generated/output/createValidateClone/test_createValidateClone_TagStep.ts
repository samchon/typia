...
export const test_createValidateClone_TagStep = _test_validateClone("TagStep", TagStep.generate, (input: any): typia.IValidation<typia.Primitive<TagStep>> => { const validate = (input: any): typia.IValidation<TagStep> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, TagStep.SPOILERS);
