...
export const test_assertPrune_ObjectUnionImplicit = _test_assertPrune("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: any): Array<ObjectUnionImplicit.IPoint | ObjectUnionImplicit.ILine | ObjectUnionImplicit.ITriangle | ObjectUnionImplicit.IRectangle | ObjectUnionImplicit.IPolyline | ObjectUnionImplicit.IPolygon | ObjectUnionImplicit.ICircle> => { const assert = (input: any): Array<ObjectUnionImplicit.IPoint | ObjectUnionImplicit.ILine | ObjectUnionImplicit.ITriangle | ObjectUnionImplicit.IRectangle | ObjectUnionImplicit.IPolyline | ObjectUnionImplicit.IPolygon | ObjectUnionImplicit.ICircle> => {
    ...
    return input;
}; const prune = (input: Array<ObjectUnionImplicit.IPoint | ObjectUnionImplicit.ILine | ObjectUnionImplicit.ITriangle | ObjectUnionImplicit.IRectangle | ObjectUnionImplicit.IPolyline | ObjectUnionImplicit.IPolygon | ObjectUnionImplicit.ICircle>): void => {
...
}; assert(input); prune(input); return input; })(input), ObjectUnionImplicit.SPOILERS);
