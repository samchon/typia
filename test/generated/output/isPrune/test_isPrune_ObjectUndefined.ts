...
export const test_isPrune_ObjectUndefined = _test_isPrune("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): input is Array<ObjectUndefined.ILecture> => { const is = (input: any): input is Array<ObjectUndefined.ILecture> => {
    ...
    return false; prune(input); return true; })(input), ObjectUndefined.SPOILERS);
