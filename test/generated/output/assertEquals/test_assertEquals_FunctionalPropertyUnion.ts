...
export const test_assertEquals_FunctionalPropertyUnion = _test_assertEquals("FunctionalPropertyUnion", FunctionalPropertyUnion.generate, (input) => ((input: any): Array<FunctionalPropertyUnion.IUnion> => {
