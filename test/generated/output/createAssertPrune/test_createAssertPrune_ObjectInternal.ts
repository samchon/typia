...
export const test_createAssertPrune_ObjectInternal = _test_assertPrune("ObjectInternal", ObjectInternal.generate, (input: any): ObjectInternal => { const assert = (input: any): ObjectInternal => {
