...
export const test_functional_isReturnAsync_ObjectUnionCompositePointer =
  _test_functional_isReturnAsync("ObjectUnionCompositePointer")(
    ...
    (
      ...
      async (
        ...
        return ((input: any): input is ObjectUnionCompositePointer => {
