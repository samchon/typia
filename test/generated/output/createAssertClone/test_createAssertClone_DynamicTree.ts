...
export const test_createAssertClone_DynamicTree = _test_assertClone("DynamicTree", DynamicTree.generate, (input: any): typia.Primitive<DynamicTree> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* DynamicTree */; return output as DynamicTree; }, DynamicTree.SPOILERS);
