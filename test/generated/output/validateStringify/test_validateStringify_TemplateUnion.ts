...
export const test_validateStringify_TemplateUnion = _test_validateStringify("TemplateUnion", TemplateUnion.generate, (input) => ((input: Array<TemplateUnion.Type>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<TemplateUnion.Type>> => {
...
}; const stringify = (input: Array<TemplateUnion.Type>): string => {
    ...
    output.data = stringify(input); return output; })(input), TemplateUnion.SPOILERS);
