...
export const test_createIsStringify_ObjectUnionComposite = _test_isStringify("ObjectUnionComposite", ObjectUnionComposite.generate, (input: ObjectUnionComposite): string | null => { const is = (input: any): input is ObjectUnionComposite => {
...
}; return is(input) ? stringify(input) : null; }, ObjectUnionComposite.SPOILERS);
