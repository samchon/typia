...
export const test_createValidateClone_ArrayRecursive = _test_validateClone("ArrayRecursive", ArrayRecursive.generate, (input: any): typia.IValidation<typia.Primitive<ICategory>> => { const validate = (input: any): typia.IValidation<ICategory> => {
    const errors = [] as any[];
