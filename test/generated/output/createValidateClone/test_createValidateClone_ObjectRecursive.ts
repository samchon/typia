...
export const test_createValidateClone_ObjectRecursive = _test_validateClone("ObjectRecursive", ObjectRecursive.generate, (input: any): typia.IValidation<typia.Primitive<ObjectRecursive>> => { const validate = (input: any): typia.IValidation<ObjectRecursive> => {
    const errors = [] as any[];
...
}; const clone = (input: ObjectRecursive): typia.Primitive<ObjectRecursive> => {
    ...
    output.data = clone(input); return output; }, ObjectRecursive.SPOILERS);
