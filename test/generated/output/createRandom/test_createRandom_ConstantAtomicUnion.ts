...
export const test_createRandom_ConstantAtomicUnion = _test_random("ConstantAtomicUnion", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
