...
export const test_isClone_ObjectTuple = _test_isClone("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.Primitive<[ObjectTuple.ISection, ObjectTuple.ICitizen]> | null => { const is = (input: any): input is [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
