...
export const test_validateClone_ObjectLiteralProperty = _test_validateClone("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectLiteralProperty.ISomething>> => { const validate = (input: any): typia.IValidation<ObjectLiteralProperty.ISomething> => {
...
}; const clone = (input: ObjectLiteralProperty.ISomething): typia.Primitive<ObjectLiteralProperty.ISomething> => {
    ...
    output.data = clone(input); return output; })(input), ObjectLiteralProperty.SPOILERS);
