...
export const test_validateStringify_ConstantAtomicSimple = _test_validateStringify("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input) => ((input: [false, true, 2, 'three']): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[false, true, 2, 'three']> => {
