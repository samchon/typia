...
export const test_validateClone_DefinitionJsonValue = _test_validateClone("DefinitionJsonValue", DefinitionJsonValue.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<string | number | boolean | DefinitionJsonValue.JsonObject | DefinitionJsonValue.JsonArray | null>> => { const validate = (input: any): typia.IValidation<string | number | boolean | DefinitionJsonValue.JsonObject | DefinitionJsonValue.JsonArray | null> => {
    ...
    output.data = clone(input); return output; })(input), DefinitionJsonValue.SPOILERS);
