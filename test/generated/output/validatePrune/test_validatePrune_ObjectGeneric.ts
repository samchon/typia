...
export const test_validatePrune_ObjectGeneric = _test_validatePrune("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): typia.IValidation<ObjectGeneric> => { const validate = (input: any): typia.IValidation<ObjectGeneric> => {
    const errors = [] as any[];
