...
export const test_createAssertClone_TupleRestObject = _test_assertClone("TupleRestObject", TupleRestObject.generate, (input: any): typia.Primitive<TupleRestObject> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* TupleRestObject */; return output as TupleRestObject; }, TupleRestObject.SPOILERS);
