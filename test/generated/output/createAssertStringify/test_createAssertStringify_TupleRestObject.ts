...
export const test_createAssertStringify_TupleRestObject = _test_assertStringify("TupleRestObject", TupleRestObject.generate, (input: TupleRestObject): string => { const assert = (input: any) => {
