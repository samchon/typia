...
export const test_assertPrune_DynamicUnion = _test_assertPrune("DynamicUnion", DynamicUnion.generate, (input) => ((input: any): DynamicUnion => { const assert = (input: any): DynamicUnion => {
