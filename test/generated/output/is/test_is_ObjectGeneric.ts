...
export const test_is_ObjectGeneric = _test_is("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): input is [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
