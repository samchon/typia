...
export const test_equals_ObjectGenericArray = _test_equals("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any, _exceptionable: boolean): input is ObjectGenericArray => {
