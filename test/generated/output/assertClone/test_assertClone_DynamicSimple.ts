...
export const test_assertClone_DynamicSimple = _test_assertClone("DynamicSimple", DynamicSimple.generate, (input) => ((input: any): typia.Primitive<DynamicSimple> => { const assert = (input: any): DynamicSimple => {
...
}; assert(input); const output = clone(input); return output; })(input), DynamicSimple.SPOILERS);
