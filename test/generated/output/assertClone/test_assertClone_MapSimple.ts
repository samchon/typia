...
export const test_assertClone_MapSimple = _test_assertClone("MapSimple", MapSimple.generate, (input) => ((input: any): typia.Primitive<MapSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* MapSimple */; return output as MapSimple; })(input), MapSimple.SPOILERS);
