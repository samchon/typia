...
export const test_misc_assertPrune_TagFormat =
    _test_misc_assertPrune<TagFormat>(TagFormat)((input: any): TagFormat => {
        const assert = (input: any): TagFormat => {
            const __is = (input: any): input is TagFormat => {
                ...
                const $is_email = (typia.misc.createAssertPrune as any)
                    .is_email;
                const $is_url = (typia.misc.createAssertPrune as any).is_url;
                const $is_ipv4 = (typia.misc.createAssertPrune as any).is_ipv4;
                const $is_ipv6 = (typia.misc.createAssertPrune as any).is_ipv6;
                const $is_date = (typia.misc.createAssertPrune as any).is_date;
                const $is_datetime = (typia.misc.createAssertPrune as any)
                    .is_datetime;
                return (
                    "object" === typeof input &&
                    null !== input &&
            ...
            if (false === __is(input))
                ((
                    ...
                    const $is_email = (typia.misc.createAssertPrune as any)
                        .is_email;
                    const $is_url = (typia.misc.createAssertPrune as any)
                        .is_url;
                    const $is_ipv4 = (typia.misc.createAssertPrune as any)
                        .is_ipv4;
                    const $is_ipv6 = (typia.misc.createAssertPrune as any)
                        .is_ipv6;
                    const $is_date = (typia.misc.createAssertPrune as any)
                        .is_date;
                    const $is_datetime = (typia.misc.createAssertPrune as any)
                        .is_datetime;
                    const $ao0 = (
        ...
        const prune = (input: TagFormat): void => {
            const $is_uuid = (typia.misc.createAssertPrune as any).is_uuid;
            const $is_email = (typia.misc.createAssertPrune as any).is_email;
            const $is_url = (typia.misc.createAssertPrune as any).is_url;
            const $is_ipv4 = (typia.misc.createAssertPrune as any).is_ipv4;
            const $is_ipv6 = (typia.misc.createAssertPrune as any).is_ipv6;
            const $is_date = (typia.misc.createAssertPrune as any).is_date;
