...
export const test_isClone_ObjectUnionNonPredictable = _test_isClone("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: any): typia.Primitive<Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>>> | null => { const is = (input: any): input is Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>> => {
    ...
    return null; const output = clone(input); return output; })(input), ObjectUnionNonPredictable.SPOILERS);
