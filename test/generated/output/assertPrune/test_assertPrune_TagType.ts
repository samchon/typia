...
export const test_assertPrune_TagType = _test_assertPrune("TagType", TagType.generate, (input) => ((input: any): Array<TagType.Type> => { const assert = (input: any): Array<TagType.Type> => {
...
}; assert(input); prune(input); return input; })(input), TagType.SPOILERS);
