...
export const test_createAssertClone_ObjectUnionComposite = _test_assertClone("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any): typia.Primitive<ObjectUnionComposite> => { const assert = (input: any): ObjectUnionComposite => {
...
}; assert(input); const output = clone(input); return output; }, ObjectUnionComposite.SPOILERS);
