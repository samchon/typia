...
export const test_createAssertClone_ObjectUnionDouble = _test_assertClone("ObjectUnionDouble", ObjectUnionDouble.generate, (input: any): typia.Primitive<ObjectUnionDouble> => { const assert = (input: any): ObjectUnionDouble => {
...
}; assert(input); const output = clone(input); return output; }, ObjectUnionDouble.SPOILERS);
