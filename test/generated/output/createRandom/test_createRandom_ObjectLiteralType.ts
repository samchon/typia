...
export const test_createRandom_ObjectLiteralType = _test_random("ObjectLiteralType", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectLiteralType> => {
