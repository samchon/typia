...
export const test_createAssertStringify_ObjectGenericUnion = _test_assertStringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input: ISaleEntireArticle): string => { const assert = (input: any) => {
