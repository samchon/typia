...
export const test_functional_validateFunction_TypeTagTuple =
  _test_functional_validateFunction("TypeTagTuple")(TypeTagTuple)(
    (p: (input: TypeTagTuple) => TypeTagTuple) =>
      (input: TypeTagTuple): import("typia").IValidation<TypeTagTuple> => {
        const paramResults = [
          ((input: any): typia.IValidation<TypeTagTuple> => {
            const errors = [] as any[];
        ...
        const result = ((input: any): typia.IValidation<TypeTagTuple> => {
          const errors = [] as any[];
          const __is = (input: any): input is TypeTagTuple => {
            const $io0 = (input: any): boolean =>
              Array.isArray(input.tuple) &&
