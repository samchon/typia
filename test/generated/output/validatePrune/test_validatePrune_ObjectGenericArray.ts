...
export const test_validatePrune_ObjectGenericArray = _test_validatePrune("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): typia.IValidation<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>> => { const validate = (input: any): typia.IValidation<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ObjectGenericArray.SPOILERS);
