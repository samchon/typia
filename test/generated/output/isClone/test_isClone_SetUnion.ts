...
export const test_isClone_SetUnion = _test_isClone("SetUnion", SetUnion.generate, (input) => ((input: any): typia.Primitive<Array<SetUnion.Union>> | null => { const is = (input: any): input is Array<SetUnion.Union> => {
