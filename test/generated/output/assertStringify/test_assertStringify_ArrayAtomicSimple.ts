...
export const test_assertStringify_ArrayAtomicSimple = _test_assertStringify("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: ArrayAtomicSimple): string => { const assert = (input: any) => {
