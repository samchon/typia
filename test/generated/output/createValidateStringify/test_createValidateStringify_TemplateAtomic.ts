...
export const test_createValidateStringify_TemplateAtomic = _test_validateStringify("TemplateAtomic", TemplateAtomic.generate, (input: TemplateAtomic): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TemplateAtomic> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, TemplateAtomic.SPOILERS);
