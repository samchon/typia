...
export const test_createValidatePrune_TagMatrix = _test_validatePrune("TagMatrix", TagMatrix.generate, (input: any): typia.IValidation<TagMatrix> => { const validate = (input: any): typia.IValidation<TagMatrix> => {
    ...
    prune(input); return output; }, TagMatrix.SPOILERS);
