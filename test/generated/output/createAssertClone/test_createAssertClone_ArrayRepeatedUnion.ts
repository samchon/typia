...
export const test_createAssertClone_ArrayRepeatedUnion = _test_assertClone("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input: any): typia.Primitive<ArrayRepeatedUnion> => { const assert = (input: any): ArrayRepeatedUnion => {
...
}; assert(input); const output = clone(input); return output; }, ArrayRepeatedUnion.SPOILERS);
