...
export const test_createAssertStringify_MapSimple = _test_assertStringify("MapSimple", MapSimple.generate, (input: any): string => { const assert = (input: any): MapSimple => {
    ...
    return $so0(input);
}; return stringify(assert(input)); }, MapSimple.SPOILERS);
