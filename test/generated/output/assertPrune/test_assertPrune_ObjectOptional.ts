...
export const test_assertPrune_ObjectOptional = _test_assertPrune("ObjectOptional", ObjectOptional.generate, (input) => ((input: any): ObjectOptional => { const assert = (input: any): ObjectOptional => {
