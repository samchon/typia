...
export const test_createRandom_DynamicTree = _test_random("DynamicTree", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<DynamicTree> => {
    ...
    const $ro1 = (_recursive: boolean = true, _depth: number = 0): any => {
        const output = {} as any;
        if (5 >= _depth) {
            (generator?.array ?? $generator.array)(() => output[(generator?.customs ?? $generator.customs)?.string?.([]) ?? (generator?.string ?? $generator.string)()] = $ro0(true, _recursive ? 1 + _depth : _depth), (generator?.integer ?? $generator.integer)(0, 3));
        }
        return output;
    };
    return $ro0();
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<DynamicTree> => {
            ...
            })) && $ao1(input.children, _path + ".children", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".children",
                expected: "Record<string, DynamicTree>",
                value: input.children
            }));
            const $ao1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => false === _exceptionable || Object.keys(input).every((key: any) => {
                ...
                if (RegExp(/(.*)/).test(key))
                    return ("object" === typeof value && null !== value || $guard(_exceptionable, {
                        ...
                        value: value
                    })) && $ao0(value, _path + $join(key), true && _exceptionable) || $guard(_exceptionable, {
                        path: _path + $join(key),
                        expected: "DynamicTree",
                        value: value
                    });
