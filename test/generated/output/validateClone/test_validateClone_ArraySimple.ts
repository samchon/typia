...
export const test_validateClone_ArraySimple = _test_validateClone("ArraySimple", ArraySimple.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<ArraySimple.IPerson>>> => { const validate = (input: any): typia.IValidation<Array<ArraySimple.IPerson>> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; })(input), ArraySimple.SPOILERS);
