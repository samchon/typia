...
export const test_createAssertPrune_ArrayUnion = _test_assertPrune("ArrayUnion", ArrayUnion.generate, (input: any): ArrayUnion => { const assert = (input: any): ArrayUnion => {
...
}; assert(input); prune(input); return input; }, ArrayUnion.SPOILERS);
