...
type plainPruneTransformerNamespace struct{}

var PlainPruneTransformer = plainPruneTransformerNamespace{}

func (plainPruneTransformerNamespace) Transform(props nativeinternal.ITransformProps) *shimast.Node {
