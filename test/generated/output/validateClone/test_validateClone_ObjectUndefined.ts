...
export const test_validateClone_ObjectUndefined = _test_validateClone("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<ObjectUndefined.ILecture>>> => { const validate = (input: any): typia.IValidation<Array<ObjectUndefined.ILecture>> => {
    const errors = [] as any[];
