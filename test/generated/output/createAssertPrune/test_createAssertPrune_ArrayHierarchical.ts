...
export const test_createAssertPrune_ArrayHierarchical = _test_assertPrune("ArrayHierarchical", ArrayHierarchical.generate, (input: any): ArrayHierarchical => { const assert = (input: any): ArrayHierarchical => {
    ...
    if (Array.isArray(input))
        $pp0(input);
}; assert(input); prune(input); return input; }, ArrayHierarchical.SPOILERS);
