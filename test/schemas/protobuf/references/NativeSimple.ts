...
function createBaseNativeSimple(): NativeSimple {
  return {
    date: undefined,
...
export const NativeSimple = {
  encode(message: NativeSimple, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): NativeSimple {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseNativeSimple();
  ...
  fromJSON(object: any): NativeSimple {
    return {
  ...
  toJSON(message: NativeSimple): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<NativeSimple>, I>>(base?: I): NativeSimple {
    return NativeSimple.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<NativeSimple>, I>>(object: I): NativeSimple {
    const message = createBaseNativeSimple();
