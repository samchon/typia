...
export const test_assertClone_ArrayAtomicSimple = _test_assertClone("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.Primitive<ArrayAtomicSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ArrayAtomicSimple */; return output as ArrayAtomicSimple; })(input), ArrayAtomicSimple.SPOILERS);
