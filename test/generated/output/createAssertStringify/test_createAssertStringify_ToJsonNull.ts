...
export const test_createAssertStringify_ToJsonNull = _test_assertStringify("ToJsonNull", ToJsonNull.generate, (input: ToJsonNull): string => { const assert = (input: any) => {
