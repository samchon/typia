...
export const test_functional_validateFunction_ArrayHierarchical =
  _test_functional_validateFunction("ArrayHierarchical")(ArrayHierarchical)(
    (p: (input: ArrayHierarchical) => ArrayHierarchical) =>
      (
        input: ArrayHierarchical,
      ): import("typia").IValidation<ArrayHierarchical> => {
        const paramResults = [
