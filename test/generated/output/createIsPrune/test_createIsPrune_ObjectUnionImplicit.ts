...
export const test_createIsPrune_ObjectUnionImplicit = _test_isPrune("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: any): input is ObjectUnionImplicit => { const is = (input: any): input is ObjectUnionImplicit => {
    ...
    return false; prune(input); return true; }, ObjectUnionImplicit.SPOILERS);
