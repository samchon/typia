...
export const test_assertStringify_SetSimple = _test_assertStringify("SetSimple", SetSimple.generate, (input) => ((input: any): string => { const assert = (input: any): SetSimple => {
    ...
    return $so0(input);
}; return stringify(assert(input)); })(input), SetSimple.SPOILERS);
