...
export const test_createAssertClone_ObjectTuple = _test_assertClone("ObjectTuple", ObjectTuple.generate, (input: any): typia.Primitive<ObjectTuple> => { const assert = (input: any): ObjectTuple => {
...
}; assert(input); const output = clone(input); return output; }, ObjectTuple.SPOILERS);
