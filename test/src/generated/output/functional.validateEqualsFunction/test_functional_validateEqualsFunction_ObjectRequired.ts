...
export const test_functional_validateEqualsFunction_ObjectRequired =
  _test_functional_validateEqualsFunction("ObjectRequired")(ObjectRequired)(
    (p: (input: ObjectRequired) => ObjectRequired) =>
      (input: ObjectRequired): import("typia").IValidation<ObjectRequired> => {
        const paramResults = [
          ((input: any): typia.IValidation<Required<ObjectRequired.IBase>> => {
            const errors = [] as any[];
            const __is = (
              input: any,
        ...
        const result = ((
          input: any,
        ): typia.IValidation<Required<ObjectRequired.IBase>> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
