...
export const test_validatePrune_ObjectTuple = _test_validatePrune("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.IValidation<ObjectTuple> => { const validate = (input: any): typia.IValidation<ObjectTuple> => {
    const errors = [] as any[];
