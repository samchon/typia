...
export const test_createAssertPrune_ArrayAtomicAlias = _test_assertPrune("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input: any): ArrayAtomicAlias => { const assert = (input: any) => {
