...
export const test_notation_validateCamel_ConstantAtomicWrapper =
  ...
  >({
    convert: (input) =>
      ((
        input: any,
      ): typia.IValidation<typia.CamelCase<ConstantAtomicWrapper>> => {
        const validate = (
          input: any,
    ...
    assert: (input: any): typia.CamelCase<ConstantAtomicWrapper> => {
      const __is = (
        input: any,
      ): input is typia.CamelCase<ConstantAtomicWrapper> => {
