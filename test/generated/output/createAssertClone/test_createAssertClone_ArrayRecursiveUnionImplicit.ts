...
export const test_createAssertClone_ArrayRecursiveUnionImplicit = _test_assertClone("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input: any): typia.Primitive<ArrayRecursiveUnionImplicit> => { const assert = (input: any): ArrayRecursiveUnionImplicit => {
...
}; assert(input); const output = clone(input); return output; }, ArrayRecursiveUnionImplicit.SPOILERS);
