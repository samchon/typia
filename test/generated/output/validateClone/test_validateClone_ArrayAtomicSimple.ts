...
export const test_validateClone_ArrayAtomicSimple = _test_validateClone("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<[Array<boolean>, Array<number>, Array<string>]>> => { const validate = (input: any): typia.IValidation<[Array<boolean>, Array<number>, Array<string>]> => {
    const errors = [] as any[];
...
}; const clone = (input: [Array<boolean>, Array<number>, Array<string>]): typia.Primitive<[Array<boolean>, Array<number>, Array<string>]> => {
    ...
    output.data = clone(input); return output; })(input), ArrayAtomicSimple.SPOILERS);
