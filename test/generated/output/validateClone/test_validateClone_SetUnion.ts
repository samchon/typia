        ...
        ((input: any, _path: string, _exceptionable: boolean = true): input is Array<SetUnion.Union> => {
            ...
            return (Array.isArray(input) || $report(true, {
                ...
                const arrayPredicators = [
                    [
                        (top: any): any => "boolean" === typeof top,
                        (entire: any[]): any => entire.map((elem: any, _index2: number) => "boolean" === typeof elem || $report(true, {
                    ...
                    [
                        (top: any): any => "number" === typeof top && Number.isFinite(top),
                        (entire: any[]): any => entire.map((elem: any, _index3: number) => "number" === typeof elem && Number.isFinite(elem) || $report(true, {
                    ...
                    [
                        (top: any): any => "string" === typeof top,
                        (entire: any[]): any => entire.map((elem: any, _index4: number) => "string" === typeof elem || $report(true, {
                    ...
                    [
                        (top: any): any => Array.isArray(top) && top.map((elem: any, _index5: number) => "number" === typeof elem && Number.isFinite(elem)).every((flag: boolean) => flag),
                        (entire: any[]): any => entire.map((elem: any, _index6: number) => (Array.isArray(elem) || $report(true, {
                            path: _path + "[" + _index1 + "][" + _index6 + "]",
                            expected: "Array<number>",
                            value: elem
                        })) && elem.map((elem: any, _index7: number) => "number" === typeof elem && Number.isFinite(elem) || $report(true, {
                    ...
                    [
                        (top: any): any => "object" === typeof top && null !== top && $vo0(top, _path + "[0]", false),
                        (entire: any[]): any => entire.map((elem: any, _index8: number) => ("object" === typeof elem && null !== elem || $report(true, {
                            path: _path + "[" + _index1 + "][" + _index8 + "]",
                            expected: "SetUnion.Person",
                            value: elem
                        })) && $vo0(elem, _path + "[" + _index1 + "][" + _index8 + "]", true) || $report(true, {
                            path: _path + "[" + _index1 + "][" + _index8 + "]",
                            expected: "SetUnion.Person",
                            value: elem
                        })).every((flag: boolean) => flag)
