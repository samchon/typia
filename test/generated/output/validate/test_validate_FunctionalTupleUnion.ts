...
export const test_validate_FunctionalTupleUnion = _test_validate("FunctionalTupleUnion", FunctionalTupleUnion.generate, (input) => ((input: any): typia.IValidation<[FunctionalTupleUnion.Union, FunctionalTupleUnion.Union, FunctionalTupleUnion.Union, FunctionalTupleUnion.Union]> => {
