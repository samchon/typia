...
export const test_createAssertEquals_AtomicAlias = _test_assertEquals("AtomicAlias", AtomicAlias.generate, (input: any): AtomicAlias => {
    const $guard = (typia.createAssertEquals as any).guard;
    const __is = (input: any, _exceptionable: boolean = true): input is AtomicAlias => {
