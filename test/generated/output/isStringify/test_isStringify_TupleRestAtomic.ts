...
export const test_isStringify_TupleRestAtomic = _test_isStringify("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: [boolean, number, ...string[]]): string | null => { const is = (input: any): input is [boolean, number, ...string[]] => {
...
}; return is(input) ? stringify(input) : null; })(input), TupleRestAtomic.SPOILERS);
