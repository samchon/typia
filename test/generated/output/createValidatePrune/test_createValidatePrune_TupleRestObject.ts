...
export const test_createValidatePrune_TupleRestObject = _test_validatePrune("TupleRestObject", TupleRestObject.generate, (input: any): typia.IValidation<TupleRestObject> => { const validate = (input: any): typia.IValidation<TupleRestObject> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, TupleRestObject.SPOILERS);
