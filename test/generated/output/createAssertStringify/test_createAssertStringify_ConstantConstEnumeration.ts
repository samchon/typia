...
export const test_createAssertStringify_ConstantConstEnumeration = _test_assertStringify("ConstantConstEnumeration", ConstantConstEnumeration.generate, (input: any): string => { const assert = (input: any): ConstantConstEnumeration => {
...
}; return stringify(assert(input)); }, ConstantConstEnumeration.SPOILERS);
