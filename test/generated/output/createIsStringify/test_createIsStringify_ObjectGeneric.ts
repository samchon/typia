...
export const test_createIsStringify_ObjectGeneric = _test_isStringify("ObjectGeneric", ObjectGeneric.generate, (input: ObjectGeneric): string | null => { const is = (input: any): input is ObjectGeneric => {
...
}; return is(input) ? stringify(input) : null; }, ObjectGeneric.SPOILERS);
