...
export const test_assertStringify_TagType = _test_assertStringify("TagType", TagType.generate, (input) => ((input: any): string => { const assert = (input: any): Array<TagType.Type> => {
