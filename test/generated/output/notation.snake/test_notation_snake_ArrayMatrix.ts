...
export const test_notation_validateSnake_ArrayMatrix =
    _test_notation_validateGeneral("ArrayMatrix")<ArrayMatrix>(ArrayMatrix)<
        typia.SnakeCase<ArrayMatrix>
    >({
        convert: (input) =>
            ((input: any): typia.IValidation<typia.SnakeCase<ArrayMatrix>> => {
                const validate = (
                    input: any,
                ): typia.IValidation<ArrayMatrix> => {
                    const errors = [] as any[];
        ...
        assert: (input: any): typia.SnakeCase<ArrayMatrix> => {
            const __is = (
                input: any,
