...
export const test_isPrune_TagStep = _test_isPrune("TagStep", TagStep.generate, (input) => ((input: any): input is Array<TagStep.Type> => { const is = (input: any): input is Array<TagStep.Type> => {
