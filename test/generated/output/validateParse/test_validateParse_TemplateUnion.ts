...
export const test_validateParse_TemplateUnion = _test_validateParse("TemplateUnion", TemplateUnion.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<TemplateUnion>> => { const validate = (input: any): typia.IValidation<TemplateUnion> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), TemplateUnion.SPOILERS);
