...
export const test_validateClone_TemplateUnion = _test_validateClone("TemplateUnion", TemplateUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<TemplateUnion.Type>>> => { const validate = (input: any): typia.IValidation<Array<TemplateUnion.Type>> => {
    const __is = (input: any): input is Array<TemplateUnion.Type> => {
...
}; const clone = (input: Array<TemplateUnion.Type>): typia.Primitive<Array<TemplateUnion.Type>> => {
    const $io1 = (input: any): boolean => "string" === typeof input.name;
    ...
    output.data = clone(input); return output; })(input), TemplateUnion.SPOILERS);
