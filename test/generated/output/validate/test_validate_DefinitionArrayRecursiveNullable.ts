...
export const test_validate_DefinitionArrayRecursiveNullable = _test_validate("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input) => ((input: any): typia.IValidation<string | number | Array<DefinitionArrayRecursiveNullable> | null> => {
