...
export const test_assertPrune_ObjectUnionComposite = _test_assertPrune("ObjectUnionComposite", ObjectUnionComposite.generate, (input) => ((input: any): ObjectUnionComposite => { const assert = (input: any) => {
