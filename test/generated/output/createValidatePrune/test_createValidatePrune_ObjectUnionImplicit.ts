...
export const test_createValidatePrune_ObjectUnionImplicit = _test_validatePrune("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: any): typia.IValidation<ObjectUnionImplicit> => { const validate = (input: any): typia.IValidation<ObjectUnionImplicit> => {
    ...
    prune(input); return output; }, ObjectUnionImplicit.SPOILERS);
