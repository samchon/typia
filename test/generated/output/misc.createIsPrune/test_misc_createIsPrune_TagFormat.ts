...
export const test_misc_isPrune_TagFormat = _test_misc_isPrune(
    "TagFormat",
)<TagFormat>(TagFormat)((input: any): input is TagFormat => {
    const is = (input: any): input is TagFormat => {
        const $is_uuid = (typia.misc.createIsPrune as any).is_uuid;
        const $is_email = (typia.misc.createIsPrune as any).is_email;
        const $is_url = (typia.misc.createIsPrune as any).is_url;
        const $is_ipv4 = (typia.misc.createIsPrune as any).is_ipv4;
        const $is_ipv6 = (typia.misc.createIsPrune as any).is_ipv6;
        const $is_date = (typia.misc.createIsPrune as any).is_date;
        const $is_datetime = (typia.misc.createIsPrune as any).is_datetime;
        return (
            "object" === typeof input &&
            null !== input &&
