...
export const test_validateParse_ObjectGenericUnion = _test_validateParse("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ObjectGenericUnion>> => { const validate = (input: any): typia.IValidation<ObjectGenericUnion> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ObjectGenericUnion.SPOILERS);
