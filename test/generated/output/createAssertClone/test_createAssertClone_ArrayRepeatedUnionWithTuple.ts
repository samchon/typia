...
export const test_createAssertClone_ArrayRepeatedUnionWithTuple = _test_assertClone("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input: any): typia.Primitive<ArrayRepeatedUnionWithTuple> => { const assert = (input: any): ArrayRepeatedUnionWithTuple => {
...
}; assert(input); const output = clone(input); return output; }, ArrayRepeatedUnionWithTuple.SPOILERS);
