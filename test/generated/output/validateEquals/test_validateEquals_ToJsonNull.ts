...
export const test_validateEquals_ToJsonNull = _test_validateEquals("ToJsonNull", ToJsonNull.generate, (input) => ((input: any): typia.IValidation<ToJsonNull> => {
    const errors = [] as any[];
    const $report = (typia.validateEquals as any).report(errors);
    const __is = (input: any, _exceptionable: boolean = true): input is ToJsonNull => {
