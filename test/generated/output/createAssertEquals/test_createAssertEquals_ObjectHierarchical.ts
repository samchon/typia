...
export const test_createAssertEquals_ObjectHierarchical = _test_assertEquals("ObjectHierarchical", ObjectHierarchical.generate, (input: any) => {
    ...
    return input as ObjectHierarchical;
});
