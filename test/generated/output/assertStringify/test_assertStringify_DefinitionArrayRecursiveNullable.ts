...
export const test_assertStringify_DefinitionArrayRecursiveNullable = _test_assertStringify("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input) => ((input: any): string => { const assert = (input: any): string | number | Array<DefinitionArrayRecursiveNullable> | null => {
...
}; return stringify(assert(input)); })(input), DefinitionArrayRecursiveNullable.SPOILERS);
