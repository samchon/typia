...
export const test_isPrune_TemplateConstant = _test_isPrune("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): input is TemplateConstant => { const is = (input: any): input is TemplateConstant => {
