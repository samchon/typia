...
export const test_assertEquals_ObjectClosure = _test_assertEquals("ObjectClosure", ObjectClosure.generate, (input) => ((input: any) => {
    ...
    return input as { id: string; open: () => string; };
})(input));
