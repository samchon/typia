...
export const test_createValidatePrune_ObjectGenericAlias = _test_validatePrune("ObjectGenericAlias", ObjectGenericAlias.generate, (input: any): typia.IValidation<Alias> => { const validate = (input: any): typia.IValidation<Alias> => {
    const errors = [] as any[];
