...
export const test_validateStringify_TupleRestArray = _test_validateStringify("TupleRestArray", TupleRestArray.generate, (input) => ((input: [boolean, number, ...Array<string>[]]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[boolean, number, ...Array<string>[]]> => {
    ...
    output.data = stringify(input); return output; })(input), TupleRestArray.SPOILERS);
