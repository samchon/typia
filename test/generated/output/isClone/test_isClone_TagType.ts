...
export const test_isClone_TagType = _test_isClone("TagType", TagType.generate, (input) => ((input: any): typia.Primitive<TagType> | null => { const is = (input: any): input is TagType => {
