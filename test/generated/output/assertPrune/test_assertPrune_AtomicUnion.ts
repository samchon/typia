...
export const test_assertPrune_AtomicUnion = _test_assertPrune("AtomicUnion", AtomicUnion.generate, (input) => ((input: any): Array<AtomicUnion.Union> => { const assert = (input: any): Array<AtomicUnion.Union> => {
