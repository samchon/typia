...
export const test_createValidateClone_ObjectInternal = _test_validateClone("ObjectInternal", ObjectInternal.generate, (input: any): typia.IValidation<typia.Primitive<ObjectInternal>> => { const validate = (input: any): typia.IValidation<ObjectInternal> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ObjectInternal.SPOILERS);
