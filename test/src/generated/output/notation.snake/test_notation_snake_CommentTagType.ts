...
export const test_notation_validateSnake_CommentTagType =
  _test_notation_validateGeneral("CommentTagType")<CommentTagType>(
    ...
    convert: (input) =>
      ((input: any): typia.IValidation<typia.SnakeCase<CommentTagType>> => {
    ...
    assert: (input: any): typia.SnakeCase<CommentTagType> => {
      const __is = (input: any): input is typia.SnakeCase<CommentTagType> => {
        const $io0 = (input: any): boolean =>
          Array.isArray(input.value) &&
          input.value.every(
            (elem: any) =>
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.SnakeCase<CommentTagType> => {
