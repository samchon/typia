...
export const test_assertPrune_TupleRestArray = _test_assertPrune("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): TupleRestArray => { const assert = (input: any) => {
