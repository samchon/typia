...
export const test_createAssertClone_ArrayAny = _test_assertClone("ArrayAny", ArrayAny.generate, (input: any): typia.Primitive<ArrayAny> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ArrayAny */; return output as ArrayAny; }, ArrayAny.SPOILERS);
