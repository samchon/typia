...
export const test_validateClone_ArrayMatrix = _test_validateClone("ArrayMatrix", ArrayMatrix.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<Array<Array<number>>>>> => { const validate = (input: any): typia.IValidation<Array<Array<Array<number>>>> => {
