...
export const test_isPrune_ArrayRecursive = _test_isPrune("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): input is ICategory => { const is = (input: any): input is ICategory => {
