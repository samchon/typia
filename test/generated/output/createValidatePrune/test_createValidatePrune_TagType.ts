...
export const test_createValidatePrune_TagType = _test_validatePrune("TagType", TagType.generate, (input: any): typia.IValidation<TagType> => { const validate = (input: any): typia.IValidation<TagType> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, TagType.SPOILERS);
