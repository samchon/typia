...
export const test_assertStringify_ArrayUnion = _test_assertStringify("ArrayUnion", ArrayUnion.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ArrayUnion.IUnion> => {
...
}; return stringify(assert(input)); })(input), ArrayUnion.SPOILERS);
