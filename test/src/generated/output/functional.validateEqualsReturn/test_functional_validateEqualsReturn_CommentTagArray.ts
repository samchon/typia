...
export const test_functional_validateEqualsReturn_CommentTagArray =
  _test_functional_validateEqualsReturn("CommentTagArray")(CommentTagArray)(
    (p: (input: CommentTagArray) => CommentTagArray) =>
      (
        input: CommentTagArray,
      ): import("typia").IValidation<CommentTagArray> => {
