...
export const test_createValidate_ArrayRepeatedRequired = _test_validate("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input: any): typia.IValidation<ArrayRepeatedRequired> => {
    const errors = [] as any[];
