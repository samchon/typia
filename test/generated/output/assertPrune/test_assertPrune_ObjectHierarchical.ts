...
export const test_assertPrune_ObjectHierarchical = _test_assertPrune("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): ObjectHierarchical.ICustomer => { const assert = (input: any): ObjectHierarchical.ICustomer => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), ObjectHierarchical.SPOILERS);
