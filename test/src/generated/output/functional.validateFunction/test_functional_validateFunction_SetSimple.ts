...
export const test_functional_validateFunction_SetSimple =
  _test_functional_validateFunction("SetSimple")(SetSimple)(
    (p: (input: SetSimple) => SetSimple) =>
      (input: SetSimple): import("typia").IValidation<SetSimple> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<SetSimple> => {
          const errors = [] as any[];
          const __is = (input: any): input is SetSimple => {
            const $io0 = (input: any): boolean =>
              input.booleans instanceof Set &&
