...
export const test_functional_validateEqualsFunction_AtomicSimple =
  _test_functional_validateEqualsFunction("AtomicSimple")(AtomicSimple)(
    (p: (input: AtomicSimple) => AtomicSimple) =>
      (input: AtomicSimple): import("typia").IValidation<AtomicSimple> => {
        const paramResults = [
