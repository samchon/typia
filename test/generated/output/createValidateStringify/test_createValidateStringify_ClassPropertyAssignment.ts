...
export const test_createValidateStringify_ClassPropertyAssignment = _test_validateStringify("ClassPropertyAssignment", ClassPropertyAssignment.generate, (input: ClassPropertyAssignment): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ClassPropertyAssignment> => {
    ...
    output.data = stringify(input); return output; }, ClassPropertyAssignment.SPOILERS);
