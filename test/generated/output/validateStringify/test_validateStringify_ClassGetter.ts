...
export const test_validateStringify_ClassGetter = _test_validateStringify("ClassGetter", ClassGetter.generate, (input) => ((input: Person): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Person> => {
    const errors = [] as any[];
