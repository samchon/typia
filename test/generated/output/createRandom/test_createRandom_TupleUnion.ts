...
export const test_createRandom_TupleUnion = _test_random("TupleUnion", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<TupleUnion> => {
    ...
    const __is = (input: any): input is typia.Primitive<TupleUnion> => {
        return Array.isArray(input) && input.every((elem: any) => Array.isArray(elem) && (() => {
            const tupleList = [[(top: any) => elem.length === 3 && ("number" === typeof elem[0] && Number.isFinite(elem[0])) && "string" === typeof elem[1] && "boolean" === typeof elem[2], (top: any) => top.length === 3 && ("number" === typeof top[0] && Number.isFinite(top[0])) && "string" === typeof top[1] && "boolean" === typeof top[2]], [(top: any) => elem.length === 2 && "boolean" === typeof elem[0] && ("number" === typeof elem[1] && Number.isFinite(elem[1])), (top: any) => top.length === 2 && "boolean" === typeof top[0] && ("number" === typeof top[1] && Number.isFinite(top[1]))], [(top: any) => 0 <= elem.length && 1 >= elem.length && true, (top: any) => 0 <= top.length && 1 >= top.length && true]];
            const front = elem;
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<TupleUnion> => {
            return (Array.isArray(input) || $guard(true, {
                path: _path + "",
                expected: "Array<([any] | [boolean, number] | [number, string, boolean])>",
                value: input
            })) && input.every((elem: any, _index1: number) => (Array.isArray(elem) || $guard(true, {
                path: _path + "[" + _index1 + "]",
                expected: "([any] | [boolean, number] | [number, string, boolean])",
                value: elem
            })) && (() => {
                const tupleList = [[(top: any) => elem.length === 3 && ("number" === typeof elem[0] && Number.isFinite(elem[0])) && "string" === typeof elem[1] && "boolean" === typeof elem[2], (top: any) => (top.length === 3 || $guard(true, {
                            ...
                            expected: "number",
                            value: top[1]
                        }))], [(top: any) => 0 <= elem.length && 1 >= elem.length && true, (top: any) => (0 <= top.length && 1 >= top.length || $guard(true, {
                            path: _path + "[" + _index1 + "]",
                            expected: "[any]",
                            value: top
                        })) && true]];
                ...
                return $guard(_exceptionable, {
                    path: _path + "[" + _index1 + "]",
                    expected: "([number, string, boolean] | [boolean, number] | [any])",
                    value: elem
                });
            })());
        })(input, "$input", true);
