...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/functional/assertFunction.ts" 
      filename="examples/src/functional/assertFunction.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/functional/assertFunction.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/functional/isFunction.ts" 
      filename="examples/src/functional/isFunction.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/functional/isFunction.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/functional/validateFunction.ts" 
      filename="examples/src/functional/validateFunction.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/functional/validateFunction.js" 
