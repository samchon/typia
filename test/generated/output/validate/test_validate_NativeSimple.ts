...
export const test_validate_NativeSimple = _test_validate("NativeSimple", NativeSimple.generate, (input) => ((input: any): typia.IValidation<NativeSimple> => {
