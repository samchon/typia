...
export const test_createValidateClone_DefinitionArrayRecursiveNullable = _test_validateClone("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input: any): typia.IValidation<typia.Primitive<DefinitionArrayRecursiveNullable>> => { const validate = (input: any): typia.IValidation<DefinitionArrayRecursiveNullable> => {
    ...
    output.data = clone(input); return output; }, DefinitionArrayRecursiveNullable.SPOILERS);
