...
export const test_createValidateClone_TemplateAtomic = _test_validateClone("TemplateAtomic", TemplateAtomic.generate, (input: any): typia.IValidation<typia.Primitive<TemplateAtomic>> => { const validate = (input: any): typia.IValidation<TemplateAtomic> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, TemplateAtomic.SPOILERS);
