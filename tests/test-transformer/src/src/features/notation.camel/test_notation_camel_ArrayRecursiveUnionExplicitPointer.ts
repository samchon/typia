...
export const test_notation_validateCamel_ArrayRecursiveUnionExplicitPointer = (): void =>
    ...
    convert: (input) => typia.notations.validateCamel<ArrayRecursiveUnionExplicitPointer>(input),
