...
export const test_validateEquals_ArrayAtomicAlias = _test_validateEquals("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input) => ((input: any): typia.IValidation<ArrayAtomicAlias> => {
    const errors = [] as any[];
