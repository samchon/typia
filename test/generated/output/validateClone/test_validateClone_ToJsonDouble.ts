...
export const test_validateClone_ToJsonDouble = _test_validateClone("ToJsonDouble", ToJsonDouble.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ToJsonDouble.Parent>> => { const validate = (input: any): typia.IValidation<ToJsonDouble.Parent> => {
...
}; const clone = (input: ToJsonDouble.Parent): typia.Primitive<ToJsonDouble.Parent> => {
