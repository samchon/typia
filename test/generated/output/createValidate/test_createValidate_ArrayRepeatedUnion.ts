...
export const test_createValidate_ArrayRepeatedUnion = _test_validate("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input: any): typia.IValidation<ArrayRepeatedUnion> => {
    const errors = [] as any[];
