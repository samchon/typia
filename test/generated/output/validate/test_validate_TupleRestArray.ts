...
export const test_validate_TupleRestArray = _test_validate("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): typia.IValidation<[boolean, number, ...Array<string>[]]> => {
