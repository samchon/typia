...
export const test_llm_applicationEquals_3_0_ArrayRecursiveUnionExplicit = (): void =>
  _test_llm_applicationEquals({
    model: "3.0",
    name: "ArrayRecursiveUnionExplicit",
    factory: ArrayRecursiveUnionExplicit
  })(
    typia.llm.application<ArrayRecursiveUnionExplicitApplication, "3.0", { equals: true }>(),
  );
