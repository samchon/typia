...
export const test_createAssertEquals_ObjectGeneric = _test_assertEquals("ObjectGeneric", ObjectGeneric.generate, (input: any): ObjectGeneric => {
    const __is = (input: any, _exceptionable: boolean = true): input is ObjectGeneric => {
