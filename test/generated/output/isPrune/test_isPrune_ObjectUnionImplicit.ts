...
export const test_isPrune_ObjectUnionImplicit = _test_isPrune("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: any): input is ObjectUnionImplicit => { const is = (input: any): input is ObjectUnionImplicit => {
