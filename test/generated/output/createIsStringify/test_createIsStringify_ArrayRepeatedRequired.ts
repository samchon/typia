...
export const test_createIsStringify_ArrayRepeatedRequired = _test_isStringify("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input: ArrayRepeatedRequired): string | null => { const is = (input: any): input is ArrayRepeatedRequired => {
...
}; return is(input) ? stringify(input) : null; }, ArrayRepeatedRequired.SPOILERS);
