...
export const test_createAssertClone_ClassGetter = _test_assertClone("ClassGetter", ClassGetter.generate, (input: any): typia.Primitive<ClassGetter> => { const assert = (input: any): ClassGetter => {
...
}; assert(input); const output = clone(input); return output; }, ClassGetter.SPOILERS);
