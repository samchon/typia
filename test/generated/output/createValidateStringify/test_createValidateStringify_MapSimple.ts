...
export const test_createValidateStringify_MapSimple = _test_validateStringify("MapSimple", MapSimple.generate, (input: MapSimple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<MapSimple> => {
    ...
    output.data = stringify(input); return output; }, MapSimple.SPOILERS);
