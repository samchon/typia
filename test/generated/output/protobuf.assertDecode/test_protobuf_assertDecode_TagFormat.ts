        ...
        ((input: Uint8Array): TagFormat => {
            ...
            const assert = (input: any): TagFormat => {
                const __is = (input: any): input is TagFormat => {
                    const $is_uuid = (typia.protobuf.assertDecode as any)
                        .is_uuid;
                    const $is_email = (typia.protobuf.assertDecode as any)
                        .is_email;
                    const $is_url = (typia.protobuf.assertDecode as any).is_url;
                    const $is_ipv4 = (typia.protobuf.assertDecode as any)
                        .is_ipv4;
                    const $is_ipv6 = (typia.protobuf.assertDecode as any)
                        .is_ipv6;
                    const $is_date = (typia.protobuf.assertDecode as any)
                        .is_date;
                    const $is_datetime = (typia.protobuf.assertDecode as any)
                        .is_datetime;
                    return (
                        "object" === typeof input &&
                        null !== input &&
