...
export const test_equals_ToJsonAtomicSimple = _test_equals("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input) => ((input: any, _exceptionable: boolean): input is ToJsonAtomicSimple => {
