...
export const test_assertEquals_TupleRestObject = _test_assertEquals("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): [boolean, number, ...TupleRestObject.IObject[]] => {
