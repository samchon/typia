...
export const test_assertPrune_TagObjectUnion = _test_assertPrune("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): Array<TagObjectUnion.Type> => { const assert = (input: any): Array<TagObjectUnion.Type> => {
...
}; assert(input); prune(input); return input; })(input), TagObjectUnion.SPOILERS);
