...
export const test_llm_stringify_root_array_error = (): void => {
  ...
  TestValidator.equals("contains element 1", output.includes("1"), true);
  ...
  TestValidator.equals("element-code-block", output2.includes("```json"), true);
  TestValidator.equals("element-error-marker", output2.includes("// ❌"), true);
  TestValidator.equals("element-path", output2.includes("$input[2]"), true);
  ...
  TestValidator.equals("empty-code-block", output3.includes("```json"), true);
  TestValidator.equals("empty-error-marker", output3.includes("// ❌"), true);
  TestValidator.equals("empty-undefined", output3.includes("undefined"), true);
};
