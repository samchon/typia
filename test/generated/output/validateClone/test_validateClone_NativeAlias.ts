...
export const test_validateClone_NativeAlias = _test_validateClone("NativeAlias", NativeAlias.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<NativeAlias>> => { const validate = (input: any): typia.IValidation<NativeAlias> => {
