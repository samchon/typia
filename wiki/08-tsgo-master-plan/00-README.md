...
| 16 | [**Package Port Boundary**](16-package-port-boundary.md) ⭐ **신규** | **현행 9개 패키지 + 신규 전환 드라이버의 Go/TS 결정** |
| 17 | [**Phase 0 Kickoff**](17-phase0-kickoff.md) ⭐ **v2 신규** | **첫 6주 실행 가이드 + cycle 2 재실측 반영** |
