...
export const test_functional_validateEqualsReturnAsync_ObjectUnionCompositePointer =
  _test_functional_validateEqualsReturnAsync("ObjectUnionCompositePointer")(
