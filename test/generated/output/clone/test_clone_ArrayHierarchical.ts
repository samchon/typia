...
export const test_clone_ArrayHierarchical = _test_clone("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: ArrayHierarchical): typia.Primitive<ArrayHierarchical> => {
