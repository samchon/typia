...
export const test_misc_createPrune_DynamicEnumeration = _test_misc_prune(
  "DynamicEnumeration",
)<DynamicEnumeration>(DynamicEnumeration)((input: DynamicEnumeration): void => {
  const $io1 = (input: any): boolean =>
    (undefined === input.ar || "string" === typeof input.ar) &&
    (undefined === input["zh-Hans"] || "string" === typeof input["zh-Hans"]) &&
    (undefined === input["zh-Hant"] || "string" === typeof input["zh-Hant"]) &&
