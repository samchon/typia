...
export const test_isStringify_ConstantAtomicUnion = _test_isStringify("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input) => ((input: Array<ConstantAtomicUnion.Union>): string | null => { const is = (input: any): input is Array<ConstantAtomicUnion.Union> => {
