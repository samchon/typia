...
export const test_validateEquals_TupleRestArray = _test_validateEquals("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): typia.IValidation<TupleRestArray> => {
    const errors = [] as any[];
