...
export const test_createAssertClone_ClassMethod = _test_assertClone("ClassMethod", ClassMethod.generate, (input: any): typia.Primitive<ClassMethod> => { const assert = (input: any): ClassMethod => {
...
}; assert(input); const output = clone(input); return output; }, ClassMethod.SPOILERS);
