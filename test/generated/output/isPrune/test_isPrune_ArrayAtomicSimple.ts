...
export const test_isPrune_ArrayAtomicSimple = _test_isPrune("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): input is [Array<boolean>, Array<number>, Array<string>] => { const is = (input: any): input is [Array<boolean>, Array<number>, Array<string>] => {
