...
export const test_assertStringify_ToJsonTuple = _test_assertStringify("ToJsonTuple", ToJsonTuple.generate, (input) => ((input: ToJsonTuple): string => { const assert = (input: any) => {
