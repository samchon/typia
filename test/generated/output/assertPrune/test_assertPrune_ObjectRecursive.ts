...
export const test_assertPrune_ObjectRecursive = _test_assertPrune("ObjectRecursive", ObjectRecursive.generate, (input) => ((input: any): ObjectRecursive.IDepartment => { const assert = (input: any): ObjectRecursive.IDepartment => {
