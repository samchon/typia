...
export const test_createAssertPrune_ObjectSimple = _test_assertPrune("ObjectSimple", ObjectSimple.generate, (input: any): ObjectSimple => { const assert = (input: any): ObjectSimple => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, ObjectSimple.SPOILERS);
