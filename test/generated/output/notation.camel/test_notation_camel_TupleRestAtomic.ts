...
export const test_notation_validateCamel_TupleRestAtomic =
  _test_notation_validateGeneral("TupleRestAtomic")<TupleRestAtomic>(
    ...
    convert: (input) =>
      ((input: any): typia.IValidation<typia.CamelCase<TupleRestAtomic>> => {
    ...
    assert: (input: any): typia.CamelCase<TupleRestAtomic> => {
      const __is = (input: any): input is typia.CamelCase<TupleRestAtomic> => {
        return (
          Array.isArray(input) &&
          input.every(
            (elem: any) =>
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.CamelCase<TupleRestAtomic> => {
