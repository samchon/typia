...
export const test_createValidateStringify_NativeUnion = _test_validateStringify("NativeUnion", NativeUnion.generate, (input: NativeUnion): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<NativeUnion> => {
    ...
    output.data = stringify(input); return output; }, NativeUnion.SPOILERS);
