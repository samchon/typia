...
export const test_equals_ToJsonUndefined = _test_equals("ToJsonUndefined", ToJsonUndefined.generate, (input) => ((input: any, _exceptionable: boolean): input is ToJsonUndefined => {
