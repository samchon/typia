...
export const test_isPrune_ObjectGenericUnion = _test_isPrune("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): input is ISaleEntireArticle => { const is = (input: any): input is ISaleEntireArticle => {
