...
export const test_validateClone_ObjectGenericUnion = _test_validateClone("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ISaleQuestion | ISaleReview>> => { const validate = (input: any): typia.IValidation<ISaleQuestion | ISaleReview> => {
    ...
    output.data = clone(input); return output; })(input), ObjectGenericUnion.SPOILERS);
