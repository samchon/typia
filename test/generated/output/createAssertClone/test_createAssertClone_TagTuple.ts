...
export const test_createAssertClone_TagTuple = _test_assertClone("TagTuple", TagTuple.generate, (input: any): typia.Primitive<TagTuple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* TagTuple */; return output as TagTuple; }, TagTuple.SPOILERS);
