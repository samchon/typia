...
export const test_createIsClone_DynamicUnion = _test_isClone("DynamicUnion", DynamicUnion.generate, (input: any): typia.Primitive<DynamicUnion> | null => { const is = (input: any): input is DynamicUnion => {
    ...
    return null; const output = clone(input); return output; }, DynamicUnion.SPOILERS);
