...
export const test_json_assertParse_TagFormat = _test_json_assertParse(
    "TagFormat",
)<TagFormat>(TagFormat)((input: string): typia.Primitive<TagFormat> => {
    const assert = (input: any): TagFormat => {
        const __is = (input: any): input is TagFormat => {
            const $is_uuid = (typia.json.createAssertParse as any).is_uuid;
            const $is_email = (typia.json.createAssertParse as any).is_email;
            const $is_url = (typia.json.createAssertParse as any).is_url;
            const $is_ipv4 = (typia.json.createAssertParse as any).is_ipv4;
            const $is_ipv6 = (typia.json.createAssertParse as any).is_ipv6;
            const $is_date = (typia.json.createAssertParse as any).is_date;
