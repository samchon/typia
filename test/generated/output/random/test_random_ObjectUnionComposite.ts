...
export const test_random_ObjectUnionComposite = _test_random("ObjectUnionComposite", () => ((generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectUnionComposite> => {
