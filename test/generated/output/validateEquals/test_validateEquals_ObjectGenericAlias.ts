...
export const test_validateEquals_ObjectGenericAlias = _test_validateEquals("ObjectGenericAlias", ObjectGenericAlias.generate, (input) => ((input: any): typia.IValidation<Alias> => {
    const errors = [] as any[];
