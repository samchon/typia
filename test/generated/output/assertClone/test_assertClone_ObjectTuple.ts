...
export const test_assertClone_ObjectTuple = _test_assertClone("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.Primitive<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => { const assert = (input: any): [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
    const __is = (input: any): input is [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
    ...
    return input;
}; const clone = (input: [ObjectTuple.ISection, ObjectTuple.ICitizen]): typia.Primitive<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => {
    const $io0 = (input: any): boolean => "string" === typeof input.id && "string" === typeof input.code && "string" === typeof input.name;
    const $io1 = (input: any): boolean => "string" === typeof input.id && "string" === typeof input.mobile && "string" === typeof input.name;
...
}; assert(input); const output = clone(input); return output; })(input), ObjectTuple.SPOILERS);
