...
export const test_createAssertClone_ArraySimple = _test_assertClone("ArraySimple", ArraySimple.generate, (input: any): typia.Primitive<ArraySimple> => { const assert = (input: any): ArraySimple => {
...
}; assert(input); const output = clone(input); return output; }, ArraySimple.SPOILERS);
