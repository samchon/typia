...
export const test_validate_ArrayAtomicSimple = _test_validate("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.IValidation<[Array<boolean>, Array<number>, Array<string>]> => {
    const errors = [] as any[];
...
})(input), ArrayAtomicSimple.SPOILERS);
