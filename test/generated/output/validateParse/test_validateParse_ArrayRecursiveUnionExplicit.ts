...
export const test_validateParse_ArrayRecursiveUnionExplicit = _test_validateParse("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ArrayRecursiveUnionExplicit>> => { const validate = (input: any): typia.IValidation<ArrayRecursiveUnionExplicit> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ArrayRecursiveUnionExplicit.SPOILERS);
