...
export const test_assertEquals_AtomicClass = _test_assertEquals("AtomicClass", AtomicClass.generate, (input) => ((input: any): [Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String] => {
