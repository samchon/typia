...
export const test_notation_createValidateSnake_SetSimple =
  ...
  >({
    convert: (input: any): typia.IValidation<typia.SnakeCase<SetSimple>> => {
      ...
      const general = (input: SetSimple): typia.SnakeCase<SetSimple> => {
        const $io1 = (input: any): boolean =>
          "string" === typeof input.id &&
          "string" === typeof input.name &&
          "number" === typeof input.age;
    ...
    assert: (input: any): typia.SnakeCase<SetSimple> => {
      const __is = (input: any): input is typia.SnakeCase<SetSimple> => {
        const $io0 = (input: any): boolean =>
          input.booleans instanceof Set &&
          (() =>
            [...input.booleans].every(
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.SnakeCase<SetSimple> => {
          // @ts-ignore;
