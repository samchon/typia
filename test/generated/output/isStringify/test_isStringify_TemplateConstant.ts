...
export const test_isStringify_TemplateConstant = _test_isStringify("TemplateConstant", TemplateConstant.generate, (input) => ((input: Array<TemplateConstant.Type>): string | null => { const is = (input: any): input is Array<TemplateConstant.Type> => {
...
}; return is(input) ? stringify(input) : null; })(input), TemplateConstant.SPOILERS);
