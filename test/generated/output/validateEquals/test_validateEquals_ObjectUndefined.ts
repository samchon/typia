...
export const test_validateEquals_ObjectUndefined = _test_validateEquals("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): typia.IValidation<Array<ObjectUndefined.ILecture>> => {
    const errors = [] as any[];
