...
export const test_is_ArrayRecursiveUnionExplicit = _test_is("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): input is ArrayRecursiveUnionExplicit => {
