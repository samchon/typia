...
export const test_isParse_TagCustom = _test_isParse("TagCustom", TagCustom.generate, (input) => ((input: any): typia.Primitive<TagCustom> => { const is = (input: any): input is TagCustom => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; })(input), TagCustom.SPOILERS);
