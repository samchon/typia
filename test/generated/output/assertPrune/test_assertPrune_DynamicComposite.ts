...
export const test_assertPrune_DynamicComposite = _test_assertPrune("DynamicComposite", DynamicComposite.generate, (input) => ((input: any): DynamicComposite => { const assert = (input: any): DynamicComposite => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), DynamicComposite.SPOILERS);
