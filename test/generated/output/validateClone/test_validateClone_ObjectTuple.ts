...
export const test_validateClone_ObjectTuple = _test_validateClone("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<[ObjectTuple.ISection, ObjectTuple.ICitizen]>> => { const validate = (input: any): typia.IValidation<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => {
    ...
    output.data = clone(input); return output; })(input), ObjectTuple.SPOILERS);
