...
export const test_createRandom_ObjectLiteralProperty = _test_random("ObjectLiteralProperty", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    const $generator = (typia.createRandom as any).generator;
    const $ro0 = (recursive = false, depth = 0) => ({
        "something-interesting-do-you-want?": (generator.string ?? $generator.string)(),
        "or-something-crazy-do-you-want?": (generator.string ?? $generator.string)()
    });
    return $ro0();
}, (input: any) => {
    ...
    return input as typia.Primitive<ObjectLiteralProperty>;
});
