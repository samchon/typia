...
export const test_createAssertClone_TagCustom = _test_assertClone("TagCustom", TagCustom.generate, (input: any): typia.Primitive<TagCustom> => { const assert = (input: any): TagCustom => {
...
}; assert(input); const output = clone(input); return output; }, TagCustom.SPOILERS);
