...
export const test_functional_validateEqualsReturn_CommentTagNaN =
  _test_functional_validateEqualsReturn("CommentTagNaN")(CommentTagNaN)(
    (p: (input: CommentTagNaN) => CommentTagNaN) =>
      (input: CommentTagNaN): import("typia").IValidation<CommentTagNaN> => {
        const result = ((input: any): typia.IValidation<CommentTagNaN> => {
          const errors = [] as any[];
          const __is = (
            input: any,
