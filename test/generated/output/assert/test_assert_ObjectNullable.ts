...
export const test_assert_ObjectNullable = _test_assert("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct] => {
