...
export const test_assertStringify_ObjectUnionNonPredictable = _test_assertStringify("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>> => {
...
}; return stringify(assert(input)); })(input), ObjectUnionNonPredictable.SPOILERS);
