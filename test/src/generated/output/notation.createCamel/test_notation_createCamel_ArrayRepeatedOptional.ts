...
export const test_notation_createValidateCamel_ArrayRepeatedOptional =
  ...
  >({
    convert: (
      input: any,
    ): typia.IValidation<typia.CamelCase<ArrayRepeatedOptional>> => {
      const validate = (
        input: any,
    ...
    assert: (input: any): typia.CamelCase<ArrayRepeatedOptional> => {
      const __is = (
        input: any,
      ): input is typia.CamelCase<ArrayRepeatedOptional> => {
        const $ia0 = (input: any): any =>
          input.every(
            (elem: any) =>
              null !== elem &&
