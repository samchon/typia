...
export const test_createAssertStringify_TagAtomicUnion = _test_assertStringify("TagAtomicUnion", TagAtomicUnion.generate, (input: TagAtomicUnion): string => { const assert = (input: any) => {
