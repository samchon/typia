...
export const test_clone_ObjectUnionNonPredictable = _test_clone("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>>): typia.Primitive<Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>>> => {
