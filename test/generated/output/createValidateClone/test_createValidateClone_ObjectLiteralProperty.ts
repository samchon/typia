...
export const test_createValidateClone_ObjectLiteralProperty = _test_validateClone("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any): typia.IValidation<typia.Primitive<ISomething>> => { const validate = (input: any): typia.IValidation<ISomething> => {
    const errors = [] as any[];
