...
export const test_isClone_ToJsonAtomicSimple = _test_isClone("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input) => ((input: any): typia.Primitive<ToJsonAtomicSimple> | null => { const is = (input: any): input is ToJsonAtomicSimple => {
