...
export const test_createAssertClone_ConstantAtomicWrapper = _test_assertClone("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input: any): typia.Primitive<ConstantAtomicWrapper> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ConstantAtomicWrapper */; return output as ConstantAtomicWrapper; }, ConstantAtomicWrapper.SPOILERS);
