...
export const test_createAssertClone_DynamicNever = _test_assertClone("DynamicNever", DynamicNever.generate, (input: any): typia.Primitive<DynamicNever> => { const assert = (input: any): DynamicNever => {
...
}; assert(input); const output = clone(input); return output; }, DynamicNever.SPOILERS);
