...
export function equal(): never {
  NoTransformConfigurationError("misc.equal");
}
...
export function cover(): never {
  NoTransformConfigurationError("misc.cover");
}
...
/** @internal */
export function createEqual(): never {
  NoTransformConfigurationError("misc.createEqual");
}
...
/** @internal */
export function createCover(): never {
  NoTransformConfigurationError("misc.createCover");
}
