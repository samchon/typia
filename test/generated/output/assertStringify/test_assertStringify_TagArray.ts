...
export const test_assertStringify_TagArray = _test_assertStringify("TagArray", TagArray.generate, (input) => ((input: any): string => { const assert = (input: any): Array<TagArray.Type> => {
