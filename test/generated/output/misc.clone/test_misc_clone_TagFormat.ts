...
export const test_misc_clone_TagFormat = _test_misc_clone(
    ...
    ((input: TagFormat): typia.Resolved<TagFormat> => {
        const $is_uuid = (typia.misc.clone as any).is_uuid;
        const $is_email = (typia.misc.clone as any).is_email;
        const $is_url = (typia.misc.clone as any).is_url;
        const $is_ipv4 = (typia.misc.clone as any).is_ipv4;
        const $is_ipv6 = (typia.misc.clone as any).is_ipv6;
        const $is_date = (typia.misc.clone as any).is_date;
        const $is_datetime = (typia.misc.clone as any).is_datetime;
