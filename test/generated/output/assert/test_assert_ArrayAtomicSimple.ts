...
export const test_assert_ArrayAtomicSimple = _test_assert("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): [Array<boolean>, Array<number>, Array<string>] => {
