...
export const test_createValidateParse_ArraySimple = _test_validateParse("ArraySimple", ArraySimple.generate, (input: string): typia.IValidation<typia.Primitive<ArraySimple>> => { const validate = (input: any): typia.IValidation<ArraySimple> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, ArraySimple.SPOILERS);
