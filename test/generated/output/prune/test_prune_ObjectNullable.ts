...
export const test_prune_ObjectNullable = _test_prune("ObjectNullable", ObjectNullable.generate, (input) => ((input: [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]): void => {
