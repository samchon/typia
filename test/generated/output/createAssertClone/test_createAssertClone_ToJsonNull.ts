...
export const test_createAssertClone_ToJsonNull = _test_assertClone("ToJsonNull", ToJsonNull.generate, (input: any): typia.Primitive<ToJsonNull> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ToJsonNull */; return output as ToJsonNull; });
