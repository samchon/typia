...
export const test_createValidateParse_ObjectTuple = _test_validateParse("ObjectTuple", ObjectTuple.generate, (input: string): typia.IValidation<typia.Primitive<ObjectTuple>> => { const validate = (input: any): typia.IValidation<ObjectTuple> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, ObjectTuple.SPOILERS);
