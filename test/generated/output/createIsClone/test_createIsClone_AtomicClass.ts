...
export const test_createIsClone_AtomicClass = _test_isClone("AtomicClass", AtomicClass.generate, (input: any): typia.Primitive<AtomicClass> | null => { const is = (input: any): input is AtomicClass => {
    ...
    return null; const output = clone(input); return output; }, AtomicClass.SPOILERS);
