...
export const test_createAssertStringify_TagType = _test_assertStringify("TagType", TagType.generate, (input: any): string => { const assert = (input: any): TagType => {
...
}; return stringify(assert(input)); }, TagType.SPOILERS);
