...
export const test_createIsClone_ToJsonUnion = _test_isClone("ToJsonUnion", ToJsonUnion.generate, (input: any): typia.Primitive<ToJsonUnion> | null => { const is = (input: any): input is ToJsonUnion => {
