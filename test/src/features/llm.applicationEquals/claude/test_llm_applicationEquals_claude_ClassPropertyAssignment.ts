...
export const test_llm_applicationEquals_claude_ClassPropertyAssignment = (): void =>
  _test_llm_applicationEquals({
    model: "claude",
    name: "ClassPropertyAssignment",
    factory: ClassPropertyAssignment
  })(
    typia.llm.application<ClassPropertyAssignmentApplication, "claude", { equals: true }>(),
  );
