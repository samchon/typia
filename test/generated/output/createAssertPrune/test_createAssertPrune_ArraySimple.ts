...
export const test_createAssertPrune_ArraySimple = _test_assertPrune("ArraySimple", ArraySimple.generate, (input: any): ArraySimple => { const assert = (input: any): ArraySimple => {
    ...
    if (Array.isArray(input))
        $pp0(input);
}; assert(input); prune(input); return input; }, ArraySimple.SPOILERS);
