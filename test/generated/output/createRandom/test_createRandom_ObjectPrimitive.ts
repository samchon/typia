...
export const test_createRandom_ObjectPrimitive = _test_random("ObjectPrimitive", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectPrimitive> => {
    ...
    const $ro0 = (_recursive: boolean = false, _depth: number = 0): any => ({
        ...
        files: (generator?.array ?? $generator.array)(() => $ro1(_recursive, _recursive ? 1 + _depth : _depth)),
    ...
    const $ro1 = (_recursive: boolean = false, _depth: number = 0): any => ({
        ...
        extension: (generator?.customs ?? $generator.customs)?.string?.([]) ?? (generator?.string ?? $generator.string)(),
    ...
    const __is = (input: any): input is typia.Primitive<ObjectPrimitive> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectPrimitive> => {
