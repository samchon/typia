...
export const test_isStringify_ObjectUnionNonPredictable = _test_isStringify("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: ObjectUnionNonPredictable): string | null => { const is = (input: any): input is ObjectUnionNonPredictable => {
    ...
    const $io4 = (input: any) => "object" === typeof input.value && null !== input.value && ("number" === typeof input.value.value && !Number.isNaN(input.value.value));
