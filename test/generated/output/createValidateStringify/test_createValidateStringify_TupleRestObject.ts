...
export const test_createValidateStringify_TupleRestObject = _test_validateStringify("TupleRestObject", TupleRestObject.generate, (input: TupleRestObject): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TupleRestObject> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, TupleRestObject.SPOILERS);
