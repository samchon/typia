...
export const test_misc_validateClone_TagFormat = _test_misc_validateClone(
    ...
    (input: any): typia.IValidation<typia.Resolved<TagFormat>> => {
        const validate = (input: any): typia.IValidation<TagFormat> => {
            ...
            const __is = (input: any): input is TagFormat => {
                const $is_uuid = (typia.misc.createValidateClone as any)
                    .is_uuid;
                const $is_email = (typia.misc.createValidateClone as any)
                    .is_email;
                const $is_url = (typia.misc.createValidateClone as any).is_url;
                const $is_ipv4 = (typia.misc.createValidateClone as any)
                    .is_ipv4;
                const $is_ipv6 = (typia.misc.createValidateClone as any)
                    .is_ipv6;
                const $is_date = (typia.misc.createValidateClone as any)
                    .is_date;
                const $is_datetime = (typia.misc.createValidateClone as any)
                    .is_datetime;
                return (
                    "object" === typeof input &&
                    null !== input &&
            ...
            if (false === __is(input)) {
                ...
                ((
                    ...
                    const $is_email = (typia.misc.createValidateClone as any)
                        .is_email;
                    const $is_url = (typia.misc.createValidateClone as any)
                        .is_url;
                    const $is_ipv4 = (typia.misc.createValidateClone as any)
                        .is_ipv4;
                    const $is_ipv6 = (typia.misc.createValidateClone as any)
        ...
        const clone = (input: TagFormat): typia.Resolved<TagFormat> => {
            ...
            const $is_url = (typia.misc.createValidateClone as any).is_url;
            const $is_ipv4 = (typia.misc.createValidateClone as any).is_ipv4;
            const $is_ipv6 = (typia.misc.createValidateClone as any).is_ipv6;
            const $is_date = (typia.misc.createValidateClone as any).is_date;
            const $is_datetime = (typia.misc.createValidateClone as any)
                .is_datetime;
