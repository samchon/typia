...
export const test_isPrune_TupleRestArray = _test_isPrune("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): input is [boolean, number, ...Array<string>[]] => { const is = (input: any): input is [boolean, number, ...Array<string>[]] => {
