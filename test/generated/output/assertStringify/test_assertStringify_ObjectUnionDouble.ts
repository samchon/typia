...
export const test_assertStringify_ObjectUnionDouble = _test_assertStringify("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: ObjectUnionDouble): string => { const assert = (input: any) => {
