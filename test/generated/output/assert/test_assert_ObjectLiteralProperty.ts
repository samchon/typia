...
export const test_assert_ObjectLiteralProperty = _test_assert("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: any): ObjectLiteralProperty.ISomething => {
