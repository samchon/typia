...
export const test_createValidateStringify_DynamicConstant = _test_validateStringify("DynamicConstant", DynamicConstant.generate, (input: DynamicConstant): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<DynamicConstant> => {
    ...
    output.data = stringify(input); return output; }, DynamicConstant.SPOILERS);
