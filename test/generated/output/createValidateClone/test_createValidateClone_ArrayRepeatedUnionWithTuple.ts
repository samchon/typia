...
export const test_createValidateClone_ArrayRepeatedUnionWithTuple = _test_validateClone("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input: any): typia.IValidation<typia.Primitive<ArrayRepeatedUnionWithTuple>> => { const validate = (input: any): typia.IValidation<ArrayRepeatedUnionWithTuple> => {
    const errors = [] as any[];
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ArrayRepeatedUnionWithTuple => {
...
}; const clone = (input: ArrayRepeatedUnionWithTuple): typia.Primitive<ArrayRepeatedUnionWithTuple> => {
    ...
    output.data = clone(input); return output; }, ArrayRepeatedUnionWithTuple.SPOILERS);
