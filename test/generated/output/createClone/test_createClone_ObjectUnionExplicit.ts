...
export const test_createClone_ObjectUnionExplicit = _test_clone("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: ObjectUnionExplicit): typia.Primitive<ObjectUnionExplicit> => {
