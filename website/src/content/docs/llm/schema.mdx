...
<Tabs items={["TypeScript Source", "Compiled JavaScript"]}>
  <Tabs.Tab>
    <LocalSource
      ...
      filename="examples/src/llm/schema.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource
      path="examples/bin/llm/schema.js"
      filename="examples/bin/llm/schema.js"
      showLineNumbers />
  </Tabs.Tab>
</Tabs>
...
<Tabs items={["TypeScript Source", "Compiled JavaScript"]}>
  <Tabs.Tab>
    <LocalSource
      ...
      filename="examples/src/llm/schema-recursive-gemini.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource
      path="examples/bin/llm/schema-recursive-gemini.js"
      filename="examples/bin/llm/schema-recursive-gemini.js"
      showLineNumbers />
  </Tabs.Tab>
</Tabs>
