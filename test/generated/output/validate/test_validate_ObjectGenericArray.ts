...
export const test_validate_ObjectGenericArray = _test_validate("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): typia.IValidation<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>> => {
...
})(input), ObjectGenericArray.SPOILERS);
