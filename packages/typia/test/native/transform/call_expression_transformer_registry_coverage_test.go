...
func TestCallExpressionTransformerRegistryCoverage(t *testing.T) {
	...
	if !callExpressionTransformer_isTarget(filepath.Join("node_modules", "typia", "src", "module.ts")) ||
		!callExpressionTransformer_isTarget(filepath.Join("node_modules", "typia", "lib", "json.d.ts")) ||
		callExpressionTransformer_isTarget(filepath.Join("node_modules", "other", "src", "module.ts")) {
