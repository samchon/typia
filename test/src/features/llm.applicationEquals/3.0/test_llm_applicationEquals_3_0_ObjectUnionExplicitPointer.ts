...
export const test_llm_applicationEquals_3_0_ObjectUnionExplicitPointer = (): void =>
  _test_llm_applicationEquals({
    model: "3.0",
    name: "ObjectUnionExplicitPointer",
    factory: ObjectUnionExplicitPointer
  })(
    typia.llm.application<ObjectUnionExplicitPointerApplication, "3.0", { equals: true }>(),
  );
