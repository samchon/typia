...
export const test_validate_ToJsonTuple = _test_validate("ToJsonTuple", ToJsonTuple.generate, (input) => ((input: any): typia.IValidation<[ToJsonTuple.IToJson<string>, ToJsonTuple.IToJson<number>, ToJsonTuple.IToJson<boolean>, ToJsonTuple.IObject]> => {
    const errors = [] as any[];
