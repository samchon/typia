...
export const test_createValidateClone_MapSimple = _test_validateClone("MapSimple", MapSimple.generate, (input: any): typia.IValidation<typia.Primitive<MapSimple>> => { const validate = (input: any): typia.IValidation<MapSimple> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, MapSimple.SPOILERS);
