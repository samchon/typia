...
export const test_assertStringify_ToJsonNull = _test_assertStringify("ToJsonNull", ToJsonNull.generate, (input) => ((input: ToJsonNull): string => { const assert = (input: any) => {
