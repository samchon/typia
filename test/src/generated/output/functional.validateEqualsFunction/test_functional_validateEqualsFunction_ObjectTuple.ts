...
export const test_functional_validateEqualsFunction_ObjectTuple =
  _test_functional_validateEqualsFunction("ObjectTuple")(ObjectTuple)(
    (p: (input: ObjectTuple) => ObjectTuple) =>
      (input: ObjectTuple): import("typia").IValidation<ObjectTuple> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<ObjectTuple> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
