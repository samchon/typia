...
export const test_assertStringify_ArrayRepeatedNullable = _test_assertStringify("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input) => ((input: any): string => { const assert = (input: any): string | number | Array<ArrayRepeatedNullable> | null => {
...
}; return stringify(assert(input)); })(input), ArrayRepeatedNullable.SPOILERS);
