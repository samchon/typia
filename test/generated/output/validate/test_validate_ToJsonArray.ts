...
export const test_validate_ToJsonArray = _test_validate("ToJsonArray", ToJsonArray.generate, (input) => ((input: any): typia.IValidation<[ToJsonArray.IArray<boolean>, ToJsonArray.IArray<number>, ToJsonArray.IArray<string>, ToJsonArray.IArray<ToJsonArray.IObject>]> => {
