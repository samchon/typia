...
export const test_notation_createValidateSnake_ObjectHttpTypeTag =
    _test_notation_validateGeneral("ObjectHttpTypeTag")<ObjectHttpTypeTag>(
        ObjectHttpTypeTag,
    )<typia.SnakeCase<ObjectHttpTypeTag>>({
        convert: (
            input: any,
        ): typia.IValidation<typia.SnakeCase<ObjectHttpTypeTag>> => {
            const validate = (
                input: any,
            ): typia.IValidation<ObjectHttpTypeTag> => {
                const errors = [] as any[];
        ...
        assert: (input: any): typia.SnakeCase<ObjectHttpTypeTag> => {
            const __is = (
                input: any,
            ): input is typia.SnakeCase<ObjectHttpTypeTag> => {
                const $io0 = (input: any): boolean =>
                    "number" === typeof input.int32 &&
                    Math.floor(input.int32) === input.int32 &&
                    -2147483648 <= input.int32 &&
