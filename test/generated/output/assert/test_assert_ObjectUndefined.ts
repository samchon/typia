...
export const test_assert_ObjectUndefined = _test_assert("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): Array<ObjectUndefined.ILecture> => {
    ...
    return input;
})(input), ObjectUndefined.SPOILERS);
