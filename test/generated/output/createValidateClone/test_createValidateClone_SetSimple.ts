...
export const test_createValidateClone_SetSimple = _test_validateClone("SetSimple", SetSimple.generate, (input: any): typia.IValidation<typia.Primitive<SetSimple>> => { const validate = (input: any): typia.IValidation<SetSimple> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, SetSimple.SPOILERS);
