...
export const test_createRandom_TemplateAtomic = _test_random("TemplateAtomic", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<TemplateAtomic> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<TemplateAtomic> => {
