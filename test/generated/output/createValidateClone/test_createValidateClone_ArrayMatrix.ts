...
export const test_createValidateClone_ArrayMatrix = _test_validateClone("ArrayMatrix", ArrayMatrix.generate, (input: any): typia.IValidation<typia.Primitive<ArrayMatrix>> => { const validate = (input: any): typia.IValidation<ArrayMatrix> => {
    ...
    output.data = clone(input); return output; }, ArrayMatrix.SPOILERS);
