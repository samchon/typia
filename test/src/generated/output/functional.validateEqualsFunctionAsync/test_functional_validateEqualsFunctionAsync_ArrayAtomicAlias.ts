...
export const test_functional_validateEqualsFunctionAsync_ArrayAtomicAlias =
  _test_functional_validateEqualsFunctionAsync("ArrayAtomicAlias")(
    ArrayAtomicAlias,
  )(
    (p: (input: ArrayAtomicAlias) => Promise<ArrayAtomicAlias>) =>
      async (
        input: ArrayAtomicAlias,
      ): Promise<import("typia").IValidation<ArrayAtomicAlias>> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<ArrayAtomicAlias> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
