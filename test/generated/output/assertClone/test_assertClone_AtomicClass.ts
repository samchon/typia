...
export const test_assertClone_AtomicClass = _test_assertClone("AtomicClass", AtomicClass.generate, (input) => ((input: any): typia.Primitive<[Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String]> => { const assert = (input: any): [Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String] => {
...
}; assert(input); const output = clone(input); return output; })(input), AtomicClass.SPOILERS);
