...
export const test_createEquals_ObjectLiteralType = _test_equals("ObjectLiteralType", ObjectLiteralType.generate, (input: any, _exceptionable: boolean = true): input is ObjectLiteralType => {
