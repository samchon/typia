...
export const test_createValidateClone_DynamicTree = _test_validateClone("DynamicTree", DynamicTree.generate, (input: any): typia.IValidation<typia.Primitive<DynamicTree>> => { const validate = (input: any): typia.IValidation<DynamicTree> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, DynamicTree.SPOILERS);
