...
export const test_createAssertClone_ObjectHierarchical = _test_assertClone("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.Primitive<ObjectHierarchical> => { const assert = (input: any): ObjectHierarchical => {
    ...
    return input;
}; const clone = (input: ObjectHierarchical): typia.Primitive<ObjectHierarchical> => {
...
}; assert(input); const output = clone(input); return output; }, ObjectHierarchical.SPOILERS);
