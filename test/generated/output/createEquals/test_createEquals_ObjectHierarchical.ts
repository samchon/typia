...
export const test_createEquals_ObjectHierarchical = _test_equals("ObjectHierarchical", ObjectHierarchical.generate, (input: any, _exceptionable: boolean): input is ICustomer => {
