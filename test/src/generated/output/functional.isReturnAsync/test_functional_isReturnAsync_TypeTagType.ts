...
export const test_functional_isReturnAsync_TypeTagType =
  _test_functional_isReturnAsync("TypeTagType")(TypeTagType)(
    (p: (input: TypeTagType) => Promise<TypeTagType>) =>
      async (input: TypeTagType): Promise<TypeTagType | null> => {
        const result = await p(input);
        return ((input: any): input is TypeTagType => {
