...
export const test_isPrune_ObjectGeneric = _test_isPrune("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): input is ObjectGeneric => { const is = (input: any): input is ObjectGeneric => {
