...
export const test_misc_createValidateClone_ConstantAtomicSimple =
  _test_misc_validateClone("ConstantAtomicSimple")<ConstantAtomicSimple>(
    ConstantAtomicSimple,
  )((input: any): typia.IValidation<typia.Resolved<ConstantAtomicSimple>> => {
    const validate = (input: any): typia.IValidation<ConstantAtomicSimple> => {
      const errors = [] as any[];
