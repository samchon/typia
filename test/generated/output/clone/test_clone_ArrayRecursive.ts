...
export const test_clone_ArrayRecursive = _test_clone("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: ArrayRecursive.ICategory): typia.Primitive<ArrayRecursive.ICategory> => {
