...
export const test_assertClone_ObjectTuple = _test_assertClone("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.Primitive<ObjectTuple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectTuple */; return output as ObjectTuple; })(input), ObjectTuple.SPOILERS);
