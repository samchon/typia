...
export const test_validateClone_ObjectHierarchical = _test_validateClone("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectHierarchical.ICustomer>> => { const validate = (input: any): typia.IValidation<ObjectHierarchical.ICustomer> => {
    ...
    output.data = clone(input); return output; })(input), ObjectHierarchical.SPOILERS);
