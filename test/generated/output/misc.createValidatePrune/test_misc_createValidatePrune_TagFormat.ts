...
export const test_misc_validatePrune_TagFormat = _test_misc_validatePrune(
    "TagFormat",
)<TagFormat>(TagFormat)((input: any): typia.IValidation<TagFormat> => {
    const validate = (input: any): typia.IValidation<TagFormat> => {
        const errors = [] as any[];
        const __is = (input: any): input is TagFormat => {
            const $is_uuid = (typia.misc.createValidatePrune as any).is_uuid;
            const $is_email = (typia.misc.createValidatePrune as any).is_email;
            const $is_url = (typia.misc.createValidatePrune as any).is_url;
            const $is_ipv4 = (typia.misc.createValidatePrune as any).is_ipv4;
            const $is_ipv6 = (typia.misc.createValidatePrune as any).is_ipv6;
            const $is_date = (typia.misc.createValidatePrune as any).is_date;
            const $is_datetime = (typia.misc.createValidatePrune as any)
                .is_datetime;
            return (
                "object" === typeof input &&
                null !== input &&
        ...
        if (false === __is(input)) {
            ...
            ((
                ...
                const $is_uuid = (typia.misc.createValidatePrune as any)
                    .is_uuid;
                const $is_email = (typia.misc.createValidatePrune as any)
                    .is_email;
                const $is_url = (typia.misc.createValidatePrune as any).is_url;
                const $is_ipv4 = (typia.misc.createValidatePrune as any)
                    .is_ipv4;
                const $is_ipv6 = (typia.misc.createValidatePrune as any)
                    .is_ipv6;
                const $is_date = (typia.misc.createValidatePrune as any)
                    .is_date;
                const $is_datetime = (typia.misc.createValidatePrune as any)
                    .is_datetime;
                const $vo0 = (
