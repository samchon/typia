...
export const test_notation_createValidateSnake_ObjectSimpleProtobufOptional = (): void =>
    ...
    convert: typia.notations.createValidateSnake<ObjectSimpleProtobufOptional>(),
