...
export const test_functional_validateReturn_MapSimpleProtobufNullable =
  _test_functional_validateReturn("MapSimpleProtobufNullable")(
    MapSimpleProtobufNullable,
  )(
    (p: (input: MapSimpleProtobufNullable) => MapSimpleProtobufNullable) =>
      (
        input: MapSimpleProtobufNullable,
      ): import("typia").IValidation<MapSimpleProtobufNullable> => {
        const result = ((
          input: any,
