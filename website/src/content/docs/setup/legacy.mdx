...
This is the production-stable path. It uses [`ts-patch`](https://github.com/nonara/ts-patch) on top of the JavaScript TypeScript compiler and is an alternative to the native `ttsc` plugin path.
