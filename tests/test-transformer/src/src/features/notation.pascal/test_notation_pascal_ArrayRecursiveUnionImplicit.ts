...
export const test_notation_validatePascal_ArrayRecursiveUnionImplicit = (): void =>
    ...
    convert: (input) => typia.notations.validatePascal<ArrayRecursiveUnionImplicit>(input),
