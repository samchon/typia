...
export const test_createIsPrune_ArrayRecursive = _test_isPrune("ArrayRecursive", ArrayRecursive.generate, (input: any): input is ArrayRecursive => { const is = (input: any): input is ArrayRecursive => {
