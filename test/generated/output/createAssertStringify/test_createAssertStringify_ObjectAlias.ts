...
export const test_createAssertStringify_ObjectAlias = _test_assertStringify("ObjectAlias", ObjectAlias.generate, (input: ObjectAlias): string => { const assert = (input: any) => {
