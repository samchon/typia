...
export const test_createAssertClone_ObjectLiteralType = _test_assertClone("ObjectLiteralType", ObjectLiteralType.generate, (input: any): typia.Primitive<ObjectLiteralType> => { const assert = (input: any): ObjectLiteralType => {
...
}; assert(input); const output = clone(input); return output; }, ObjectLiteralType.SPOILERS);
