...
export const test_assertClone_ObjectSimple = _test_assertClone("ObjectSimple", ObjectSimple.generate, (input) => ((input: any): typia.Primitive<ObjectSimple.IBox3D> => { const assert = (input: any): ObjectSimple.IBox3D => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectSimple.SPOILERS);
