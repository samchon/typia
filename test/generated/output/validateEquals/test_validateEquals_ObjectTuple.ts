...
export const test_validateEquals_ObjectTuple = _test_validateEquals("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.IValidation<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => {
    const __is = (input: any, _exceptionable: boolean = true): input is [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
        const $io0 = (input: any, _exceptionable: boolean = true): boolean => "string" === typeof input.id && "string" === typeof input.code && "string" === typeof input.name && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io1 = (input: any, _exceptionable: boolean = true): boolean => "string" === typeof input.id && "string" === typeof input.mobile && "string" === typeof input.name && (3 === Object.keys(input).length || Object.keys(input).every(key => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
