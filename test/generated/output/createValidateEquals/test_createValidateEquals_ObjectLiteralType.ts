...
export const test_createValidateEquals_ObjectLiteralType = _test_validateEquals("ObjectLiteralType", ObjectLiteralType.generate, (input: any): typia.IValidation<{ id: string; name: string; age: number; }> => {
    const errors = [] as any[];
