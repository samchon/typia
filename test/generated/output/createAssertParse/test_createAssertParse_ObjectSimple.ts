...
export const test_createAssertParse_ObjectSimple = _test_assertParse("ObjectSimple", ObjectSimple.generate, (input: string): typia.Primitive<ObjectSimple> => { const assert = (input: any): ObjectSimple => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, ObjectSimple.SPOILERS);
