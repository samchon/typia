...
export const test_assertStringify_ObjectNullable = _test_assertStringify("ObjectNullable", ObjectNullable.generate, (input) => ((input: ObjectNullable): string => { const assert = (input: any) => {
