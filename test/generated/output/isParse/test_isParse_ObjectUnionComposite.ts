...
export const test_isParse_ObjectUnionComposite = _test_isParse("ObjectUnionComposite", ObjectUnionComposite.generate, (input) => ((input: any): typia.Primitive<ObjectUnionComposite> => { const is = (input: any): input is ObjectUnionComposite => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; })(input), ObjectUnionComposite.SPOILERS);
