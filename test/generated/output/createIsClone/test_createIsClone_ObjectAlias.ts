...
export const test_createIsClone_ObjectAlias = _test_isClone("ObjectAlias", ObjectAlias.generate, (input: any): typia.Primitive<ObjectAlias> | null => { const is = (input: any): input is ObjectAlias => {
    ...
    return null; const output = clone(input); return output; }, ObjectAlias.SPOILERS);
