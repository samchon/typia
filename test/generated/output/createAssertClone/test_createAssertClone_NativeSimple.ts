...
export const test_createAssertClone_NativeSimple = _test_assertClone("NativeSimple", NativeSimple.generate, (input: any): typia.Primitive<NativeSimple> => { const assert = (input: any): NativeSimple => {
...
}; assert(input); const output = clone(input); return output; }, NativeSimple.SPOILERS);
