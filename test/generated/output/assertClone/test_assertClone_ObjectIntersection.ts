...
export const test_assertClone_ObjectIntersection = _test_assertClone("ObjectIntersection", ObjectIntersection.generate, (input) => ((input: any): typia.Primitive<ObjectIntersection.IEmail & ObjectIntersection.IName> => { const assert = (input: any): ObjectIntersection.IEmail & ObjectIntersection.IName => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectIntersection.SPOILERS);
