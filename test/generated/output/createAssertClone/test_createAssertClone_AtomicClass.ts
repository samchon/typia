...
export const test_createAssertClone_AtomicClass = _test_assertClone("AtomicClass", AtomicClass.generate, (input: any): typia.Primitive<AtomicClass> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* AtomicClass */; return output as AtomicClass; }, AtomicClass.SPOILERS);
