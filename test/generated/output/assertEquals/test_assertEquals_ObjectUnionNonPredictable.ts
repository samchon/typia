...
export const test_assertEquals_ObjectUnionNonPredictable = _test_assertEquals("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: any): Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>> => {
