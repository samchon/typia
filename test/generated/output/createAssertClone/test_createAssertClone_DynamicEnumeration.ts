...
export const test_createAssertClone_DynamicEnumeration = _test_assertClone("DynamicEnumeration", DynamicEnumeration.generate, (input: any): typia.Primitive<DynamicEnumeration> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* __type */; return output as DynamicEnumeration; }, DynamicEnumeration.SPOILERS);
