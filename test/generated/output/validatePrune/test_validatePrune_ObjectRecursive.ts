...
export const test_validatePrune_ObjectRecursive = _test_validatePrune("ObjectRecursive", ObjectRecursive.generate, (input) => ((input: any): typia.IValidation<ObjectRecursive.IDepartment> => { const validate = (input: any): typia.IValidation<ObjectRecursive.IDepartment> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ObjectRecursive.SPOILERS);
