...
export const test_isStringify_TupleRestArray = _test_isStringify("TupleRestArray", TupleRestArray.generate, (input) => ((input: TupleRestArray): string | null => { const is = (input: any): input is TupleRestArray => {
