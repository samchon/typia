...
export const test_assertPrune_ArrayUnion = _test_assertPrune("ArrayUnion", ArrayUnion.generate, (input) => ((input: any): Array<ArrayUnion.IUnion> => { const assert = (input: any): Array<ArrayUnion.IUnion> => {
