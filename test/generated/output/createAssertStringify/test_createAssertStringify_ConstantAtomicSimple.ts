...
export const test_createAssertStringify_ConstantAtomicSimple = _test_assertStringify("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input: ConstantAtomicSimple): string => { const assert = (input: any) => {
