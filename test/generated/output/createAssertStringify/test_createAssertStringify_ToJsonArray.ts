...
export const test_createAssertStringify_ToJsonArray = _test_assertStringify("ToJsonArray", ToJsonArray.generate, (input: ToJsonArray): string => { const assert = (input: any) => {
