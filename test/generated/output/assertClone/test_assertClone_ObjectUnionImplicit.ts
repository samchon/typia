...
export const test_assertClone_ObjectUnionImplicit = _test_assertClone("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: any): typia.Primitive<Array<ObjectUnionImplicit.IPoint | ObjectUnionImplicit.ILine | ObjectUnionImplicit.ITriangle | ObjectUnionImplicit.IRectangle | ObjectUnionImplicit.IPolyline | ObjectUnionImplicit.IPolygon | ObjectUnionImplicit.ICircle>> => { const assert = (input: any): Array<ObjectUnionImplicit.IPoint | ObjectUnionImplicit.ILine | ObjectUnionImplicit.ITriangle | ObjectUnionImplicit.IRectangle | ObjectUnionImplicit.IPolyline | ObjectUnionImplicit.IPolygon | ObjectUnionImplicit.ICircle> => {
    ...
    const $cp1 = (input: any) => input.map((elem: any) => "object" === typeof elem && null !== elem ? $co0(elem) : elem as any);
    const $cp2 = (input: any) => input.map((elem: any) => "object" === typeof elem && null !== elem ? $co4(elem) : elem as any);
    ...
    const $co4 = (input: any): any => ({
        points: Array.isArray(input.points) ? $cp1(input.points) : input.points as any,
        length: input.length as any
    });
    const $co5 = (input: any): any => ({
        outer: "object" === typeof input.outer && null !== input.outer ? $co4(input.outer) : input.outer as any,
        inner: Array.isArray(input.inner) ? $cp2(input.inner) : input.inner as any,
        area: input.area as any
    });
