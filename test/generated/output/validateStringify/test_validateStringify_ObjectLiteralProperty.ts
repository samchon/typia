...
export const test_validateStringify_ObjectLiteralProperty = _test_validateStringify("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: ISomething): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ISomething> => {
    const errors = [] as any[];
