...
export const test_isPrune_ObjectUnionDouble = _test_isPrune("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): input is ObjectUnionDouble => { const is = (input: any): input is ObjectUnionDouble => {
