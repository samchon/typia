...
export const test_createValidatePrune_ObjectGenericUnion = _test_validatePrune("ObjectGenericUnion", ObjectGenericUnion.generate, (input: any): typia.IValidation<ISaleEntireArticle> => { const validate = (input: any): typia.IValidation<ISaleEntireArticle> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ObjectGenericUnion.SPOILERS);
