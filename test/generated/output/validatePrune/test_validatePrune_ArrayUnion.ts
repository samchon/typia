...
export const test_validatePrune_ArrayUnion = _test_validatePrune("ArrayUnion", ArrayUnion.generate, (input) => ((input: any): typia.IValidation<Array<ArrayUnion.IUnion>> => { const validate = (input: any): typia.IValidation<Array<ArrayUnion.IUnion>> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ArrayUnion.SPOILERS);
