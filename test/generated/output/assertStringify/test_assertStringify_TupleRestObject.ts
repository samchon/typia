...
export const test_assertStringify_TupleRestObject = _test_assertStringify("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): string => { const assert = (input: any): [boolean, number, ...TupleRestObject.IObject[]] => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is [boolean, number, ...TupleRestObject.IObject[]] => {
            ...
            return (Array.isArray(input) || $guard(true, {
                ...
                expected: "TupleRestObject.IObject",
                value: elem
            })) && $ao0(elem, _path + "[" + (2 + _index1) + "]", true) || $guard(true, {
                path: _path + "[" + (2 + _index1) + "]",
                expected: "TupleRestObject.IObject",
                value: elem
            })) || $guard(true, {
...
}; return stringify(assert(input)); })(input), TupleRestObject.SPOILERS);
