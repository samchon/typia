...
export const test_createIsClone_DefinitionJsonValue = _test_isClone("DefinitionJsonValue", DefinitionJsonValue.generate, (input: any): typia.Primitive<DefinitionJsonValue> | null => { const is = (input: any): input is DefinitionJsonValue => {
    ...
    return null; const output = clone(input); return output; }, DefinitionJsonValue.SPOILERS);
