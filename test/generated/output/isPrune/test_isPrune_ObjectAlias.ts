...
export const test_isPrune_ObjectAlias = _test_isPrune("ObjectAlias", ObjectAlias.generate, (input) => ((input: any): input is ObjectAlias => { const is = (input: any): input is ObjectAlias => {
