...
export const test_createAssertClone_AtomicUnion = _test_assertClone("AtomicUnion", AtomicUnion.generate, (input: any): typia.Primitive<AtomicUnion> => { const assert = (input: any): AtomicUnion => {
...
}; assert(input); const output = clone(input); return output; }, AtomicUnion.SPOILERS);
