...
export const test_assertPrune_ObjectGenericUnion = _test_assertPrune("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): ISaleQuestion | ISaleReview => { const assert = (input: any): ISaleQuestion | ISaleReview => {
    ...
    return input;
}; const prune = (input: ISaleQuestion | ISaleReview): void => {
    ...
    if ("object" === typeof input && null !== input)
        $pu0(input);
}; assert(input); prune(input); return input; })(input), ObjectGenericUnion.SPOILERS);
