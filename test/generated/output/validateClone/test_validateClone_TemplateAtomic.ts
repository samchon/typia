...
export const test_validateClone_TemplateAtomic = _test_validateClone("TemplateAtomic", TemplateAtomic.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<TemplateAtomic>> => { const validate = (input: any): typia.IValidation<TemplateAtomic> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; })(input), TemplateAtomic.SPOILERS);
