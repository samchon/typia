...
export const test_functional_isReturnAsync_SetUnion =
  _test_functional_isReturnAsync("SetUnion")(SetUnion)(
    (p: (input: SetUnion) => Promise<SetUnion>) =>
      async (input: SetUnion): Promise<SetUnion | null> => {
        const result = await p(input);
        return ((input: any): input is SetUnion => {
