...
export const test_createValidateEquals_ConstantEnumeration = _test_validateEquals("ConstantEnumeration", ConstantEnumeration.generate, (input: any): typia.IValidation<ConstantEnumeration> => {
    const __is = (input: any, _exceptionable: boolean = true): input is ConstantEnumeration => {
