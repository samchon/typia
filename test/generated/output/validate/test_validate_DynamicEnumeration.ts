...
export const test_validate_DynamicEnumeration = _test_validate("DynamicEnumeration", DynamicEnumeration.generate, (input) => ((input: any): typia.IValidation<DynamicEnumeration> => {
    const errors = [] as any[];
