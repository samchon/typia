...
export const test_isPrune_ObjectTuple = _test_isPrune("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): input is ObjectTuple => { const is = (input: any): input is ObjectTuple => {
