...
export const test_createEquals_TagObjectUnion = _test_equals("TagObjectUnion", TagObjectUnion.generate, (input: any, _exceptionable: boolean): input is TagObjectUnion => {
