...
export const test_createValidatePrune_ArrayMatrix = _test_validatePrune("ArrayMatrix", ArrayMatrix.generate, (input: any): typia.IValidation<ArrayMatrix> => { const validate = (input: any): typia.IValidation<ArrayMatrix> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ArrayMatrix.SPOILERS);
