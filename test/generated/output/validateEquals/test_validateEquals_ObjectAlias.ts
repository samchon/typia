...
export const test_validateEquals_ObjectAlias = _test_validateEquals("ObjectAlias", ObjectAlias.generate, (input) => ((input: any): typia.IValidation<Array<ObjectAlias.IMember>> => {
    const errors = [] as any[];
