...
export const test_isStringify_ObjectUnionNonPredictable = _test_isStringify("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>>): string | null => { const is = (input: any): input is Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>> => {
...
}; return is(input) ? stringify(input) : null; })(input), ObjectUnionNonPredictable.SPOILERS);
