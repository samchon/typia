...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/validate.ts" 
      filename="examples/src/validators/validate.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/validate.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/validateEquals.ts" 
      filename="examples/src/validators/validateEquals.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/validateEquals.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/createValidate.ts" 
      filename="examples/src/validators/createValidate.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/createValidate.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/validate-map.ts" 
      filename="examples/src/validators/validate-map.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/validate-map.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/validators/validate-custom-tags.ts" 
      filename="examples/src/validators/validate-custom-tags.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/validators/validate-custom-tags.js" 
