...
export const test_createAssertPrune_ObjectPropertyNullable = _test_assertPrune("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input: any): ObjectPropertyNullable => { const assert = (input: any): ObjectPropertyNullable => {
