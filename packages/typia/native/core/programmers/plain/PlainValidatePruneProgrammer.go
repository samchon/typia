...
type plainValidatePruneProgrammerNamespace struct{}

var PlainValidatePruneProgrammer = plainValidatePruneProgrammerNamespace{}

type PlainValidatePruneProgrammer_DecomposeProps struct {
...
var plainValidatePruneProgrammer_factory = shimast.NewNodeFactory(shimast.NodeFactoryHooks{})

func (plainValidatePruneProgrammerNamespace) Decompose(props PlainValidatePruneProgrammer_DecomposeProps) nativeinternal.FeatureProgrammer_IDecomposed {
  f := nativecontext.EmitFactoryOf(plainValidatePruneProgrammer_factory, props.Context.Emit)
  ...
  return nativeinternal.FeatureProgrammer_IDecomposed{
    Functions:  plainProgrammer_merge_functions(validate.Functions, prune.Functions),
...
func (plainValidatePruneProgrammerNamespace) Write(props nativecontext.IProgrammerProps) *shimast.Node {
  functor := nativehelpers.NewFunctionProgrammer(plainCloneProgrammer_method_text(props.Modulo), props.Context.Emit)
  result := PlainValidatePruneProgrammer.Decompose(PlainValidatePruneProgrammer_DecomposeProps{
    Context: props.Context,
    Modulo:  props.Modulo,
    Functor: functor,
    Type:    props.Type,
