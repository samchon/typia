...
export const test_clone_ObjectGeneric = _test_clone("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]): typia.Primitive<[ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]> => {
