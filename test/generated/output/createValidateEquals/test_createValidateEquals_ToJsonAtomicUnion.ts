...
export const test_createValidateEquals_ToJsonAtomicUnion = _test_validateEquals("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input: any): typia.IValidation<ToJsonAtomicUnion> => {
