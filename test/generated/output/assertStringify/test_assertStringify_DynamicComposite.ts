...
export const test_assertStringify_DynamicComposite = _test_assertStringify("DynamicComposite", DynamicComposite.generate, (input) => ((input: DynamicComposite): string => { const assert = (input: any) => {
