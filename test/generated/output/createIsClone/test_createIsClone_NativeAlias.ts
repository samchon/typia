...
export const test_createIsClone_NativeAlias = _test_isClone("NativeAlias", NativeAlias.generate, (input: any): typia.Primitive<NativeAlias> | null => { const is = (input: any): input is NativeAlias => {
    ...
    return null; const output = clone(input); return output; }, NativeAlias.SPOILERS);
