...
export const test_createAssertStringify_TupleRestArray = _test_assertStringify("TupleRestArray", TupleRestArray.generate, (input: TupleRestArray): string => { const assert = (input: any) => {
