...
export const test_assertPrune_ArrayRecursiveUnionImplicit = _test_assertPrune("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): Array<ArrayRecursiveUnionImplicit.IBucket> => { const assert = (input: any): Array<ArrayRecursiveUnionImplicit.IBucket> => {
...
}; assert(input); prune(input); return input; })(input), ArrayRecursiveUnionImplicit.SPOILERS);
