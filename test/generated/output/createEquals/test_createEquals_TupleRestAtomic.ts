...
export const test_createEquals_TupleRestAtomic = _test_equals("TupleRestAtomic", TupleRestAtomic.generate, (input: any, _exceptionable: boolean): input is TupleRestAtomic => {
