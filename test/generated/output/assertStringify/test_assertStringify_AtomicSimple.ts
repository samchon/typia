...
export const test_assertStringify_AtomicSimple = _test_assertStringify("AtomicSimple", AtomicSimple.generate, (input) => ((input: AtomicSimple): string => { const assert = (input: any) => {
