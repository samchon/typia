...
export const test_assertPrune_DynamicTemplate = _test_assertPrune("DynamicTemplate", DynamicTemplate.generate, (input) => ((input: any): DynamicTemplate => { const assert = (input: any) => {
