...
export const test_isStringify_TemplateUnion = _test_isStringify("TemplateUnion", TemplateUnion.generate, (input) => ((input: Array<TemplateUnion.Type>): string | null => { const is = (input: any): input is Array<TemplateUnion.Type> => {
