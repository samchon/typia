...
export const test_createValidatePrune_ConstantEnumeration = _test_validatePrune("ConstantEnumeration", ConstantEnumeration.generate, (input: any): typia.IValidation<ConstantEnumeration> => { const validate = (input: any): typia.IValidation<ConstantEnumeration> => {
    ...
    prune(input); return output; }, ConstantEnumeration.SPOILERS);
