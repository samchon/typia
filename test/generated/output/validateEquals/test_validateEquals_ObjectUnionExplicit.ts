...
export const test_validateEquals_ObjectUnionExplicit = _test_validateEquals("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input) => ((input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
