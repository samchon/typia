...
export const test_validateStringify_DynamicUndefined = _test_validateStringify("DynamicUndefined", DynamicUndefined.generate, (input) => ((input: DynamicUndefined): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<DynamicUndefined> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), DynamicUndefined.SPOILERS);
