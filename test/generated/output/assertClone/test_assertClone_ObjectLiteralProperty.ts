...
export const test_assertClone_ObjectLiteralProperty = _test_assertClone("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: any): typia.Primitive<ISomething> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectLiteralProperty.ISomething */; return output as ISomething; })(input), ObjectLiteralProperty.SPOILERS);
