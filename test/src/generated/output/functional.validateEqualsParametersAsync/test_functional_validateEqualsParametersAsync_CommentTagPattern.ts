...
export const test_functional_validateEqualsParametersAsync_CommentTagPattern =
  _test_functional_validateEqualsParametersAsync("CommentTagPattern")(
    CommentTagPattern,
  )(
    (p: (input: CommentTagPattern) => Promise<CommentTagPattern>) =>
      async (
        input: CommentTagPattern,
      ): Promise<import("typia").IValidation<CommentTagPattern>> => {
        const paramResults = [
          ((input: any): typia.IValidation<CommentTagPattern> => {
            const errors = [] as any[];
            const __is = (
              input: any,
