...
export const test_createValidatePrune_TemplateAtomic = _test_validatePrune("TemplateAtomic", TemplateAtomic.generate, (input: any): typia.IValidation<TemplateAtomic> => { const validate = (input: any): typia.IValidation<TemplateAtomic> => {
    ...
    prune(input); return output; }, TemplateAtomic.SPOILERS);
