...
export const test_equals_ConstantAtomicWrapper = _test_equals("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input) => ((input: any, _exceptionable: boolean): input is ConstantAtomicWrapper => {
