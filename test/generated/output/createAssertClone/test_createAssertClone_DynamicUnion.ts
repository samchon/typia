...
export const test_createAssertClone_DynamicUnion = _test_assertClone("DynamicUnion", DynamicUnion.generate, (input: any): typia.Primitive<DynamicUnion> => { const assert = (input: any): DynamicUnion => {
...
}; assert(input); const output = clone(input); return output; }, DynamicUnion.SPOILERS);
