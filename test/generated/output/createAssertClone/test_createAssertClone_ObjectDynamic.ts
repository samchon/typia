...
export const test_createAssertClone_ObjectDynamic = _test_assertClone("ObjectDynamic", ObjectDynamic.generate, (input: any): typia.Primitive<ObjectDynamic> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectDynamic */; return output as ObjectDynamic; }, ObjectDynamic.SPOILERS);
