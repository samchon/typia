...
export const test_createRandom_ObjectUnionImplicit = _test_random("ObjectUnionImplicit", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectUnionImplicit> => {
    ...
    const $ro4 = (_recursive: boolean = false, _depth: number = 0): any => ({
        points: (generator?.array ?? $generator.array)(() => $ro0(_recursive, _recursive ? 1 + _depth : _depth)),
        length: $pick([
            () => undefined,
            () => null,
            () => (generator?.customs ?? $generator.customs)?.number?.([]) ?? (generator?.number ?? $generator.number)(0, 100)
    ...
    const $ro5 = (_recursive: boolean = false, _depth: number = 0): any => ({
        ...
        inner: $pick([
            () => undefined,
            () => (generator?.array ?? $generator.array)(() => $ro4(_recursive, _recursive ? 1 + _depth : _depth))
        ])(),
        area: $pick([
            () => undefined,
            () => null,
    ...
    const $ro6 = (_recursive: boolean = false, _depth: number = 0): any => ({
        ...
        radius: (generator?.customs ?? $generator.customs)?.number?.([]) ?? (generator?.number ?? $generator.number)(0, 100),
        area: $pick([
            () => undefined,
            () => null,
            () => (generator?.customs ?? $generator.customs)?.number?.([]) ?? (generator?.number ?? $generator.number)(0, 100)
    ...
    const __is = (input: any): input is typia.Primitive<ObjectUnionImplicit> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectUnionImplicit> => {
