...
export const test_createValidateParse_DefinitionArrayRecursiveNullable = _test_validateParse("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input: string): typia.IValidation<typia.Primitive<DefinitionArrayRecursiveNullable>> => { const validate = (input: any): typia.IValidation<DefinitionArrayRecursiveNullable> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, DefinitionArrayRecursiveNullable.SPOILERS);
