...
export const test_createValidatePrune_ArrayRecursive = _test_validatePrune("ArrayRecursive", ArrayRecursive.generate, (input: any): typia.IValidation<ArrayRecursive> => { const validate = (input: any): typia.IValidation<ArrayRecursive> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ArrayRecursive.SPOILERS);
