  ...
  _test_http_assertFormData("ObjectHttpNullable")<ObjectHttpNullable>(
    ...
    ((input: FormData): typia.Resolved<ObjectHttpNullable> => {
      const decode = (input: FormData): typia.Resolved<ObjectHttpNullable> => {
        const $boolean = (typia.http.assertFormData as any).boolean;
        const $bigint = (typia.http.assertFormData as any).bigint;
        const $number = (typia.http.assertFormData as any).number;
        const $string = (typia.http.assertFormData as any).string;
        const $array = (typia.http.assertFormData as any).array;
        const output = {
