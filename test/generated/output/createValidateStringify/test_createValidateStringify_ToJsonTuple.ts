...
export const test_createValidateStringify_ToJsonTuple = _test_validateStringify("ToJsonTuple", ToJsonTuple.generate, (input: ToJsonTuple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ToJsonTuple> => {
    const errors = [] as any[];
