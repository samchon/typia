...
export const test_createValidateStringify_ObjectOptional = _test_validateStringify("ObjectOptional", ObjectOptional.generate, (input: ObjectOptional): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectOptional> => {
    ...
    output.data = stringify(input); return output; }, ObjectOptional.SPOILERS);
