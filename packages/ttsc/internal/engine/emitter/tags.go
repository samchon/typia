...
var formatRegexps = map[string]string{
	...
	// patterns are large (1.5kB each) and rarely used in Phase 0 fixtures; we
	// keep compact but correct approximations and leave the long patterns for
	// Phase 1 parity alignment.
