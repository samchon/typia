...
export const test_createAssertClone_ObjectUnionImplicit = _test_assertClone("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: any): typia.Primitive<ObjectUnionImplicit> => { const assert = (input: any): ObjectUnionImplicit => {
...
}; assert(input); const output = clone(input); return output; }, ObjectUnionImplicit.SPOILERS);
