...
export const test_validate_ObjectGeneric = _test_validate("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): typia.IValidation<[ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]> => {
    const errors = [] as any[];
