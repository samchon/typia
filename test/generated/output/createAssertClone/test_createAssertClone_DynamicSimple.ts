...
export const test_createAssertClone_DynamicSimple = _test_assertClone("DynamicSimple", DynamicSimple.generate, (input: any): typia.Primitive<DynamicSimple> => { const assert = (input: any): DynamicSimple => {
...
}; assert(input); const output = clone(input); return output; }, DynamicSimple.SPOILERS);
