...
export const test_createAssertClone_ToJsonTuple = _test_assertClone("ToJsonTuple", ToJsonTuple.generate, (input: any): typia.Primitive<ToJsonTuple> => { const assert = (input: any): ToJsonTuple => {
