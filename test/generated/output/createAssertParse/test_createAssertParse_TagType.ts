...
export const test_createAssertParse_TagType = _test_assertParse("TagType", TagType.generate, (input: string): typia.Primitive<TagType> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, TagType.SPOILERS);
