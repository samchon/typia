...
export const test_functional_validateEqualsReturn_TypeTagInfinite =
  _test_functional_validateEqualsReturn("TypeTagInfinite")(TypeTagInfinite)(
    (p: (input: TypeTagInfinite) => TypeTagInfinite) =>
      (
        input: TypeTagInfinite,
      ): import("typia").IValidation<TypeTagInfinite> => {
