...
export const test_createAssertClone_ToJsonAtomicSimple = _test_assertClone("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input: any): typia.Primitive<ToJsonAtomicSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ToJsonAtomicSimple */; return output as ToJsonAtomicSimple; });
