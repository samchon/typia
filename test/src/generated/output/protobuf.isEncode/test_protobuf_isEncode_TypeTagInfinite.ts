...
export const test_protobuf_isEncode_TypeTagInfinite = _test_protobuf_isEncode(
  "TypeTagInfinite",
)<TypeTagInfinite>(TypeTagInfinite)({
  encode: (input) =>
    ((input: TypeTagInfinite): Uint8Array | null => {
  ...
  decode: (input: Uint8Array): import("typia").Resolved<TypeTagInfinite> => {
