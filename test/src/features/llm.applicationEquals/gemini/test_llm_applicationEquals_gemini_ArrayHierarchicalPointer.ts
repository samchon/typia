...
export const test_llm_applicationEquals_gemini_ArrayHierarchicalPointer = (): void =>
  _test_llm_applicationEquals({
    model: "gemini",
    name: "ArrayHierarchicalPointer",
    factory: ArrayHierarchicalPointer
  })(
    typia.llm.application<ArrayHierarchicalPointerApplication, "gemini", { equals: true }>(),
  );
