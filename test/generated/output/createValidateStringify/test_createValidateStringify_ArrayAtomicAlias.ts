...
export const test_createValidateStringify_ArrayAtomicAlias = _test_validateStringify("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input: ArrayAtomicAlias): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayAtomicAlias> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ArrayAtomicAlias.SPOILERS);
