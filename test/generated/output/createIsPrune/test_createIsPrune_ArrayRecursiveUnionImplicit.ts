...
export const test_createIsPrune_ArrayRecursiveUnionImplicit = _test_isPrune("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input: any): input is ArrayRecursiveUnionImplicit => { const is = (input: any): input is ArrayRecursiveUnionImplicit => {
    ...
    return false; prune(input); return true; }, ArrayRecursiveUnionImplicit.SPOILERS);
