...
export const test_createAssertPrune_ArrayMatrix = _test_assertPrune("ArrayMatrix", ArrayMatrix.generate, (input: any): ArrayMatrix => { const assert = (input: any): ArrayMatrix => {
