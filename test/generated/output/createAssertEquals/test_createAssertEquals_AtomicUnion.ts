...
export const test_createAssertEquals_AtomicUnion = _test_assertEquals("AtomicUnion", AtomicUnion.generate, (input: any): AtomicUnion => {
    const $guard = (typia.createAssertEquals as any).guard;
    const __is = (input: any, _exceptionable: boolean = true): input is AtomicUnion => {
