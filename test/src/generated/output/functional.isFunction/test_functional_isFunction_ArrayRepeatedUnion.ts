...
export const test_functional_isFunction_ArrayRepeatedUnion =
  _test_functional_isFunction("ArrayRepeatedUnion")(ArrayRepeatedUnion)(
    (p: (input: ArrayRepeatedUnion) => ArrayRepeatedUnion) =>
      (input: ArrayRepeatedUnion): ArrayRepeatedUnion | null => {
        if (
          false ===
