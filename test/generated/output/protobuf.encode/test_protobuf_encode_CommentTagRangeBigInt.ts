...
export const test_protobuf_createEncode_CommentTagRangeBigInt =
  _test_protobuf_encode("CommentTagRangeBigInt")<CommentTagRangeBigInt>(
    CommentTagRangeBigInt,
  )({
    encode: (input) =>
      ((input: CommentTagRangeBigInt): Uint8Array => {
