...
export const test_validateEquals_AtomicUnion = _test_validateEquals("AtomicUnion", AtomicUnion.generate, (input) => ((input: any): typia.IValidation<Array<AtomicUnion.Union>> => {
    const errors = [] as any[];
