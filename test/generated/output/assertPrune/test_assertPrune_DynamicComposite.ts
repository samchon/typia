...
export const test_assertPrune_DynamicComposite = _test_assertPrune("DynamicComposite", DynamicComposite.generate, (input) => ((input: any): DynamicComposite => { const assert = (input: any) => {
