...
export const test_assertPrune_TagInfinite = _test_assertPrune("TagInfinite", TagInfinite.generate, (input) => ((input: any): TagInfinite => { const assert = (input: any): TagInfinite => {
