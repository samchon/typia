...
export const test_assertStringify_DynamicTemplate = _test_assertStringify("DynamicTemplate", DynamicTemplate.generate, (input) => ((input: DynamicTemplate): string => { const assert = (input: any) => {
