...
export const test_isClone_ToJsonDouble = _test_isClone("ToJsonDouble", ToJsonDouble.generate, (input) => ((input: any): typia.Primitive<Parent> | null => { const is = (input: any): input is Parent => {
