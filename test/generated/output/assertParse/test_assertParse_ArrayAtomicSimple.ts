...
export const test_assertParse_ArrayAtomicSimple = _test_assertParse("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: string): typia.Primitive<ArrayAtomicSimple> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); })(input), ArrayAtomicSimple.SPOILERS);
