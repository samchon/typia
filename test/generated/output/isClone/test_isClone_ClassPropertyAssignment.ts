...
export const test_isClone_ClassPropertyAssignment = _test_isClone("ClassPropertyAssignment", ClassPropertyAssignment.generate, (input) => ((input: any): typia.Primitive<ClassPropertyAssignment> | null => { const is = (input: any): input is ClassPropertyAssignment => {
    ...
    return null; const output = clone(input); return output; })(input), ClassPropertyAssignment.SPOILERS);
