...
export const test_validate_ArrayRepeatedUnion = _test_validate("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input) => ((input: any): typia.IValidation<number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>> => {
    const errors = [] as any[];
...
})(input), ArrayRepeatedUnion.SPOILERS);
