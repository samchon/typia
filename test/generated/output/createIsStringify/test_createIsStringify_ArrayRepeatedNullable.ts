...
export const test_createIsStringify_ArrayRepeatedNullable = _test_isStringify("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input: ArrayRepeatedNullable): string | null => { const is = (input: any): input is ArrayRepeatedNullable => {
...
}; return is(input) ? stringify(input) : null; }, ArrayRepeatedNullable.SPOILERS);
