...
export const test_assertStringify_TagObjectUnion = _test_assertStringify("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: TagObjectUnion): string => { const assert = (input: any) => {
