...
export const test_validateStringify_ObjectGenericUnion = _test_validateStringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: ISaleQuestion | ISaleReview): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ISaleQuestion | ISaleReview> => {
