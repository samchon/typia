...
export const test_assert_ArrayRepeatedNullable = _test_assert("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input) => ((input: any): string | number | Array<ArrayRepeatedNullable> | null => {
