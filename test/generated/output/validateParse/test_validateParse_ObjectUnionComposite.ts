...
export const test_validateParse_ObjectUnionComposite = _test_validateParse("ObjectUnionComposite", ObjectUnionComposite.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ObjectUnionComposite>> => { const validate = (input: any): typia.IValidation<ObjectUnionComposite> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ObjectUnionComposite.SPOILERS);
