...
export const test_isStringify_ObjectLiteralProperty = _test_isStringify("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: ObjectLiteralProperty.ISomething): string | null => { const is = (input: any): input is ObjectLiteralProperty.ISomething => {
...
}; return is(input) ? stringify(input) : null; })(input), ObjectLiteralProperty.SPOILERS);
