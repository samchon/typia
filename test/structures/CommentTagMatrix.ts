...
export interface CommentTagMatrix {
    /**
     * Doubled array.
     *
     * @items 3
...
export namespace CommentTagMatrix {
    export function generate(): CommentTagMatrix {
        return {
    ...
    export const SPOILERS: Spoiler<CommentTagMatrix>[] = [
        (input) => {
