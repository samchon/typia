...
export const test_createValidate_DefinitionArrayRecursiveOptional = _test_validate("DefinitionArrayRecursiveOptional", DefinitionArrayRecursiveOptional.generate, (input: any): typia.IValidation<DefinitionArrayRecursiveOptional> => {
