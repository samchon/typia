...
export const test_isPrune_TemplateUnion = _test_isPrune("TemplateUnion", TemplateUnion.generate, (input) => ((input: any): input is Array<TemplateUnion.Type> => { const is = (input: any): input is Array<TemplateUnion.Type> => {
    ...
    return false; prune(input); return true; })(input), TemplateUnion.SPOILERS);
