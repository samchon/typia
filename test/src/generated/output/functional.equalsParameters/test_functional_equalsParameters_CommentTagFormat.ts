...
export const test_functional_equalsParameters_CommentTagFormat =
  _test_functional_equalsParameters("CommentTagFormat")(CommentTagFormat)(
    (p: (input: CommentTagFormat) => CommentTagFormat) =>
      (input: CommentTagFormat): CommentTagFormat | null => {
        if (
          false ===
          ((
            input: any,
