...
export const test_functional_equalsParameters_TypeTagFormat =
  _test_functional_equalsParameters("TypeTagFormat")(TypeTagFormat)(
    (p: (input: TypeTagFormat) => TypeTagFormat) =>
      (input: TypeTagFormat): TypeTagFormat | null => {
        if (
          false ===
          ((
            input: any,
