...
export const test_createAssertClone_AtomicAlias = _test_assertClone("AtomicAlias", AtomicAlias.generate, (input: any): typia.Primitive<AtomicAlias> => { const assert = (input: any): AtomicAlias => {
...
}; assert(input); const output = clone(input); return output; }, AtomicAlias.SPOILERS);
