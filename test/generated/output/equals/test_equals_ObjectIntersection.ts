...
export const test_equals_ObjectIntersection = _test_equals("ObjectIntersection", ObjectIntersection.generate, (input) => ((input: any, _exceptionable: boolean): input is ObjectIntersection => {
