...
export const test_validateEquals_ArraySimple = _test_validateEquals("ArraySimple", ArraySimple.generate, (input) => ((input: any): typia.IValidation<Array<ArraySimple.IPerson>> => {
    const errors = [] as any[];
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Array<ArraySimple.IPerson> => {
            ...
            const $vo1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.name || $report(_exceptionable, {
                    ...
                    expected: "string",
                    value: input.body
                }), "number" === typeof input.rank && Number.isFinite(input.rank) || $report(_exceptionable, {
                    path: _path + ".rank",
                    expected: "number",
                    value: input.rank
                }), 3 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).map((key: any) => {
