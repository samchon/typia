...
export const test_assertStringify_NativeSimple = _test_assertStringify("NativeSimple", NativeSimple.generate, (input) => ((input: any): string => { const assert = (input: any): NativeSimple => {
