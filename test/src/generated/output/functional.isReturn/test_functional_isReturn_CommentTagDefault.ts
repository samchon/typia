...
export const test_functional_isReturn_CommentTagDefault =
  _test_functional_isReturn("CommentTagDefault")(CommentTagDefault)(
    (p: (input: CommentTagDefault) => CommentTagDefault) =>
      (input: CommentTagDefault): CommentTagDefault | null => {
        const result = p(input);
        return ((input: any): input is CommentTagDefault => {
