...
export const test_assertClone_ObjectInternal = _test_assertClone("ObjectInternal", ObjectInternal.generate, (input) => ((input: any): typia.Primitive<ObjectInternal> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectInternal */; return output as ObjectInternal; })(input), ObjectInternal.SPOILERS);
