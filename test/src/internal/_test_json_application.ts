...
//   <App extends IJsonApplication<any, any>>(app: App) => {
//     const actual: IJsonApplication<any, any> = JSON.parse(
//       fs.readFileSync(
//         `${__dirname}/../../schemas/json.application/v${props.version.replace(".", "_")}/${props.name}.json`,
//         "utf8",
//       ),
//     );
//     sort(app);
...
// function sort(app: IJsonApplication<any, any>): void {
