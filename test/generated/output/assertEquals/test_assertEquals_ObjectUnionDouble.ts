...
export const test_assertEquals_ObjectUnionDouble = _test_assertEquals("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): Array<ObjectUnionDouble.Union> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Array<ObjectUnionDouble.Union> => {
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("object" === typeof input.value && null !== input.value || $guard(_exceptionable, {
                ...
                value: input.child
            })) && $au0(input.child, _path + ".child", true && _exceptionable)) && (2 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["value", "child"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao6 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("object" === typeof input.value && null !== input.value || $guard(_exceptionable, {
                ...
                value: input.child
            })) && $au1(input.child, _path + ".child", true && _exceptionable)) && (2 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["value", "child"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao8 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("object" === typeof input.value && null !== input.value || $guard(_exceptionable, {
                ...
                expected: "__type.o4",
                value: input.value
            })) && $ao9(input.value, _path + ".value", true && _exceptionable) && (1 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["value"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao10 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("object" === typeof input.value && null !== input.value || $guard(_exceptionable, {
                ...
                expected: "__type.o5",
                value: input.value
            })) && $ao11(input.value, _path + ".value", true && _exceptionable) && (1 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["value"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
