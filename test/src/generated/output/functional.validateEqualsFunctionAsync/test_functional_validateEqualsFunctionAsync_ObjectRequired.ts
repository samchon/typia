...
export const test_functional_validateEqualsFunctionAsync_ObjectRequired =
  _test_functional_validateEqualsFunctionAsync("ObjectRequired")(
    ObjectRequired,
  )(
    (p: (input: ObjectRequired) => Promise<ObjectRequired>) =>
      async (
        input: ObjectRequired,
      ): Promise<import("typia").IValidation<ObjectRequired>> => {
        const paramResults = [
