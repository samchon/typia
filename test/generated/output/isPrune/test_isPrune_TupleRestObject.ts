...
export const test_isPrune_TupleRestObject = _test_isPrune("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): input is [boolean, number, ...TupleRestObject.IObject[]] => { const is = (input: any): input is [boolean, number, ...TupleRestObject.IObject[]] => {
    ...
    return false; prune(input); return true; })(input), TupleRestObject.SPOILERS);
