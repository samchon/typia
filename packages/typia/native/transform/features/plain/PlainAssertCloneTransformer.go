...
type plainAssertCloneTransformerNamespace struct{}

var PlainAssertCloneTransformer = plainAssertCloneTransformerNamespace{}

func (plainAssertCloneTransformerNamespace) Transform(props nativeinternal.ITransformProps) *shimast.Node {
  return nativeinternal.GenericTransformer.Scalar(nativeinternal.GenericTransformer_IProps{
    ITransformProps: props,
    Method:          "plain.assertClone",
