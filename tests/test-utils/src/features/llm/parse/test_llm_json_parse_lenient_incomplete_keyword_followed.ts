...
export const test_llm_json_parse_lenient_incomplete_keyword_followed =
  (): void => {
    ...
    if (r1.success) {
      TestValidator.equals("tru-comma-data", r1.data, {
        active: true,
        name: "test",
      });
    }
    ...
    if (r2.success) {
      TestValidator.equals("fal-comma-data", r2.data, {
        enabled: false,
        count: 5,
      });
    }
    ...
    if (r10.success) {
      TestValidator.equals("multiple-incomplete-data", r10.data, {
        x: true,
        y: false,
        z: null,
      });
    ...
    if (r11.success) {
      TestValidator.equals("nested-incomplete-data", r11.data, {
        outer: { inner: true },
      });
    }
    ...
    if (r12.success) {
      TestValidator.equals("array-incomplete-data", r12.data, [
        true,
        false,
        null,
      ]);
