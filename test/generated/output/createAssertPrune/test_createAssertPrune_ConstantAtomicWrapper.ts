...
export const test_createAssertPrune_ConstantAtomicWrapper = _test_assertPrune("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input: any): ConstantAtomicWrapper => { const assert = (input: any) => {
