...
export const test_assertPrune_ObjectNullable = _test_assertPrune("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): ObjectNullable => { const assert = (input: any) => {
