...
export const test_createValidate_ObjectLiteralProperty = _test_validate("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any): typia.IValidation<ObjectLiteralProperty> => {
