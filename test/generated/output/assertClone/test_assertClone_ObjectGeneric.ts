...
export const test_assertClone_ObjectGeneric = _test_assertClone("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): typia.Primitive<ObjectGeneric> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectGeneric */; return output as ObjectGeneric; })(input), ObjectGeneric.SPOILERS);
