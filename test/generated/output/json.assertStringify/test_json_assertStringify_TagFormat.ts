    ...
    _test_json_assertStringify<TagFormat>(TagFormat)((input) =>
        ((input: any): string => {
            const assert = (input: any): TagFormat => {
                const __is = (input: any): input is TagFormat => {
                    const $is_uuid = (typia.json.assertStringify as any)
                        .is_uuid;
                    const $is_email = (typia.json.assertStringify as any)
                        .is_email;
                    const $is_url = (typia.json.assertStringify as any).is_url;
                    const $is_ipv4 = (typia.json.assertStringify as any)
                        .is_ipv4;
                    const $is_ipv6 = (typia.json.assertStringify as any)
                        .is_ipv6;
                    const $is_date = (typia.json.assertStringify as any)
                        .is_date;
                    const $is_datetime = (typia.json.assertStringify as any)
                        .is_datetime;
            ...
            const stringify = (input: TagFormat): string => {
                ...
                const $is_email = (typia.json.assertStringify as any).is_email;
                const $is_url = (typia.json.assertStringify as any).is_url;
                const $is_ipv4 = (typia.json.assertStringify as any).is_ipv4;
                const $is_ipv6 = (typia.json.assertStringify as any).is_ipv6;
                const $is_date = (typia.json.assertStringify as any).is_date;
                const $is_datetime = (typia.json.assertStringify as any)
                    .is_datetime;
