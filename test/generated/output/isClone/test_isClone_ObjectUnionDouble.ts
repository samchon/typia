...
export const test_isClone_ObjectUnionDouble = _test_isClone("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): typia.Primitive<Array<ObjectUnionDouble.Union>> | null => { const is = (input: any): input is Array<ObjectUnionDouble.Union> => {
    ...
    return null; const output = clone(input); return output; })(input), ObjectUnionDouble.SPOILERS);
