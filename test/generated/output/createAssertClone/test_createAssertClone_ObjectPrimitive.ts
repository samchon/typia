...
export const test_createAssertClone_ObjectPrimitive = _test_assertClone("ObjectPrimitive", ObjectPrimitive.generate, (input: any): typia.Primitive<ObjectPrimitive> => { const assert = (input: any): ObjectPrimitive => {
...
}; assert(input); const output = clone(input); return output; }, ObjectPrimitive.SPOILERS);
