...
export const test_assertStringify_ArrayRecursiveUnionExplicit = _test_assertStringify("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ArrayRecursiveUnionExplicit.IBucket> => {
...
}; return stringify(assert(input)); })(input), ArrayRecursiveUnionExplicit.SPOILERS);
