...
export const test_assertClone_TupleRestArray = _test_assertClone("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): typia.Primitive<TupleRestArray> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* TupleRestArray */; return output as TupleRestArray; })(input), TupleRestArray.SPOILERS);
