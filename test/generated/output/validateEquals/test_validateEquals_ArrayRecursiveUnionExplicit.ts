...
export const test_validateEquals_ArrayRecursiveUnionExplicit = _test_validateEquals("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): typia.IValidation<ArrayRecursiveUnionExplicit> => {
    const errors = [] as any[];
