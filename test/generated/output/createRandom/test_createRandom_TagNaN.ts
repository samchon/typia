...
export const test_createRandom_TagNaN = _test_random("TagNaN", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<TagNaN> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<TagNaN> => {
