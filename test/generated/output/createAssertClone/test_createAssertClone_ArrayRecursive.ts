...
export const test_createAssertClone_ArrayRecursive = _test_assertClone("ArrayRecursive", ArrayRecursive.generate, (input: any): typia.Primitive<ArrayRecursive> => { const assert = (input: any): ArrayRecursive => {
...
}; assert(input); const output = clone(input); return output; }, ArrayRecursive.SPOILERS);
