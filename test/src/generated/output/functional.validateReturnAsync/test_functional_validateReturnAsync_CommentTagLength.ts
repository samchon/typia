...
export const test_functional_validateReturnAsync_CommentTagLength =
  _test_functional_validateReturnAsync("CommentTagLength")(CommentTagLength)(
    (p: (input: CommentTagLength) => Promise<CommentTagLength>) =>
      async (
        input: CommentTagLength,
      ): Promise<import("typia").IValidation<CommentTagLength>> => {
        const result = ((input: any): typia.IValidation<CommentTagLength> => {
          const errors = [] as any[];
