...
export const test_validateStringify_ArraySimple = _test_validateStringify("ArraySimple", ArraySimple.generate, (input) => ((input: Array<ArraySimple.IPerson>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<ArraySimple.IPerson>> => {
    ...
    output.data = stringify(input); return output; })(input), ArraySimple.SPOILERS);
