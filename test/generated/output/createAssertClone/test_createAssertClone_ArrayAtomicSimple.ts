...
export const test_createAssertClone_ArrayAtomicSimple = _test_assertClone("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: any): typia.Primitive<ArrayAtomicSimple> => { const assert = (input: any): ArrayAtomicSimple => {
...
}; assert(input); const output = clone(input); return output; }, ArrayAtomicSimple.SPOILERS);
