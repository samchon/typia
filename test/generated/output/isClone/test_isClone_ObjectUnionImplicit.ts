...
export const test_isClone_ObjectUnionImplicit = _test_isClone("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: any): typia.Primitive<ObjectUnionImplicit> | null => { const is = (input: any): input is ObjectUnionImplicit => {
