...
export const test_validate_ObjectUnionDouble = _test_validate("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): typia.IValidation<ObjectUnionDouble> => {
    const errors = [] as any[];
