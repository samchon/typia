...
export const test_assertClone_ObjectGenericUnion = _test_assertClone("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.Primitive<ISaleQuestion | ISaleReview> => { const assert = (input: any): ISaleQuestion | ISaleReview => {
    const $guard = (typia.assertClone as any).guard;
    const __is = (input: any): input is ISaleQuestion | ISaleReview => {
    ...
    return input;
}; const clone = (input: ISaleQuestion | ISaleReview): typia.Primitive<ISaleQuestion | ISaleReview> => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectGenericUnion.SPOILERS);
