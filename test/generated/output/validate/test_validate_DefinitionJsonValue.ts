...
export const test_validate_DefinitionJsonValue = _test_validate("DefinitionJsonValue", DefinitionJsonValue.generate, (input) => ((input: any): typia.IValidation<string | number | boolean | DefinitionJsonValue.JsonObject | DefinitionJsonValue.JsonArray | null> => {
