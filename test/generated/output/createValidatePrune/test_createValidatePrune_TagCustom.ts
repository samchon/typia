...
export const test_createValidatePrune_TagCustom = _test_validatePrune("TagCustom", TagCustom.generate, (input: any): typia.IValidation<TagCustom> => { const validate = (input: any): typia.IValidation<TagCustom> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, TagCustom.SPOILERS);
