...
export const test_validatePrune_AtomicSimple = _test_validatePrune("AtomicSimple", AtomicSimple.generate, (input) => ((input: any): typia.IValidation<AtomicSimple> => { const validate = (input: any): typia.IValidation<AtomicSimple> => {
    const errors = [] as any[];
