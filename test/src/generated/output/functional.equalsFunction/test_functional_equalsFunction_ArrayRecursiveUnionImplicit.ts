...
export const test_functional_equalsFunction_ArrayRecursiveUnionImplicit =
  _test_functional_equalsFunction("ArrayRecursiveUnionImplicit")(
        ...
        return ((
          ...
          const $io2 = (input: any, _exceptionable: boolean = true): boolean =>
            ...
            (7 === Object.keys(input).length ||
              Object.keys(input).every((key: any) => {
                if (
                  ["id", "name", "path", "width", "height", "url", "size"].some(
                    (prop: any) => key === prop,
                  )
                )
                  return true;
