...
export const test_functional_isReturn_ObjectPropertyNullable =
  _test_functional_isReturn("ObjectPropertyNullable")(ObjectPropertyNullable)(
    (p: (input: ObjectPropertyNullable) => ObjectPropertyNullable) =>
      (input: ObjectPropertyNullable): ObjectPropertyNullable | null => {
        const result = p(input);
        return ((input: any): input is ObjectPropertyNullable => {
