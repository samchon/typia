...
export const test_createValidateParse_DefinitionJsonValue = _test_validateParse("DefinitionJsonValue", DefinitionJsonValue.generate, (input: string): typia.IValidation<typia.Primitive<DefinitionJsonValue>> => { const validate = (input: any): typia.IValidation<DefinitionJsonValue> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, DefinitionJsonValue.SPOILERS);
