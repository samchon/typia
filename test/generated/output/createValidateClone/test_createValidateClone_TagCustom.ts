...
export const test_createValidateClone_TagCustom = _test_validateClone("TagCustom", TagCustom.generate, (input: any): typia.IValidation<typia.Primitive<TagCustom>> => { const validate = (input: any): typia.IValidation<TagCustom> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, TagCustom.SPOILERS);
