...
export const test_createAssertClone_ConstantAtomicSimple = _test_assertClone("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input: any): typia.Primitive<ConstantAtomicSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ConstantAtomicSimple */; return output as ConstantAtomicSimple; }, ConstantAtomicSimple.SPOILERS);
