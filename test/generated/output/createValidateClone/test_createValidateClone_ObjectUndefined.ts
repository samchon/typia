...
export const test_createValidateClone_ObjectUndefined = _test_validateClone("ObjectUndefined", ObjectUndefined.generate, (input: any): typia.IValidation<typia.Primitive<ObjectUndefined>> => { const validate = (input: any): typia.IValidation<ObjectUndefined> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ObjectUndefined.SPOILERS);
