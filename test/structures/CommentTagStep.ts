...
export type CommentTagStep = IPointer<CommentTagStep.Type[]>;
export namespace CommentTagStep {
    ...
    // prettier-ignore
    export function generate(): CommentTagStep {
        const output: Type[] = [];
    ...
    export const SPOILERS: Spoiler<CommentTagStep>[] = [
        (input) => {
