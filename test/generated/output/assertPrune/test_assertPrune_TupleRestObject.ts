...
export const test_assertPrune_TupleRestObject = _test_assertPrune("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): [boolean, number, ...TupleRestObject.IObject[]] => { const assert = (input: any): [boolean, number, ...TupleRestObject.IObject[]] => {
    ...
    return input;
}; const prune = (input: [boolean, number, ...TupleRestObject.IObject[]]): void => {
    const $io0 = (input: any): boolean => "string" === typeof input.value;
...
}; assert(input); prune(input); return input; })(input), TupleRestObject.SPOILERS);
