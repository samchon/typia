...
export const test_createAssertEquals_ObjectUnionComposite = _test_assertEquals("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any): ObjectUnionComposite => {
    ...
    const __is = (input: any, _exceptionable: boolean = true): input is ObjectUnionComposite => {
        const $io0 = (input: any, _exceptionable: boolean = true): boolean => "number" === typeof input.x && Number.isFinite(input.x) && ("number" === typeof input.y && Number.isFinite(input.y)) && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io1 = (input: any, _exceptionable: boolean = true): boolean => "object" === typeof input.p1 && null !== input.p1 && $io0(input.p1, true && _exceptionable) && ("object" === typeof input.p2 && null !== input.p2 && $io0(input.p2, true && _exceptionable)) && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io3 = (input: any, _exceptionable: boolean = true): boolean => "object" === typeof input.p1 && null !== input.p1 && $io0(input.p1, true && _exceptionable) && ("object" === typeof input.p2 && null !== input.p2 && $io0(input.p2, true && _exceptionable)) && ("object" === typeof input.p3 && null !== input.p3 && $io0(input.p3, true && _exceptionable)) && ("object" === typeof input.p4 && null !== input.p4 && $io0(input.p4, true && _exceptionable)) && (4 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io4 = (input: any, _exceptionable: boolean = true): boolean => Array.isArray(input.points) && input.points.every((elem: any, _index2: number) => "object" === typeof elem && null !== elem && $io0(elem, true && _exceptionable)) && (1 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io7 = (input: any, _exceptionable: boolean = true): boolean => "object" === typeof input.centroid && null !== input.centroid && $io0(input.centroid, true && _exceptionable) && ("number" === typeof input.radius && Number.isFinite(input.radius)) && (2 === Object.keys(input).length || Object.keys(input).every(key => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ObjectUnionComposite => {
            ...
            const $ao1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("object" === typeof input.p1 && null !== input.p1 || $guard(_exceptionable, {
                ...
                expected: "ObjectUnionComposite.IPoint",
                value: input.p2
            })) && $ao0(input.p2, _path + ".p2", true && _exceptionable)) && (2 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["p1", "p2"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao2 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("object" === typeof input.p1 && null !== input.p1 || $guard(_exceptionable, {
                ...
                expected: "ObjectUnionComposite.IPoint",
                value: input.p3
            })) && $ao0(input.p3, _path + ".p3", true && _exceptionable)) && (3 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["p1", "p2", "p3"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao3 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("object" === typeof input.p1 && null !== input.p1 || $guard(_exceptionable, {
                ...
                expected: "ObjectUnionComposite.IPoint",
                value: input.p4
            })) && $ao0(input.p4, _path + ".p4", true && _exceptionable)) && (4 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["p1", "p2", "p3", "p4"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao4 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (Array.isArray(input.points) || $guard(_exceptionable, {
                ...
                expected: "ObjectUnionComposite.IPoint",
                value: elem
            })) && $ao0(elem, _path + ".points[" + _index2 + "]", true && _exceptionable)) && (1 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["points"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao5 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("object" === typeof input.outer && null !== input.outer || $guard(_exceptionable, {
                ...
                expected: "ObjectUnionComposite.IPolyline",
                value: elem
            })) && $ao4(elem, _path + ".inner[" + _index3 + "]", true && _exceptionable))) && (2 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["outer", "inner"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao6 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (Array.isArray(input.outer) || $guard(_exceptionable, {
                ...
                expected: "ObjectUnionComposite.IPoint",
                value: input.inner
            })) && $ao0(input.inner, _path + ".inner", true && _exceptionable)) && (2 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["outer", "inner"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
