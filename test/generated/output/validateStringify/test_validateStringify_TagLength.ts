...
export const test_validateStringify_TagLength = _test_validateStringify("TagLength", TagLength.generate, (input) => ((input: Array<TagLength.Type>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<TagLength.Type>> => {
    ...
    output.data = stringify(input); return output; })(input), TagLength.SPOILERS);
