...
export const test_isParse_ObjectPrimitive = _test_isParse("ObjectPrimitive", ObjectPrimitive.generate, (input) => ((input: any): typia.Primitive<ObjectPrimitive> => { const is = (input: any): input is ObjectPrimitive => {
