...
export const test_createValidateEquals_ObjectHierarchical = _test_validateEquals("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.IValidation<ObjectHierarchical> => {
    const errors = [] as any[];
