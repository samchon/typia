...
export const test_validateEquals_TagAtomicUnion = _test_validateEquals("TagAtomicUnion", TagAtomicUnion.generate, (input) => ((input: any): typia.IValidation<Array<TagAtomicUnion.Type>> => {
