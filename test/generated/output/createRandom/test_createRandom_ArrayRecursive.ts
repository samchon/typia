...
export const test_createRandom_ArrayRecursive = _test_random("ArrayRecursive", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ArrayRecursive> => {
    const $generator = (typia.createRandom as any).generator;
    const $ro0 = (_recursive: boolean = true, _depth: number = 0): any => ({
        children: _recursive && 5 < _depth ? [] : 5 >= _depth ? (generator?.array ?? $generator.array)(() => $ro0(true, _recursive ? 1 + _depth : _depth)) : [],
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ArrayRecursive> => {
            ...
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ((Array.isArray(input.children) || $guard(_exceptionable, {
                ...
                value: elem
            })) && $ao0(elem, _path + ".children[" + _index1 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".children[" + _index1 + "]",
                expected: "ArrayRecursive.ICategory",
                value: elem
