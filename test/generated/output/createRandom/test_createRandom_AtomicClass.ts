...
export const test_createRandom_AtomicClass = _test_random("AtomicClass", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<AtomicClass> => {
    ...
    const __is = (input: any): input is typia.Primitive<AtomicClass> => {
        return Array.isArray(input) && (input.length === 9 && "boolean" === typeof input[0] && ("boolean" === typeof input[1] || input[1] instanceof Boolean) && (null !== input[2] && undefined !== input[2] && ("boolean" === typeof input[2] || input[2] instanceof Boolean)) && ("number" === typeof input[3] && Number.isFinite(input[3])) && ("number" === typeof input[4] || input[4] instanceof Number) && (null !== input[5] && undefined !== input[5] && ("number" === typeof input[5] || input[5] instanceof Number)) && "string" === typeof input[6] && ("string" === typeof input[7] || input[7] instanceof String) && (null !== input[8] && undefined !== input[8] && ("string" === typeof input[8] || input[8] instanceof String)));
    };
    if (false === __is(input))
