...
export const test_createValidateStringify_ArrayRepeatedUnion = _test_validateStringify("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input: ArrayRepeatedUnion): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayRepeatedUnion> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ArrayRepeatedUnion.SPOILERS);
