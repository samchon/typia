...
export const test_json_validateParse_TagFormat =
    _test_json_validateParse<TagFormat>(TagFormat)(
        (input: string): typia.IValidation<typia.Primitive<TagFormat>> => {
            const validate = (input: any): typia.IValidation<TagFormat> => {
                ...
                const __is = (input: any): input is TagFormat => {
                    const $is_uuid = (typia.json.createValidateParse as any)
                        .is_uuid;
                    const $is_email = (typia.json.createValidateParse as any)
                        .is_email;
                    const $is_url = (typia.json.createValidateParse as any)
                        .is_url;
                    const $is_ipv4 = (typia.json.createValidateParse as any)
                        .is_ipv4;
                    const $is_ipv6 = (typia.json.createValidateParse as any)
                        .is_ipv6;
                    const $is_date = (typia.json.createValidateParse as any)
                        .is_date;
                    const $is_datetime = (typia.json.createValidateParse as any)
                        .is_datetime;
                    return (
                        "object" === typeof input &&
                        null !== input &&
