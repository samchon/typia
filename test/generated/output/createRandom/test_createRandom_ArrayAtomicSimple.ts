...
export const test_createRandom_ArrayAtomicSimple = _test_random("ArrayAtomicSimple", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    ...
    return input as typia.Primitive<ArrayAtomicSimple>;
});
