...
export const test_createEquals_ObjectUnionNonPredictable = _test_equals("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input: any, _exceptionable: boolean): input is ObjectUnionNonPredictable => {
