...
export const test_createIsStringify_ArrayRecursiveUnionImplicit = _test_isStringify("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input: ArrayRecursiveUnionImplicit): string | null => { const is = (input: any): input is ArrayRecursiveUnionImplicit => {
...
}; return is(input) ? stringify(input) : null; }, ArrayRecursiveUnionImplicit.SPOILERS);
