...
export const test_clone_ObjectUnionImplicit = _test_clone("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: Array<ObjectUnionImplicit.IPoint | ObjectUnionImplicit.ILine | ObjectUnionImplicit.ITriangle | ObjectUnionImplicit.IRectangle | ObjectUnionImplicit.IPolyline | ObjectUnionImplicit.IPolygon | ObjectUnionImplicit.ICircle>): typia.Primitive<Array<ObjectUnionImplicit.IPoint | ObjectUnionImplicit.ILine | ObjectUnionImplicit.ITriangle | ObjectUnionImplicit.IRectangle | ObjectUnionImplicit.IPolyline | ObjectUnionImplicit.IPolygon | ObjectUnionImplicit.ICircle>> => {
