...
export const test_validateClone_ArrayRepeatedUnion = _test_validateClone("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>>> => { const validate = (input: any): typia.IValidation<number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>> => {
    const errors = [] as any[];
...
}; const clone = (input: number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>): typia.Primitive<number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>> => {
    ...
    output.data = clone(input); return output; })(input), ArrayRepeatedUnion.SPOILERS);
