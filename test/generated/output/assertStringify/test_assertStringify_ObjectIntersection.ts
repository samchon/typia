...
export const test_assertStringify_ObjectIntersection = _test_assertStringify("ObjectIntersection", ObjectIntersection.generate, (input) => ((input: any): string => { const assert = (input: any): ObjectIntersection.IEmail & ObjectIntersection.IName => {
...
}; return stringify(assert(input)); })(input), ObjectIntersection.SPOILERS);
