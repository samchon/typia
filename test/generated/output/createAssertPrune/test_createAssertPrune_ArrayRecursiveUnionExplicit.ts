...
export const test_createAssertPrune_ArrayRecursiveUnionExplicit = _test_assertPrune("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input: any): ArrayRecursiveUnionExplicit => { const assert = (input: any) => {
