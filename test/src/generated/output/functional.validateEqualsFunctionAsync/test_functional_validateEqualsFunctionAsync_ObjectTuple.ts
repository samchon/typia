...
export const test_functional_validateEqualsFunctionAsync_ObjectTuple =
  _test_functional_validateEqualsFunctionAsync("ObjectTuple")(ObjectTuple)(
    (p: (input: ObjectTuple) => Promise<ObjectTuple>) =>
      async (
        input: ObjectTuple,
      ): Promise<import("typia").IValidation<ObjectTuple>> => {
        const paramResults = [
