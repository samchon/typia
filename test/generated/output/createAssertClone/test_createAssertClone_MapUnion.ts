...
export const test_createAssertClone_MapUnion = _test_assertClone("MapUnion", MapUnion.generate, (input: any): typia.Primitive<MapUnion> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as MapUnion; }, MapUnion.SPOILERS);
