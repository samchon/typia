...
export const test_createValidateStringify_ObjectUnionImplicit = _test_validateStringify("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: ObjectUnionImplicit): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectUnionImplicit> => {
    ...
    output.data = stringify(input); return output; }, ObjectUnionImplicit.SPOILERS);
