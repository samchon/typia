...
export const test_stringify_ObjectUnionExplicit = _test_stringify("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input) => ((input: ObjectUnionExplicit): string => {
    ...
    const $so0 = (input: any) => `{"x":${$number(input.x)},"y":${$number(input.y)},"type":${(() => {
    ...
    const $so1 = (input: any) => `{"p1":${`{"x":${$number(input.p1.x)},"y":${$number(input.p1.y)}}`},"p2":${`{"x":${$number(input.p2.x)},"y":${$number(input.p2.y)}}`},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
    ...
    const $so3 = (input: any) => `{"p1":${`{"x":${$number(input.p1.x)},"y":${$number(input.p1.y)}}`},"p2":${`{"x":${$number(input.p2.x)},"y":${$number(input.p2.y)}}`},"p3":${`{"x":${$number(input.p3.x)},"y":${$number(input.p3.y)}}`},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
    ...
    const $so4 = (input: any) => `{"p1":${`{"x":${$number(input.p1.x)},"y":${$number(input.p1.y)}}`},"p2":${`{"x":${$number(input.p2.x)},"y":${$number(input.p2.y)}}`},"p3":${`{"x":${$number(input.p3.x)},"y":${$number(input.p3.y)}}`},"p4":${`{"x":${$number(input.p4.x)},"y":${$number(input.p4.y)}}`},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
    ...
    const $so5 = (input: any) => `{"points":${`[${input.points.map((elem: any) => `{"x":${$number(elem.x)},"y":${$number(elem.y)}}`).join(",")}]`},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
    ...
    const $so7 = (input: any) => `{"points":${`[${input.points.map((elem: any) => `{"x":${$number(elem.x)},"y":${$number(elem.y)}}`).join(",")}]`}}`;
    const $so8 = (input: any) => `{"centroid":${`{"x":${$number(input.centroid.x)},"y":${$number(input.centroid.y)}}`},"radius":${$number(input.radius)},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
