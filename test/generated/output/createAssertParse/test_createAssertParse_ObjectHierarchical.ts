...
export const test_createAssertParse_ObjectHierarchical = _test_assertParse("ObjectHierarchical", ObjectHierarchical.generate, (input: string): typia.Primitive<ICustomer> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, ObjectHierarchical.SPOILERS);
