...
export const test_assertStringify_ObjectOptional = _test_assertStringify("ObjectOptional", ObjectOptional.generate, (input) => ((input: any): string => { const assert = (input: any): ObjectOptional => {
