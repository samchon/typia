...
export const test_assertStringify_TupleRestArray = _test_assertStringify("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): string => { const assert = (input: any): [boolean, number, ...Array<string>[]] => {
...
}; return stringify(assert(input)); })(input), TupleRestArray.SPOILERS);
