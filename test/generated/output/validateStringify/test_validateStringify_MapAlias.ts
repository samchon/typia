...
export const test_validateStringify_MapAlias = _test_validateStringify("MapAlias", MapAlias.generate, (input) => ((input: MapAlias): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<MapAlias> => {
    ...
    output.data = stringify(input); return output; })(input), MapAlias.SPOILERS);
