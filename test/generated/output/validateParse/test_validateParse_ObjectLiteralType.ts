...
export const test_validateParse_ObjectLiteralType = _test_validateParse("ObjectLiteralType", ObjectLiteralType.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ObjectLiteralType>> => { const validate = (input: any): typia.IValidation<ObjectLiteralType> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ObjectLiteralType.SPOILERS);
