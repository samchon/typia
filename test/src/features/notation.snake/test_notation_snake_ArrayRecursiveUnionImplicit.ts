...
export const test_notation_validateSnake_ArrayRecursiveUnionImplicit = (): void =>
    ...
    convert: (input) => typia.notations.validateSnake<ArrayRecursiveUnionImplicit>(input),
