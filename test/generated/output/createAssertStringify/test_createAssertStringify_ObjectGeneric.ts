...
export const test_createAssertStringify_ObjectGeneric = _test_assertStringify("ObjectGeneric", ObjectGeneric.generate, (input: any): string => { const assert = (input: any): ObjectGeneric => {
...
}; return stringify(assert(input)); }, ObjectGeneric.SPOILERS);
