...
export const test_createValidateStringify_ObjectIntersection = _test_validateStringify("ObjectIntersection", ObjectIntersection.generate, (input: ObjectIntersection): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectIntersection> => {
    ...
    output.data = stringify(input); return output; }, ObjectIntersection.SPOILERS);
