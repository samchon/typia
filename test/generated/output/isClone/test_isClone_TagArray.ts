...
export const test_isClone_TagArray = _test_isClone("TagArray", TagArray.generate, (input) => ((input: any): typia.Primitive<Array<TagArray.Type>> | null => { const is = (input: any): input is Array<TagArray.Type> => {
    ...
    return null; const output = clone(input); return output; })(input), TagArray.SPOILERS);
