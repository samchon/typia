...
export const test_notation_createValidateSnake_ObjectUnionCompositePointer = (): void =>
    ...
    convert: typia.notations.createValidateSnake<ObjectUnionCompositePointer>(),
