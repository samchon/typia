...
export const test_createAssertPrune_ObjectUnionComposite = _test_assertPrune("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any): ObjectUnionComposite => { const assert = (input: any) => {
