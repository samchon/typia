...
export const test_createValidateStringify_MapAlias = _test_validateStringify("MapAlias", MapAlias.generate, (input: MapAlias): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<MapAlias> => {
    ...
    output.data = stringify(input); return output; }, MapAlias.SPOILERS);
