...
export const test_isStringify_ArrayRecursiveUnionExplicit = _test_isStringify("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: Array<ArrayRecursiveUnionExplicit.IBucket>): string | null => { const is = (input: any): input is Array<ArrayRecursiveUnionExplicit.IBucket> => {
