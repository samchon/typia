...
export const test_createValidateParse_ObjectUnionImplicit = _test_validateParse("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: string): typia.IValidation<typia.Primitive<ObjectUnionImplicit>> => { const validate = (input: any): typia.IValidation<ObjectUnionImplicit> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, ObjectUnionImplicit.SPOILERS);
