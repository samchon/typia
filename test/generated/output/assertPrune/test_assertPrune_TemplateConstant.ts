...
export const test_assertPrune_TemplateConstant = _test_assertPrune("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): Array<TemplateConstant.Type> => { const assert = (input: any): Array<TemplateConstant.Type> => {
...
}; assert(input); prune(input); return input; })(input), TemplateConstant.SPOILERS);
