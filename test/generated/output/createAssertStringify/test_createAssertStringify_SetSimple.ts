...
export const test_createAssertStringify_SetSimple = _test_assertStringify("SetSimple", SetSimple.generate, (input: any): string => { const assert = (input: any): SetSimple => {
    ...
    return $so0(input);
}; return stringify(assert(input)); }, SetSimple.SPOILERS);
