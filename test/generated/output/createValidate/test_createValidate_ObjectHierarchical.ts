...
export const test_createValidate_ObjectHierarchical = _test_validate("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.IValidation<ObjectHierarchical> => {
