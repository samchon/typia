...
func TestLlmApplicationProgrammerCoverage(t *testing.T) {
  ...
  if !llmApplicationProgrammer_hidden([]schemametadata.IJsDocTagInfo{{Name: "internal"}}) ||
    !llmApplicationProgrammer_hidden([]schemametadata.IJsDocTagInfo{{Name: "hidden"}}) ||
    !llmApplicationProgrammer_hidden([]schemametadata.IJsDocTagInfo{{Name: "ignore"}}) ||
    llmApplicationProgrammer_hidden(nil) {
    t.Fatal("hidden helper should detect internal, hidden, and ignore tags")
  }
