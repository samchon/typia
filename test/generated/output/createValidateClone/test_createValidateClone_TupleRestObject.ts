...
export const test_createValidateClone_TupleRestObject = _test_validateClone("TupleRestObject", TupleRestObject.generate, (input: any): typia.IValidation<typia.Primitive<TupleRestObject>> => { const validate = (input: any): typia.IValidation<TupleRestObject> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, TupleRestObject.SPOILERS);
