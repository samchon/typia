...
export const test_validate_ArrayRecursive = _test_validate("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): typia.IValidation<ArrayRecursive.ICategory> => {
    const errors = [] as any[];
