...
export const test_createIsParse_ObjectLiteralProperty = _test_isParse("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any): typia.Primitive<ObjectLiteralProperty> => { const is = (input: any): input is ObjectLiteralProperty => {
