...
export const test_isStringify_ArrayRepeatedNullable = _test_isStringify("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input) => ((input: string | number | Array<ArrayRepeatedNullable> | null): string | null => { const is = (input: any): input is string | number | Array<ArrayRepeatedNullable> | null => {
...
}; const stringify = (input: string | number | Array<ArrayRepeatedNullable> | null): string => {
    ...
    const $sa0 = (input: any): any => `[${input.map((elem: any) => null !== elem ? (() => {
...
}; return is(input) ? stringify(input) : null; })(input), ArrayRepeatedNullable.SPOILERS);
