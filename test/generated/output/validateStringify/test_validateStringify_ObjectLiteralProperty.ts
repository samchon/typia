...
export const test_validateStringify_ObjectLiteralProperty = _test_validateStringify("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: ObjectLiteralProperty.ISomething): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectLiteralProperty.ISomething> => {
    ...
    output.data = stringify(input); return output; })(input), ObjectLiteralProperty.SPOILERS);
