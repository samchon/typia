...
export const test_createValidateClone_ObjectUnionComposite = _test_validateClone("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any): typia.IValidation<typia.Primitive<ObjectUnionComposite>> => { const validate = (input: any): typia.IValidation<ObjectUnionComposite> => {
    ...
    output.data = clone(input); return output; }, ObjectUnionComposite.SPOILERS);
