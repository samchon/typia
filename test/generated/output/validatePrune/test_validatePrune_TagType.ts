...
export const test_validatePrune_TagType = _test_validatePrune("TagType", TagType.generate, (input) => ((input: any): typia.IValidation<Array<TagType.Type>> => { const validate = (input: any): typia.IValidation<Array<TagType.Type>> => {
    ...
    prune(input); return output; })(input), TagType.SPOILERS);
