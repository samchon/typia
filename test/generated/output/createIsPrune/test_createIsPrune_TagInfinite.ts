...
export const test_createIsPrune_TagInfinite = _test_isPrune("TagInfinite", TagInfinite.generate, (input: any): input is TagInfinite => { const is = (input: any): input is TagInfinite => {
    ...
    return false; prune(input); return true; }, TagInfinite.SPOILERS);
