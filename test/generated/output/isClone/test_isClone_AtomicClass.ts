...
export const test_isClone_AtomicClass = _test_isClone("AtomicClass", AtomicClass.generate, (input) => ((input: any): typia.Primitive<[Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String]> | null => { const is = (input: any): input is [Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String] => {
    ...
    return null; const output = clone(input); return output; })(input), AtomicClass.SPOILERS);
