...
export const test_validateStringify_ConstantEnumeration = _test_validateStringify("ConstantEnumeration", ConstantEnumeration.generate, (input) => ((input: Array<ConstantEnumeration.Enumeration>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<ConstantEnumeration.Enumeration>> => {
    ...
    output.data = stringify(input); return output; })(input), ConstantEnumeration.SPOILERS);
