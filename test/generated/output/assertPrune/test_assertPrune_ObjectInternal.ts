...
export const test_assertPrune_ObjectInternal = _test_assertPrune("ObjectInternal", ObjectInternal.generate, (input) => ((input: any): ObjectInternal => { const assert = (input: any): ObjectInternal => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), ObjectInternal.SPOILERS);
