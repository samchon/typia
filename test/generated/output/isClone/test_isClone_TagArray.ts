...
export const test_isClone_TagArray = _test_isClone("TagArray", TagArray.generate, (input) => ((input: any): typia.Primitive<TagArray> | null => { const is = (input: any): input is TagArray => {
