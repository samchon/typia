...
export const test_validateStringify_ClassGetter = _test_validateStringify("ClassGetter", ClassGetter.generate, (input) => ((input: ClassGetter.Person): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ClassGetter.Person> => {
    ...
    output.data = stringify(input); return output; })(input), ClassGetter.SPOILERS);
