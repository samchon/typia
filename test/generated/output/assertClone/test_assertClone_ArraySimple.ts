...
export const test_assertClone_ArraySimple = _test_assertClone("ArraySimple", ArraySimple.generate, (input) => ((input: any): typia.Primitive<Array<ArraySimple.IPerson>> => { const assert = (input: any): Array<ArraySimple.IPerson> => {
...
}; assert(input); const output = clone(input); return output; })(input), ArraySimple.SPOILERS);
