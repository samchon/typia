...
export const test_functional_validateEqualsParameters_CommentTagArrayUnion =
  _test_functional_validateEqualsParameters("CommentTagArrayUnion")(
    CommentTagArrayUnion,
  )(
    (p: (input: CommentTagArrayUnion) => CommentTagArrayUnion) =>
      (
        input: CommentTagArrayUnion,
      ): import("typia").IValidation<CommentTagArrayUnion> => {
        const paramResults = [
