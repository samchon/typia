...
export const test_isPrune_ArrayRecursiveUnionImplicit = _test_isPrune("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): input is Array<ArrayRecursiveUnionImplicit.IBucket> => { const is = (input: any): input is Array<ArrayRecursiveUnionImplicit.IBucket> => {
