...
export const test_createRandom_TagAtomicUnion = _test_random("TagAtomicUnion", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<TagAtomicUnion> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<TagAtomicUnion> => {
