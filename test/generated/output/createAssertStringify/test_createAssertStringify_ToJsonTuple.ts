...
export const test_createAssertStringify_ToJsonTuple = _test_assertStringify("ToJsonTuple", ToJsonTuple.generate, (input: any): string => { const assert = (input: any): ToJsonTuple => {
