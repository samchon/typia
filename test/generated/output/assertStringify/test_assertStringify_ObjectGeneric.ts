...
export const test_assertStringify_ObjectGeneric = _test_assertStringify("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: ObjectGeneric): string => { const assert = (input: any) => {
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is ObjectGeneric => {
        ...
        const $ao2 = (input: any, _path: string, _exceptionable: boolean) => ("number" === typeof input.value && !Number.isNaN(input.value) || $guard(_exceptionable, {
            path: _path + ".value",
            expected: "number",
            value: input.value
        })) && (("object" === typeof input.child && null !== input.child || $guard(_exceptionable, {
        ...
        const $ao3 = (input: any, _path: string, _exceptionable: boolean) => ("number" === typeof input.child_value && !Number.isNaN(input.child_value) || $guard(_exceptionable, {
            path: _path + ".child_value",
            expected: "number",
            value: input.child_value
        })) && ("number" === typeof input.child_next && !Number.isNaN(input.child_next) || $guard(_exceptionable, {
            path: _path + ".child_next",
            expected: "number",
            value: input.child_next
        }));
