...
export const test_createAssertStringify_ObjectNullable = _test_assertStringify("ObjectNullable", ObjectNullable.generate, (input: any): string => { const assert = (input: any): ObjectNullable => {
