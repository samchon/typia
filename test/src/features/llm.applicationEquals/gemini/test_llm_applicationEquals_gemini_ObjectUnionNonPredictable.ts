...
export const test_llm_applicationEquals_gemini_ObjectUnionNonPredictable = (): void =>
  _test_llm_applicationEquals({
    model: "gemini",
    name: "ObjectUnionNonPredictable",
    factory: ObjectUnionNonPredictable
  })(
    typia.llm.application<ObjectUnionNonPredictableApplication, "gemini", { equals: true }>(),
  );
