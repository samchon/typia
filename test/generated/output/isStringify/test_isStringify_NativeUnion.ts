...
export const test_isStringify_NativeUnion = _test_isStringify("NativeUnion", NativeUnion.generate, (input) => ((input: NativeUnion): string | null => { const is = (input: any): input is NativeUnion => {
