...
export const test_isClone_ObjectGenericUnion = _test_isClone("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.Primitive<ISaleQuestion | ISaleReview> | null => { const is = (input: any): input is ISaleQuestion | ISaleReview => {
    ...
    return null; const output = clone(input); return output; })(input), ObjectGenericUnion.SPOILERS);
