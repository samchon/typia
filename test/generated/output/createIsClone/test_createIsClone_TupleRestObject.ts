...
export const test_createIsClone_TupleRestObject = _test_isClone("TupleRestObject", TupleRestObject.generate, (input: any): typia.Primitive<TupleRestObject> | null => { const is = (input: any): input is TupleRestObject => {
    ...
    return null; const output = clone(input); return output; }, TupleRestObject.SPOILERS);
