...
export const test_validate_ArrayAtomicAlias = _test_validate("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input) => ((input: any): typia.IValidation<ArrayAtomicAlias> => {
    const errors = [] as any[];
