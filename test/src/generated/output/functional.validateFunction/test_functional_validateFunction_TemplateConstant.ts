...
export const test_functional_validateFunction_TemplateConstant =
  _test_functional_validateFunction("TemplateConstant")(TemplateConstant)(
    (p: (input: TemplateConstant) => TemplateConstant) =>
      (
        input: TemplateConstant,
      ): import("typia").IValidation<TemplateConstant> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<TemplateConstant> => {
          const errors = [] as any[];
          const __is = (input: any): input is TemplateConstant => {
            const $io0 = (input: any): boolean =>
              Array.isArray(input.value) &&
