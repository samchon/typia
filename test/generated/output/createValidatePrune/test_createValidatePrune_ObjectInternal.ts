...
export const test_createValidatePrune_ObjectInternal = _test_validatePrune("ObjectInternal", ObjectInternal.generate, (input: any): typia.IValidation<ObjectInternal> => { const validate = (input: any): typia.IValidation<ObjectInternal> => {
    ...
    prune(input); return output; }, ObjectInternal.SPOILERS);
