...
export const test_createAssertStringify_TemplateUnion = _test_assertStringify("TemplateUnion", TemplateUnion.generate, (input: TemplateUnion): string => { const assert = (input: any) => {
...
}; return stringify(assert(input)); }, TemplateUnion.SPOILERS);
