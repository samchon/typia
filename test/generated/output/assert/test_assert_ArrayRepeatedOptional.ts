...
export const test_assert_ArrayRepeatedOptional = _test_assert("ArrayRepeatedOptional", ArrayRepeatedOptional.generate, (input) => ((input: any): string | number | Array<ArrayRepeatedOptional> | undefined => {
