...
export const test_createRandom_ArrayRecursiveUnionExplicit = _test_random("ArrayRecursiveUnionExplicit", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    ...
    const $ro4 = (recursive = true, depth = 0) => ({
        id: (generator.number ?? $generator.number)(0, 100),
        name: (generator.string ?? $generator.string)(),
        path: (generator.string ?? $generator.string)(),
        target: $pick([
    ...
    return input as typia.Primitive<ArrayRecursiveUnionExplicit>;
});
