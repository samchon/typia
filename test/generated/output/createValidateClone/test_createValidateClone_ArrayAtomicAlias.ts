...
export const test_createValidateClone_ArrayAtomicAlias = _test_validateClone("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input: any): typia.IValidation<typia.Primitive<ArrayAtomicAlias>> => { const validate = (input: any): typia.IValidation<ArrayAtomicAlias> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ArrayAtomicAlias.SPOILERS);
