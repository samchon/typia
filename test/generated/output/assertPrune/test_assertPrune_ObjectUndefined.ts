...
export const test_assertPrune_ObjectUndefined = _test_assertPrune("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): ObjectUndefined => { const assert = (input: any) => {
