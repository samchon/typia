...
export const test_llm_json_parse_lenient_markdown_block = (): void => {
  ...
  if (r1.success)
    TestValidator.equals("basic-markdown-data", r1.data, { name: "test" });
  ...
  if (r5.success)
    TestValidator.equals("markdown-in-string-data", r5.data, {
      code: "```json\n{}\n```",
    });
  ...
  if (r6.success)
    TestValidator.equals("obj-before-markdown-data", r6.data, {
      text: "see ```json block",
    });
  ...
  if (r7.success)
    TestValidator.equals("arr-before-markdown-data", r7.data, [
      "```json",
      "test",
    ]);
  ...
  if (r12.success)
    TestValidator.equals("markdown-with-comments-data", r12.data, { key: 1 });
  ...
  if (r13.success)
    TestValidator.equals("markdown-unquoted-keys-data", r13.data, {
      name: "test",
    });
};
