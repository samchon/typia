...
export const test_assert_AtomicClass = _test_assert("AtomicClass", AtomicClass.generate, (input) => ((input: any): [Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String] => {
