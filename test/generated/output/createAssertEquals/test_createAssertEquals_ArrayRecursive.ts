...
export const test_createAssertEquals_ArrayRecursive = _test_assertEquals("ArrayRecursive", ArrayRecursive.generate, (input: any): ArrayRecursive => {
    const __is = (input: any, _exceptionable: boolean = true): input is ArrayRecursive => {
