...
export const test_assertStringify_ObjectUnionComposite = _test_assertStringify("ObjectUnionComposite", ObjectUnionComposite.generate, (input) => ((input: ObjectUnionComposite): string => { const assert = (input: any) => {
