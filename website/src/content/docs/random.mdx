...
> For long-running test suites and especially anything that goes into a real database, prefer type tags — typos in comment tags fall back to defaults silently. See [Special Tags](/docs/validators/tags#comment-tags) for the trade-off.
