...
export const test_assertClone_ArrayRecursiveUnionExplicit = _test_assertClone("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): typia.Primitive<Array<ArrayRecursiveUnionExplicit.IBucket>> => { const assert = (input: any): Array<ArrayRecursiveUnionExplicit.IBucket> => {
...
}; assert(input); const output = clone(input); return output; })(input), ArrayRecursiveUnionExplicit.SPOILERS);
