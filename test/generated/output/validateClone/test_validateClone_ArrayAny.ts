...
export const test_validateClone_ArrayAny = _test_validateClone("ArrayAny", ArrayAny.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ArrayAny>> => { const validate = (input: any): typia.IValidation<ArrayAny> => {
    ...
    output.data = clone(input); return output; })(input), ArrayAny.SPOILERS);
