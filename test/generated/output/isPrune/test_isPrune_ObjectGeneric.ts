...
export const test_isPrune_ObjectGeneric = _test_isPrune("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): input is [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => { const is = (input: any): input is [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
    ...
    return false; prune(input); return true; })(input), ObjectGeneric.SPOILERS);
