...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/validators/validate.ts" 
      filename="examples/src/validators/validate.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/validators/validate.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/validators/validateEquals.ts" 
      filename="examples/src/validators/validateEquals.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/validators/validateEquals.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/validators/createValidate.ts" 
      filename="examples/src/validators/createValidate.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/validators/createValidate.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/validators/validate-map.ts" 
      filename="examples/src/validators/validate-map.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/validators/validate-map.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/validators/validate-custom-tags.ts" 
      filename="examples/src/validators/validate-custom-tags.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/validators/validate-custom-tags.js" 
