...
export const test_createAssertStringify_SetUnion = _test_assertStringify("SetUnion", SetUnion.generate, (input: SetUnion): string => { const assert = (input: any) => {
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is SetUnion => {
        ...
        return (Array.isArray(input) || $guard(true, {
            ...
            const tupleList = [[top => "boolean" === typeof top, top => top.every((elem: any, _index2: number) => "boolean" === typeof elem || $guard(true, {
                        ...
                        expected: "string",
                        value: elem
                    }))], [top => Array.isArray(top) && top.every((elem: any, _index3: number) => "number" === typeof elem && !Number.isNaN(elem)), top => top.every((elem: any, _index2: number) => (Array.isArray(elem) || $guard(true, {
                        path: _path + "[" + _index1 + "][" + _index2 + "]",
                        expected: "Array<number>",
                        value: elem
                    })) && elem.every((elem: any, _index4: number) => "number" === typeof elem && !Number.isNaN(elem) || $guard(true, {
