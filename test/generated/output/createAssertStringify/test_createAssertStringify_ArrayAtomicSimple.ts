...
export const test_createAssertStringify_ArrayAtomicSimple = _test_assertStringify("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: ArrayAtomicSimple): string => { const assert = (input: any) => {
