...
export const test_createAssertStringify_ObjectUnionNonPredictable = _test_assertStringify("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input: any): string => { const assert = (input: any): ObjectUnionNonPredictable => {
