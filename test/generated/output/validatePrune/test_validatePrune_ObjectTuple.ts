...
export const test_validatePrune_ObjectTuple = _test_validatePrune("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.IValidation<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => { const validate = (input: any): typia.IValidation<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ObjectTuple.SPOILERS);
