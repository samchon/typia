...
export const test_functional_validateEqualsFunction_ObjectHttpCommentTag =
  _test_functional_validateEqualsFunction("ObjectHttpCommentTag")(
    ObjectHttpCommentTag,
  )(
    (p: (input: ObjectHttpCommentTag) => ObjectHttpCommentTag) =>
      (
        input: ObjectHttpCommentTag,
      ): import("typia").IValidation<ObjectHttpCommentTag> => {
        const paramResults = [
