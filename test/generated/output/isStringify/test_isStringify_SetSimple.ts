...
export const test_isStringify_SetSimple = _test_isStringify("SetSimple", SetSimple.generate, (input) => ((input: SetSimple): string | null => { const is = (input: any): input is SetSimple => {
    ...
    return $so0(input);
}; return is(input) ? stringify(input) : null; })(input), SetSimple.SPOILERS);
