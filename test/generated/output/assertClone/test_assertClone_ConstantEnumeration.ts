...
export const test_assertClone_ConstantEnumeration = _test_assertClone("ConstantEnumeration", ConstantEnumeration.generate, (input) => ((input: any): typia.Primitive<Array<ConstantEnumeration.Enumeration>> => { const assert = (input: any): Array<ConstantEnumeration.Enumeration> => {
...
}; assert(input); const output = clone(input); return output; })(input), ConstantEnumeration.SPOILERS);
