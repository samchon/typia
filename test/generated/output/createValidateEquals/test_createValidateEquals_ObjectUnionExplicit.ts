...
export const test_createValidateEquals_ObjectUnionExplicit = _test_validateEquals("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const __is = (input: any, _exceptionable: boolean = true): input is ObjectUnionExplicit => {
        const $io0 = (input: any, _exceptionable: boolean = true): boolean => "number" === typeof input.x && Number.isFinite(input.x) && ("number" === typeof input.y && Number.isFinite(input.y)) && "point" === input.type && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io1 = (input: any, _exceptionable: boolean = true): boolean => "object" === typeof input.p1 && null !== input.p1 && $io2(input.p1, true && _exceptionable) && ("object" === typeof input.p2 && null !== input.p2 && $io2(input.p2, true && _exceptionable)) && "line" === input.type && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io2 = (input: any, _exceptionable: boolean = true): boolean => "number" === typeof input.x && Number.isFinite(input.x) && ("number" === typeof input.y && Number.isFinite(input.y)) && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io3 = (input: any, _exceptionable: boolean = true): boolean => "object" === typeof input.p1 && null !== input.p1 && $io2(input.p1, true && _exceptionable) && ("object" === typeof input.p2 && null !== input.p2 && $io2(input.p2, true && _exceptionable)) && ("object" === typeof input.p3 && null !== input.p3 && $io2(input.p3, true && _exceptionable)) && "triangle" === input.type && (4 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io4 = (input: any, _exceptionable: boolean = true): boolean => "object" === typeof input.p1 && null !== input.p1 && $io2(input.p1, true && _exceptionable) && ("object" === typeof input.p2 && null !== input.p2 && $io2(input.p2, true && _exceptionable)) && ("object" === typeof input.p3 && null !== input.p3 && $io2(input.p3, true && _exceptionable)) && ("object" === typeof input.p4 && null !== input.p4 && $io2(input.p4, true && _exceptionable)) && "rectangle" === input.type && (5 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io5 = (input: any, _exceptionable: boolean = true): boolean => Array.isArray(input.points) && input.points.every((elem: any, _index2: number) => "object" === typeof elem && null !== elem && $io2(elem, true && _exceptionable)) && "polyline" === input.type && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io7 = (input: any, _exceptionable: boolean = true): boolean => Array.isArray(input.points) && input.points.every((elem: any, _index4: number) => "object" === typeof elem && null !== elem && $io2(elem, true && _exceptionable)) && (1 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io8 = (input: any, _exceptionable: boolean = true): boolean => "object" === typeof input.centroid && null !== input.centroid && $io2(input.centroid, true && _exceptionable) && ("number" === typeof input.radius && Number.isFinite(input.radius)) && "circle" === input.type && (3 === Object.keys(input).length || Object.keys(input).every(key => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ObjectUnionExplicit => {
            ...
            const $vo4 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [("object" === typeof input.p1 && null !== input.p1 || $report(_exceptionable, {
                    path: _path + ".p1",
                    expected: "ObjectUnionExplicit.IPoint",
                    value: input.p1
                })) && $vo2(input.p1, _path + ".p1", true && _exceptionable) || $report(_exceptionable, {
            ...
            const $vo5 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [(Array.isArray(input.points) || $report(_exceptionable, {
                    path: _path + ".points",
            ...
            const $vo6 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [("object" === typeof input.outer && null !== input.outer || $report(_exceptionable, {
                    path: _path + ".outer",
            ...
            const $vo8 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [("object" === typeof input.centroid && null !== input.centroid || $report(_exceptionable, {
                    path: _path + ".centroid",
                    expected: "ObjectUnionExplicit.IPoint",
