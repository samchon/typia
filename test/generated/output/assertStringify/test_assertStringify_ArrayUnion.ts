...
export const test_assertStringify_ArrayUnion = _test_assertStringify("ArrayUnion", ArrayUnion.generate, (input) => ((input: ArrayUnion): string => { const assert = (input: any) => {
