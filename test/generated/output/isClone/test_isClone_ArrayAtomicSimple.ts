...
export const test_isClone_ArrayAtomicSimple = _test_isClone("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.Primitive<ArrayAtomicSimple> | null => { const is = (input: any): input is ArrayAtomicSimple => {
