...
export const test_createAssertStringify_ConstantAtomicSimple = _test_assertStringify("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input: any): string => { const assert = (input: any): ConstantAtomicSimple => {
...
}; return stringify(assert(input)); }, ConstantAtomicSimple.SPOILERS);
