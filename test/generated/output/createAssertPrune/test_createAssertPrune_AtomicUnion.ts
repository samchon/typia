...
export const test_createAssertPrune_AtomicUnion = _test_assertPrune("AtomicUnion", AtomicUnion.generate, (input: any): AtomicUnion => { const assert = (input: any): AtomicUnion => {
...
}; assert(input); prune(input); return input; }, AtomicUnion.SPOILERS);
