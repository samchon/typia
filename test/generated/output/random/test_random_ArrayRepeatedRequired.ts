...
export const test_random_ArrayRepeatedRequired = _test_random("ArrayRepeatedRequired", () => ((generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ArrayRepeatedRequired> => {
