...
export const test_createIsPrune_TupleRestObject = _test_isPrune("TupleRestObject", TupleRestObject.generate, (input: any): input is TupleRestObject => { const is = (input: any): input is TupleRestObject => {
    ...
    return false; prune(input); return true; }, TupleRestObject.SPOILERS);
