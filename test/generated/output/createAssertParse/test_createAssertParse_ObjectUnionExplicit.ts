...
export const test_createAssertParse_ObjectUnionExplicit = _test_assertParse("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: string): typia.Primitive<ObjectUnionExplicit> => { const assert = (input: any): ObjectUnionExplicit => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, ObjectUnionExplicit.SPOILERS);
