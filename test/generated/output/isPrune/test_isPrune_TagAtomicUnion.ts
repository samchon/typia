...
export const test_isPrune_TagAtomicUnion = _test_isPrune("TagAtomicUnion", TagAtomicUnion.generate, (input) => ((input: any): input is Array<TagAtomicUnion.Type> => { const is = (input: any): input is Array<TagAtomicUnion.Type> => {
