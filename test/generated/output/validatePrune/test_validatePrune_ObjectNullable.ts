...
export const test_validatePrune_ObjectNullable = _test_validatePrune("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): typia.IValidation<[ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]> => { const validate = (input: any): typia.IValidation<[ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ObjectNullable.SPOILERS);
