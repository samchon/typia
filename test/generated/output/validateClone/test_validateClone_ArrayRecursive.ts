...
export const test_validateClone_ArrayRecursive = _test_validateClone("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ArrayRecursive.ICategory>> => { const validate = (input: any): typia.IValidation<ArrayRecursive.ICategory> => {
    const errors = [] as any[];
