...
export const test_llm_applicationEquals_chatgpt_ClassPropertyAssignment = (): void =>
  _test_llm_applicationEquals({
    model: "chatgpt",
    name: "ClassPropertyAssignment",
    factory: ClassPropertyAssignment
  })(
    typia.llm.application<ClassPropertyAssignmentApplication, "chatgpt", { equals: true }>(),
  );
