...
export const test_createValidateStringify_ArrayMatrix = _test_validateStringify("ArrayMatrix", ArrayMatrix.generate, (input: ArrayMatrix): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayMatrix> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ArrayMatrix.SPOILERS);
