...
export const test_misc_isClone_TagFormat = _test_misc_isClone(
    "TagFormat",
)<TagFormat>(TagFormat)((input: any): typia.Primitive<TagFormat> | null => {
    const is = (input: any): input is TagFormat => {
        const $is_uuid = (typia.misc.createIsClone as any).is_uuid;
        const $is_email = (typia.misc.createIsClone as any).is_email;
        const $is_url = (typia.misc.createIsClone as any).is_url;
        const $is_ipv4 = (typia.misc.createIsClone as any).is_ipv4;
        const $is_ipv6 = (typia.misc.createIsClone as any).is_ipv6;
        const $is_date = (typia.misc.createIsClone as any).is_date;
        const $is_datetime = (typia.misc.createIsClone as any).is_datetime;
        return (
            "object" === typeof input &&
            null !== input &&
