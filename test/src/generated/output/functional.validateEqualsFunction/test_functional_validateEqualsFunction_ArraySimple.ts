...
export const test_functional_validateEqualsFunction_ArraySimple =
  _test_functional_validateEqualsFunction("ArraySimple")(ArraySimple)(
    (p: (input: ArraySimple) => ArraySimple) =>
      (input: ArraySimple): import("typia").IValidation<ArraySimple> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<ArraySimple> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
