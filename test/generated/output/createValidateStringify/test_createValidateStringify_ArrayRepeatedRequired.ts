...
export const test_createValidateStringify_ArrayRepeatedRequired = _test_validateStringify("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input: ArrayRepeatedRequired): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayRepeatedRequired> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ArrayRepeatedRequired.SPOILERS);
