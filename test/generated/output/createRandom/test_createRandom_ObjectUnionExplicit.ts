...
export const test_createRandom_ObjectUnionExplicit = _test_random("ObjectUnionExplicit", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectUnionExplicit> => {
    ...
    const $ro5 = (_recursive: boolean = false, _depth: number = 0): any => ({
        points: (generator?.array ?? $generator.array)(() => $ro2(_recursive, _recursive ? 1 + _depth : _depth)),
        type: "polyline"
    });
    const $ro6 = (_recursive: boolean = false, _depth: number = 0): any => ({
        outer: $ro7(_recursive, _recursive ? 1 + _depth : _depth),
        inner: (generator?.array ?? $generator.array)(() => $ro7(_recursive, _recursive ? 1 + _depth : _depth)),
        type: "polygon"
    });
    ...
    const __is = (input: any): input is typia.Primitive<ObjectUnionExplicit> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectUnionExplicit> => {
