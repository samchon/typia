...
export const test_assertClone_ArrayRepeatedRequired = _test_assertClone("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input) => ((input: any): typia.Primitive<string | number | Array<ArrayRepeatedRequired>> => { const assert = (input: any): string | number | Array<ArrayRepeatedRequired> => {
...
}; assert(input); const output = clone(input); return output; })(input), ArrayRepeatedRequired.SPOILERS);
