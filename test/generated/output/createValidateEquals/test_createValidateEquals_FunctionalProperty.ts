...
export const test_createValidateEquals_FunctionalProperty = _test_validateEquals("FunctionalProperty", FunctionalProperty.generate, (input: any): typia.IValidation<FunctionalProperty> => {
    const errors = [] as any[];
