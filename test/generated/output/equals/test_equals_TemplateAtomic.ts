...
export const test_equals_TemplateAtomic = _test_equals("TemplateAtomic", TemplateAtomic.generate, (input) => ((input: any, _exceptionable: boolean): input is TemplateAtomic => {
