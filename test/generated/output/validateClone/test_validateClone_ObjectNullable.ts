...
export const test_validateClone_ObjectNullable = _test_validateClone("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<[ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]>> => { const validate = (input: any): typia.IValidation<[ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]> => {
    ...
    output.data = clone(input); return output; })(input), ObjectNullable.SPOILERS);
