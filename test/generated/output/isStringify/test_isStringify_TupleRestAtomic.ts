...
export const test_isStringify_TupleRestAtomic = _test_isStringify("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: TupleRestAtomic): string | null => { const is = (input: any): input is TupleRestAtomic => {
