...
export const test_validateClone_DynamicUndefined = _test_validateClone("DynamicUndefined", DynamicUndefined.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<DynamicUndefined>> => { const validate = (input: any): typia.IValidation<DynamicUndefined> => {
    ...
    output.data = clone(input); return output; })(input), DynamicUndefined.SPOILERS);
