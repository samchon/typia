...
export const test_createAssertStringify_ObjectOptional = _test_assertStringify("ObjectOptional", ObjectOptional.generate, (input: ObjectOptional): string => { const assert = (input: any) => {
