...
export const test_assertClone_TagType = _test_assertClone("TagType", TagType.generate, (input) => ((input: any): typia.Primitive<TagType> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as TagType; })(input), TagType.SPOILERS);
