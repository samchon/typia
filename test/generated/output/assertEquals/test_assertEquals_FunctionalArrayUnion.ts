...
export const test_assertEquals_FunctionalArrayUnion = _test_assertEquals("FunctionalArrayUnion", FunctionalArrayUnion.generate, (input) => ((input: any): Array<FunctionalArrayUnion.Union> => {
