...
export const test_assertClone_ObjectHierarchical = _test_assertClone("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): typia.Primitive<ObjectHierarchical.ICustomer> => { const assert = (input: any): ObjectHierarchical.ICustomer => {
    ...
    return input;
}; const clone = (input: ObjectHierarchical.ICustomer): typia.Primitive<ObjectHierarchical.ICustomer> => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectHierarchical.SPOILERS);
