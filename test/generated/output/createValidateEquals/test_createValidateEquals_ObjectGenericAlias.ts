...
export const test_createValidateEquals_ObjectGenericAlias = _test_validateEquals("ObjectGenericAlias", ObjectGenericAlias.generate, (input: any): typia.IValidation<ObjectGenericAlias> => {
