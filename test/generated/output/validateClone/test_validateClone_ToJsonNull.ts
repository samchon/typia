...
export const test_validateClone_ToJsonNull = _test_validateClone("ToJsonNull", ToJsonNull.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ToJsonNull>> => { const validate = (input: any): typia.IValidation<ToJsonNull> => {
    const errors = [] as any[];
