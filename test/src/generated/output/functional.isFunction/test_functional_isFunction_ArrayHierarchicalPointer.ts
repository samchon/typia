...
export const test_functional_isFunction_ArrayHierarchicalPointer =
  _test_functional_isFunction("ArrayHierarchicalPointer")(
    ArrayHierarchicalPointer,
  )(
    (p: (input: ArrayHierarchicalPointer) => ArrayHierarchicalPointer) =>
      (input: ArrayHierarchicalPointer): ArrayHierarchicalPointer | null => {
        if (
          false ===
        ...
        return ((input: any): input is ArrayHierarchicalPointer => {
          const $io0 = (input: any): boolean =>
            Array.isArray(input.value) &&
            input.value.every(
              (elem: any) =>
