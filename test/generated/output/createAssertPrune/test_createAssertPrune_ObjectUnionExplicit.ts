...
export const test_createAssertPrune_ObjectUnionExplicit = _test_assertPrune("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: any): ObjectUnionExplicit => { const assert = (input: any): ObjectUnionExplicit => {
...
}; assert(input); prune(input); return input; }, ObjectUnionExplicit.SPOILERS);
