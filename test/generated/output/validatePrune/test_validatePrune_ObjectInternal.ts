...
export const test_validatePrune_ObjectInternal = _test_validatePrune("ObjectInternal", ObjectInternal.generate, (input) => ((input: any): typia.IValidation<ObjectInternal> => { const validate = (input: any): typia.IValidation<ObjectInternal> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ObjectInternal.SPOILERS);
