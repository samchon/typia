...
export const test_assertStringify_ObjectRecursive = _test_assertStringify("ObjectRecursive", ObjectRecursive.generate, (input) => ((input: any): string => { const assert = (input: any): ObjectRecursive.IDepartment => {
