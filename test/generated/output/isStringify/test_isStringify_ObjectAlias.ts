...
export const test_isStringify_ObjectAlias = _test_isStringify("ObjectAlias", ObjectAlias.generate, (input) => ((input: Array<ObjectAlias.IMember>): string | null => { const is = (input: any): input is Array<ObjectAlias.IMember> => {
...
}; return is(input) ? stringify(input) : null; })(input), ObjectAlias.SPOILERS);
