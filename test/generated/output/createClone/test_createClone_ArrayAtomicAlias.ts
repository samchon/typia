...
export const test_createClone_ArrayAtomicAlias = _test_clone("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input: ArrayAtomicAlias): typia.Primitive<ArrayAtomicAlias> => {
