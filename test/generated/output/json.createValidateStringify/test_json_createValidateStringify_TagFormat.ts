...
export const test_json_validateStringify_TagFormat =
    _test_json_validateStringify("TagFormat")<TagFormat>(TagFormat)(
        (input: TagFormat): typia.IValidation<string> => {
            const validate = (input: any): typia.IValidation<TagFormat> => {
                ...
                const __is = (input: any): input is TagFormat => {
                    ...
                    const $is_url = (typia.json.createValidateStringify as any)
                        .is_url;
                    const $is_ipv4 = (typia.json.createValidateStringify as any)
                        .is_ipv4;
                    const $is_ipv6 = (typia.json.createValidateStringify as any)
                        .is_ipv6;
                    const $is_date = (typia.json.createValidateStringify as any)
                        .is_date;
                    const $is_datetime = (
                        typia.json.createValidateStringify as any
                    ).is_datetime;
            ...
            const stringify = (input: TagFormat): string => {
                ...
                const $is_uuid = (typia.json.createValidateStringify as any)
                    .is_uuid;
                const $is_email = (typia.json.createValidateStringify as any)
                    .is_email;
                const $is_url = (typia.json.createValidateStringify as any)
                    .is_url;
                const $is_ipv4 = (typia.json.createValidateStringify as any)
