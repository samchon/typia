...
export const test_createValidateEquals_ArrayRecursive = _test_validateEquals("ArrayRecursive", ArrayRecursive.generate, (input: any): typia.IValidation<ArrayRecursive> => {
