...
export const test_validateStringify_AtomicClass = _test_validateStringify("AtomicClass", AtomicClass.generate, (input) => ((input: AtomicClass): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<AtomicClass> => {
    const errors = [] as any[];
