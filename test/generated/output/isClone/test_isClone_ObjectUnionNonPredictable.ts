...
export const test_isClone_ObjectUnionNonPredictable = _test_isClone("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: any): typia.Primitive<ObjectUnionNonPredictable> | null => { const is = (input: any): input is ObjectUnionNonPredictable => {
