...
export const test_isClone_ArrayAtomicSimple = _test_isClone("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.Primitive<[Array<boolean>, Array<number>, Array<string>]> | null => { const is = (input: any): input is [Array<boolean>, Array<number>, Array<string>] => {
    ...
    return null; const output = clone(input); return output; })(input), ArrayAtomicSimple.SPOILERS);
