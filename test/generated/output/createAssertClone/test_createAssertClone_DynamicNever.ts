...
export const test_createAssertClone_DynamicNever = _test_assertClone("DynamicNever", DynamicNever.generate, (input: any): typia.Primitive<DynamicNever> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* DynamicNever */; return output as DynamicNever; }, DynamicNever.SPOILERS);
