...
export const test_notation_createValidateSnake_ArrayRecursiveUnionImplicit =
  ...
  >({
    convert: (
      input: any,
    ): typia.IValidation<typia.SnakeCase<ArrayRecursiveUnionImplicit>> => {
      const validate = (
        input: any,
    ...
    assert: (input: any): typia.SnakeCase<ArrayRecursiveUnionImplicit> => {
      const __is = (
        input: any,
      ): input is typia.SnakeCase<ArrayRecursiveUnionImplicit> => {
        const $io0 = (input: any): boolean =>
          "number" === typeof input.id &&
          Number.isFinite(input.id) &&
          "string" === typeof input.name &&
