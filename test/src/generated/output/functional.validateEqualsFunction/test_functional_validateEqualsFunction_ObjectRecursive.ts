...
export const test_functional_validateEqualsFunction_ObjectRecursive =
  _test_functional_validateEqualsFunction("ObjectRecursive")(ObjectRecursive)(
    (p: (input: ObjectRecursive) => ObjectRecursive) =>
      (
        input: ObjectRecursive,
      ): import("typia").IValidation<ObjectRecursive> => {
        const paramResults = [
