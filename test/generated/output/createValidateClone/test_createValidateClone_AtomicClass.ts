...
export const test_createValidateClone_AtomicClass = _test_validateClone("AtomicClass", AtomicClass.generate, (input: any): typia.IValidation<typia.Primitive<AtomicClass>> => { const validate = (input: any): typia.IValidation<AtomicClass> => {
    ...
    output.data = clone(input); return output; }, AtomicClass.SPOILERS);
