...
export const test_assertStringify_ToJsonUnion = _test_assertStringify("ToJsonUnion", ToJsonUnion.generate, (input) => ((input: ToJsonUnion): string => { const assert = (input: any) => {
