...
export const test_equals_ArrayRecursive = _test_equals("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any, _exceptionable: boolean = true): input is ArrayRecursive.ICategory => {
