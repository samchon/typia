...
export const test_validateEquals_ObjectGenericAlias = _test_validateEquals("ObjectGenericAlias", ObjectGenericAlias.generate, (input) => ((input: any): typia.IValidation<ObjectGenericAlias.ISomething<string>> => {
    const errors = [] as any[];
