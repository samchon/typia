...
export const test_isPrune_ObjectPropertyNullable = _test_isPrune("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input) => ((input: any): input is ObjectPropertyNullable => { const is = (input: any): input is ObjectPropertyNullable => {
