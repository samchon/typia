...
export const test_createIsStringify_ArrayRecursive = _test_isStringify("ArrayRecursive", ArrayRecursive.generate, (input: ArrayRecursive): string | null => { const is = (input: any): input is ArrayRecursive => {
