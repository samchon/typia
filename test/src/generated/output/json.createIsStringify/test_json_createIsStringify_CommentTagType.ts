...
export const test_json_createIsStringify_CommentTagType =
  _test_json_isStringify("CommentTagType")<CommentTagType>(CommentTagType)(
    (input: CommentTagType): string | null => {
