...
export const test_llm_applicationEquals_gemini_ArrayRecursiveUnionExplicit = (): void =>
  _test_llm_applicationEquals({
    model: "gemini",
    name: "ArrayRecursiveUnionExplicit",
    factory: ArrayRecursiveUnionExplicit
  })(
    typia.llm.application<ArrayRecursiveUnionExplicitApplication, "gemini", { equals: true }>(),
  );
