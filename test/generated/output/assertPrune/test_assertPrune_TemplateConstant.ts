...
export const test_assertPrune_TemplateConstant = _test_assertPrune("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): TemplateConstant => { const assert = (input: any) => {
