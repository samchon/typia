...
export const test_assertEquals_TupleOptional = _test_assertEquals("TupleOptional", TupleOptional.generate, (input) => ((input: any): Array<[number, boolean, string, (number | null | undefined)?, (string | null | undefined)?]> => {
