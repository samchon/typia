...
export const test_createValidate_ToJsonAtomicSimple = _test_validate("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input: any): typia.IValidation<ToJsonAtomicSimple> => {
    const errors = [] as any[];
