...
export const test_createValidateClone_ArrayUnion = _test_validateClone("ArrayUnion", ArrayUnion.generate, (input: any): typia.IValidation<typia.Primitive<ArrayUnion>> => { const validate = (input: any): typia.IValidation<ArrayUnion> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ArrayUnion.SPOILERS);
