...
export const test_createRandom_ObjectRecursive = _test_random("ObjectRecursive", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectRecursive> => {
    ...
    const __is = (input: any): input is typia.Primitive<ObjectRecursive> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectRecursive> => {
            ...
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (null === input.parent || ("object" === typeof input.parent && null !== input.parent || $guard(_exceptionable, {
                ...
                value: input.parent
            })) && $ao0(input.parent, _path + ".parent", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".parent",
                expected: "(ObjectRecursive.IDepartment | null)",
                value: input.parent
