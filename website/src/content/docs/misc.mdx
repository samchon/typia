...
<Tabs items={[
  <code key="typia">typia</code>, 
  <code key="TypeGuardError.ts">TypeGuardError.ts</code>, 
  <code key="IValidation.ts">IValidation.ts</code>,
  <code key="Resolved.ts">Resolved.ts</code>
]}>
  <Tabs.Tab>
```typescript
...
<Tabs items={[
  ...
  <code key="TypeGuardError.ts">TypeGuardError.ts</code>, 
  <code key="IValidation.ts">IValidation.ts</code>,
  <code key="CamelCase.ts">CamelCase.ts</code>
]}>
  <Tabs.Tab>
```typescript
...
<Tabs items={[
  ...
  <code key="TypeGuardError.ts">TypeGuardError.ts</code>, 
  <code key="IValidation.ts">IValidation.ts</code>,
  <code key="PascalCase.ts">PascalCase.ts</code>
]}>
  <Tabs.Tab>
```typescript
export namespace notations {
...
<Tabs items={[
  ...
  <code key="TypeGuardError.ts">TypeGuardError.ts</code>, 
  <code key="IValidation.ts">IValidation.ts</code>,
  <code key="SnakeCase.ts">SnakeCase.ts</code>
]}>
  <Tabs.Tab>
```typescript
export namespace notations {
