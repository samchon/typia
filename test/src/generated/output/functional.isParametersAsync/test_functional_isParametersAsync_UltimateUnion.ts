...
export const test_functional_isParametersAsync_UltimateUnion =
  _test_functional_isParametersAsync("UltimateUnion")(UltimateUnion)(
    (p: (input: UltimateUnion) => Promise<UltimateUnion>) =>
      async (input: UltimateUnion): Promise<UltimateUnion | null> => {
        if (
          false ===
