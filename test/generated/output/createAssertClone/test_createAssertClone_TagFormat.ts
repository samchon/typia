...
export const test_createAssertClone_TagFormat = _test_assertClone("TagFormat", TagFormat.generate, (input: any): typia.Primitive<TagFormat> => { const assert = (input: any): TagFormat => {
...
}; assert(input); const output = clone(input); return output; }, TagFormat.SPOILERS);
