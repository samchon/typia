...
export const test_validateClone_SetSimple = _test_validateClone("SetSimple", SetSimple.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<SetSimple>> => { const validate = (input: any): typia.IValidation<SetSimple> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is SetSimple => {
            const $vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [(input.booleans instanceof Set || $report(_exceptionable, {
                    path: _path + ".booleans",
                    ...
                    expected: "Set<number>",
                    value: input.numbers
                })) && [...input.numbers].map((elem: any, _index2: number) => "number" === typeof elem && Number.isFinite(elem) || $report(_exceptionable, {
                    ...
                    value: elem
                })) && elem.map((elem: any, _index5: number) => "number" === typeof elem && Number.isFinite(elem) || $report(_exceptionable, {
    ...
    output.data = clone(input); return output; })(input), SetSimple.SPOILERS);
