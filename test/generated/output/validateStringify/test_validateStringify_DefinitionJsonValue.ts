...
export const test_validateStringify_DefinitionJsonValue = _test_validateStringify("DefinitionJsonValue", DefinitionJsonValue.generate, (input) => ((input: string | number | boolean | DefinitionJsonValue.JsonObject | DefinitionJsonValue.JsonArray | null): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<string | number | boolean | DefinitionJsonValue.JsonObject | DefinitionJsonValue.JsonArray | null> => {
    ...
    output.data = stringify(input); return output; })(input), DefinitionJsonValue.SPOILERS);
