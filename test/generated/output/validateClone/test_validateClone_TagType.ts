...
export const test_validateClone_TagType = _test_validateClone("TagType", TagType.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<TagType.Type>>> => { const validate = (input: any): typia.IValidation<Array<TagType.Type>> => {
    const errors = [] as any[];
...
}; const clone = (input: Array<TagType.Type>): typia.Primitive<Array<TagType.Type>> => {
    ...
    output.data = clone(input); return output; })(input), TagType.SPOILERS);
