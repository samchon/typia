...
3. **Functional namespace** (typia.functional.*)
4. **Protobuf / LLM / Random namespaces**
5. **소스맵 생성** — tsgo WriteFile 훅에 `.js.map` 통과 확인 필요
6. **index signature / Record<K,V>** — 현재 Natives Map/Set 임시 매핑, 정규 MetadataMap/Set로 이관
