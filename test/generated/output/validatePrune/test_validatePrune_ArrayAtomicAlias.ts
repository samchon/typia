...
export const test_validatePrune_ArrayAtomicAlias = _test_validatePrune("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input) => ((input: any): typia.IValidation<ArrayAtomicAlias> => { const validate = (input: any): typia.IValidation<ArrayAtomicAlias> => {
    const errors = [] as any[];
