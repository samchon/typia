...
export const test_validateEquals_FunctionalTupleUnion = _test_validateEquals("FunctionalTupleUnion", FunctionalTupleUnion.generate, (input) => ((input: any): typia.IValidation<FunctionalTupleUnion> => {
    const errors = [] as any[];
