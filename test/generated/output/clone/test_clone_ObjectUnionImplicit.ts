...
export const test_clone_ObjectUnionImplicit = _test_clone("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: ObjectUnionImplicit): typia.Primitive<ObjectUnionImplicit> => {
