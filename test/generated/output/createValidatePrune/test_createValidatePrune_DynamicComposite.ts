...
export const test_createValidatePrune_DynamicComposite = _test_validatePrune("DynamicComposite", DynamicComposite.generate, (input: any): typia.IValidation<DynamicComposite> => { const validate = (input: any): typia.IValidation<DynamicComposite> => {
    ...
    prune(input); return output; }, DynamicComposite.SPOILERS);
