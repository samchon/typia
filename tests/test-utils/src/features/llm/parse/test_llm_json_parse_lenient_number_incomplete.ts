...
export const test_llm_json_parse_lenient_number_incomplete = (): void => {
  ...
  if (result1.success)
    TestValidator.equals("value1", result1.data, { value: 0 });
  ...
  if (result2.success)
    TestValidator.equals("value2", result2.data, { value: 1 });
  ...
  if (result3.success)
    TestValidator.equals("value3", result3.data, { value: 0 });
  ...
  if (result4.success)
    TestValidator.equals("value4", result4.data, { value: 0 });
};
