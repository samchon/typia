...
export const test_validatePrune_ArraySimple = _test_validatePrune("ArraySimple", ArraySimple.generate, (input) => ((input: any): typia.IValidation<ArraySimple> => { const validate = (input: any): typia.IValidation<ArraySimple> => {
    const errors = [] as any[];
