...
export const test_validateStringify_ObjectUnionDouble = _test_validateStringify("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: Array<ObjectUnionDouble.Union>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<ObjectUnionDouble.Union>> => {
    const __is = (input: any): input is Array<ObjectUnionDouble.Union> => {
        const $io0 = (input: any): boolean => "object" === typeof input.value && null !== input.value && ("number" === typeof input.value.x && Number.isFinite(input.value.x)) && ("object" === typeof input.child && null !== input.child && $iu0(input.child));
        const $io2 = (input: any): boolean => "object" === typeof input.value && null !== input.value && "boolean" === typeof input.value.y;
        const $io4 = (input: any): boolean => "object" === typeof input.value && null !== input.value && ("number" === typeof input.value.y && Number.isFinite(input.value.y));
        const $io6 = (input: any): boolean => "object" === typeof input.value && null !== input.value && "string" === typeof input.value.x && ("object" === typeof input.child && null !== input.child && $iu1(input.child));
        const $io8 = (input: any): boolean => "object" === typeof input.value && null !== input.value && "string" === typeof input.value.y;
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Array<ObjectUnionDouble.Union> => {
            ...
            const $vu0 = (input: any, _path: string, _exceptionable: boolean = true): any => $vo4(input, _path, false && _exceptionable) || $vo2(input, _path, false && _exceptionable);
            const $vu1 = (input: any, _path: string, _exceptionable: boolean = true): any => $vo10(input, _path, false && _exceptionable) || $vo8(input, _path, false && _exceptionable);
            const $vu2 = (input: any, _path: string, _exceptionable: boolean = true): any => $vo6(input, _path, false && _exceptionable) || $vo0(input, _path, false && _exceptionable);
...
}; const stringify = (input: Array<ObjectUnionDouble.Union>): string => {
    ...
    const $so0 = (input: any): any => `{"value":${`{"x":${$number(input.value.x)}}`},"child":${$su0(input.child)}}`;
    const $so2 = (input: any): any => `{"value":${`{"y":${input.value.y}}`}}`;
    const $so4 = (input: any): any => `{"value":${`{"y":${$number(input.value.y)}}`}}`;
    const $so6 = (input: any): any => `{"value":${`{"x":${$string(input.value.x)}}`},"child":${$su1(input.child)}}`;
    const $so8 = (input: any): any => `{"value":${`{"y":${$string(input.value.y)}}`}}`;
