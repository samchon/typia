...
export const test_isStringify_DefinitionJsonValue = _test_isStringify("DefinitionJsonValue", DefinitionJsonValue.generate, (input) => ((input: string | number | boolean | DefinitionJsonValue.JsonObject | DefinitionJsonValue.JsonArray | null): string | null => { const is = (input: any): input is string | number | boolean | DefinitionJsonValue.JsonObject | DefinitionJsonValue.JsonArray | null => {
...
}; return is(input) ? stringify(input) : null; })(input), DefinitionJsonValue.SPOILERS);
