...
export const test_createValidateClone_NativeSimple = _test_validateClone("NativeSimple", NativeSimple.generate, (input: any): typia.IValidation<typia.Primitive<NativeSimple>> => { const validate = (input: any): typia.IValidation<NativeSimple> => {
    ...
    output.data = clone(input); return output; }, NativeSimple.SPOILERS);
