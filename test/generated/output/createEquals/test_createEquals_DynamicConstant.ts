...
export const test_createEquals_DynamicConstant = _test_equals("DynamicConstant", DynamicConstant.generate, (input: any, _exceptionable: boolean): input is DynamicConstant => {
