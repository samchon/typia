...
export const test_is_ObjectGenericArray = _test_is("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): input is ObjectGenericArray.IPage<ObjectGenericArray.IPerson> => {
