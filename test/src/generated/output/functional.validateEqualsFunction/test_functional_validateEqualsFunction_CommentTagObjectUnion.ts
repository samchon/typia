...
export const test_functional_validateEqualsFunction_CommentTagObjectUnion =
  _test_functional_validateEqualsFunction("CommentTagObjectUnion")(
    CommentTagObjectUnion,
  )(
    (p: (input: CommentTagObjectUnion) => CommentTagObjectUnion) =>
      (
        input: CommentTagObjectUnion,
      ): import("typia").IValidation<CommentTagObjectUnion> => {
        const paramResults = [
