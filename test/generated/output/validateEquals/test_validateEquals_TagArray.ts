...
export const test_validateEquals_TagArray = _test_validateEquals("TagArray", TagArray.generate, (input) => ((input: any): typia.IValidation<Type[]> => {
    const errors = [] as any[];
