...
export const test_validatePrune_ObjectGenericArray = _test_validatePrune("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): typia.IValidation<ObjectGenericArray> => { const validate = (input: any): typia.IValidation<ObjectGenericArray> => {
    const errors = [] as any[];
