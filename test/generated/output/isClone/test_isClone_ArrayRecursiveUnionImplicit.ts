...
export const test_isClone_ArrayRecursiveUnionImplicit = _test_isClone("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): typia.Primitive<Array<ArrayRecursiveUnionImplicit.IBucket>> | null => { const is = (input: any): input is Array<ArrayRecursiveUnionImplicit.IBucket> => {
    ...
    return null; const output = clone(input); return output; })(input), ArrayRecursiveUnionImplicit.SPOILERS);
