...
export const test_createAssertPrune_TemplateConstant = _test_assertPrune("TemplateConstant", TemplateConstant.generate, (input: any): TemplateConstant => { const assert = (input: any) => {
