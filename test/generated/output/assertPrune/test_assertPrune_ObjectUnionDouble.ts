...
export const test_assertPrune_ObjectUnionDouble = _test_assertPrune("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): ObjectUnionDouble => { const assert = (input: any) => {
