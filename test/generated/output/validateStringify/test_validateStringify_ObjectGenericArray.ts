...
export const test_validateStringify_ObjectGenericArray = _test_validateStringify("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: ObjectGenericArray.IPage<ObjectGenericArray.IPerson>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>> => {
...
}; const stringify = (input: ObjectGenericArray.IPage<ObjectGenericArray.IPerson>): string => {
    ...
    output.data = stringify(input); return output; })(input), ObjectGenericArray.SPOILERS);
