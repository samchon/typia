...
export const test_createIsPrune_TagStep = _test_isPrune("TagStep", TagStep.generate, (input: any): input is TagStep => { const is = (input: any): input is TagStep => {
    ...
    return false; prune(input); return true; }, TagStep.SPOILERS);
