...
export const test_validatePrune_ConstantAtomicUnion = _test_validatePrune("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input) => ((input: any): typia.IValidation<Array<ConstantAtomicUnion.Union>> => { const validate = (input: any): typia.IValidation<Array<ConstantAtomicUnion.Union>> => {
