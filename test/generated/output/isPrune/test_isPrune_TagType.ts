...
export const test_isPrune_TagType = _test_isPrune("TagType", TagType.generate, (input) => ((input: any): input is Array<TagType.Type> => { const is = (input: any): input is Array<TagType.Type> => {
