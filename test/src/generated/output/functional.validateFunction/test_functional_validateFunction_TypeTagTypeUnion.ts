...
export const test_functional_validateFunction_TypeTagTypeUnion =
  _test_functional_validateFunction("TypeTagTypeUnion")(TypeTagTypeUnion)(
    (p: (input: TypeTagTypeUnion) => TypeTagTypeUnion) =>
      (
        input: TypeTagTypeUnion,
      ): import("typia").IValidation<TypeTagTypeUnion> => {
        const paramResults = [
