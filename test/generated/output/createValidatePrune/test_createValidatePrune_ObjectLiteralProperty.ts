...
export const test_createValidatePrune_ObjectLiteralProperty = _test_validatePrune("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any): typia.IValidation<ObjectLiteralProperty> => { const validate = (input: any): typia.IValidation<ObjectLiteralProperty> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ObjectLiteralProperty.SPOILERS);
