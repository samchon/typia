...
export const test_misc_assertClone_NativeAlias = _test_misc_assertClone(
    "NativeAlias",
)<NativeAlias>(NativeAlias)((input: any): typia.Primitive<NativeAlias> => {
    ...
    const clone = (input: NativeAlias): typia.Primitive<NativeAlias> => {
        ...
        const $co0 = (input: any): any => ({
            ...
            weakSet:
                input.weakSet instanceof WeakSet ? {} : (input.weakSet as any),
            weakMap:
                input.weakMap instanceof WeakMap ? {} : (input.weakMap as any),
        });
