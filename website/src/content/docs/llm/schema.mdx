...
<Tabs items={["TypeScript Source Code", "Compiled JavaScript"]}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/llm/schema.ts"
      filename="example/src/llm/schema.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/llm/schema.js"
...
<Tabs items={["TypeScript Source Code", "Compiled JavaScript File"]}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/llm/schema-recursive-gemini.ts"
      filename="example/src/llm/schema-recursive-gemini.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/llm/schema-recursive-gemini.js"
