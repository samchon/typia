...
export const test_createIsPrune_DynamicConstant = _test_isPrune("DynamicConstant", DynamicConstant.generate, (input: any): input is DynamicConstant => { const is = (input: any): input is DynamicConstant => {
    ...
    return false; prune(input); return true; }, DynamicConstant.SPOILERS);
