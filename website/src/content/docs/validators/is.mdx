...
- **Function types** — function values pass through unchecked. typia validates the structural data your code passes around, not the behavior of callables stored inside it.
