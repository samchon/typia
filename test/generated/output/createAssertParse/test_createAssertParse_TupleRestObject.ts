...
export const test_createAssertParse_TupleRestObject = _test_assertParse("TupleRestObject", TupleRestObject.generate, (input: string): typia.Primitive<TupleRestObject> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, TupleRestObject.SPOILERS);
