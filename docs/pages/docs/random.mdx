...
```
    ...
    <Tab>
```typescript filename="typia/IRandomGenerator.ts"
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
    <Tab>
```typescript filename="examples/src/.ts" showLineNumbers {3}
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
    <Tab>
```typescript filename="examples/src/createRandom.ts" showLineNumbers {3}
import typia from "typia";
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
    <Tab>
```typescript filename="examples/src/application-comment-tags.ts" showLineNumbers {3}
import typia from "typia";
...
```
    ...
    <Tab>
```typescript filename="typia/IRandomGenerator.ts" showLineNumbers {18, 21-24}
export interface IRandomGenerator {
    boolean(): boolean;
    integer(minimum?: number, maximum?: number): number;
    number(minimum?: number, maximum?: number): number;
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
    <Tab>
```typescript filename="examples/src/random-customization.ts" showLineNumbers {4-23}
import typia from "typia";
