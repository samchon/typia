...
export const test_createRandom_ObjectAlias = _test_random("ObjectAlias", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectAlias> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectAlias> => {
