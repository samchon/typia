...
export const test_createAssertClone_ToJsonUnion = _test_assertClone("ToJsonUnion", ToJsonUnion.generate, (input: any): typia.Primitive<ToJsonUnion> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as ToJsonUnion; });
