...
export const test_functional_validateEqualsFunctionAsync_CommentTagArrayUnion =
  _test_functional_validateEqualsFunctionAsync("CommentTagArrayUnion")(
    CommentTagArrayUnion,
  )(
    (p: (input: CommentTagArrayUnion) => Promise<CommentTagArrayUnion>) =>
      async (
        input: CommentTagArrayUnion,
      ): Promise<import("typia").IValidation<CommentTagArrayUnion>> => {
        const paramResults = [
