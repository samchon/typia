...
export const test_validateStringify_TagType = _test_validateStringify("TagType", TagType.generate, (input) => ((input: TagType): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TagType> => {
    const errors = [] as any[];
