...
export const test_createAssertClone_ArrayAtomicAlias = _test_assertClone("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input: any): typia.Primitive<ArrayAtomicAlias> => { const assert = (input: any): ArrayAtomicAlias => {
...
}; assert(input); const output = clone(input); return output; }, ArrayAtomicAlias.SPOILERS);
