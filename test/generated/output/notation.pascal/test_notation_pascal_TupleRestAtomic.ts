...
export const test_notation_validatePascal_TupleRestAtomic =
  _test_notation_validateGeneral("TupleRestAtomic")<TupleRestAtomic>(
    TupleRestAtomic,
  )<typia.PascalCase<TupleRestAtomic>>({
    convert: (input) =>
      ((input: any): typia.IValidation<typia.PascalCase<TupleRestAtomic>> => {
    ...
    assert: (input: any): typia.PascalCase<TupleRestAtomic> => {
