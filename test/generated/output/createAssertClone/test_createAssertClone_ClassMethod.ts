...
export const test_createAssertClone_ClassMethod = _test_assertClone("ClassMethod", ClassMethod.generate, (input: any): typia.Primitive<Animal> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ClassMethod.Animal */; return output as Animal; }, ClassMethod.SPOILERS);
