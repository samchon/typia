...
export const test_isClone_MapAlias = _test_isClone("MapAlias", MapAlias.generate, (input) => ((input: any): typia.Primitive<MapSimple> | null => { const is = (input: any): input is MapSimple => {
    ...
    return null; const output = clone(input); return output; })(input), MapAlias.SPOILERS);
