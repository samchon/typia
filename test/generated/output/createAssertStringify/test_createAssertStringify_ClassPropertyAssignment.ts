...
export const test_createAssertStringify_ClassPropertyAssignment = _test_assertStringify("ClassPropertyAssignment", ClassPropertyAssignment.generate, (input: any): string => { const assert = (input: any): ClassPropertyAssignment => {
    ...
    return $so0(input);
}; return stringify(assert(input)); }, ClassPropertyAssignment.SPOILERS);
