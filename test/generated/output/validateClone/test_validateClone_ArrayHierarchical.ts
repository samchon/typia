...
export const test_validateClone_ArrayHierarchical = _test_validateClone("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<ArrayHierarchical.ICompany>>> => { const validate = (input: any): typia.IValidation<Array<ArrayHierarchical.ICompany>> => {
    const __is = (input: any): input is Array<ArrayHierarchical.ICompany> => {
        const $io0 = (input: any): boolean => "number" === typeof input.id && Number.isFinite(input.id) && ("number" === typeof input.serial && Number.isFinite(input.serial)) && "string" === typeof input.name && ("object" === typeof input.established_at && null !== input.established_at && ("number" === typeof input.established_at.time && Number.isFinite(input.established_at.time) && ("number" === typeof input.established_at.zone && Number.isFinite(input.established_at.zone)))) && (Array.isArray(input.departments) && input.departments.every((elem: any) => "object" === typeof elem && null !== elem && $io2(elem)));
        const $io2 = (input: any): boolean => "number" === typeof input.id && Number.isFinite(input.id) && "string" === typeof input.code && ("number" === typeof input.sales && Number.isFinite(input.sales)) && ("object" === typeof input.created_at && null !== input.created_at && ("number" === typeof input.created_at.time && Number.isFinite(input.created_at.time) && ("number" === typeof input.created_at.zone && Number.isFinite(input.created_at.zone)))) && (Array.isArray(input.employees) && input.employees.every((elem: any) => "object" === typeof elem && null !== elem && $io3(elem)));
        const $io3 = (input: any): boolean => "number" === typeof input.id && Number.isFinite(input.id) && "string" === typeof input.name && ("number" === typeof input.age && Number.isFinite(input.age)) && ("number" === typeof input.grade && Number.isFinite(input.grade)) && ("object" === typeof input.employeed_at && null !== input.employeed_at && ("number" === typeof input.employeed_at.time && Number.isFinite(input.employeed_at.time) && ("number" === typeof input.employeed_at.zone && Number.isFinite(input.employeed_at.zone))));
    ...
    const $co0 = (input: any): any => ({
        ...
        departments: Array.isArray(input.departments) ? input.departments.map((elem: any) => "object" === typeof elem && null !== elem ? $co2(elem) : elem as any) : input.departments as any
    });
    ...
    const $co2 = (input: any): any => ({
        ...
        employees: Array.isArray(input.employees) ? input.employees.map((elem: any) => "object" === typeof elem && null !== elem ? $co3(elem) : elem as any) : input.employees as any
    });
