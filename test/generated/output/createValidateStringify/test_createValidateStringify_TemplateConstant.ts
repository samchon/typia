...
export const test_createValidateStringify_TemplateConstant = _test_validateStringify("TemplateConstant", TemplateConstant.generate, (input: TemplateConstant): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TemplateConstant> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, TemplateConstant.SPOILERS);
