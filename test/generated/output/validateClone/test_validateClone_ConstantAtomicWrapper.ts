...
export const test_validateClone_ConstantAtomicWrapper = _test_validateClone("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ConstantAtomicWrapper>> => { const validate = (input: any): typia.IValidation<ConstantAtomicWrapper> => {
    const errors = [] as any[];
