...
export const test_validate_ToJsonUnion = _test_validate("ToJsonUnion", ToJsonUnion.generate, (input) => ((input: any): typia.IValidation<Array<string | number | ToJsonUnion.ICitizen | ToJsonUnion.IWrapper<boolean> | ToJsonUnion.IWrapper<ToJsonUnion.ICitizen> | ToJsonUnion.IWrapper<ToJsonUnion.IProduct>>> => {
