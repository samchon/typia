...
export const test_notation_validateCamel_CommentTagType =
  _test_notation_validateGeneral("CommentTagType")<CommentTagType>(
    CommentTagType,
  )<typia.CamelCase<CommentTagType>>({
    convert: (input) =>
      ((input: any): typia.IValidation<typia.CamelCase<CommentTagType>> => {
    ...
    assert: (input: any): typia.CamelCase<CommentTagType> => {
      const __is = (input: any): input is typia.CamelCase<CommentTagType> => {
        const $io0 = (input: any): boolean =>
          Array.isArray(input.value) &&
          input.value.every(
            (elem: any) =>
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.CamelCase<CommentTagType> => {
