...
export const test_createIsParse_TagRange = _test_isParse("TagRange", TagRange.generate, (input: any): typia.Primitive<TagRange> => { const is = (input: any): input is TagRange => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; }, TagRange.SPOILERS);
