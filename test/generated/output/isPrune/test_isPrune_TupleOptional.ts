...
export const test_isPrune_TupleOptional = _test_isPrune("TupleOptional", TupleOptional.generate, (input) => ((input: any): input is Array<[number, boolean, string, (number | null | undefined)?, (string | null | undefined)?]> => { const is = (input: any): input is Array<[number, boolean, string, (number | null | undefined)?, (string | null | undefined)?]> => {
    ...
    return false; prune(input); return true; })(input), TupleOptional.SPOILERS);
