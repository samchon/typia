...
export const test_functional_validateEqualsFunctionAsync_TypeTagFormat =
  _test_functional_validateEqualsFunctionAsync("TypeTagFormat")(TypeTagFormat)(
    (p: (input: TypeTagFormat) => Promise<TypeTagFormat>) =>
      async (
        input: TypeTagFormat,
      ): Promise<import("typia").IValidation<TypeTagFormat>> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<TypeTagFormat> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
