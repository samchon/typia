...
export const test_isClone_ObjectUnionExplicit = _test_isClone("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input) => ((input: any): typia.Primitive<ObjectUnionExplicit> | null => { const is = (input: any): input is ObjectUnionExplicit => {
