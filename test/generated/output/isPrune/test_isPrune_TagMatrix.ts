...
export const test_isPrune_TagMatrix = _test_isPrune("TagMatrix", TagMatrix.generate, (input) => ((input: any): input is TagMatrix => { const is = (input: any): input is TagMatrix => {
    ...
    return false; prune(input); return true; })(input), TagMatrix.SPOILERS);
