...
export const test_isClone_ArrayUnion = _test_isClone("ArrayUnion", ArrayUnion.generate, (input) => ((input: any): typia.Primitive<Array<ArrayUnion.IUnion>> | null => { const is = (input: any): input is Array<ArrayUnion.IUnion> => {
