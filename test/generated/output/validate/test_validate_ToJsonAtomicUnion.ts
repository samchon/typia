...
export const test_validate_ToJsonAtomicUnion = _test_validate("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input) => ((input: any): typia.IValidation<ToJsonAtomicUnion> => {
    const errors = [] as any[];
