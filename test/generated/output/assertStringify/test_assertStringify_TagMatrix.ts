...
export const test_assertStringify_TagMatrix = _test_assertStringify("TagMatrix", TagMatrix.generate, (input) => ((input: any): string => { const assert = (input: any): TagMatrix => {
