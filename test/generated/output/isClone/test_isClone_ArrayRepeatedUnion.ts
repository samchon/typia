...
export const test_isClone_ArrayRepeatedUnion = _test_isClone("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input) => ((input: any): typia.Primitive<number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>> | null => { const is = (input: any): input is number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D> => {
    const $ip0 = (input: any) => {
        const array = input;
        const top = input[0];
        if (0 === input.length)
    ...
    return null; const output = clone(input); return output; })(input), ArrayRepeatedUnion.SPOILERS);
