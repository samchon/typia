...
export const test_assert_FunctionalArrayUnion = _test_assert("FunctionalArrayUnion", FunctionalArrayUnion.generate, (input) => ((input: any): Array<FunctionalArrayUnion.Union> => {
