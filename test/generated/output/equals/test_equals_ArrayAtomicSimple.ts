...
export const test_equals_ArrayAtomicSimple = _test_equals("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any, _exceptionable: boolean = true): input is [Array<boolean>, Array<number>, Array<string>] => {
