...
export const test_assertPrune_ObjectPropertyNullable = _test_assertPrune("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input) => ((input: any): ObjectPropertyNullable => { const assert = (input: any) => {
