...
export const test_assertStringify_AtomicClass = _test_assertStringify("AtomicClass", AtomicClass.generate, (input) => ((input: any): string => { const assert = (input: any): [Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String] => {
...
}; return stringify(assert(input)); })(input), AtomicClass.SPOILERS);
