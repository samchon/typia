...
export const test_createAssertParse_ArrayHierarchical = _test_assertParse("ArrayHierarchical", ArrayHierarchical.generate, (input: string): typia.Primitive<ArrayHierarchical> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, ArrayHierarchical.SPOILERS);
