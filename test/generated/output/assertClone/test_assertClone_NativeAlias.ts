...
export const test_assertClone_NativeAlias = _test_assertClone("NativeAlias", NativeAlias.generate, (input) => ((input: any): typia.Primitive<NativeSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* NativeSimple */; return output as NativeSimple; })(input), NativeAlias.SPOILERS);
