...
export const test_isStringify_ObjectNullable = _test_isStringify("ObjectNullable", ObjectNullable.generate, (input) => ((input: ObjectNullable): string | null => { const is = (input: any): input is ObjectNullable => {
