...
export const test_validateEquals_ClassClosure = _test_validateEquals("ClassClosure", ClassClosure.generate, (input) => ((input: any): typia.IValidation<ClassClosure.Something> => {
    const __is = (input: any, _exceptionable: boolean = true): input is ClassClosure.Something => {
