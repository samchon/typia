...
export const test_createValidateStringify_AtomicClass = _test_validateStringify("AtomicClass", AtomicClass.generate, (input: AtomicClass): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<AtomicClass> => {
    ...
    output.data = stringify(input); return output; }, AtomicClass.SPOILERS);
