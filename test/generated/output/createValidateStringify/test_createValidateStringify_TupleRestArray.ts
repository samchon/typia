...
export const test_createValidateStringify_TupleRestArray = _test_validateStringify("TupleRestArray", TupleRestArray.generate, (input: TupleRestArray): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TupleRestArray> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, TupleRestArray.SPOILERS);
