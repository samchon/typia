...
export const test_validate_TupleOptional = _test_validate("TupleOptional", TupleOptional.generate, (input) => ((input: any): typia.IValidation<Array<[number, boolean, string, (number | null | undefined)?, (string | null | undefined)?]>> => {
