...
export const test_createValidatePrune_ObjectLiteralType = _test_validatePrune("ObjectLiteralType", ObjectLiteralType.generate, (input: any): typia.IValidation<ObjectLiteralType> => { const validate = (input: any): typia.IValidation<ObjectLiteralType> => {
    const errors = [] as any[];
