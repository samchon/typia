...
export const test_createValidatePrune_ObjectHierarchical = _test_validatePrune("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.IValidation<ICustomer> => { const validate = (input: any): typia.IValidation<ICustomer> => {
    const errors = [] as any[];
...
}; const prune = (input: ICustomer): void => {
