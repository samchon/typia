...
export const test_assertStringify_TagAtomicUnion = _test_assertStringify("TagAtomicUnion", TagAtomicUnion.generate, (input) => ((input: any): string => { const assert = (input: any): Array<TagAtomicUnion.Type> => {
