...
export const test_equals_DynamicComposite = _test_equals("DynamicComposite", DynamicComposite.generate, (input) => ((input: any, _exceptionable: boolean): input is DynamicComposite => {
