...
export const test_functional_equalsParametersAsync_ArrayRecursiveUnionExplicitPointer =
  _test_functional_equalsParametersAsync("ArrayRecursiveUnionExplicitPointer")(
