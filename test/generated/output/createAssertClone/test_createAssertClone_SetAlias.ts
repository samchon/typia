...
export const test_createAssertClone_SetAlias = _test_assertClone("SetAlias", SetAlias.generate, (input: any): typia.Primitive<SetAlias> => { const assert = (input: any): SetAlias => {
...
}; assert(input); const output = clone(input); return output; }, SetAlias.SPOILERS);
