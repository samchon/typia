...
export const test_functional_isFunctionAsync_TypeTagTypeUnion =
  _test_functional_isFunctionAsync("TypeTagTypeUnion")(TypeTagTypeUnion)(
    (p: (input: TypeTagTypeUnion) => Promise<TypeTagTypeUnion>) =>
      async (input: TypeTagTypeUnion): Promise<TypeTagTypeUnion | null> => {
        if (
          false ===
        ...
        return ((input: any): input is TypeTagTypeUnion => {
          const $io0 = (input: any): boolean =>
            "number" === typeof input.int32_or_uint32 &&
            ((Math.floor(input.int32_or_uint32) === input.int32_or_uint32 &&
              -2147483648 <= input.int32_or_uint32 &&
