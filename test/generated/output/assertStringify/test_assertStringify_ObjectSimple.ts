...
export const test_assertStringify_ObjectSimple = _test_assertStringify("ObjectSimple", ObjectSimple.generate, (input) => ((input: any): string => { const assert = (input: any): ObjectSimple.IBox3D => {
    ...
    return $so0(input);
}; return stringify(assert(input)); })(input), ObjectSimple.SPOILERS);
