...
export const test_validateEquals_ArrayHierarchical = _test_validateEquals("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: any): typia.IValidation<ArrayHierarchical> => {
    const errors = [] as any[];
