...
export const test_createIsStringify_ArrayRepeatedUnionWithTuple = _test_isStringify("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input: ArrayRepeatedUnionWithTuple): string | null => { const is = (input: any): input is ArrayRepeatedUnionWithTuple => {
    const $ip0 = (input: any) => {
        const array = input;
...
}; return is(input) ? stringify(input) : null; }, ArrayRepeatedUnionWithTuple.SPOILERS);
