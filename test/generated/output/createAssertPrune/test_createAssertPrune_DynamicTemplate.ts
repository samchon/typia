...
export const test_createAssertPrune_DynamicTemplate = _test_assertPrune("DynamicTemplate", DynamicTemplate.generate, (input: any): DynamicTemplate => { const assert = (input: any): DynamicTemplate => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, DynamicTemplate.SPOILERS);
