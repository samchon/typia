...
export const test_validateStringify_DefinitionArrayRecursiveNullable = _test_validateStringify("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input) => ((input: string | number | Array<DefinitionArrayRecursiveNullable> | null): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<string | number | Array<DefinitionArrayRecursiveNullable> | null> => {
    ...
    output.data = stringify(input); return output; })(input), DefinitionArrayRecursiveNullable.SPOILERS);
