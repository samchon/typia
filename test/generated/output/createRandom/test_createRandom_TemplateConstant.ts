...
export const test_createRandom_TemplateConstant = _test_random("TemplateConstant", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<TemplateConstant> => {
    ...
    const __is = (input: any): input is typia.Primitive<TemplateConstant> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<TemplateConstant> => {
