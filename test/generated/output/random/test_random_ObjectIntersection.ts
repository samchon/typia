...
export const test_random_ObjectIntersection = _test_random("ObjectIntersection", () => ((generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectIntersection> => {
