...
export const test_functional_equalsFunction_ObjectUnionExplicit =
  _test_functional_equalsFunction("ObjectUnionExplicit")(ObjectUnionExplicit)(
    (p: (input: ObjectUnionExplicit) => ObjectUnionExplicit) =>
      (input: ObjectUnionExplicit): ObjectUnionExplicit | null => {
        if (
          false ===
          ((
            input: any,
