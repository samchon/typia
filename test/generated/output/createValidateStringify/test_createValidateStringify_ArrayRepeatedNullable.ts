...
export const test_createValidateStringify_ArrayRepeatedNullable = _test_validateStringify("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input: ArrayRepeatedNullable): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayRepeatedNullable> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ArrayRepeatedNullable.SPOILERS);
