...
export const test_functional_validateEqualsReturnAsync_TypeTagTuple =
  _test_functional_validateEqualsReturnAsync("TypeTagTuple")(TypeTagTuple)(
    (p: (input: TypeTagTuple) => Promise<TypeTagTuple>) =>
      async (
        input: TypeTagTuple,
      ): Promise<import("typia").IValidation<TypeTagTuple>> => {
