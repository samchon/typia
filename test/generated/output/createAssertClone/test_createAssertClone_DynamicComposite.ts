...
export const test_createAssertClone_DynamicComposite = _test_assertClone("DynamicComposite", DynamicComposite.generate, (input: any): typia.Primitive<DynamicComposite> => { const assert = (input: any): DynamicComposite => {
...
}; assert(input); const output = clone(input); return output; }, DynamicComposite.SPOILERS);
