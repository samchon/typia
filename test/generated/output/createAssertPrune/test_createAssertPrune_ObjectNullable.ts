...
export const test_createAssertPrune_ObjectNullable = _test_assertPrune("ObjectNullable", ObjectNullable.generate, (input: any): ObjectNullable => { const assert = (input: any): ObjectNullable => {
