...
export const test_notation_validateCamel_ObjectIntersection =
  _test_notation_validateGeneral("ObjectIntersection")<ObjectIntersection>(
    ...
    convert: (input) =>
      ((input: any): typia.IValidation<typia.CamelCase<ObjectIntersection>> => {
        const validate = (
          input: any,
    ...
    assert: (input: any): typia.CamelCase<ObjectIntersection> => {
      const __is = (
        input: any,
      ): input is typia.CamelCase<ObjectIntersection> => {
        return (
          "object" === typeof input &&
          null !== input &&
          "string" === typeof (input as any).email &&
