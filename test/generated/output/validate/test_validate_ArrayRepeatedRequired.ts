...
export const test_validate_ArrayRepeatedRequired = _test_validate("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input) => ((input: any): typia.IValidation<string | number | Array<ArrayRepeatedRequired>> => {
    const errors = [] as any[];
...
})(input), ArrayRepeatedRequired.SPOILERS);
