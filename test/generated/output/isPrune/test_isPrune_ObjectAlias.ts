...
export const test_isPrune_ObjectAlias = _test_isPrune("ObjectAlias", ObjectAlias.generate, (input) => ((input: any): input is Array<ObjectAlias.IMember> => { const is = (input: any): input is Array<ObjectAlias.IMember> => {
    ...
    return false; prune(input); return true; })(input), ObjectAlias.SPOILERS);
