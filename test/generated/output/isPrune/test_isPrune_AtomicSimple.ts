...
export const test_isPrune_AtomicSimple = _test_isPrune("AtomicSimple", AtomicSimple.generate, (input) => ((input: any): input is AtomicSimple => { const is = (input: any): input is AtomicSimple => {
