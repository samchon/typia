...
export const test_assertClone_ObjectUnionExplicit = _test_assertClone("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input) => ((input: any): typia.Primitive<ObjectUnionExplicit> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as ObjectUnionExplicit; })(input), ObjectUnionExplicit.SPOILERS);
