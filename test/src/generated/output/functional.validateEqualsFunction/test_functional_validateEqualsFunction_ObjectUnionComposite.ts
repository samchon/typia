...
export const test_functional_validateEqualsFunction_ObjectUnionComposite =
  _test_functional_validateEqualsFunction("ObjectUnionComposite")(
    ObjectUnionComposite,
  )(
    (p: (input: ObjectUnionComposite) => ObjectUnionComposite) =>
      (
        input: ObjectUnionComposite,
      ): import("typia").IValidation<ObjectUnionComposite> => {
        const paramResults = [
