...
export const test_validatePrune_ArrayRecursiveUnionImplicit = _test_validatePrune("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): typia.IValidation<Array<ArrayRecursiveUnionImplicit.IBucket>> => { const validate = (input: any): typia.IValidation<Array<ArrayRecursiveUnionImplicit.IBucket>> => {
...
}; const prune = (input: Array<ArrayRecursiveUnionImplicit.IBucket>): void => {
    ...
    prune(input); return output; })(input), ArrayRecursiveUnionImplicit.SPOILERS);
