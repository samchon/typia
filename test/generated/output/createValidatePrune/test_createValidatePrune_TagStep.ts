...
export const test_createValidatePrune_TagStep = _test_validatePrune("TagStep", TagStep.generate, (input: any): typia.IValidation<TagStep> => { const validate = (input: any): typia.IValidation<TagStep> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, TagStep.SPOILERS);
