...
export const test_createEquals_ToJsonAtomicUnion = _test_equals("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input: any, _exceptionable: boolean = true): input is ToJsonAtomicUnion => {
