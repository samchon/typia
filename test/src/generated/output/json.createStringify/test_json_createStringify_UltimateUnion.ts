...
export const test_json_createStringify_UltimateUnion = _test_json_stringify(
  ...
  const $io4 = (input: any): boolean =>
    ...
    "number" === input.type &&
    (undefined === input.title || "string" === typeof input.title) &&
    (undefined === input["default"] || "number" === typeof input["default"]) &&
    (undefined === input.nullable || "boolean" === typeof input.nullable) &&
    (undefined === input.deprecated || "boolean" === typeof input.deprecated) &&
    (undefined === input.description ||
      "string" === typeof input.description) &&
        ...
        : `"text":${
            undefined !== input.text
              ? `[${input.text
                  .map(
                    (elem: any) =>
                      `{"text":${$string((elem as any).text)},"kind":${$string(
                        (elem as any).kind,
                      )}}`,
                  )
                  .join(",")}]`
  ...
  const $so7 = (input: any): any =>
    `{${
      undefined === input.value || "function" === typeof input.value
        ? ""
        : `"value":${
            undefined !== input.value ? JSON.stringify(input.value) : undefined
          },`
    }${
      undefined === input.validate
        ? ""
        : `"validate":${
            undefined !== input.validate ? $string(input.validate) : undefined
          },`
    }"target":${(() => {
  ...
  const $so8 = (input: any): any =>
    `{${
      undefined === input.minimum
        ? ""
        : `"minimum":${
            undefined !== input.minimum ? $number(input.minimum) : undefined
          },`
    }${
      undefined === input.maximum
        ? ""
        : `"maximum":${
            undefined !== input.maximum ? $number(input.maximum) : undefined
          },`
    }${
      undefined === input.exclusiveMinimum
        ? ""
  ...
  const $so10 = (input: any): any =>
    `{${
      undefined === input.minLength
        ? ""
        : `"minLength":${
            undefined !== input.minLength ? $number(input.minLength) : undefined
          },`
    }${
      undefined === input.maxLength
        ? ""
        : `"maxLength":${
            undefined !== input.maxLength ? $number(input.maxLength) : undefined
          },`
    }${
      undefined === input.pattern
        ? ""
        : `"pattern":${
            undefined !== input.pattern ? $string(input.pattern) : undefined
          },`
    }${
  ...
  const $so11 = (input: any): any =>
    `{${
      undefined === input.minItems
        ? ""
        : `"minItems":${
            undefined !== input.minItems ? $number(input.minItems) : undefined
          },`
    }${
      undefined === input.maxItems
        ? ""
        : `"maxItems":${
            undefined !== input.maxItems ? $number(input.maxItems) : undefined
          },`
    }${
      undefined === input["x-typia-tuple"]
        ? ""
  ...
  const $so12 = (input: any): any =>
    `{${
      ...
      .map((elem: any) => $su0(elem))
      .join(",")}]`},"minItems":${$number(input.minItems)},"type":${(() => {
      if ("string" === typeof input.type) return $string(input.type);
      if ("string" === typeof input.type) return '"' + input.type + '"';
      $throws({
        expected: '"array"',
  ...
  const $so13 = (input: any): any =>
    `{${
      ...
      undefined === input["x-typia-patternProperties"]
        ...
        : `"x-typia-patternProperties":${
            undefined !== input["x-typia-patternProperties"]
              ? $so14(input["x-typia-patternProperties"])
              : undefined
          },`
    }${
      undefined === input["x-typia-additionalProperties"]
    ...
    }"properties":${$so14(input.properties)},"type":${(() => {
      if ("string" === typeof input.type) return $string(input.type);
      if ("string" === typeof input.type) return '"' + input.type + '"';
      $throws({
        expected: '"object"',
  ...
  const $so17 = (input: any): any =>
    ...
    }"oneOf":${`[${input.oneOf.map((elem: any) => $su0(elem)).join(",")}]`}}`;
    ...
    `{${$tail(
      `${
        undefined === input.schemas
          ? ""
          : `"schemas":${
              undefined !== input.schemas ? $so20(input.schemas) : undefined
            }`
      }`,
    )}}`;
