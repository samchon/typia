...
export const test_isPrune_TagCustom = _test_isPrune("TagCustom", TagCustom.generate, (input) => ((input: any): input is TagCustom => { const is = (input: any): input is TagCustom => {
    ...
    return false; prune(input); return true; })(input), TagCustom.SPOILERS);
