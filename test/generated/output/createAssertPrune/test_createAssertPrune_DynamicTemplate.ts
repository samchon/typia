...
export const test_createAssertPrune_DynamicTemplate = _test_assertPrune("DynamicTemplate", DynamicTemplate.generate, (input: any): DynamicTemplate => { const assert = (input: any) => {
