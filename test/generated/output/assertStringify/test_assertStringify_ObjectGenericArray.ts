...
export const test_assertStringify_ObjectGenericArray = _test_assertStringify("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): string => { const assert = (input: any): ObjectGenericArray.IPage<ObjectGenericArray.IPerson> => {
