...
export const test_is_FunctionalObjectUnion = _test_is("FunctionalObjectUnion", FunctionalObjectUnion.generate, (input) => ((input: any): input is FunctionalObjectUnion => {
