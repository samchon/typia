...
export const test_isParse_ObjectTuple = _test_isParse("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.Primitive<ObjectTuple> => { const is = (input: any): input is ObjectTuple => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; })(input), ObjectTuple.SPOILERS);
