...
export const test_validateStringify_ArrayAtomicSimple = _test_validateStringify("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: [Array<boolean>, Array<number>, Array<string>]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[Array<boolean>, Array<number>, Array<string>]> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ArrayAtomicSimple.SPOILERS);
