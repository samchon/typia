...
export const test_isClone_ObjectRecursive = _test_isClone("ObjectRecursive", ObjectRecursive.generate, (input) => ((input: any): typia.Primitive<IDepartment> | null => { const is = (input: any): input is IDepartment => {
