...
export const test_equals_DynamicTemplate = _test_equals("DynamicTemplate", DynamicTemplate.generate, (input) => ((input: any, _exceptionable: boolean): input is DynamicTemplate => {
