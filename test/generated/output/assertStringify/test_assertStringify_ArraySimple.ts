...
export const test_assertStringify_ArraySimple = _test_assertStringify("ArraySimple", ArraySimple.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ArraySimple.IPerson> => {
