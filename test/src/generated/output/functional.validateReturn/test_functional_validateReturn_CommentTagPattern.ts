...
export const test_functional_validateReturn_CommentTagPattern =
  _test_functional_validateReturn("CommentTagPattern")(CommentTagPattern)(
    (p: (input: CommentTagPattern) => CommentTagPattern) =>
      (
        input: CommentTagPattern,
      ): import("typia").IValidation<CommentTagPattern> => {
        const result = ((input: any): typia.IValidation<CommentTagPattern> => {
          const errors = [] as any[];
