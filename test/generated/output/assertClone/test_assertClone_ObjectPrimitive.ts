...
export const test_assertClone_ObjectPrimitive = _test_assertClone("ObjectPrimitive", ObjectPrimitive.generate, (input) => ((input: any): typia.Primitive<ObjectPrimitive.IArticle> => { const assert = (input: any): ObjectPrimitive.IArticle => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectPrimitive.SPOILERS);
