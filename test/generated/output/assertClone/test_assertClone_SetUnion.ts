...
export const test_assertClone_SetUnion = _test_assertClone("SetUnion", SetUnion.generate, (input) => ((input: any): typia.Primitive<SetUnion> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as SetUnion; })(input), SetUnion.SPOILERS);
