...
export const test_functional_validateFunction_ObjectHttpTypeTag =
  _test_functional_validateFunction("ObjectHttpTypeTag")(ObjectHttpTypeTag)(
    (p: (input: ObjectHttpTypeTag) => ObjectHttpTypeTag) =>
      (
        input: ObjectHttpTypeTag,
      ): import("typia").IValidation<ObjectHttpTypeTag> => {
        const paramResults = [
