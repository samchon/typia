...
export const test_validateEquals_TagObjectUnion = _test_validateEquals("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): typia.IValidation<TagObjectUnion> => {
    const errors = [] as any[];
