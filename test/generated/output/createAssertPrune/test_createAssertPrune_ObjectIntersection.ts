...
export const test_createAssertPrune_ObjectIntersection = _test_assertPrune("ObjectIntersection", ObjectIntersection.generate, (input: any): ObjectIntersection => { const assert = (input: any): ObjectIntersection => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, ObjectIntersection.SPOILERS);
