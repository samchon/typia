...
export const test_validatePrune_TemplateConstant = _test_validatePrune("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): typia.IValidation<Array<TemplateConstant.Type>> => { const validate = (input: any): typia.IValidation<Array<TemplateConstant.Type>> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), TemplateConstant.SPOILERS);
