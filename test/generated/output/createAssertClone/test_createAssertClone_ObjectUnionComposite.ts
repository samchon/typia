...
export const test_createAssertClone_ObjectUnionComposite = _test_assertClone("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any): typia.Primitive<ObjectUnionComposite> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as ObjectUnionComposite; }, ObjectUnionComposite.SPOILERS);
