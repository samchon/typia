...
export const test_createAssertPrune_AtomicAlias = _test_assertPrune("AtomicAlias", AtomicAlias.generate, (input: any): AtomicAlias => { const assert = (input: any): AtomicAlias => {
...
}; assert(input); prune(input); return input; }, AtomicAlias.SPOILERS);
