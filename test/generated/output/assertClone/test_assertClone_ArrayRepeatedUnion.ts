...
export const test_assertClone_ArrayRepeatedUnion = _test_assertClone("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input) => ((input: any): typia.Primitive<number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>> => { const assert = (input: any): number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D> => {
...
}; assert(input); const output = clone(input); return output; })(input), ArrayRepeatedUnion.SPOILERS);
