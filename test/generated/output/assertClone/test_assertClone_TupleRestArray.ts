...
export const test_assertClone_TupleRestArray = _test_assertClone("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): typia.Primitive<[boolean, number, ...Array<string>[]]> => { const assert = (input: any): [boolean, number, ...Array<string>[]] => {
...
}; assert(input); const output = clone(input); return output; })(input), TupleRestArray.SPOILERS);
