...
export const test_validateEquals_ObjectGenericArray = _test_validateEquals("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): typia.IValidation<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>> => {
    const errors = [] as any[];
    ...
    const __is = (input: any, _exceptionable: boolean = true): input is ObjectGenericArray.IPage<ObjectGenericArray.IPerson> => {
        ...
        const $io1 = (input: any, _exceptionable: boolean = true): boolean => "number" === typeof input.page && Number.isFinite(input.page) && ("number" === typeof input.limit && Number.isFinite(input.limit)) && ("number" === typeof input.total_count && Number.isFinite(input.total_count)) && ("number" === typeof input.total_pages && Number.isFinite(input.total_pages)) && (4 === Object.keys(input).length || Object.keys(input).every((key: any) => {
            if (["page", "limit", "total_count", "total_pages"].some((prop: any) => key === prop))
                return true;
            const value = input[key];
            if (undefined === value)
                return true;
        ...
        const $io2 = (input: any, _exceptionable: boolean = true): boolean => "string" === typeof input.name && ("number" === typeof input.age && Number.isFinite(input.age)) && (2 === Object.keys(input).length || Object.keys(input).every((key: any) => {
