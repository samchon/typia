...
export const test_validateEquals_TupleRestArray = _test_validateEquals("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): typia.IValidation<[boolean, number, ...Array<string>[]]> => {
    const __is = (input: any, _exceptionable: boolean = true): input is [boolean, number, ...Array<string>[]] => {
