...
export const test_createAssertStringify_ObjectUnionExplicit = _test_assertStringify("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: any): string => { const assert = (input: any): ObjectUnionExplicit => {
...
}; return stringify(assert(input)); }, ObjectUnionExplicit.SPOILERS);
