...
func (typeFactoryNamespace) GetFunction(t *shimchecker.Type) *shimast.Node {
	...
	return typeFactory_get_function(t.Symbol())
}

func typeFactory_get_function(symbol *shimast.Symbol) *shimast.Node {
...
func typeFactory_get_type_arguments(checker *shimchecker.Checker, typ *shimchecker.Type) (output []*shimchecker.Type) {
