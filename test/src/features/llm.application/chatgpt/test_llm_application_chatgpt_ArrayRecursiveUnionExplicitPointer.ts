...
export const test_llm_application_chatgpt_ArrayRecursiveUnionExplicitPointer = (): void =>
  _test_llm_application({
    model: "chatgpt",
    name: "ArrayRecursiveUnionExplicitPointer",
    factory: ArrayRecursiveUnionExplicitPointer
  })(
    typia.llm.application<ArrayRecursiveUnionExplicitPointerApplication, "chatgpt">(),
  );
