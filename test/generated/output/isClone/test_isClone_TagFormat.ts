...
export const test_isClone_TagFormat = _test_isClone("TagFormat", TagFormat.generate, (input) => ((input: any): typia.Primitive<TagFormat> | null => { const is = (input: any): input is TagFormat => {
    ...
    return null; const output = clone(input); return output; })(input), TagFormat.SPOILERS);
