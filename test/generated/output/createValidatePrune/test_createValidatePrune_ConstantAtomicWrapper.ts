...
export const test_createValidatePrune_ConstantAtomicWrapper = _test_validatePrune("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input: any): typia.IValidation<ConstantAtomicWrapper> => { const validate = (input: any): typia.IValidation<ConstantAtomicWrapper> => {
    ...
    prune(input); return output; }, ConstantAtomicWrapper.SPOILERS);
