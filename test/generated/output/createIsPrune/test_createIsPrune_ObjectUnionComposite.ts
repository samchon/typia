...
export const test_createIsPrune_ObjectUnionComposite = _test_isPrune("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any): input is ObjectUnionComposite => { const is = (input: any): input is ObjectUnionComposite => {
    ...
    return false; prune(input); return true; }, ObjectUnionComposite.SPOILERS);
