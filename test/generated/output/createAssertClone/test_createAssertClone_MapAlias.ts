...
export const test_createAssertClone_MapAlias = _test_assertClone("MapAlias", MapAlias.generate, (input: any): typia.Primitive<MapAlias> => { const assert = (input: any): MapAlias => {
...
}; assert(input); const output = clone(input); return output; }, MapAlias.SPOILERS);
