...
export const test_createAssertClone_AtomicAlias = _test_assertClone("AtomicAlias", AtomicAlias.generate, (input: any): typia.Primitive<AtomicAlias> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* AtomicAlias */; return output as AtomicAlias; }, AtomicAlias.SPOILERS);
