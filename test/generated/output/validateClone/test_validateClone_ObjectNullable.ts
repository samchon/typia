...
export const test_validateClone_ObjectNullable = _test_validateClone("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectNullable>> => { const validate = (input: any): typia.IValidation<ObjectNullable> => {
    const errors = [] as any[];
