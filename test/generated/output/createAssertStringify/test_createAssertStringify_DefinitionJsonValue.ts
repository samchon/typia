...
export const test_createAssertStringify_DefinitionJsonValue = _test_assertStringify("DefinitionJsonValue", DefinitionJsonValue.generate, (input: any): string => { const assert = (input: any): DefinitionJsonValue => {
...
}; return stringify(assert(input)); }, DefinitionJsonValue.SPOILERS);
