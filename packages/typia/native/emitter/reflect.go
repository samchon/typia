...
// `typia.reflect.schema<T>()` and inspect the IR at runtime. The current emitter returns the schema exactly as the Go side sees it,
// serialised via encoding/json.
