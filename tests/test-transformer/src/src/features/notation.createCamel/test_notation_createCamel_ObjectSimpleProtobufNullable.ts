...
export const test_notation_createValidateCamel_ObjectSimpleProtobufNullable = (): void =>
    ...
    convert: typia.notations.createValidateCamel<ObjectSimpleProtobufNullable>(),
