        ...
        ((input: string): typia.Primitive<TagFormat> => {
            const assert: any = (input: any): TagFormat => {
                const __is: any = (input: any): input is TagFormat => {
                    ...
                    const $is_email: any = (typia.assertParse as any).is_email;
                    const $is_url: any = (typia.assertParse as any).is_url;
                    const $is_ipv4: any = (typia.assertParse as any).is_ipv4;
                    const $is_ipv6: any = (typia.assertParse as any).is_ipv6;
                    const $is_date: any = (typia.assertParse as any).is_date;
                    const $is_datetime: any = (typia.assertParse as any)
                        .is_datetime;
