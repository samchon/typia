...
export const test_validateClone_ToJsonAtomicUnion = _test_validateClone("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ToJsonAtomicUnion>> => { const validate = (input: any): typia.IValidation<ToJsonAtomicUnion> => {
    const errors = [] as any[];
