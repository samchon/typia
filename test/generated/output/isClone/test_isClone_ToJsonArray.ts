...
export const test_isClone_ToJsonArray = _test_isClone("ToJsonArray", ToJsonArray.generate, (input) => ((input: any): typia.Primitive<ToJsonArray> | null => { const is = (input: any): input is ToJsonArray => {
