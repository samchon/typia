...
export const test_validate_ArrayHierarchical = _test_validate("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: any): typia.IValidation<ArrayHierarchical> => {
    const errors = [] as any[];
