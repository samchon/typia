...
export const test_assert_FunctionalObjectUnion = _test_assert("FunctionalObjectUnion", FunctionalObjectUnion.generate, (input) => ((input: any): Array<FunctionalObjectUnion.Union> => {
    const $guard = (typia.assert as any).guard;
    const __is = (input: any): input is Array<FunctionalObjectUnion.Union> => {
