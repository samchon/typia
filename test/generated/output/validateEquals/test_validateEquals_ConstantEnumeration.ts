...
export const test_validateEquals_ConstantEnumeration = _test_validateEquals("ConstantEnumeration", ConstantEnumeration.generate, (input) => ((input: any): typia.IValidation<ConstantEnumeration> => {
    const errors = [] as any[];
