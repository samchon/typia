...
export const test_validateParse_ObjectHierarchical = _test_validateParse("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ObjectHierarchical>> => { const validate = (input: any): typia.IValidation<ObjectHierarchical> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ObjectHierarchical.SPOILERS);
