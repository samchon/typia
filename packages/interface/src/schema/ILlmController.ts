 ...
 * executor. Contains the controller {@link name}, function calling schemas
 * in {@link application}, and the class instance in {@link execute}.
 *
 * For HTTP protocol, use `IHttpLlmController`. For MCP, use `IMcpLlmController`.
 *
