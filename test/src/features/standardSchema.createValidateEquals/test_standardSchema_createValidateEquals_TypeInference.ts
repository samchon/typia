...
/**
 * Test that StandardSchema properly infers Input and Output types for createValidateEquals
 */
export const test_standardSchema_createValidateEquals_TypeInference =
  (): void => {
    interface Post {
      slug: string;
      title: string;
    ...
    const postSchema = typia.createValidateEquals<Post>();
