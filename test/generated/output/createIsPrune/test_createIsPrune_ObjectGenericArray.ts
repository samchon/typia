...
export const test_createIsPrune_ObjectGenericArray = _test_isPrune("ObjectGenericArray", ObjectGenericArray.generate, (input: any): input is ObjectGenericArray => { const is = (input: any): input is ObjectGenericArray => {
    ...
    return false; prune(input); return true; }, ObjectGenericArray.SPOILERS);
