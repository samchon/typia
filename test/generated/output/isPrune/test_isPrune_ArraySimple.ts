...
export const test_isPrune_ArraySimple = _test_isPrune("ArraySimple", ArraySimple.generate, (input) => ((input: any): input is ArraySimple => { const is = (input: any): input is ArraySimple => {
