...
export const test_isStringify_SetAlias = _test_isStringify("SetAlias", SetAlias.generate, (input) => ((input: SetAlias): string | null => { const is = (input: any): input is SetAlias => {
