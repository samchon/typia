...
export const test_createIs_ArrayRepeatedOptional = _test_is("ArrayRepeatedOptional", ArrayRepeatedOptional.generate, (input: any): input is ArrayRepeatedOptional => {
