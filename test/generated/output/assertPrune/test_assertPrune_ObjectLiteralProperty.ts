...
export const test_assertPrune_ObjectLiteralProperty = _test_assertPrune("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: any): ISomething => { const assert = (input: any) => {
