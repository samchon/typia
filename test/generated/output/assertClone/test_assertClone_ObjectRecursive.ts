...
export const test_assertClone_ObjectRecursive = _test_assertClone("ObjectRecursive", ObjectRecursive.generate, (input) => ((input: any): typia.Primitive<ObjectRecursive.IDepartment> => { const assert = (input: any): ObjectRecursive.IDepartment => {
    ...
    return input;
}; const clone = (input: ObjectRecursive.IDepartment): typia.Primitive<ObjectRecursive.IDepartment> => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectRecursive.SPOILERS);
