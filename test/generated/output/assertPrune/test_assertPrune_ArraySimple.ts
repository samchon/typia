...
export const test_assertPrune_ArraySimple = _test_assertPrune("ArraySimple", ArraySimple.generate, (input) => ((input: any): Array<ArraySimple.IPerson> => { const assert = (input: any): Array<ArraySimple.IPerson> => {
