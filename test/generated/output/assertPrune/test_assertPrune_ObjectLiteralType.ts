...
export const test_assertPrune_ObjectLiteralType = _test_assertPrune("ObjectLiteralType", ObjectLiteralType.generate, (input) => ((input: any): { id: string; name: string; age: number; } => { const assert = (input: any) => {
