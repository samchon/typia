...
export const test_createRandom_AtomicAlias = _test_random("AtomicAlias", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<AtomicAlias> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<AtomicAlias> => {
