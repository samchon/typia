...
export const test_createAssertStringify_TagAtomicUnion = _test_assertStringify("TagAtomicUnion", TagAtomicUnion.generate, (input: any): string => { const assert = (input: any): TagAtomicUnion => {
...
}; return stringify(assert(input)); }, TagAtomicUnion.SPOILERS);
