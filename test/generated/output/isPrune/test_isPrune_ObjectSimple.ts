...
export const test_isPrune_ObjectSimple = _test_isPrune("ObjectSimple", ObjectSimple.generate, (input) => ((input: any): input is ObjectSimple.IBox3D => { const is = (input: any): input is ObjectSimple.IBox3D => {
