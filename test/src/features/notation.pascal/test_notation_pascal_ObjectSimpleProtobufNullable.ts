...
export const test_notation_validatePascal_ObjectSimpleProtobufNullable = (): void =>
    ...
    convert: (input) => typia.notations.validatePascal<ObjectSimpleProtobufNullable>(input),
