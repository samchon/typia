...
export const test_validate_DynamicUndefined = _test_validate("DynamicUndefined", DynamicUndefined.generate, (input) => ((input: any): typia.IValidation<DynamicUndefined> => {
...
})(input), DynamicUndefined.SPOILERS);
