...
export const test_assertClone_TemplateAtomic = _test_assertClone("TemplateAtomic", TemplateAtomic.generate, (input) => ((input: any): typia.Primitive<TemplateAtomic> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* TemplateAtomic */; return output as TemplateAtomic; })(input), TemplateAtomic.SPOILERS);
