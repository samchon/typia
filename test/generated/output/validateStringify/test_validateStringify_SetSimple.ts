...
export const test_validateStringify_SetSimple = _test_validateStringify("SetSimple", SetSimple.generate, (input) => ((input: SetSimple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<SetSimple> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), SetSimple.SPOILERS);
