...
export const test_assertStringify_ToJsonDouble = _test_assertStringify("ToJsonDouble", ToJsonDouble.generate, (input) => ((input: any): string => { const assert = (input: any): ToJsonDouble.Parent => {
