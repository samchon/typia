...
export const test_createAssertParse_ObjectUnionDouble = _test_assertParse("ObjectUnionDouble", ObjectUnionDouble.generate, (input: string): typia.Primitive<ObjectUnionDouble> => { const assert = (input: any): ObjectUnionDouble => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, ObjectUnionDouble.SPOILERS);
