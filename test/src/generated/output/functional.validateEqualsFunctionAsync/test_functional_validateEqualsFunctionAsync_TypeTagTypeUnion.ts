...
export const test_functional_validateEqualsFunctionAsync_TypeTagTypeUnion =
  _test_functional_validateEqualsFunctionAsync("TypeTagTypeUnion")(
    TypeTagTypeUnion,
  )(
    (p: (input: TypeTagTypeUnion) => Promise<TypeTagTypeUnion>) =>
      async (
        input: TypeTagTypeUnion,
      ): Promise<import("typia").IValidation<TypeTagTypeUnion>> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<TypeTagTypeUnion> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
