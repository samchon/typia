...
export const test_validateEquals_ConstantAtomicUnion = _test_validateEquals("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input) => ((input: any): typia.IValidation<ConstantAtomicUnion> => {
    const errors = [] as any[];
