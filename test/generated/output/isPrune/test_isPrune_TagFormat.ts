...
export const test_isPrune_TagFormat = _test_isPrune("TagFormat", TagFormat.generate, (input) => ((input: any): input is TagFormat => { const is = (input: any): input is TagFormat => {
    ...
    const $is_date = (typia.isPrune as any).is_date;
    const $is_datetime = (typia.isPrune as any).is_datetime;
    ...
    return false; prune(input); return true; })(input), TagFormat.SPOILERS);
