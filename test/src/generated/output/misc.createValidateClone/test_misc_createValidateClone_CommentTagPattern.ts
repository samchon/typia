...
export const test_misc_createValidateClone_CommentTagPattern =
  _test_misc_validateClone("CommentTagPattern")<CommentTagPattern>(
    CommentTagPattern,
  )((input: any): typia.IValidation<typia.Resolved<CommentTagPattern>> => {
    const validate = (input: any): typia.IValidation<CommentTagPattern> => {
      const errors = [] as any[];
