...
export const test_createRandom_ObjectUnionDouble = _test_random("ObjectUnionDouble", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectUnionDouble> => {
    ...
    const $ro7 = (_recursive: boolean = false, _depth: number = 0): any => ({
        x: (generator?.customs ?? $generator.customs)?.string?.([]) ?? (generator?.string ?? $generator.string)()
    });
    ...
    const $ro9 = (_recursive: boolean = false, _depth: number = 0): any => ({
        y: (generator?.customs ?? $generator.customs)?.string?.([]) ?? (generator?.string ?? $generator.string)()
    });
    ...
    const $ro11 = (_recursive: boolean = false, _depth: number = 0): any => ({
        y: (generator?.array ?? $generator.array)(() => (generator?.customs ?? $generator.customs)?.number?.([]) ?? (generator?.number ?? $generator.number)(0, 100))
    });
    ...
    const __is = (input: any): input is typia.Primitive<ObjectUnionDouble> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectUnionDouble> => {
