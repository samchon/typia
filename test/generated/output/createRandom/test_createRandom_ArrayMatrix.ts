...
export const test_createRandom_ArrayMatrix = _test_random("ArrayMatrix", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    const $generator = (typia.createRandom as any).generator;
    return (generator.array ?? $generator.array)(() => (generator.array ?? $generator.array)(() => (generator.array ?? $generator.array)(() => (generator.number ?? $generator.number)(0, 100))));
}, (input: any) => {
    ...
    return input as typia.Primitive<ArrayMatrix>;
});
