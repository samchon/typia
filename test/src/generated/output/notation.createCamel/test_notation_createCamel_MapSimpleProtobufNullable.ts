...
export const test_notation_createValidateCamel_MapSimpleProtobufNullable =
  ...
  >({
    convert: (
      input: any,
    ): typia.IValidation<typia.CamelCase<MapSimpleProtobufNullable>> => {
      const validate = (
        input: any,
    ...
    assert: (input: any): typia.CamelCase<MapSimpleProtobufNullable> => {
      const __is = (
        input: any,
      ): input is typia.CamelCase<MapSimpleProtobufNullable> => {
        const $io0 = (input: any): boolean =>
          (null === input.boolean ||
            (input.boolean instanceof Map &&
              (() =>
