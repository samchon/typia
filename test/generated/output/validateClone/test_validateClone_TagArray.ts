...
export const test_validateClone_TagArray = _test_validateClone("TagArray", TagArray.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<TagArray.Type>>> => { const validate = (input: any): typia.IValidation<Array<TagArray.Type>> => {
    ...
    output.data = clone(input); return output; })(input), TagArray.SPOILERS);
