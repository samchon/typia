...
export const test_createIsClone_ObjectSimple = _test_isClone("ObjectSimple", ObjectSimple.generate, (input: any): typia.Primitive<IBox3D> | null => { const is = (input: any): input is IBox3D => {
