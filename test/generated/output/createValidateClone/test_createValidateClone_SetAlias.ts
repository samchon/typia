...
export const test_createValidateClone_SetAlias = _test_validateClone(
    "SetAlias",
    SetAlias.generate,
    (input: any): typia.IValidation<typia.Primitive<SetAlias>> => {
        const validate: any = (input: any): typia.IValidation<SetAlias> => {
        ...
        const clone: any = (input: SetAlias): typia.Primitive<SetAlias> => {
            const $io1: any = (input: any): boolean =>
                "string" === typeof input.id &&
                "string" === typeof input.name &&
                "number" === typeof input.age;
