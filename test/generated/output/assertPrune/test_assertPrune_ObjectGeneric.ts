...
export const test_assertPrune_ObjectGeneric = _test_assertPrune("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => { const assert = (input: any): [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
    ...
    return input;
}; const prune = (input: [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]): void => {
...
}; assert(input); prune(input); return input; })(input), ObjectGeneric.SPOILERS);
