...
export const test_assertStringify_ClassPropertyAssignment = _test_assertStringify("ClassPropertyAssignment", ClassPropertyAssignment.generate, (input) => ((input: any): string => { const assert = (input: any): ClassPropertyAssignment => {
