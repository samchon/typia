...
export const test_createValidateStringify_DynamicUnion = _test_validateStringify("DynamicUnion", DynamicUnion.generate, (input: DynamicUnion): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<DynamicUnion> => {
    ...
    output.data = stringify(input); return output; }, DynamicUnion.SPOILERS);
