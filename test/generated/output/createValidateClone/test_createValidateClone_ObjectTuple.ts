...
export const test_createValidateClone_ObjectTuple = _test_validateClone("ObjectTuple", ObjectTuple.generate, (input: any): typia.IValidation<typia.Primitive<ObjectTuple>> => { const validate = (input: any): typia.IValidation<ObjectTuple> => {
    ...
    output.data = clone(input); return output; }, ObjectTuple.SPOILERS);
