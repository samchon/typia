...
export const test_createAssertPrune_ObjectGenericUnion = _test_assertPrune("ObjectGenericUnion", ObjectGenericUnion.generate, (input: any): ObjectGenericUnion => { const assert = (input: any): ObjectGenericUnion => {
    ...
    if ("object" === typeof input && null !== input)
        $pu0(input);
}; assert(input); prune(input); return input; }, ObjectGenericUnion.SPOILERS);
