...
export const test_createValidateStringify_SetUnion = _test_validateStringify("SetUnion", SetUnion.generate, (input: SetUnion): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<SetUnion> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, SetUnion.SPOILERS);
