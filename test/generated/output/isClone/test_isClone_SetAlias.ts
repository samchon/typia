...
export const test_isClone_SetAlias = _test_isClone("SetAlias", SetAlias.generate, (input) => ((input: any): typia.Primitive<SetSimple> | null => { const is = (input: any): input is SetSimple => {
    ...
    return null; const output = clone(input); return output; })(input), SetAlias.SPOILERS);
