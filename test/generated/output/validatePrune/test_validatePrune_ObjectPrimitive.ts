...
export const test_validatePrune_ObjectPrimitive = _test_validatePrune("ObjectPrimitive", ObjectPrimitive.generate, (input) => ((input: any): typia.IValidation<ObjectPrimitive.IArticle> => { const validate = (input: any): typia.IValidation<ObjectPrimitive.IArticle> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ObjectPrimitive.SPOILERS);
