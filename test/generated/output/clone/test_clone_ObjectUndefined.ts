...
export const test_clone_ObjectUndefined = _test_clone("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: Array<ObjectUndefined.ILecture>): typia.Primitive<Array<ObjectUndefined.ILecture>> => {
