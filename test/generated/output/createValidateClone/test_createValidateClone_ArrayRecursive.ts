...
export const test_createValidateClone_ArrayRecursive = _test_validateClone("ArrayRecursive", ArrayRecursive.generate, (input: any): typia.IValidation<typia.Primitive<ArrayRecursive>> => { const validate = (input: any): typia.IValidation<ArrayRecursive> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ArrayRecursive.SPOILERS);
