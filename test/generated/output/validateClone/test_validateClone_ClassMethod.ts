...
export const test_validateClone_ClassMethod = _test_validateClone("ClassMethod", ClassMethod.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ClassMethod.Animal>> => { const validate = (input: any): typia.IValidation<ClassMethod.Animal> => {
...
}; const clone = (input: ClassMethod.Animal): typia.Primitive<ClassMethod.Animal> => {
    ...
    output.data = clone(input); return output; })(input), ClassMethod.SPOILERS);
