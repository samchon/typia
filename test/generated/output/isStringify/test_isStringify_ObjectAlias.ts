...
export const test_isStringify_ObjectAlias = _test_isStringify("ObjectAlias", ObjectAlias.generate, (input) => ((input: ObjectAlias): string | null => { const is = (input: any): input is ObjectAlias => {
