...
export const test_createAssertClone_ObjectInternal = _test_assertClone("ObjectInternal", ObjectInternal.generate, (input: any): typia.Primitive<ObjectInternal> => { const assert = (input: any): ObjectInternal => {
...
}; assert(input); const output = clone(input); return output; }, ObjectInternal.SPOILERS);
