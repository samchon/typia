...
export const test_validateClone_ArrayRecursiveUnionExplicit = _test_validateClone("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ArrayRecursiveUnionExplicit>> => { const validate = (input: any): typia.IValidation<ArrayRecursiveUnionExplicit> => {
    const errors = [] as any[];
