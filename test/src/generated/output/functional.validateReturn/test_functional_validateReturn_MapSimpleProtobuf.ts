...
export const test_functional_validateReturn_MapSimpleProtobuf =
  _test_functional_validateReturn("MapSimpleProtobuf")(MapSimpleProtobuf)(
    (p: (input: MapSimpleProtobuf) => MapSimpleProtobuf) =>
      (
        input: MapSimpleProtobuf,
      ): import("typia").IValidation<MapSimpleProtobuf> => {
        const result = ((input: any): typia.IValidation<MapSimpleProtobuf> => {
          const errors = [] as any[];
