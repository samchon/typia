...
export const test_equals_ArrayRecursiveUnionExplicit = _test_equals("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any, _exceptionable: boolean): input is ArrayRecursiveUnionExplicit => {
