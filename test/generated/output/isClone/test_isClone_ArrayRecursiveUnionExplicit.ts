...
export const test_isClone_ArrayRecursiveUnionExplicit = _test_isClone("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): typia.Primitive<Array<ArrayRecursiveUnionExplicit.IBucket>> | null => { const is = (input: any): input is Array<ArrayRecursiveUnionExplicit.IBucket> => {
    ...
    return null; const output = clone(input); return output; })(input), ArrayRecursiveUnionExplicit.SPOILERS);
