...
export const test_isPrune_TemplateUnion = _test_isPrune("TemplateUnion", TemplateUnion.generate, (input) => ((input: any): input is TemplateUnion => { const is = (input: any): input is TemplateUnion => {
