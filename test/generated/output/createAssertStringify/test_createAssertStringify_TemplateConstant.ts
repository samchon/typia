...
export const test_createAssertStringify_TemplateConstant = _test_assertStringify("TemplateConstant", TemplateConstant.generate, (input: any): string => { const assert = (input: any): TemplateConstant => {
...
}; return stringify(assert(input)); }, TemplateConstant.SPOILERS);
