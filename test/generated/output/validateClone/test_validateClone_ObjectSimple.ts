...
export const test_validateClone_ObjectSimple = _test_validateClone("ObjectSimple", ObjectSimple.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectSimple.IBox3D>> => { const validate = (input: any): typia.IValidation<ObjectSimple.IBox3D> => {
