...
export const test_validate_TagAtomicUnion = _test_validate("TagAtomicUnion", TagAtomicUnion.generate, (input) => ((input: any): typia.IValidation<Array<TagAtomicUnion.Type>> => {
