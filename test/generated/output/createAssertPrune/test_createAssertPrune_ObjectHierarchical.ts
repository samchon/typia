...
export const test_createAssertPrune_ObjectHierarchical = _test_assertPrune("ObjectHierarchical", ObjectHierarchical.generate, (input: any): ICustomer => { const assert = (input: any) => {
