...
export const test_createValidateClone_ToJsonDouble = _test_validateClone("ToJsonDouble", ToJsonDouble.generate, (input: any): typia.IValidation<typia.Primitive<Parent>> => { const validate = (input: any): typia.IValidation<Parent> => {
    const errors = [] as any[];
