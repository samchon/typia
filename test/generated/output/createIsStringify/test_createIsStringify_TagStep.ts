...
export const test_createIsStringify_TagStep = _test_isStringify("TagStep", TagStep.generate, (input: TagStep): string | null => { const is = (input: any): input is TagStep => {
...
}; return is(input) ? stringify(input) : null; }, TagStep.SPOILERS);
