...
export const test_validateStringify_ConstantAtomicUnion = _test_validateStringify("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input) => ((input: Array<ConstantAtomicUnion.Union>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<ConstantAtomicUnion.Union>> => {
...
}; const stringify = (input: Array<ConstantAtomicUnion.Union>): string => {
    ...
    output.data = stringify(input); return output; })(input), ConstantAtomicUnion.SPOILERS);
