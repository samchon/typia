...
export const test_assertClone_ArrayAtomicSimple = _test_assertClone("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.Primitive<[Array<boolean>, Array<number>, Array<string>]> => { const assert = (input: any): [Array<boolean>, Array<number>, Array<string>] => {
...
}; assert(input); const output = clone(input); return output; })(input), ArrayAtomicSimple.SPOILERS);
