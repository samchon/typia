...
export const test_notation_createValidateSnake_ObjectSimpleProtobufNullable = (): void =>
    ...
    convert: typia.notations.createValidateSnake<ObjectSimpleProtobufNullable>(),
