...
export const test_validatePrune_ObjectSimple = _test_validatePrune("ObjectSimple", ObjectSimple.generate, (input) => ((input: any): typia.IValidation<ObjectSimple.IBox3D> => { const validate = (input: any): typia.IValidation<ObjectSimple.IBox3D> => {
    const errors = [] as any[];
