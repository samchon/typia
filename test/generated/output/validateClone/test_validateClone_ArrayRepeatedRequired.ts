...
export const test_validateClone_ArrayRepeatedRequired = _test_validateClone("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<string | number | Array<ArrayRepeatedRequired>>> => { const validate = (input: any): typia.IValidation<string | number | Array<ArrayRepeatedRequired>> => {
    const errors = [] as any[];
    const $report = (typia.validateClone as any).report(errors);
    const __is = (input: any): input is string | number | Array<ArrayRepeatedRequired> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is string | number | Array<ArrayRepeatedRequired> => {
            const $va0 = (input: any, _path: string, _exceptionable: boolean = true): any => input.map((elem: any, _index1: number) => (null !== elem || $report(_exceptionable, {
                path: _path + "[" + _index1 + "]",
                ...
                expected: "(Array<ArrayRepeatedRequired> | number | string)",
                value: elem
            })) && ("string" === typeof elem || "number" === typeof elem && Number.isFinite(elem) || (Array.isArray(elem) || $report(_exceptionable, {
                path: _path + "[" + _index1 + "]",
                expected: "(Array<ArrayRepeatedRequired> | number | string)",
                value: elem
    ...
    output.data = clone(input); return output; })(input), ArrayRepeatedRequired.SPOILERS);
