...
export const test_clone_ObjectGenericUnion = _test_clone("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: ISaleEntireArticle): typia.Primitive<ISaleEntireArticle> => {
