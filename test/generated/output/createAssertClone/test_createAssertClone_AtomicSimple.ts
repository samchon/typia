...
export const test_createAssertClone_AtomicSimple = _test_assertClone("AtomicSimple", AtomicSimple.generate, (input: any): typia.Primitive<AtomicSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* AtomicSimple */; return output as AtomicSimple; }, AtomicSimple.SPOILERS);
