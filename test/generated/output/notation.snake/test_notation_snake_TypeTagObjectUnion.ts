...
export const test_notation_validateSnake_TypeTagObjectUnion =
    _test_notation_validateGeneral("TypeTagObjectUnion")<TypeTagObjectUnion>(
        ...
        convert: (input) =>
            ((
                input: any,
            ): typia.IValidation<typia.SnakeCase<TypeTagObjectUnion>> => {
                const validate = (
                    input: any,
                ...
                const general = (
                    ...
                    const $io1 = (input: any): boolean =>
                        ...
                        3 <= input.value.length &&
                        input.value.length <= 7;
                    const $throws = (typia.notations.validateSnake as any)
                        .throws;
                    const $cp0 = (input: any) =>
                        input.map((elem: any) =>
        ...
        assert: (input: any): typia.SnakeCase<TypeTagObjectUnion> => {
            const __is = (
                input: any,
