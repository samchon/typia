...
export const test_createIsPrune_TagCustom = _test_isPrune("TagCustom", TagCustom.generate, (input: any): input is TagCustom => { const is = (input: any): input is TagCustom => {
    ...
    return false; prune(input); return true; }, TagCustom.SPOILERS);
