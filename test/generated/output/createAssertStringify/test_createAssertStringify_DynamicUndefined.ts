...
export const test_createAssertStringify_DynamicUndefined = _test_assertStringify("DynamicUndefined", DynamicUndefined.generate, (input: any): string => { const assert = (input: any): DynamicUndefined => {
    ...
    return $so0(input);
}; return stringify(assert(input)); }, DynamicUndefined.SPOILERS);
