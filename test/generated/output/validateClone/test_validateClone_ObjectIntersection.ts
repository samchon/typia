...
export const test_validateClone_ObjectIntersection = _test_validateClone("ObjectIntersection", ObjectIntersection.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectIntersection.IEmail & ObjectIntersection.IName>> => { const validate = (input: any): typia.IValidation<ObjectIntersection.IEmail & ObjectIntersection.IName> => {
    const errors = [] as any[];
