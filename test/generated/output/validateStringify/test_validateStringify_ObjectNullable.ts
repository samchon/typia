...
export const test_validateStringify_ObjectNullable = _test_validateStringify("ObjectNullable", ObjectNullable.generate, (input) => ((input: [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ObjectNullable.SPOILERS);
