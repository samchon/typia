...
export const test_validatePrune_TagLength = _test_validatePrune("TagLength", TagLength.generate, (input) => ((input: any): typia.IValidation<TagLength> => { const validate = (input: any): typia.IValidation<TagLength> => {
    const errors = [] as any[];
