...
export const test_equals_TemplateConstant = _test_equals("TemplateConstant", TemplateConstant.generate, (input) => ((input: any, _exceptionable: boolean): input is Type[] => {
