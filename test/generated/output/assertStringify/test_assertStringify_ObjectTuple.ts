...
export const test_assertStringify_ObjectTuple = _test_assertStringify("ObjectTuple", ObjectTuple.generate, (input) => ((input: ObjectTuple): string => { const assert = (input: any) => {
