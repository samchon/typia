...
export const test_createValidatePrune_ObjectTuple = _test_validatePrune("ObjectTuple", ObjectTuple.generate, (input: any): typia.IValidation<ObjectTuple> => { const validate = (input: any): typia.IValidation<ObjectTuple> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ObjectTuple.SPOILERS);
