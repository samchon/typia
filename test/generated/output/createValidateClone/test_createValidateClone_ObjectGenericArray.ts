...
export const test_createValidateClone_ObjectGenericArray = _test_validateClone("ObjectGenericArray", ObjectGenericArray.generate, (input: any): typia.IValidation<typia.Primitive<ObjectGenericArray>> => { const validate = (input: any): typia.IValidation<ObjectGenericArray> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ObjectGenericArray.SPOILERS);
