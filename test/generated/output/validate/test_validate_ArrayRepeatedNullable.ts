...
export const test_validate_ArrayRepeatedNullable = _test_validate("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input) => ((input: any): typia.IValidation<string | number | Array<ArrayRepeatedNullable> | null> => {
    const errors = [] as any[];
...
})(input), ArrayRepeatedNullable.SPOILERS);
