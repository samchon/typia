...
export const test_createAssertClone_TagArray = _test_assertClone("TagArray", TagArray.generate, (input: any): typia.Primitive<TagArray> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as TagArray; }, TagArray.SPOILERS);
