...
export const test_createIsClone_SetUnion = _test_isClone("SetUnion", SetUnion.generate, (input: any): typia.Primitive<SetUnion> | null => { const is = (input: any): input is SetUnion => {
    ...
    return null; const output = clone(input); return output; }, SetUnion.SPOILERS);
