...
export const test_createAssertParse_ArrayAtomicSimple = _test_assertParse("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: string): typia.Primitive<ArrayAtomicSimple> => { const assert = (input: any): ArrayAtomicSimple => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, ArrayAtomicSimple.SPOILERS);
