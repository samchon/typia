...
export const test_assertClone_TagCustom = _test_assertClone("TagCustom", TagCustom.generate, (input) => ((input: any): typia.Primitive<TagCustom> => { const assert = (input: any): TagCustom => {
...
}; assert(input); const output = clone(input); return output; })(input), TagCustom.SPOILERS);
