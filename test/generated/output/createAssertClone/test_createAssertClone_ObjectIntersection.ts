...
export const test_createAssertClone_ObjectIntersection = _test_assertClone("ObjectIntersection", ObjectIntersection.generate, (input: any): typia.Primitive<ObjectIntersection> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectIntersection */; return output as ObjectIntersection; }, ObjectIntersection.SPOILERS);
