...
export const test_llm_applicationEquals_3_1_ObjectUnionCompositePointer = (): void =>
  _test_llm_applicationEquals({
    model: "3.1",
    name: "ObjectUnionCompositePointer",
    factory: ObjectUnionCompositePointer
  })(
    typia.llm.application<ObjectUnionCompositePointerApplication, "3.1", { equals: true }>(),
  );
