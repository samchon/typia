...
export const test_validate_TupleUnion = _test_validate("TupleUnion", TupleUnion.generate, (input) => ((input: any): typia.IValidation<TupleUnion> => {
    const errors = [] as any[];
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is TupleUnion => {
        return (Array.isArray(input) || $report(true, {
            ...
            const tupleList = [[top => elem.length === 3 && [
                        ...
                        "number" === typeof top[0] || $report(true, {
