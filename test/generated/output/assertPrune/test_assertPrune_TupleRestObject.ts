...
export const test_assertPrune_TupleRestObject = _test_assertPrune("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): TupleRestObject => { const assert = (input: any) => {
