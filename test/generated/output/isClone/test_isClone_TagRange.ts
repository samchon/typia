...
export const test_isClone_TagRange = _test_isClone("TagRange", TagRange.generate, (input) => ((input: any): typia.Primitive<Array<TagRange.Type>> | null => { const is = (input: any): input is Array<TagRange.Type> => {
