...
export const test_createValidateStringify_ObjectUndefined = _test_validateStringify("ObjectUndefined", ObjectUndefined.generate, (input: ObjectUndefined): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectUndefined> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, ObjectUndefined.SPOILERS);
