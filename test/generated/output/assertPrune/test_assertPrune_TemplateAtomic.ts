...
export const test_assertPrune_TemplateAtomic = _test_assertPrune("TemplateAtomic", TemplateAtomic.generate, (input) => ((input: any): TemplateAtomic => { const assert = (input: any): TemplateAtomic => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), TemplateAtomic.SPOILERS);
