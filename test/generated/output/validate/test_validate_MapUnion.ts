...
export const test_validate_MapUnion = _test_validate("MapUnion", MapUnion.generate, (input) => ((input: any): typia.IValidation<MapUnion> => {
    const errors = [] as any[];
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is MapUnion => {
        ...
        return (Array.isArray(input) || $report(true, {
            ...
            if (0 === elem.size)
                return true;
            const tupleList = [[top => "boolean" === typeof top[0] && "number" === typeof top[1], top => top.map((elem: any, _index2: number) => (Array.isArray(elem) || $report(true, {
                        ...
                        expected: "[boolean, number]",
                        value: elem
                    })).every((flag: boolean) => flag)], [top => "number" === typeof top[0] && "number" === typeof top[1], top => top.map((elem: any, _index3: number) => (Array.isArray(elem) || $report(true, {
                        ...
                        expected: "[number, number]",
                        value: elem
                    })).every((flag: boolean) => flag)], [top => "string" === typeof top[0] && "number" === typeof top[1], top => top.map((elem: any, _index4: number) => (Array.isArray(elem) || $report(true, {
                        ...
                        expected: "[string, number]",
                        value: elem
                    })).every((flag: boolean) => flag)], [top => Array.isArray(top[0]) && top[0].map((elem: any, _index5: number) => "number" === typeof elem).every((flag: boolean) => flag) && "number" === typeof top[1], top => top.map((elem: any, _index6: number) => (Array.isArray(elem) || $report(true, {
                        ...
                        (Array.isArray(elem[0]) || $report(true, {
                            ...
                            value: elem[0]
                        })) && elem[0].map((elem: any, _index7: number) => "number" === typeof elem || $report(true, {
                        ...
                        expected: "[Array<number>, number]",
                        value: elem
                    })).every((flag: boolean) => flag)], [top => "object" === typeof top[0] && null !== top[0] && $vo0(top[0], _path + "[0]"[0], false) && "number" === typeof top[1], top => top.map((elem: any, _index8: number) => (Array.isArray(elem) || $report(true, {
