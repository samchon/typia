...
export const test_isClone_TupleRestObject = _test_isClone("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): typia.Primitive<TupleRestObject> | null => { const is = (input: any): input is TupleRestObject => {
