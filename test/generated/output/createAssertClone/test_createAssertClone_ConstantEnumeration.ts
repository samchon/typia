...
export const test_createAssertClone_ConstantEnumeration = _test_assertClone("ConstantEnumeration", ConstantEnumeration.generate, (input: any): typia.Primitive<ConstantEnumeration> => { const assert = (input: any): ConstantEnumeration => {
...
}; assert(input); const output = clone(input); return output; }, ConstantEnumeration.SPOILERS);
