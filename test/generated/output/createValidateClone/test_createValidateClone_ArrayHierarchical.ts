...
export const test_createValidateClone_ArrayHierarchical = _test_validateClone("ArrayHierarchical", ArrayHierarchical.generate, (input: any): typia.IValidation<typia.Primitive<ArrayHierarchical>> => { const validate = (input: any): typia.IValidation<ArrayHierarchical> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ArrayHierarchical.SPOILERS);
