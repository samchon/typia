...
The first time when an user of [`typia`](https://github.com/samchon/typia) had requested me to support `protobuf` functions, I could not understand the reason why. In the JavaScript world, there already had been many libaries supporting `protobuf` function like `protobufjs` or `ts-proto`.
