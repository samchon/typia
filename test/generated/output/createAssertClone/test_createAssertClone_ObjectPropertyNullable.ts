...
export const test_createAssertClone_ObjectPropertyNullable = _test_assertClone("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input: any): typia.Primitive<ObjectPropertyNullable> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectPropertyNullable */; return output as ObjectPropertyNullable; }, ObjectPropertyNullable.SPOILERS);
