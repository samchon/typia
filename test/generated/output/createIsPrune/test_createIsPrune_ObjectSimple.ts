...
export const test_createIsPrune_ObjectSimple = _test_isPrune("ObjectSimple", ObjectSimple.generate, (input: any): input is ObjectSimple => { const is = (input: any): input is ObjectSimple => {
    ...
    return false; prune(input); return true; }, ObjectSimple.SPOILERS);
