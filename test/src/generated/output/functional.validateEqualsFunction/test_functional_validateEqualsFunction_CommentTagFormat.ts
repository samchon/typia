...
export const test_functional_validateEqualsFunction_CommentTagFormat =
  _test_functional_validateEqualsFunction("CommentTagFormat")(CommentTagFormat)(
    (p: (input: CommentTagFormat) => CommentTagFormat) =>
      (
        input: CommentTagFormat,
      ): import("typia").IValidation<CommentTagFormat> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<CommentTagFormat> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
