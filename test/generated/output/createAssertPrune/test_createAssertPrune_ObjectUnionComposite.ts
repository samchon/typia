...
export const test_createAssertPrune_ObjectUnionComposite = _test_assertPrune("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any): ObjectUnionComposite => { const assert = (input: any): ObjectUnionComposite => {
    ...
    if (Array.isArray(input))
        $pp0(input);
}; assert(input); prune(input); return input; }, ObjectUnionComposite.SPOILERS);
