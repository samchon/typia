...
export const test_createValidateEquals_ObjectHierarchical = _test_validateEquals("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.IValidation<ICustomer> => {
    const errors = [] as any[];
