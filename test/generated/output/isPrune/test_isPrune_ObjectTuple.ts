...
export const test_isPrune_ObjectTuple = _test_isPrune("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): input is [ObjectTuple.ISection, ObjectTuple.ICitizen] => { const is = (input: any): input is [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
    ...
    return false; prune(input); return true; })(input), ObjectTuple.SPOILERS);
