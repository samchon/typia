...
export const test_notation_validateSnake_ConstantAtomicAbsorbed =
  ...
  >({
    convert: (input) =>
      ((
        input: any,
      ): typia.IValidation<typia.SnakeCase<ConstantAtomicAbsorbed>> => {
        const validate = (
          input: any,
    ...
    assert: (input: any): typia.SnakeCase<ConstantAtomicAbsorbed> => {
      const __is = (
        input: any,
      ): input is typia.SnakeCase<ConstantAtomicAbsorbed> => {
        return (
          "object" === typeof input &&
          null !== input &&
          "string" === typeof (input as any).id &&
