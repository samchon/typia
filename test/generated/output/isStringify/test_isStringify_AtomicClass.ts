...
export const test_isStringify_AtomicClass = _test_isStringify("AtomicClass", AtomicClass.generate, (input) => ((input: AtomicClass): string | null => { const is = (input: any): input is AtomicClass => {
