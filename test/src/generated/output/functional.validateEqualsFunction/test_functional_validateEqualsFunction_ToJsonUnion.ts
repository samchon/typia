...
export const test_functional_validateEqualsFunction_ToJsonUnion =
  _test_functional_validateEqualsFunction("ToJsonUnion")(ToJsonUnion)(
    (p: (input: ToJsonUnion) => ToJsonUnion) =>
      (input: ToJsonUnion): import("typia").IValidation<ToJsonUnion> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<ToJsonUnion> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
