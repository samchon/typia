...
export const test_assertClone_ArrayRecursiveUnionImplicit = _test_assertClone("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): typia.Primitive<Array<ArrayRecursiveUnionImplicit.IBucket>> => { const assert = (input: any): Array<ArrayRecursiveUnionImplicit.IBucket> => {
...
}; assert(input); const output = clone(input); return output; })(input), ArrayRecursiveUnionImplicit.SPOILERS);
