...
export const test_equals_FunctionalObjectUnion = _test_equals("FunctionalObjectUnion", FunctionalObjectUnion.generate, (input) => ((input: any, _exceptionable: boolean): input is FunctionalObjectUnion => {
