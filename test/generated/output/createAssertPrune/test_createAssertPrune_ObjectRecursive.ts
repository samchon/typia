...
export const test_createAssertPrune_ObjectRecursive = _test_assertPrune("ObjectRecursive", ObjectRecursive.generate, (input: any): IDepartment => { const assert = (input: any) => {
