...
export const test_isClone_NativeSimple = _test_isClone("NativeSimple", NativeSimple.generate, (input) => ((input: any): typia.Primitive<NativeSimple> | null => { const is = (input: any): input is NativeSimple => {
    ...
    return null; const output = clone(input); return output; })(input), NativeSimple.SPOILERS);
