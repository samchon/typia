...
export const test_createValidateEquals_ObjectUndefined = _test_validateEquals("ObjectUndefined", ObjectUndefined.generate, (input: any): typia.IValidation<ObjectUndefined> => {
    const errors = [] as any[];
