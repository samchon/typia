...
export const test_createIsParse_ObjectGenericUnion = _test_isParse("ObjectGenericUnion", ObjectGenericUnion.generate, (input: any): typia.Primitive<ObjectGenericUnion> => { const is = (input: any): input is ObjectGenericUnion => {
