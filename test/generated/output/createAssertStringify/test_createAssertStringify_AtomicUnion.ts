...
export const test_createAssertStringify_AtomicUnion = _test_assertStringify("AtomicUnion", AtomicUnion.generate, (input: any): string => { const assert = (input: any): AtomicUnion => {
