...
export const test_isParse_ArrayRecursiveUnionImplicit = _test_isParse("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): typia.Primitive<ArrayRecursiveUnionImplicit> => { const is = (input: any): input is ArrayRecursiveUnionImplicit => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; })(input), ArrayRecursiveUnionImplicit.SPOILERS);
