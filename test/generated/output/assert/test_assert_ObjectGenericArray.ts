...
export const test_assert_ObjectGenericArray = _test_assert("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): ObjectGenericArray.IPage<ObjectGenericArray.IPerson> => {
