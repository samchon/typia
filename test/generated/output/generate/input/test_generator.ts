 ...
 */
export const generate_validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
...
export const generate_assert_equals = (input: any) => {
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is ObjectUnionExplicit => {
        ...
        const $ao4 = (input: any, _path: string, _exceptionable: boolean) => ("object" === typeof input.p1 && null !== input.p1 || $guard(_exceptionable, {
            ...
            if (["p1", "p2", "p3", "p4", "type"].some(prop => key === prop))
                return true;
            const value = input[key];
            if (undefined === value)
                return true;
        ...
        const $ao7 = (input: any, _path: string, _exceptionable: boolean) => (Array.isArray(input.points) || $guard(_exceptionable, {
            ...
            expected: "Resolve<ObjectUnionExplicit.IPoint>",
            value: elem
        })) && $ao2(elem, _path + ".points[" + _index4 + "]", true && _exceptionable)) && (1 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
 ...
 */
export const generate_equals = (input: any, _exceptionable: boolean): input is ObjectUnionExplicit => {
    const $io0 = (input: any, _exceptionable: boolean) => "number" === typeof input.x && "number" === typeof input.y && "point" === input.type && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["x", "y", "type"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
    ...
    const $io1 = (input: any, _exceptionable: boolean) => "object" === typeof input.p1 && null !== input.p1 && $io2(input.p1, true && _exceptionable) && ("object" === typeof input.p2 && null !== input.p2 && $io2(input.p2, true && _exceptionable)) && "line" === input.type && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["p1", "p2", "type"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
    ...
    const $io2 = (input: any, _exceptionable: boolean) => "number" === typeof input.x && "number" === typeof input.y && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["x", "y"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
    ...
    const $io3 = (input: any, _exceptionable: boolean) => "object" === typeof input.p1 && null !== input.p1 && $io2(input.p1, true && _exceptionable) && ("object" === typeof input.p2 && null !== input.p2 && $io2(input.p2, true && _exceptionable)) && ("object" === typeof input.p3 && null !== input.p3 && $io2(input.p3, true && _exceptionable)) && "triangle" === input.type && (4 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["p1", "p2", "p3", "type"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
    ...
    const $io4 = (input: any, _exceptionable: boolean) => "object" === typeof input.p1 && null !== input.p1 && $io2(input.p1, true && _exceptionable) && ("object" === typeof input.p2 && null !== input.p2 && $io2(input.p2, true && _exceptionable)) && ("object" === typeof input.p3 && null !== input.p3 && $io2(input.p3, true && _exceptionable)) && ("object" === typeof input.p4 && null !== input.p4 && $io2(input.p4, true && _exceptionable)) && "rectangle" === input.type && (5 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["p1", "p2", "p3", "p4", "type"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
    ...
    const $io5 = (input: any, _exceptionable: boolean) => Array.isArray(input.points) && input.points.every((elem: any, _index2: number) => "object" === typeof elem && null !== elem && $io2(elem, true && _exceptionable)) && "polyline" === input.type && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["points", "type"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
    ...
    const $io6 = (input: any, _exceptionable: boolean) => "object" === typeof input.outer && null !== input.outer && $io7(input.outer, true && _exceptionable) && (Array.isArray(input.inner) && input.inner.every((elem: any, _index3: number) => "object" === typeof elem && null !== elem && $io7(elem, true && _exceptionable))) && "polygon" === input.type && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["outer", "inner", "type"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
    ...
    const $io7 = (input: any, _exceptionable: boolean) => Array.isArray(input.points) && input.points.every((elem: any, _index4: number) => "object" === typeof elem && null !== elem && $io2(elem, true && _exceptionable)) && (1 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["points"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
    ...
    const $io8 = (input: any, _exceptionable: boolean) => "object" === typeof input.centroid && null !== input.centroid && $io2(input.centroid, true && _exceptionable) && "number" === typeof input.radius && "circle" === input.type && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        if (["centroid", "radius", "type"].some(prop => key === prop))
            return true;
        const value = input[key];
        if (undefined === value)
 ...
 */
export const generate_validate_equals = (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
 ...
 */
export const generate_assert_parse = (input: string): typia.Primitive<ObjectUnionExplicit> => { const assert = (input: any) => {
    ...
    return input as ObjectUnionExplicit;
}; input = JSON.parse(input); return assert(input); };
/**
 * Transformed {@link createIsParse} function
 */
export const generate_is_parse = (input: any): typia.Primitive<ObjectUnionExplicit> => { const is = (input: any): input is ObjectUnionExplicit => {
    const $io0 = (input: any) => "number" === typeof input.x && "number" === typeof input.y && "point" === input.type;
    const $io1 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && "number" === typeof input.p1.y) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && "number" === typeof input.p2.y)) && "line" === input.type;
    const $io2 = (input: any) => "number" === typeof input.x && "number" === typeof input.y;
    const $io3 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && "number" === typeof input.p1.y) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && "number" === typeof input.p2.y)) && ("object" === typeof input.p3 && null !== input.p3 && ("number" === typeof input.p3.x && "number" === typeof input.p3.y)) && "triangle" === input.type;
 ...
 */
export const generate_validate_parse = (input: string): typia.IValidation<typia.Primitive<ObjectUnionExplicit>> => { const validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
...
}; input = JSON.parse(input); const output = validate(input); return output; };
/**
 ...
 */
export const generate_assert_stringify = (input: ObjectUnionExplicit): string => { const assert = (input: any) => {
 ...
 */
export const generate_is_stringify = (input: ObjectUnionExplicit): string | null => { const is = (input: any): input is ObjectUnionExplicit => {
    const $io0 = (input: any) => "number" === typeof input.x && !Number.isNaN(input.x) && ("number" === typeof input.y && !Number.isNaN(input.y)) && "point" === input.type;
    const $io1 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && !Number.isNaN(input.p1.x) && ("number" === typeof input.p1.y && !Number.isNaN(input.p1.y))) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && !Number.isNaN(input.p2.x) && ("number" === typeof input.p2.y && !Number.isNaN(input.p2.y)))) && "line" === input.type;
    const $io2 = (input: any) => "number" === typeof input.x && !Number.isNaN(input.x) && ("number" === typeof input.y && !Number.isNaN(input.y));
    const $io3 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && !Number.isNaN(input.p1.x) && ("number" === typeof input.p1.y && !Number.isNaN(input.p1.y))) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && !Number.isNaN(input.p2.x) && ("number" === typeof input.p2.y && !Number.isNaN(input.p2.y)))) && ("object" === typeof input.p3 && null !== input.p3 && ("number" === typeof input.p3.x && !Number.isNaN(input.p3.x) && ("number" === typeof input.p3.y && !Number.isNaN(input.p3.y)))) && "triangle" === input.type;
    const $io4 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && !Number.isNaN(input.p1.x) && ("number" === typeof input.p1.y && !Number.isNaN(input.p1.y))) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && !Number.isNaN(input.p2.x) && ("number" === typeof input.p2.y && !Number.isNaN(input.p2.y)))) && ("object" === typeof input.p3 && null !== input.p3 && ("number" === typeof input.p3.x && !Number.isNaN(input.p3.x) && ("number" === typeof input.p3.y && !Number.isNaN(input.p3.y)))) && ("object" === typeof input.p4 && null !== input.p4 && ("number" === typeof input.p4.x && !Number.isNaN(input.p4.x) && ("number" === typeof input.p4.y && !Number.isNaN(input.p4.y)))) && "rectangle" === input.type;
    const $io5 = (input: any) => Array.isArray(input.points) && input.points.every((elem: any) => "object" === typeof elem && null !== elem && $io2(elem)) && "polyline" === input.type;
    const $io6 = (input: any) => "object" === typeof input.outer && null !== input.outer && $io7(input.outer) && (Array.isArray(input.inner) && input.inner.every((elem: any) => "object" === typeof elem && null !== elem && $io7(elem))) && "polygon" === input.type;
    const $io7 = (input: any) => Array.isArray(input.points) && input.points.every((elem: any) => "object" === typeof elem && null !== elem && $io2(elem));
    const $io8 = (input: any) => "object" === typeof input.centroid && null !== input.centroid && ("number" === typeof input.centroid.x && !Number.isNaN(input.centroid.x) && ("number" === typeof input.centroid.y && !Number.isNaN(input.centroid.y))) && ("number" === typeof input.radius && !Number.isNaN(input.radius)) && "circle" === input.type;
    const $iu0 = (input: any) => (() => {
        if ("point" === input.type)
            return $io0(input);
        if ("line" === input.type)
 ...
 */
export const generate_validate_stringify = (input: ObjectUnionExplicit): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
 ...
 */
export const generate_random = (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    ...
    const $ro5 = (recursive = false, depth = 0) => ({
        points: (generator.array ?? $generator.array)(() => $ro2(recursive, recursive ? 1 + depth : depth)),
        type: "polyline"
    });
    const $ro6 = (recursive = false, depth = 0) => ({
        outer: $ro7(recursive, recursive ? 1 + depth : depth),
        inner: (generator.array ?? $generator.array)(() => $ro7(recursive, recursive ? 1 + depth : depth)),
        type: "polygon"
    });
 ...
 */
export const generate_clone = (input: ObjectUnionExplicit): typia.Primitive<ObjectUnionExplicit> => {
 ...
 */
export const generate_assert_clone = (input: any): typia.Primitive<ObjectUnionExplicit> => { const assert = (input: any) => {
    ...
    return Array.isArray(input) ? input.map((elem: any) => "object" === typeof elem && null !== elem ? $cu0(elem) : elem) : input;
}; assert(input); const output = clone(input); /* Array */; return output as ObjectUnionExplicit; };
/**
 * Transformed {@link createIsClone} function
 */
export const generate_is_clone = (input: any): typia.Primitive<ObjectUnionExplicit> | null => { const is = (input: any): input is ObjectUnionExplicit => {
    const $io0 = (input: any) => "number" === typeof input.x && "number" === typeof input.y && "point" === input.type;
    const $io1 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && "number" === typeof input.p1.y) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && "number" === typeof input.p2.y)) && "line" === input.type;
    const $io2 = (input: any) => "number" === typeof input.x && "number" === typeof input.y;
    const $io3 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && "number" === typeof input.p1.y) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && "number" === typeof input.p2.y)) && ("object" === typeof input.p3 && null !== input.p3 && ("number" === typeof input.p3.x && "number" === typeof input.p3.y)) && "triangle" === input.type;
 ...
 */
export const generate_validate_clone = (input: any): typia.IValidation<typia.Primitive<ObjectUnionExplicit>> => { const validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
 ...
 */
export const generate_assert_prune = (input: any): ObjectUnionExplicit => { const assert = (input: any) => {
...
}; assert(input); prune(input); return input; };
/**
 * Transformed {@link createIsPrune} function
 */
export const generate_is_prune = (input: any): input is ObjectUnionExplicit => { const is = (input: any): input is ObjectUnionExplicit => {
    const $io0 = (input: any) => "number" === typeof input.x && "number" === typeof input.y && "point" === input.type;
    const $io1 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && "number" === typeof input.p1.y) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && "number" === typeof input.p2.y)) && "line" === input.type;
    const $io2 = (input: any) => "number" === typeof input.x && "number" === typeof input.y;
    const $io3 = (input: any) => "object" === typeof input.p1 && null !== input.p1 && ("number" === typeof input.p1.x && "number" === typeof input.p1.y) && ("object" === typeof input.p2 && null !== input.p2 && ("number" === typeof input.p2.x && "number" === typeof input.p2.y)) && ("object" === typeof input.p3 && null !== input.p3 && ("number" === typeof input.p3.x && "number" === typeof input.p3.y)) && "triangle" === input.type;
    ...
    return false; prune(input); return true; };
/**
 * Transformed {@link createValidatePrune} function
 */
export const generate_validate_prune = (input: any): typia.IValidation<ObjectUnionExplicit> => { const validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
