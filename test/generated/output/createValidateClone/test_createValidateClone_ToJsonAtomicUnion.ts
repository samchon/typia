...
export const test_createValidateClone_ToJsonAtomicUnion = _test_validateClone("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input: any): typia.IValidation<typia.Primitive<ToJsonAtomicUnion>> => { const validate = (input: any): typia.IValidation<ToJsonAtomicUnion> => {
    const errors = [] as any[];
