...
export const test_functional_isReturn_CommentTagPattern =
  _test_functional_isReturn("CommentTagPattern")(CommentTagPattern)(
    (p: (input: CommentTagPattern) => CommentTagPattern) =>
      (input: CommentTagPattern): CommentTagPattern | null => {
        const result = p(input);
        return ((input: any): input is CommentTagPattern => {
          return (
            "object" === typeof input &&
            null !== input &&
