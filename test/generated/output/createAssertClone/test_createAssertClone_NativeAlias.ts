...
export const test_createAssertClone_NativeAlias = _test_assertClone("NativeAlias", NativeAlias.generate, (input: any): typia.Primitive<NativeAlias> => { const assert = (input: any): NativeAlias => {
...
}; assert(input); const output = clone(input); return output; }, NativeAlias.SPOILERS);
