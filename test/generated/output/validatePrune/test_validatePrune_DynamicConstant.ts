...
export const test_validatePrune_DynamicConstant = _test_validatePrune("DynamicConstant", DynamicConstant.generate, (input) => ((input: any): typia.IValidation<{    a: number;    b: number;    c: number;    d: number;}> => { const validate = (input: any): typia.IValidation<{    a: number;    b: number;    c: number;    d: number;}> => {
