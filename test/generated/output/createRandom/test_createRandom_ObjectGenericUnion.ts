...
export const test_createRandom_ObjectGenericUnion = _test_random("ObjectGenericUnion", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectGenericUnion> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectGenericUnion> => {
            ...
            const $au0 = (input: any, _path: string, _exceptionable: boolean = true): any => $ao4(input, _path, false && _exceptionable) || $ao0(input, _path, false && _exceptionable) || $guard(_exceptionable, {
                path: _path,
