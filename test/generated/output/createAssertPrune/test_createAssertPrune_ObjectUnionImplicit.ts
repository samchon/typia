...
export const test_createAssertPrune_ObjectUnionImplicit = _test_assertPrune("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: any): ObjectUnionImplicit => { const assert = (input: any): ObjectUnionImplicit => {
...
}; assert(input); prune(input); return input; }, ObjectUnionImplicit.SPOILERS);
