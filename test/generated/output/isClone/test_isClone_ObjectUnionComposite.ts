...
export const test_isClone_ObjectUnionComposite = _test_isClone("ObjectUnionComposite", ObjectUnionComposite.generate, (input) => ((input: any): typia.Primitive<ObjectUnionComposite> | null => { const is = (input: any): input is ObjectUnionComposite => {
