...
export const test_is_ObjectNullable = _test_is("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): input is [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct] => {
