...
export const test_createValidateStringify_TagType = _test_validateStringify("TagType", TagType.generate, (input: TagType): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TagType> => {
    ...
    output.data = stringify(input); return output; }, TagType.SPOILERS);
