...
export const test_notation_createValidateCamel_ObjectSimpleProtobufOptional =
  ...
  >({
    convert: (
      input: any,
    ): typia.IValidation<typia.CamelCase<ObjectSimpleProtobufOptional>> => {
      const validate = (
        input: any,
    ...
    assert: (input: any): typia.CamelCase<ObjectSimpleProtobufOptional> => {
      const __is = (
        input: any,
      ): input is typia.CamelCase<ObjectSimpleProtobufOptional> => {
        const $io0 = (input: any): boolean =>
          (undefined === input.bool || "boolean" === typeof input.bool) &&
          (undefined === input.int32 ||
            ("number" === typeof input.int32 &&
