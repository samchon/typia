...
export const test_isStringify_ObjectUnionDouble = _test_isStringify("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: Array<ObjectUnionDouble.Union>): string | null => { const is = (input: any): input is Array<ObjectUnionDouble.Union> => {
