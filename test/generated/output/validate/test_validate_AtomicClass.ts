...
export const test_validate_AtomicClass = _test_validate("AtomicClass", AtomicClass.generate, (input) => ((input: any): typia.IValidation<[Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String]> => {
