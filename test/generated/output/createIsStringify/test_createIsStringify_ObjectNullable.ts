...
export const test_createIsStringify_ObjectNullable = _test_isStringify("ObjectNullable", ObjectNullable.generate, (input: ObjectNullable): string | null => { const is = (input: any): input is ObjectNullable => {
...
}; return is(input) ? stringify(input) : null; }, ObjectNullable.SPOILERS);
