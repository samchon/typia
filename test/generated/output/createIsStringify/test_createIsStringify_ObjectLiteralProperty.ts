...
export const test_createIsStringify_ObjectLiteralProperty = _test_isStringify("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: ObjectLiteralProperty): string | null => { const is = (input: any): input is ObjectLiteralProperty => {
