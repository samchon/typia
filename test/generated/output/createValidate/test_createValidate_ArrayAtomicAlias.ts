...
export const test_createValidate_ArrayAtomicAlias = _test_validate("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input: any): typia.IValidation<ArrayAtomicAlias> => {
    const errors = [] as any[];
