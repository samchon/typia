...
export const test_createAssertPrune_ObjectUnionNonPredictable = _test_assertPrune("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input: any): ObjectUnionNonPredictable => { const assert = (input: any) => {
