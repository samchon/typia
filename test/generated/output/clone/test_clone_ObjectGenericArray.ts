...
export const test_clone_ObjectGenericArray = _test_clone("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: ObjectGenericArray.IPage<ObjectGenericArray.IPerson>): typia.Primitive<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>> => {
