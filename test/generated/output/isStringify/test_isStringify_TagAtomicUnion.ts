...
export const test_isStringify_TagAtomicUnion = _test_isStringify("TagAtomicUnion", TagAtomicUnion.generate, (input) => ((input: Array<TagAtomicUnion.Type>): string | null => { const is = (input: any): input is Array<TagAtomicUnion.Type> => {
