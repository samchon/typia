...
export const test_validateStringify_ArrayRepeatedRequired = _test_validateStringify("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input) => ((input: string | number | Array<ArrayRepeatedRequired>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<string | number | Array<ArrayRepeatedRequired>> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ArrayRepeatedRequired.SPOILERS);
