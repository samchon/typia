...
export const test_assert_ArrayRepeatedRequired = _test_assert("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input) => ((input: any): string | number | Array<ArrayRepeatedRequired> => {
