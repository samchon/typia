...
export const test_createRandom_ConstantEnumeration = _test_random("ConstantEnumeration", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
