...
export const test_createAssertStringify_ObjectInternal = _test_assertStringify("ObjectInternal", ObjectInternal.generate, (input: any): string => { const assert = (input: any): ObjectInternal => {
