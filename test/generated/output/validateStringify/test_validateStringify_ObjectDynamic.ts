...
export const test_validateStringify_ObjectDynamic = _test_validateStringify("ObjectDynamic", ObjectDynamic.generate, (input) => ((input: ObjectDynamic): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectDynamic> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ObjectDynamic.SPOILERS);
