...
export const test_createRandom_ObjectIntersection = _test_random("ObjectIntersection", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectIntersection> => {
    ...
    const __is = (input: any): input is typia.Primitive<ObjectIntersection> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectIntersection> => {
