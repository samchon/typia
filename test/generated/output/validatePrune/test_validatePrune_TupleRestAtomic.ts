...
export const test_validatePrune_TupleRestAtomic = _test_validatePrune("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: any): typia.IValidation<[boolean, number, ...string[]]> => { const validate = (input: any): typia.IValidation<[boolean, number, ...string[]]> => {
    ...
    prune(input); return output; })(input), TupleRestAtomic.SPOILERS);
