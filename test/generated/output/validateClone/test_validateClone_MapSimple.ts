...
export const test_validateClone_MapSimple = _test_validateClone("MapSimple", MapSimple.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<MapSimple>> => { const validate = (input: any): typia.IValidation<MapSimple> => {
    const errors = [] as any[];
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is MapSimple => {
            const $vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [(input.boolean instanceof Map || $report(_exceptionable, {
                    path: _path + ".boolean",
                    ...
                    "number" === typeof elem[1] && Number.isFinite(elem[1]) || $report(_exceptionable, {
                    ...
                    "number" === typeof elem[0] && Number.isFinite(elem[0]) || $report(_exceptionable, {
                    ...
                    (Array.isArray(elem[0]) || $report(_exceptionable, {
                        ...
                        value: elem[0]
                    })) && elem[0].map((elem: any, _index5: number) => "number" === typeof elem && Number.isFinite(elem) || $report(_exceptionable, {
    ...
    output.data = clone(input); return output; })(input), MapSimple.SPOILERS);
