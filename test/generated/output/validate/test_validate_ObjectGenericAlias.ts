...
export const test_validate_ObjectGenericAlias = _test_validate("ObjectGenericAlias", ObjectGenericAlias.generate, (input) => ((input: any): typia.IValidation<ObjectGenericAlias.ISomething<string>> => {
