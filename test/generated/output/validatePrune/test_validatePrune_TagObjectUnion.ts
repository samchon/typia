...
export const test_validatePrune_TagObjectUnion = _test_validatePrune("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): typia.IValidation<Array<TagObjectUnion.Type>> => { const validate = (input: any): typia.IValidation<Array<TagObjectUnion.Type>> => {
    ...
    prune(input); return output; })(input), TagObjectUnion.SPOILERS);
