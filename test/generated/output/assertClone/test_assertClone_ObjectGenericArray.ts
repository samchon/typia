...
export const test_assertClone_ObjectGenericArray = _test_assertClone("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): typia.Primitive<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>> => { const assert = (input: any): ObjectGenericArray.IPage<ObjectGenericArray.IPerson> => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectGenericArray.SPOILERS);
