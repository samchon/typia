...
export const test_createAssertPrune_TupleRestArray = _test_assertPrune("TupleRestArray", TupleRestArray.generate, (input: any): TupleRestArray => { const assert = (input: any) => {
