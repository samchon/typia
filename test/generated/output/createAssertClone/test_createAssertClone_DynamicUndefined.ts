...
export const test_createAssertClone_DynamicUndefined = _test_assertClone("DynamicUndefined", DynamicUndefined.generate, (input: any): typia.Primitive<DynamicUndefined> => { const assert = (input: any): DynamicUndefined => {
...
}; assert(input); const output = clone(input); return output; }, DynamicUndefined.SPOILERS);
