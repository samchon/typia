...
export const test_assert_TupleOptional = _test_assert("TupleOptional", TupleOptional.generate, (input) => ((input: any): Array<[number, boolean, string, (number | null | undefined)?, (string | null | undefined)?]> => {
