...
export const test_functional_validateEqualsFunction_TupleUnion =
  _test_functional_validateEqualsFunction("TupleUnion")(TupleUnion)(
    (p: (input: TupleUnion) => TupleUnion) =>
      (input: TupleUnion): import("typia").IValidation<TupleUnion> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<TupleUnion> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
