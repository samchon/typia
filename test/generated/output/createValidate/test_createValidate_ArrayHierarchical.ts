...
export const test_createValidate_ArrayHierarchical = _test_validate("ArrayHierarchical", ArrayHierarchical.generate, (input: any): typia.IValidation<ArrayHierarchical> => {
    const errors = [] as any[];
