...
export const test_notation_createValidateSnake_MapSimpleProtobufOptional =
  ...
  >({
    convert: (
      input: any,
    ): typia.IValidation<typia.SnakeCase<MapSimpleProtobufOptional>> => {
      const validate = (
        input: any,
    ...
    assert: (input: any): typia.SnakeCase<MapSimpleProtobufOptional> => {
      const __is = (
        input: any,
