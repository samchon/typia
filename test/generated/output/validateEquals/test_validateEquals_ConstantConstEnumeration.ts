...
export const test_validateEquals_ConstantConstEnumeration = _test_validateEquals("ConstantConstEnumeration", ConstantConstEnumeration.generate, (input) => ((input: any): typia.IValidation<Array<ConstantConstEnumeration.Enumeration>> => {
