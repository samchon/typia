...
export const test_random_ConstantAtomicWrapper = _test_random("ConstantAtomicWrapper", () => ((generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ConstantAtomicWrapper> => {
