...
export const test_createIs_UltimateUnion = _test_is(
  ...
  const $io3 = (input: any): boolean =>
    ("string" === typeof input["const"] ||
      ("number" === typeof input["const"] && Number.isFinite(input["const"])) ||
  ...
  const $io16 = (input: any): boolean =>
    ...
    (undefined === input.description || "string" === typeof input.description);
  ...
  const $io21 = (input: any): boolean =>
    ...
    (undefined === input.refreshUrl || "string" === typeof input.refreshUrl) &&
