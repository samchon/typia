...
export const test_functional_validateParametersAsync_ObjectHttpArray =
  _test_functional_validateParametersAsync("ObjectHttpArray")(ObjectHttpArray)(
    (p: (input: ObjectHttpArray) => Promise<ObjectHttpArray>) =>
      async (
        input: ObjectHttpArray,
      ): Promise<import("typia").IValidation<ObjectHttpArray>> => {
        const paramResults = [
