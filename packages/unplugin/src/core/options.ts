...
export type Options = {
  /**
   * The patterns of files to include. This options is not merged but
   * overridden.
   *
   * @default [/\.[cm]?[jt]sx?$/]
   */
  ...
  /**
   * The patterns of files to exclude. This options is not merged but
   * overridden.
   *
  ...
  /**
   * The path to the tsconfig file. If not specified, the plugin will try to
   ...
   * node_modules/.cache/unplugin_typia. if `false`, it will disable cache.
   *
   * @default false
   */
  cache?: true | false;
