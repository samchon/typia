...
export const test_createValidatePrune_ObjectPropertyNullable = _test_validatePrune("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input: any): typia.IValidation<ObjectPropertyNullable> => { const validate = (input: any): typia.IValidation<ObjectPropertyNullable> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ObjectPropertyNullable.SPOILERS);
