...
export const test_assertClone_ToJsonTuple = _test_assertClone("ToJsonTuple", ToJsonTuple.generate, (input) => ((input: any): typia.Primitive<ToJsonTuple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ToJsonTuple */; return output as ToJsonTuple; })(input));
