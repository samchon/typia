...
export const test_functional_validateEqualsFunction_ObjectPartial =
  _test_functional_validateEqualsFunction("ObjectPartial")(ObjectPartial)(
    (p: (input: ObjectPartial) => ObjectPartial) =>
      (input: ObjectPartial): import("typia").IValidation<ObjectPartial> => {
        const paramResults = [
        ...
        const result = ((
          input: any,
        ): typia.IValidation<Partial<ObjectPartial.IBase>> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
