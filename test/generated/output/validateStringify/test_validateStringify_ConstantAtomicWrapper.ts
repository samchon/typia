...
export const test_validateStringify_ConstantAtomicWrapper = _test_validateStringify("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input) => ((input: [ConstantAtomicWrapper.IPointer<boolean>, ConstantAtomicWrapper.IPointer<number>, ConstantAtomicWrapper.IPointer<string>]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[ConstantAtomicWrapper.IPointer<boolean>, ConstantAtomicWrapper.IPointer<number>, ConstantAtomicWrapper.IPointer<string>]> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ConstantAtomicWrapper.SPOILERS);
