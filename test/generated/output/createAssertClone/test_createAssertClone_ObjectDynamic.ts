...
export const test_createAssertClone_ObjectDynamic = _test_assertClone("ObjectDynamic", ObjectDynamic.generate, (input: any): typia.Primitive<ObjectDynamic> => { const assert = (input: any): ObjectDynamic => {
...
}; assert(input); const output = clone(input); return output; }, ObjectDynamic.SPOILERS);
