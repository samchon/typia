...
export const test_isClone_ObjectPrimitive = _test_isClone("ObjectPrimitive", ObjectPrimitive.generate, (input) => ((input: any): typia.Primitive<ObjectPrimitive.IArticle> | null => { const is = (input: any): input is ObjectPrimitive.IArticle => {
