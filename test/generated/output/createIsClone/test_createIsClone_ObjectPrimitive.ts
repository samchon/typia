...
export const test_createIsClone_ObjectPrimitive = _test_isClone("ObjectPrimitive", ObjectPrimitive.generate, (input: any): typia.Primitive<ObjectPrimitive> | null => { const is = (input: any): input is ObjectPrimitive => {
