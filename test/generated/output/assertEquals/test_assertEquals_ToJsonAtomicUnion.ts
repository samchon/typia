...
export const test_assertEquals_ToJsonAtomicUnion = _test_assertEquals("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input) => ((input: any): Array<ToJsonAtomicUnion.IToJson> => {
