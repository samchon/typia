...
export const test_createValidatePrune_TagFormat = _test_validatePrune("TagFormat", TagFormat.generate, (input: any): typia.IValidation<TagFormat> => { const validate = (input: any): typia.IValidation<TagFormat> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, TagFormat.SPOILERS);
