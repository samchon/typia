...
export const test_notation_validateCamel_ArrayRecursiveUnionExplicit = (): void =>
    ...
    convert: (input) => typia.notations.validateCamel<ArrayRecursiveUnionExplicit>(input),
