...
export const test_clone_ObjectTuple = _test_clone("ObjectTuple", ObjectTuple.generate, (input) => ((input: [ObjectTuple.ISection, ObjectTuple.ICitizen]): typia.Primitive<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => {
