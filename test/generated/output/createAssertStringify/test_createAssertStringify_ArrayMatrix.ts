...
export const test_createAssertStringify_ArrayMatrix = _test_assertStringify("ArrayMatrix", ArrayMatrix.generate, (input: any): string => { const assert = (input: any): ArrayMatrix => {
...
}; return stringify(assert(input)); }, ArrayMatrix.SPOILERS);
