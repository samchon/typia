...
export const test_notation_validateSnake_ArrayRecursiveUnionExplicit = (): void =>
    ...
    convert: (input) => typia.notations.validateSnake<ArrayRecursiveUnionExplicit>(input),
