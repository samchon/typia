...
export const test_createAssertClone_MapSimple = _test_assertClone("MapSimple", MapSimple.generate, (input: any): typia.Primitive<MapSimple> => { const assert = (input: any): MapSimple => {
...
}; assert(input); const output = clone(input); return output; }, MapSimple.SPOILERS);
