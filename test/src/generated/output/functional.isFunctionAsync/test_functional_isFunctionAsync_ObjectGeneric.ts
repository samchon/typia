...
export const test_functional_isFunctionAsync_ObjectGeneric =
  _test_functional_isFunctionAsync("ObjectGeneric")(ObjectGeneric)(
    (p: (input: ObjectGeneric) => Promise<ObjectGeneric>) =>
      async (input: ObjectGeneric): Promise<ObjectGeneric | null> => {
        ...
        return ((input: any): input is ObjectGeneric => {
          const $io0 = (input: any): boolean =>
            "boolean" === typeof input.value &&
            "object" === typeof input.child &&
            null !== input.child &&
