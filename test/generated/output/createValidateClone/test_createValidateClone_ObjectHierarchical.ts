...
export const test_createValidateClone_ObjectHierarchical = _test_validateClone("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.IValidation<typia.Primitive<ObjectHierarchical>> => { const validate = (input: any): typia.IValidation<ObjectHierarchical> => {
