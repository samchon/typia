...
export const test_assertClone_TagMatrix = _test_assertClone("TagMatrix", TagMatrix.generate, (input) => ((input: any): typia.Primitive<TagMatrix> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* TagMatrix */; return output as TagMatrix; })(input), TagMatrix.SPOILERS);
