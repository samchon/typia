...
export const test_functional_validateEqualsReturnAsync_TypeTagInfinite =
  _test_functional_validateEqualsReturnAsync("TypeTagInfinite")(
    TypeTagInfinite,
  )(
    (p: (input: TypeTagInfinite) => Promise<TypeTagInfinite>) =>
      async (
        input: TypeTagInfinite,
      ): Promise<import("typia").IValidation<TypeTagInfinite>> => {
        const result = ((input: any): typia.IValidation<TypeTagInfinite> => {
          const errors = [] as any[];
          const __is = (
            input: any,
