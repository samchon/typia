    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("boolean" === typeof input.value || $guard(_exceptionable, {
                ...
                expected: "ObjectGeneric.IChild<boolean, boolean>",
                value: elem
            })) && $ao1(elem, _path + ".elements[" + _index1 + "]", true && _exceptionable))) && (3 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["value", "child", "elements"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao2 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.value && Number.isFinite(input.value) || $guard(_exceptionable, {
                ...
                expected: "ObjectGeneric.IChild<number, number>",
                value: elem
            })) && $ao3(elem, _path + ".elements[" + _index2 + "]", true && _exceptionable))) && (3 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["value", "child", "elements"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao4 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.value || $guard(_exceptionable, {
                ...
                expected: "ObjectGeneric.IChild<string, string>",
                value: elem
            })) && $ao5(elem, _path + ".elements[" + _index3 + "]", true && _exceptionable))) && (3 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["value", "child", "elements"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
