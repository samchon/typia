...
export const test_createValidateStringify_TagObjectUnion = _test_validateStringify("TagObjectUnion", TagObjectUnion.generate, (input: TagObjectUnion): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<TagObjectUnion> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, TagObjectUnion.SPOILERS);
