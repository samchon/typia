...
export const test_assertPrune_ObjectUnionImplicit = _test_assertPrune("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: any): ObjectUnionImplicit => { const assert = (input: any) => {
