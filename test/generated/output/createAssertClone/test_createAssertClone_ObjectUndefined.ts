...
export const test_createAssertClone_ObjectUndefined = _test_assertClone("ObjectUndefined", ObjectUndefined.generate, (input: any): typia.Primitive<ObjectUndefined> => { const assert = (input: any): ObjectUndefined => {
...
}; assert(input); const output = clone(input); return output; }, ObjectUndefined.SPOILERS);
