...
export const test_assertClone_ArrayAtomicAlias = _test_assertClone("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input) => ((input: any): typia.Primitive<[ArrayAtomicAlias.Alias<boolean>, ArrayAtomicAlias.Alias<number>, ArrayAtomicAlias.Alias<string>]> => { const assert = (input: any): [ArrayAtomicAlias.Alias<boolean>, ArrayAtomicAlias.Alias<number>, ArrayAtomicAlias.Alias<string>] => {
...
}; assert(input); const output = clone(input); return output; })(input), ArrayAtomicAlias.SPOILERS);
