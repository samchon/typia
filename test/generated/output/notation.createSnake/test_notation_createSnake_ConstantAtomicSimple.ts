...
export const test_notation_createValidateSnake_ConstantAtomicSimple =
  _test_notation_validateGeneral("ConstantAtomicSimple")<ConstantAtomicSimple>(
    ...
    convert: (
      input: any,
    ): typia.IValidation<typia.SnakeCase<ConstantAtomicSimple>> => {
      const validate = (
        input: any,
    ...
    assert: (input: any): typia.SnakeCase<ConstantAtomicSimple> => {
      const __is = (
        input: any,
      ): input is typia.SnakeCase<ConstantAtomicSimple> => {
        return (
          Array.isArray(input) &&
          input.length === 4 &&
          false === input[0] &&
