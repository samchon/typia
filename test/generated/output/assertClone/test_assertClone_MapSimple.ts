...
export const test_assertClone_MapSimple = _test_assertClone("MapSimple", MapSimple.generate, (input) => ((input: any): typia.Primitive<MapSimple> => { const assert = (input: any): MapSimple => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is MapSimple => {
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (input.boolean instanceof Map || $guard(_exceptionable, {
                path: _path + ".boolean",
                expected: "Map<boolean, number>",
                value: input.boolean
            })) && [...input.boolean].every((elem: any, _index1: number) => (Array.isArray(elem) || $guard(_exceptionable, {
                ...
                expected: "[boolean, number]",
                value: elem
            })) && ("boolean" === typeof elem[0] || $guard(_exceptionable, {
                path: _path + ".boolean[" + _index1 + "][0]",
                expected: "boolean",
                value: elem[0]
            })) && ("number" === typeof elem[1] && Number.isFinite(elem[1]) || $guard(_exceptionable, {
                path: _path + ".boolean[" + _index1 + "][1]",
                expected: "number",
                value: elem[1]
            })))) && ((input.number instanceof Map || $guard(_exceptionable, {
                path: _path + ".number",
                expected: "Map<number, number>",
                value: input.number
            })) && [...input.number].every((elem: any, _index2: number) => (Array.isArray(elem) || $guard(_exceptionable, {
                ...
                expected: "[number, number]",
                value: elem
            })) && ("number" === typeof elem[0] && Number.isFinite(elem[0]) || $guard(_exceptionable, {
                ...
                expected: "number",
                value: elem[1]
            }))))) && ((input.strings instanceof Map || $guard(_exceptionable, {
                path: _path + ".strings",
                expected: "Map<string, number>",
                value: input.strings
            })) && [...input.strings].every((elem: any, _index3: number) => (Array.isArray(elem) || $guard(_exceptionable, {
                ...
                expected: "number",
                value: elem[1]
            }))))) && ((input.arrays instanceof Map || $guard(_exceptionable, {
                path: _path + ".arrays",
                expected: "Map<Array<number>, number>",
                value: input.arrays
            })) && [...input.arrays].every((elem: any, _index4: number) => (Array.isArray(elem) || $guard(_exceptionable, {
                ...
                value: elem[0]
            })) && elem[0].every((elem: any, _index5: number) => "number" === typeof elem && Number.isFinite(elem) || $guard(_exceptionable, {
                ...
                expected: "number",
                value: elem[1]
            }))))) && ((input.objects instanceof Map || $guard(_exceptionable, {
                path: _path + ".objects",
                expected: "Map<MapSimple.Person, number>",
                value: input.objects
            })) && [...input.objects].every((elem: any, _index6: number) => (Array.isArray(elem) || $guard(_exceptionable, {
                ...
                expected: "[MapSimple.Person, number]",
                value: elem
            })) && (("object" === typeof elem[0] && null !== elem[0] || $guard(_exceptionable, {
                path: _path + ".objects[" + _index6 + "][0]",
                expected: "MapSimple.Person",
                value: elem[0]
            })) && $ao1(elem[0], _path + ".objects[" + _index6 + "][0]", true && _exceptionable)) && ("number" === typeof elem[1] && Number.isFinite(elem[1]) || $guard(_exceptionable, {
...
}; assert(input); const output = clone(input); return output; })(input), MapSimple.SPOILERS);
