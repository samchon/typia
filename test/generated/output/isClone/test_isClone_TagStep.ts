...
export const test_isClone_TagStep = _test_isClone("TagStep", TagStep.generate, (input) => ((input: any): typia.Primitive<TagStep> | null => { const is = (input: any): input is TagStep => {
    ...
    return null; const output = clone(input); return output; })(input), TagStep.SPOILERS);
