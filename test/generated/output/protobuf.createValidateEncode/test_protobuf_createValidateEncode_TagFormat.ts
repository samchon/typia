...
export const test_protobuf_validateEncode_TagFormat =
    _test_protobuf_validateEncode("TagFormat")<TagFormat>(TagFormat)({
        validateEncode: (input: TagFormat): typia.IValidation<Uint8Array> => {
            ...
            const encode = (input: TagFormat): Uint8Array => {
                const $is_uuid = (typia.protobuf.createValidateEncode as any)
                    .is_uuid;
                const $is_email = (typia.protobuf.createValidateEncode as any)
                    .is_email;
                const $is_url = (typia.protobuf.createValidateEncode as any)
                    .is_url;
                const $is_ipv4 = (typia.protobuf.createValidateEncode as any)
                    .is_ipv4;
                const $is_ipv6 = (typia.protobuf.createValidateEncode as any)
                    .is_ipv6;
                const $is_date = (typia.protobuf.createValidateEncode as any)
                    .is_date;
                const $is_datetime = (
                    typia.protobuf.createValidateEncode as any
                ).is_datetime;
