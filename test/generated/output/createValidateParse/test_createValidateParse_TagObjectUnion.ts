...
export const test_createValidateParse_TagObjectUnion = _test_validateParse("TagObjectUnion", TagObjectUnion.generate, (input: string): typia.IValidation<typia.Primitive<TagObjectUnion>> => { const validate = (input: any): typia.IValidation<TagObjectUnion> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, TagObjectUnion.SPOILERS);
