...
export const test_functional_validateEqualsFunctionAsync_TupleOptional =
  _test_functional_validateEqualsFunctionAsync("TupleOptional")(TupleOptional)(
    (p: (input: TupleOptional) => Promise<TupleOptional>) =>
      async (
        input: TupleOptional,
      ): Promise<import("typia").IValidation<TupleOptional>> => {
        const paramResults = [
