...
export const test_createIsStringify_ObjectLiteralType = _test_isStringify("ObjectLiteralType", ObjectLiteralType.generate, (input: { id: string; name: string; age: number; }): string | null => { const is = (input: any): input is { id: string; name: string; age: number; } => {
