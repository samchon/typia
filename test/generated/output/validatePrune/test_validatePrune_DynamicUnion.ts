...
export const test_validatePrune_DynamicUnion = _test_validatePrune("DynamicUnion", DynamicUnion.generate, (input) => ((input: any): typia.IValidation<DynamicUnion> => { const validate = (input: any): typia.IValidation<DynamicUnion> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), DynamicUnion.SPOILERS);
