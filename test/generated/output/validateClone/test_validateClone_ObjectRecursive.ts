...
export const test_validateClone_ObjectRecursive = _test_validateClone("ObjectRecursive", ObjectRecursive.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectRecursive.IDepartment>> => { const validate = (input: any): typia.IValidation<ObjectRecursive.IDepartment> => {
    const errors = [] as any[];
