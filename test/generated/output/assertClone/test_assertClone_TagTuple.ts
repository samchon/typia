...
export const test_assertClone_TagTuple = _test_assertClone("TagTuple", TagTuple.generate, (input) => ((input: any): typia.Primitive<TagTuple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* TagTuple */; return output as TagTuple; })(input), TagTuple.SPOILERS);
