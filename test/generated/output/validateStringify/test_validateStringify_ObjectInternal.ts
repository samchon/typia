...
export const test_validateStringify_ObjectInternal = _test_validateStringify("ObjectInternal", ObjectInternal.generate, (input) => ((input: ObjectInternal): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectInternal> => {
    ...
    output.data = stringify(input); return output; })(input), ObjectInternal.SPOILERS);
