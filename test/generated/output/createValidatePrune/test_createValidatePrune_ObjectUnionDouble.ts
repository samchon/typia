...
export const test_createValidatePrune_ObjectUnionDouble = _test_validatePrune("ObjectUnionDouble", ObjectUnionDouble.generate, (input: any): typia.IValidation<ObjectUnionDouble> => { const validate = (input: any): typia.IValidation<ObjectUnionDouble> => {
    ...
    prune(input); return output; }, ObjectUnionDouble.SPOILERS);
