...
export const test_assertStringify_ObjectGenericUnion = _test_assertStringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): string => { const assert = (input: any): ISaleQuestion | ISaleReview => {
