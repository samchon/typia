...
export const test_createValidatePrune_AtomicSimple = _test_validatePrune("AtomicSimple", AtomicSimple.generate, (input: any): typia.IValidation<AtomicSimple> => { const validate = (input: any): typia.IValidation<AtomicSimple> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, AtomicSimple.SPOILERS);
