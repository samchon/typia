...
export const test_notation_validatePascal_ArrayRecursiveUnionExplicitPointer = (): void =>
    ...
    convert: (input) => typia.notations.validatePascal<ArrayRecursiveUnionExplicitPointer>(input),
