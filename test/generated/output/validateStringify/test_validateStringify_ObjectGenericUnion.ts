...
export const test_validateStringify_ObjectGenericUnion = _test_validateStringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: ISaleEntireArticle): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ISaleEntireArticle> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ObjectGenericUnion.SPOILERS);
