...
export const test_createAssertClone_ConstantAtomicUnion = _test_assertClone("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input: any): typia.Primitive<ConstantAtomicUnion> => { const assert = (input: any): ConstantAtomicUnion => {
...
}; assert(input); const output = clone(input); return output; }, ConstantAtomicUnion.SPOILERS);
