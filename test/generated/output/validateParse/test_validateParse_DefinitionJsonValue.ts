...
export const test_validateParse_DefinitionJsonValue = _test_validateParse("DefinitionJsonValue", DefinitionJsonValue.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<DefinitionJsonValue>> => { const validate = (input: any): typia.IValidation<DefinitionJsonValue> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), DefinitionJsonValue.SPOILERS);
