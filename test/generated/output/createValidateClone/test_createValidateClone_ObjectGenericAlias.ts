...
export const test_createValidateClone_ObjectGenericAlias = _test_validateClone("ObjectGenericAlias", ObjectGenericAlias.generate, (input: any): typia.IValidation<typia.Primitive<ObjectGenericAlias>> => { const validate = (input: any): typia.IValidation<ObjectGenericAlias> => {
