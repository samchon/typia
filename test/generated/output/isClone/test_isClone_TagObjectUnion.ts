...
export const test_isClone_TagObjectUnion = _test_isClone("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): typia.Primitive<TagObjectUnion> | null => { const is = (input: any): input is TagObjectUnion => {
