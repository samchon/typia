...
export const test_assertPrune_ArrayHierarchical = _test_assertPrune("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: any): Array<ArrayHierarchical.ICompany> => { const assert = (input: any): Array<ArrayHierarchical.ICompany> => {
