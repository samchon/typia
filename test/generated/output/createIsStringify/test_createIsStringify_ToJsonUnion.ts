...
export const test_createIsStringify_ToJsonUnion = _test_isStringify("ToJsonUnion", ToJsonUnion.generate, (input: ToJsonUnion): string | null => { const is = (input: any): input is ToJsonUnion => {
