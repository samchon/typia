...
export const test_createAssertPrune_AtomicClass = _test_assertPrune("AtomicClass", AtomicClass.generate, (input: any): AtomicClass => { const assert = (input: any): AtomicClass => {
...
}; assert(input); prune(input); return input; }, AtomicClass.SPOILERS);
