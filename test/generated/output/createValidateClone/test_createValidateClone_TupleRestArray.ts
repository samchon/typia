...
export const test_createValidateClone_TupleRestArray = _test_validateClone("TupleRestArray", TupleRestArray.generate, (input: any): typia.IValidation<typia.Primitive<TupleRestArray>> => { const validate = (input: any): typia.IValidation<TupleRestArray> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is TupleRestArray => {
    ...
    output.data = clone(input); return output; }, TupleRestArray.SPOILERS);
