...
export const test_createValidateStringify_ClassGetter = _test_validateStringify("ClassGetter", ClassGetter.generate, (input: ClassGetter): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ClassGetter> => {
    ...
    output.data = stringify(input); return output; }, ClassGetter.SPOILERS);
