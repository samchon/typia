...
export const test_createAssertStringify_SetAlias = _test_assertStringify("SetAlias", SetAlias.generate, (input: any): string => { const assert = (input: any): SetAlias => {
    ...
    return $so0(input);
}; return stringify(assert(input)); }, SetAlias.SPOILERS);
