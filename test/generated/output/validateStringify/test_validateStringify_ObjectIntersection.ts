...
export const test_validateStringify_ObjectIntersection = _test_validateStringify("ObjectIntersection", ObjectIntersection.generate, (input) => ((input: ObjectIntersection.IEmail & ObjectIntersection.IName): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectIntersection.IEmail & ObjectIntersection.IName> => {
    ...
    output.data = stringify(input); return output; })(input), ObjectIntersection.SPOILERS);
