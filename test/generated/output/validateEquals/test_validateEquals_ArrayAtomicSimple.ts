...
export const test_validateEquals_ArrayAtomicSimple = _test_validateEquals("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.IValidation<[Array<boolean>, Array<number>, Array<string>]> => {
    const __is = (input: any, _exceptionable: boolean = true): input is [Array<boolean>, Array<number>, Array<string>] => {
