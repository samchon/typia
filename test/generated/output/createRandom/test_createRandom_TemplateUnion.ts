...
export const test_createRandom_TemplateUnion = _test_random("TemplateUnion", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<TemplateUnion> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<TemplateUnion> => {
