...
export const test_createValidateStringify_SetAlias = _test_validateStringify("SetAlias", SetAlias.generate, (input: SetAlias): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<SetAlias> => {
    ...
    output.data = stringify(input); return output; }, SetAlias.SPOILERS);
