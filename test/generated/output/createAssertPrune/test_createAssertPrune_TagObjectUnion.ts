...
export const test_createAssertPrune_TagObjectUnion = _test_assertPrune("TagObjectUnion", TagObjectUnion.generate, (input: any): TagObjectUnion => { const assert = (input: any): TagObjectUnion => {
