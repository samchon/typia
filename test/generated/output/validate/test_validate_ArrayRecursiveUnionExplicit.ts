...
export const test_validate_ArrayRecursiveUnionExplicit = _test_validate("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): typia.IValidation<Array<ArrayRecursiveUnionExplicit.IBucket>> => {
...
})(input), ArrayRecursiveUnionExplicit.SPOILERS);
