...
export const test_createAssertPrune_ObjectHierarchical = _test_assertPrune("ObjectHierarchical", ObjectHierarchical.generate, (input: any): ObjectHierarchical => { const assert = (input: any): ObjectHierarchical => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, ObjectHierarchical.SPOILERS);
