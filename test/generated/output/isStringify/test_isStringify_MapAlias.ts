...
export const test_isStringify_MapAlias = _test_isStringify("MapAlias", MapAlias.generate, (input) => ((input: MapAlias): string | null => { const is = (input: any): input is MapAlias => {
