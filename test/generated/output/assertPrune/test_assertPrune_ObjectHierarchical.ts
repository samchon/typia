...
export const test_assertPrune_ObjectHierarchical = _test_assertPrune("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): ICustomer => { const assert = (input: any) => {
