...
export const test_assertPrune_ObjectUnionNonPredictable = _test_assertPrune("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: any): ObjectUnionNonPredictable => { const assert = (input: any) => {
