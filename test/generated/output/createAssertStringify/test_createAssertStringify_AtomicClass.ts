...
export const test_createAssertStringify_AtomicClass = _test_assertStringify("AtomicClass", AtomicClass.generate, (input: AtomicClass): string => { const assert = (input: any) => {
