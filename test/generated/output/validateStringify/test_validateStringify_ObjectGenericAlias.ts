...
export const test_validateStringify_ObjectGenericAlias = _test_validateStringify("ObjectGenericAlias", ObjectGenericAlias.generate, (input) => ((input: ObjectGenericAlias.ISomething<string>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectGenericAlias.ISomething<string>> => {
    const errors = [] as any[];
...
}; const stringify = (input: ObjectGenericAlias.ISomething<string>): string => {
