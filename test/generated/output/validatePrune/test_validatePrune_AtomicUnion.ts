...
export const test_validatePrune_AtomicUnion = _test_validatePrune("AtomicUnion", AtomicUnion.generate, (input) => ((input: any): typia.IValidation<Array<AtomicUnion.Union>> => { const validate = (input: any): typia.IValidation<Array<AtomicUnion.Union>> => {
    ...
    prune(input); return output; })(input), AtomicUnion.SPOILERS);
