...
export const test_createValidateClone_ObjectGenericUnion = _test_validateClone("ObjectGenericUnion", ObjectGenericUnion.generate, (input: any): typia.IValidation<typia.Primitive<ISaleEntireArticle>> => { const validate = (input: any): typia.IValidation<ISaleEntireArticle> => {
    const errors = [] as any[];
