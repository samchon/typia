...
export const test_validateParse_ObjectGenericArray = _test_validateParse("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ObjectGenericArray>> => { const validate = (input: any): typia.IValidation<ObjectGenericArray> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ObjectGenericArray.SPOILERS);
