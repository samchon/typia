...
export const test_isPrune_TagRange = _test_isPrune("TagRange", TagRange.generate, (input) => ((input: any): input is Array<TagRange.Type> => { const is = (input: any): input is Array<TagRange.Type> => {
    ...
    return false; prune(input); return true; })(input), TagRange.SPOILERS);
