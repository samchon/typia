...
export const test_validateStringify_ArrayRecursiveUnionExplicit = _test_validateStringify("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: Array<ArrayRecursiveUnionExplicit.IBucket>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<ArrayRecursiveUnionExplicit.IBucket>> => {
    const __is = (input: any): input is Array<ArrayRecursiveUnionExplicit.IBucket> => {
...
}; const stringify = (input: Array<ArrayRecursiveUnionExplicit.IBucket>): string => {
    ...
    const $so0 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"children":${`[${input.children.map((elem: any) => $su0(elem)).join(",")}]`},"type":${(() => {
    ...
    const $so1 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"width":${$number(input.width)},"height":${$number(input.height)},"url":${$string(input.url)},"size":${$number(input.size)},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
    ...
    const $so2 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"size":${$number(input.size)},"content":${$string(input.content)},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
    ...
    const $so3 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"size":${$number(input.size)},"count":${$number(input.count)},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
    ...
    const $so4 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"target":${$su0(input.target)},"type":${(() => {
        if ("string" === typeof input.type)
            return $string(input.type);
        if ("string" === typeof input.type)
            return "\"" + input.type + "\"";
    ...
    output.data = stringify(input); return output; })(input), ArrayRecursiveUnionExplicit.SPOILERS);
