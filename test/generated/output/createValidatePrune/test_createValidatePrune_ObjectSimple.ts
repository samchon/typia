...
export const test_createValidatePrune_ObjectSimple = _test_validatePrune("ObjectSimple", ObjectSimple.generate, (input: any): typia.IValidation<IBox3D> => { const validate = (input: any): typia.IValidation<IBox3D> => {
    const errors = [] as any[];
