...
export const test_llm_parameters_ObjectUnionNonPredictable = (): void =>
  _test_llm_parameters("ObjectUnionNonPredictable")(
    typia.llm.parameters<ObjectUnionNonPredictableParameters>(),
  );
