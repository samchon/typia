...
export const test_assertPrune_ArrayRecursiveUnionExplicit = _test_assertPrune("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): ArrayRecursiveUnionExplicit => { const assert = (input: any) => {
