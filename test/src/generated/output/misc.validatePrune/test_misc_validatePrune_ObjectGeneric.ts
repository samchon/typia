  ...
  ((input: any): typia.IValidation<ObjectGeneric> => {
          ...
          const $vo0 = (
            ...
            [
              ...
              ((("object" === typeof input.child && null !== input.child) ||
                ...
                $vo1(input.child, _path + ".child", true && _exceptionable)) ||
                $report(_exceptionable, {
                  path: _path + ".child",
                  expected: "ObjectGeneric.IChild<boolean, boolean>",
                  value: input.child,
          ...
          const $vo2 = (
            ...
            [
              ...
              ((("object" === typeof input.child && null !== input.child) ||
                ...
                $vo3(input.child, _path + ".child", true && _exceptionable)) ||
                $report(_exceptionable, {
                  path: _path + ".child",
                  expected: "ObjectGeneric.IChild<number, number>",
                  value: input.child,
          ...
          const $vo4 = (
            ...
            [
              ...
              ((("object" === typeof input.child && null !== input.child) ||
                ...
                $vo5(input.child, _path + ".child", true && _exceptionable)) ||
                $report(_exceptionable, {
                  path: _path + ".child",
                  expected: "ObjectGeneric.IChild<string, string>",
                  value: input.child,
    ...
    const prune = (input: ObjectGeneric): void => {
      ...
      if (
        ...
        if ("object" === typeof input[1] && null !== input[1]) $po2(input[1]);
        if ("object" === typeof input[2] && null !== input[2]) $po4(input[2]);
      }
    };
