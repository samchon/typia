...
export const test_createAssertPrune_ObjectUndefined = _test_assertPrune("ObjectUndefined", ObjectUndefined.generate, (input: any): ObjectUndefined => { const assert = (input: any) => {
