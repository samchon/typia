...
export const test_isClone_ObjectGeneric = _test_isClone("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): typia.Primitive<ObjectGeneric> | null => { const is = (input: any): input is ObjectGeneric => {
