...
export const test_llm_applicationEquals_claude_ObjectUnionCompositePointer = (): void =>
  _test_llm_applicationEquals({
    model: "claude",
    name: "ObjectUnionCompositePointer",
    factory: ObjectUnionCompositePointer
  })(
    typia.llm.application<ObjectUnionCompositePointerApplication, "claude", { equals: true }>(),
  );
