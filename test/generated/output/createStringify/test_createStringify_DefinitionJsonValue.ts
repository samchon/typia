...
export const test_createStringify_DefinitionJsonValue = _test_stringify("DefinitionJsonValue", DefinitionJsonValue.generate, (input: DefinitionJsonValue): string => {
