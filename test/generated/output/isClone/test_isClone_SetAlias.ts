...
export const test_isClone_SetAlias = _test_isClone("SetAlias", SetAlias.generate, (input) => ((input: any): typia.Primitive<SetAlias> | null => { const is = (input: any): input is SetAlias => {
