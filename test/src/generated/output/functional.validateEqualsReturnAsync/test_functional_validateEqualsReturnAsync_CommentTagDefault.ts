...
export const test_functional_validateEqualsReturnAsync_CommentTagDefault =
  _test_functional_validateEqualsReturnAsync("CommentTagDefault")(
    CommentTagDefault,
  )(
    (p: (input: CommentTagDefault) => Promise<CommentTagDefault>) =>
      async (
        input: CommentTagDefault,
      ): Promise<import("typia").IValidation<CommentTagDefault>> => {
