...
export const test_createAssertClone_ObjectSimple = _test_assertClone("ObjectSimple", ObjectSimple.generate, (input: any): typia.Primitive<ObjectSimple> => { const assert = (input: any): ObjectSimple => {
...
}; assert(input); const output = clone(input); return output; }, ObjectSimple.SPOILERS);
