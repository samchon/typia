...
export const test_createValidateClone_ArraySimple = _test_validateClone("ArraySimple", ArraySimple.generate, (input: any): typia.IValidation<typia.Primitive<ArraySimple>> => { const validate = (input: any): typia.IValidation<ArraySimple> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ArraySimple.SPOILERS);
