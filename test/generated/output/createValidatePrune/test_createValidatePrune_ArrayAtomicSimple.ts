...
export const test_createValidatePrune_ArrayAtomicSimple = _test_validatePrune("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: any): typia.IValidation<ArrayAtomicSimple> => { const validate = (input: any): typia.IValidation<ArrayAtomicSimple> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ArrayAtomicSimple.SPOILERS);
