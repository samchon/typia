...
const random = /* @__PURE__ */ ((generator) => {
  const __unit = { "components": { "schemas": { "\uFFFDtype": { "additionalProperties": false, "properties": { "age": { "exclusiveMinimum": 19, "maximum": 100, "type": "number" }, "email": { "format": "email", "type": "string" }, "id": { "format": "uuid", "type": "string" } }, "required": ["age", "email", "id"], "type": "object" } } }, "schema": { "additionalProperties": false, "properties": { "age": { "exclusiveMinimum": 19, "maximum": 100, "type": "number" }, "email": { "format": "email", "type": "string" }, "id": { "format": "uuid", "type": "string" } }, "required": ["age", "email", "id"], "type": "object" }, "version": "3.1" };
