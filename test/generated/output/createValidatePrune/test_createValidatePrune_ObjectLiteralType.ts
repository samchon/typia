...
export const test_createValidatePrune_ObjectLiteralType = _test_validatePrune("ObjectLiteralType", ObjectLiteralType.generate, (input: any): typia.IValidation<{ id: string; name: string; age: number; }> => { const validate = (input: any): typia.IValidation<{ id: string; name: string; age: number; }> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ObjectLiteralType.SPOILERS);
