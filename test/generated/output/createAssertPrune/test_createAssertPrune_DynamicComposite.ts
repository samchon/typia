...
export const test_createAssertPrune_DynamicComposite = _test_assertPrune("DynamicComposite", DynamicComposite.generate, (input: any): DynamicComposite => { const assert = (input: any) => {
