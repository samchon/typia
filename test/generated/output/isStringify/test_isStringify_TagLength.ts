...
export const test_isStringify_TagLength = _test_isStringify("TagLength", TagLength.generate, (input) => ((input: Array<TagLength.Type>): string | null => { const is = (input: any): input is Array<TagLength.Type> => {
...
}; return is(input) ? stringify(input) : null; })(input), TagLength.SPOILERS);
