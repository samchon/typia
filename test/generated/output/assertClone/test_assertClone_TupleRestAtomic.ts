...
export const test_assertClone_TupleRestAtomic = _test_assertClone("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: any): typia.Primitive<TupleRestAtomic> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* TupleRestAtomic */; return output as TupleRestAtomic; })(input), TupleRestAtomic.SPOILERS);
