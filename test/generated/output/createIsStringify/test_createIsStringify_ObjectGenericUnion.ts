...
export const test_createIsStringify_ObjectGenericUnion = _test_isStringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input: ISaleEntireArticle): string | null => { const is = (input: any): input is ISaleEntireArticle => {
    ...
    return $su0(input);
}; return is(input) ? stringify(input) : null; }, ObjectGenericUnion.SPOILERS);
