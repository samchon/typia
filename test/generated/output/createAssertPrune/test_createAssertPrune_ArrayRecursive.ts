...
export const test_createAssertPrune_ArrayRecursive = _test_assertPrune("ArrayRecursive", ArrayRecursive.generate, (input: any): ArrayRecursive => { const assert = (input: any): ArrayRecursive => {
