...
export const test_notation_createValidateSnake_CommentTagObjectUnion =
    ...
    >({
        convert: (
            input: any,
        ): typia.IValidation<typia.SnakeCase<CommentTagObjectUnion>> => {
            const validate = (
                input: any,
            ...
            const general = (
                ...
                const $io1 = (input: any): boolean =>
                    ...
                    3 <= input.value.length &&
                    input.value.length <= 7;
                const $throws = (typia.notations.createValidateSnake as any)
                    .throws;
                const $cp0 = (input: any) =>
                    input.map((elem: any) =>
        ...
        assert: (input: any): typia.SnakeCase<CommentTagObjectUnion> => {
            const __is = (
                input: any,
