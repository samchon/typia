...
export const test_createAssertClone_DefinitionJsonValue = _test_assertClone("DefinitionJsonValue", DefinitionJsonValue.generate, (input: any): typia.Primitive<DefinitionJsonValue> => { const assert = (input: any): DefinitionJsonValue => {
...
}; assert(input); const output = clone(input); return output; }, DefinitionJsonValue.SPOILERS);
