...
export const test_createValidate_ObjectGenericUnion = _test_validate("ObjectGenericUnion", ObjectGenericUnion.generate, (input: any): typia.IValidation<ISaleEntireArticle> => {
    const errors = [] as any[];
