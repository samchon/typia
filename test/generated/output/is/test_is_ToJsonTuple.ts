...
export const test_is_ToJsonTuple = _test_is("ToJsonTuple", ToJsonTuple.generate, (input) => ((input: any): input is [ToJsonTuple.IToJson<string>, ToJsonTuple.IToJson<number>, ToJsonTuple.IToJson<boolean>, ToJsonTuple.IObject] => {
