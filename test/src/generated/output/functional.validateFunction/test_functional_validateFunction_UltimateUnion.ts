...
export const test_functional_validateFunction_UltimateUnion =
  _test_functional_validateFunction("UltimateUnion")(UltimateUnion)(
    (p: (input: UltimateUnion) => UltimateUnion) =>
      (input: UltimateUnion): import("typia").IValidation<UltimateUnion> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<UltimateUnion> => {
          const errors = [] as any[];
          const __is = (input: any): input is UltimateUnion => {
            const $io0 = (input: any): boolean =>
              Array.isArray(input.schemas) &&
