...
export const test_notation_validatePascal_ObjectUnionCompositePointer = (): void =>
    ...
    convert: (input) => typia.notations.validatePascal<ObjectUnionCompositePointer>(input),
