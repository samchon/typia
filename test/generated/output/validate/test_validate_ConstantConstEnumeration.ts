...
export const test_validate_ConstantConstEnumeration = _test_validate("ConstantConstEnumeration", ConstantConstEnumeration.generate, (input) => ((input: any): typia.IValidation<Array<ConstantConstEnumeration.Enumeration>> => {
    const errors = [] as any[];
