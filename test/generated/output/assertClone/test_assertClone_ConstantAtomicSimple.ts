...
export const test_assertClone_ConstantAtomicSimple = _test_assertClone("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input) => ((input: any): typia.Primitive<[false, true, 2, 'three']> => { const assert = (input: any): [false, true, 2, 'three'] => {
...
}; assert(input); const output = clone(input); return output; })(input), ConstantAtomicSimple.SPOILERS);
