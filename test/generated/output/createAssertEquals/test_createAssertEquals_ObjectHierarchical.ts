...
export const test_createAssertEquals_ObjectHierarchical = _test_assertEquals("ObjectHierarchical", ObjectHierarchical.generate, (input: any): ObjectHierarchical => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ObjectHierarchical => {
            ...
            })) && $ao2(input.created_at, _path + ".created_at", true && _exceptionable)) && (8 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["id", "channel", "member", "account", "href", "referrer", "ip", "created_at"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.id && Number.isFinite(input.id) || $guard(_exceptionable, {
                ...
                expected: "ObjectHierarchical.ITimestamp",
                value: input.created_at
            })) && $ao2(input.created_at, _path + ".created_at", true && _exceptionable)) && (7 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["id", "code", "name", "sequence", "exclusive", "priority", "created_at"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao4 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.id && Number.isFinite(input.id) || $guard(_exceptionable, {
                ...
                expected: "ObjectHierarchical.ITimestamp",
                value: input.created_at
            })) && $ao2(input.created_at, _path + ".created_at", true && _exceptionable)) && (3 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["id", "code", "created_at"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao5 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.id && Number.isFinite(input.id) || $guard(_exceptionable, {
                ...
                expected: "ObjectHierarchical.ITimestamp",
                value: input.created_at
            })) && $ao2(input.created_at, _path + ".created_at", true && _exceptionable)) && (5 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every(key => {
                if (["id", "account", "name", "grade", "created_at"].some(prop => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
