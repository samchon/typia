...
export const test_assertPrune_ArrayRecursiveUnionImplicit = _test_assertPrune("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): ArrayRecursiveUnionImplicit => { const assert = (input: any) => {
