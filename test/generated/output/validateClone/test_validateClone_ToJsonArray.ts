...
export const test_validateClone_ToJsonArray = _test_validateClone("ToJsonArray", ToJsonArray.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ToJsonArray>> => { const validate = (input: any): typia.IValidation<ToJsonArray> => {
    const errors = [] as any[];
