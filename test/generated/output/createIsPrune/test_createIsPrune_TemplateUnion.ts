...
export const test_createIsPrune_TemplateUnion = _test_isPrune("TemplateUnion", TemplateUnion.generate, (input: any): input is TemplateUnion => { const is = (input: any): input is TemplateUnion => {
    ...
    return false; prune(input); return true; }, TemplateUnion.SPOILERS);
