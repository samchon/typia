...
export const test_assert_ArrayAtomicAlias = _test_assert("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input) => ((input: any): [ArrayAtomicAlias.Alias<boolean>, ArrayAtomicAlias.Alias<number>, ArrayAtomicAlias.Alias<string>] => {
