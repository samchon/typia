...
export const test_functional_validateParametersAsync_SetUnion =
  _test_functional_validateParametersAsync("SetUnion")(SetUnion)(
    (p: (input: SetUnion) => Promise<SetUnion>) =>
      async (
        input: SetUnion,
      ): Promise<import("typia").IValidation<SetUnion>> => {
        const paramResults = [
