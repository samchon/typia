...
export const test_llm_parameters_ObjectUnionCompositePointer = (): void =>
  _test_llm_parameters("ObjectUnionCompositePointer")(
    typia.llm.parameters<ObjectUnionCompositePointerParameters>(),
  );
