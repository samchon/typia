...
export const test_validatePrune_DynamicTemplate = _test_validatePrune("DynamicTemplate", DynamicTemplate.generate, (input) => ((input: any): typia.IValidation<DynamicTemplate> => { const validate = (input: any): typia.IValidation<DynamicTemplate> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), DynamicTemplate.SPOILERS);
