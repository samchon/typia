...
export const test_isClone_TemplateAtomic = _test_isClone("TemplateAtomic", TemplateAtomic.generate, (input) => ((input: any): typia.Primitive<TemplateAtomic> | null => { const is = (input: any): input is TemplateAtomic => {
    ...
    return null; const output = clone(input); return output; })(input), TemplateAtomic.SPOILERS);
