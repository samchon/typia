...
export const test_createIsClone_SetAlias = _test_isClone("SetAlias", SetAlias.generate, (input: any): typia.Primitive<SetAlias> | null => { const is = (input: any): input is SetAlias => {
    ...
    return null; const output = clone(input); return output; }, SetAlias.SPOILERS);
