...
export const test_validateClone_ToJsonTuple = _test_validateClone("ToJsonTuple", ToJsonTuple.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ToJsonTuple>> => { const validate = (input: any): typia.IValidation<ToJsonTuple> => {
    const errors = [] as any[];
