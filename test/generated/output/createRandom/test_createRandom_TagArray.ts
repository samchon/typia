...
export const test_createRandom_TagArray = _test_random("TagArray", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    const $generator = (typia.createRandom as any).generator;
    const $pick = (typia.createRandom as any).pick;
    const $ro0 = (recursive = false, depth = 0) => ({
        items: (generator.array ?? $generator.array)(() => (generator.uuid ?? $generator.uuid)(), 3),
        minItems: (generator.array ?? $generator.array)(() => (generator.number ?? $generator.number)(3, 13), (generator.integer ?? $generator.integer)(3, 6)),
        ...
        both: (generator.array ?? $generator.array)(() => (generator.uuid ?? $generator.uuid)(), (generator.integer ?? $generator.integer)(3, 7))
    });
    ...
    return input as typia.Primitive<TagArray>;
});
