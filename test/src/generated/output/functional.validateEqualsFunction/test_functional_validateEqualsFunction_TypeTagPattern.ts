...
export const test_functional_validateEqualsFunction_TypeTagPattern =
  _test_functional_validateEqualsFunction("TypeTagPattern")(TypeTagPattern)(
    (p: (input: TypeTagPattern) => TypeTagPattern) =>
      (input: TypeTagPattern): import("typia").IValidation<TypeTagPattern> => {
        const paramResults = [
