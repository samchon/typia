...
export const test_validatePrune_ArrayAtomicSimple = _test_validatePrune("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): typia.IValidation<[Array<boolean>, Array<number>, Array<string>]> => { const validate = (input: any): typia.IValidation<[Array<boolean>, Array<number>, Array<string>]> => {
...
}; const prune = (input: [Array<boolean>, Array<number>, Array<string>]): void => {
}; const output = validate(input); if (output.success)
    prune(input); return output; })(input), ArrayAtomicSimple.SPOILERS);
