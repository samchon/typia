...
export const test_functional_equalsParametersAsync_TypeTagPattern =
  _test_functional_equalsParametersAsync("TypeTagPattern")(TypeTagPattern)(
    (p: (input: TypeTagPattern) => Promise<TypeTagPattern>) =>
      async (input: TypeTagPattern): Promise<TypeTagPattern | null> => {
        if (
          false ===
          ((
            input: any,
