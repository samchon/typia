...
export const test_createEquals_TemplateConstant = _test_equals("TemplateConstant", TemplateConstant.generate, (input: any, _exceptionable: boolean = true): input is TemplateConstant => {
