...
export const test_assertClone_MapAlias = _test_assertClone("MapAlias", MapAlias.generate, (input) => ((input: any): typia.Primitive<MapSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* MapSimple */; return output as MapSimple; })(input), MapAlias.SPOILERS);
