...
export const test_assertPrune_ObjectGeneric = _test_assertPrune("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): ObjectGeneric => { const assert = (input: any) => {
