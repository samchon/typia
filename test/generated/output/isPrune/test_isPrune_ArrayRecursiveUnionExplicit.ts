...
export const test_isPrune_ArrayRecursiveUnionExplicit = _test_isPrune("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): input is Array<ArrayRecursiveUnionExplicit.IBucket> => { const is = (input: any): input is Array<ArrayRecursiveUnionExplicit.IBucket> => {
    ...
    return false; prune(input); return true; })(input), ArrayRecursiveUnionExplicit.SPOILERS);
