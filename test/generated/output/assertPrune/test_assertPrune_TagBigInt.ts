...
export const test_assertPrune_TagBigInt = _test_assertPrune("TagBigInt", TagBigInt.generate, (input) => ((input: any): TagBigInt => { const assert = (input: any): TagBigInt => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), TagBigInt.SPOILERS);
