...
export const test_createAssertEquals_ObjectLiteralProperty = _test_assertEquals("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any): ObjectLiteralProperty => {
