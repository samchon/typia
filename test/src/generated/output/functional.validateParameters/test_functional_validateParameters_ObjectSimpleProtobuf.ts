...
export const test_functional_validateParameters_ObjectSimpleProtobuf =
  _test_functional_validateParameters("ObjectSimpleProtobuf")(
    ObjectSimpleProtobuf,
  )(
    (p: (input: ObjectSimpleProtobuf) => ObjectSimpleProtobuf) =>
      (
        input: ObjectSimpleProtobuf,
      ): import("typia").IValidation<ObjectSimpleProtobuf> => {
        const paramResults = [
