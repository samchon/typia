...
export const test_createValidateEquals_FunctionalObjectUnion = _test_validateEquals("FunctionalObjectUnion", FunctionalObjectUnion.generate, (input: any): typia.IValidation<FunctionalObjectUnion> => {
    const errors = [] as any[];
