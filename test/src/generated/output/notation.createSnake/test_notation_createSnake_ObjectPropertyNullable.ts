...
export const test_notation_createValidateSnake_ObjectPropertyNullable =
  ...
  >({
    convert: (
      input: any,
    ): typia.IValidation<typia.SnakeCase<ObjectPropertyNullable>> => {
      const validate = (
        input: any,
    ...
    assert: (input: any): typia.SnakeCase<ObjectPropertyNullable> => {
      const __is = (
        input: any,
      ): input is typia.SnakeCase<ObjectPropertyNullable> => {
        const $io0 = (input: any): boolean =>
          null === input.value || "boolean" === typeof input.value;
        const $io1 = (input: any): boolean =>
          null === input.value ||
