...
export const test_createAssertStringify_AtomicClass = _test_assertStringify("AtomicClass", AtomicClass.generate, (input: any): string => { const assert = (input: any): AtomicClass => {
...
}; return stringify(assert(input)); }, AtomicClass.SPOILERS);
