...
//-------------------------------------------------------
console.log(" Packing typia sources for the wasm worker");
//-------------------------------------------------------
require("./typia-pack");
//-------------------------------------------------------

//-------------------------------------------------------
console.log(" Packing typia runtime for the Execute sandbox");
//-------------------------------------------------------
require("./pack-typia-runtime");
//-------------------------------------------------------

//-------------------------------------------------------
console.log(" Building ttsc-typia WebAssembly module");
//-------------------------------------------------------
require("./wasm");
//-------------------------------------------------------
