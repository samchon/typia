...
export const test_createIsStringify_TagObjectUnion = _test_isStringify("TagObjectUnion", TagObjectUnion.generate, (input: TagObjectUnion): string | null => { const is = (input: any): input is TagObjectUnion => {
...
}; return is(input) ? stringify(input) : null; }, TagObjectUnion.SPOILERS);
