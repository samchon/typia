...
export const test_createAssert_FunctionalObjectUnion = _test_assert("FunctionalObjectUnion", FunctionalObjectUnion.generate, (input: any): FunctionalObjectUnion => {
