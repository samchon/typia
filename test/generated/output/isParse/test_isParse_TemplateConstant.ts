...
export const test_isParse_TemplateConstant = _test_isParse("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): typia.Primitive<TemplateConstant> => { const is = (input: any): input is TemplateConstant => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; })(input), TemplateConstant.SPOILERS);
