...
export const test_createValidateClone_ObjectUnionImplicit = _test_validateClone("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: any): typia.IValidation<typia.Primitive<ObjectUnionImplicit>> => { const validate = (input: any): typia.IValidation<ObjectUnionImplicit> => {
    ...
    output.data = clone(input); return output; }, ObjectUnionImplicit.SPOILERS);
