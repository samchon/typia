 ...
 */
export const generate_assert = (input: any): ObjectUnionExplicit => {
 ...
 */
export const generate_assert_equals = (input: any): ObjectUnionExplicit => {
 ...
 */
export const generate_assert_stringify = (input: any): string => {
    const assert = (input: any): ObjectUnionExplicit => {
