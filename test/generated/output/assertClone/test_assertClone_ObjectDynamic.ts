...
export const test_assertClone_ObjectDynamic = _test_assertClone("ObjectDynamic", ObjectDynamic.generate, (input) => ((input: any): typia.Primitive<ObjectDynamic> => { const assert = (input: any): ObjectDynamic => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectDynamic.SPOILERS);
