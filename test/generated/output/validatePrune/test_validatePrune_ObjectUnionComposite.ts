...
export const test_validatePrune_ObjectUnionComposite = _test_validatePrune("ObjectUnionComposite", ObjectUnionComposite.generate, (input) => ((input: any): typia.IValidation<ObjectUnionComposite> => { const validate = (input: any): typia.IValidation<ObjectUnionComposite> => {
    const errors = [] as any[];
