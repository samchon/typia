...
export const test_createAssertClone_TagLength = _test_assertClone("TagLength", TagLength.generate, (input: any): typia.Primitive<TagLength> => { const assert = (input: any): TagLength => {
...
}; assert(input); const output = clone(input); return output; }, TagLength.SPOILERS);
