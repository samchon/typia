...
export const test_notation_createValidateCamel_ArrayMatrix =
  ...
  >({
    convert: (input: any): typia.IValidation<typia.CamelCase<ArrayMatrix>> => {
      ...
      const general = (input: ArrayMatrix): typia.CamelCase<ArrayMatrix> => {
    ...
    assert: (input: any): typia.CamelCase<ArrayMatrix> => {
      const __is = (input: any): input is typia.CamelCase<ArrayMatrix> => {
        return (
          Array.isArray(input) &&
          input.every(
            (elem: any) =>
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.CamelCase<ArrayMatrix> => {
