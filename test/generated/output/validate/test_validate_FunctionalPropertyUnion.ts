...
export const test_validate_FunctionalPropertyUnion = _test_validate("FunctionalPropertyUnion", FunctionalPropertyUnion.generate, (input) => ((input: any): typia.IValidation<FunctionalPropertyUnion> => {
    const errors = [] as any[];
