...
export const test_clone_TagObjectUnion = _test_clone("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: Array<TagObjectUnion.Type>): typia.Primitive<Array<TagObjectUnion.Type>> => {
