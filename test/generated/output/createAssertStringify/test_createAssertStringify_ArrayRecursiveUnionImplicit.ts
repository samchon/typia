...
export const test_createAssertStringify_ArrayRecursiveUnionImplicit = _test_assertStringify("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input: any): string => { const assert = (input: any): ArrayRecursiveUnionImplicit => {
