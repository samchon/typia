...
export const test_isClone_ObjectUndefined = _test_isClone("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): typia.Primitive<Array<ObjectUndefined.ILecture>> | null => { const is = (input: any): input is Array<ObjectUndefined.ILecture> => {
    ...
    return null; const output = clone(input); return output; })(input), ObjectUndefined.SPOILERS);
