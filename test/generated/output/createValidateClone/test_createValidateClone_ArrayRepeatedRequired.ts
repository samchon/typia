...
export const test_createValidateClone_ArrayRepeatedRequired = _test_validateClone("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input: any): typia.IValidation<typia.Primitive<ArrayRepeatedRequired>> => { const validate = (input: any): typia.IValidation<ArrayRepeatedRequired> => {
    const errors = [] as any[];
...
}; const clone = (input: ArrayRepeatedRequired): typia.Primitive<ArrayRepeatedRequired> => {
    ...
    output.data = clone(input); return output; }, ArrayRepeatedRequired.SPOILERS);
