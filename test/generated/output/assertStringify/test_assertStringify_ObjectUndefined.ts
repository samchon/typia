...
export const test_assertStringify_ObjectUndefined = _test_assertStringify("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: ObjectUndefined): string => { const assert = (input: any) => {
