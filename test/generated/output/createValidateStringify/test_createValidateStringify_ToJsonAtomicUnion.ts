...
export const test_createValidateStringify_ToJsonAtomicUnion = _test_validateStringify("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input: ToJsonAtomicUnion): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ToJsonAtomicUnion> => {
    const errors = [] as any[];
