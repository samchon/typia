...
export const test_createValidatePrune_ObjectHierarchical = _test_validatePrune("ObjectHierarchical", ObjectHierarchical.generate, (input: any): typia.IValidation<ObjectHierarchical> => { const validate = (input: any): typia.IValidation<ObjectHierarchical> => {
    ...
    prune(input); return output; }, ObjectHierarchical.SPOILERS);
