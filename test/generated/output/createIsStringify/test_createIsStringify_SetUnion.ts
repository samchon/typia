...
export const test_createIsStringify_SetUnion = _test_isStringify("SetUnion", SetUnion.generate, (input: SetUnion): string | null => { const is = (input: any): input is SetUnion => {
...
}; return is(input) ? stringify(input) : null; }, SetUnion.SPOILERS);
