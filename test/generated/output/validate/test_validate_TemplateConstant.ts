...
export const test_validate_TemplateConstant = _test_validate("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): typia.IValidation<TemplateConstant> => {
    const errors = [] as any[];
