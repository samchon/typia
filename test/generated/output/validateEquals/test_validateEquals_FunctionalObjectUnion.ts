...
export const test_validateEquals_FunctionalObjectUnion = _test_validateEquals("FunctionalObjectUnion", FunctionalObjectUnion.generate, (input) => ((input: any): typia.IValidation<FunctionalObjectUnion> => {
    const errors = [] as any[];
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is FunctionalObjectUnion => {
        ...
        const $vo2 = (input: any, _path: string, _exceptionable: boolean) => [(Array.isArray(input.points) || $report(_exceptionable, {
                path: _path + ".points",
        ...
        const $vo3 = (input: any, _path: string, _exceptionable: boolean) => [(Array.isArray(input.points) || $report(_exceptionable, {
                path: _path + ".points",
                expected: "Array<Resolve<FunctionalObjectUnion.IPoint>>",
                value: input.points
    ...
    } as typia.IValidation<FunctionalObjectUnion>;
})(input));
