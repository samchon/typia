...
export const test_assertClone_TemplateConstant = _test_assertClone("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): typia.Primitive<TemplateConstant> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as TemplateConstant; })(input), TemplateConstant.SPOILERS);
