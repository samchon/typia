...
export const test_assert_ObjectUnionNonPredictable = _test_assert("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: any): Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>> => {
