...
export const test_createValidateClone_ObjectRecursive = _test_validateClone("ObjectRecursive", ObjectRecursive.generate, (input: any): typia.IValidation<typia.Primitive<IDepartment>> => { const validate = (input: any): typia.IValidation<IDepartment> => {
    const errors = [] as any[];
