...
export const test_assertPrune_ObjectNullable = _test_assertPrune("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct] => { const assert = (input: any): [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct] => {
    ...
    return input;
}; const prune = (input: [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]): void => {
    const $io0 = (input: any): boolean => "string" === typeof input.name && ("object" === typeof input.manufacturer && null !== input.manufacturer && $io1(input.manufacturer)) && (null === input.brand || "object" === typeof input.brand && null !== input.brand && $io2(input.brand)) && (null === input.similar || "object" === typeof input.similar && null !== input.similar && $iu0(input.similar));
    const $io1 = (input: any): boolean => "manufacturer" === input.type && "string" === typeof input.name;
    const $io2 = (input: any): boolean => "brand" === input.type && "string" === typeof input.name;
    const $iu0 = (input: any): any => (() => {
...
}; assert(input); prune(input); return input; })(input), ObjectNullable.SPOILERS);
