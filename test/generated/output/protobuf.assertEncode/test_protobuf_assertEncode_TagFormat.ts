    ...
    assertEncode: (input) =>
        ((input: any): Uint8Array => {
            const assert = (input: any): TagFormat => {
                const __is = (input: any): input is TagFormat => {
                    const $is_uuid = (typia.protobuf.assertEncode as any)
                        .is_uuid;
                    const $is_email = (typia.protobuf.assertEncode as any)
                        .is_email;
                    const $is_url = (typia.protobuf.assertEncode as any).is_url;
                    const $is_ipv4 = (typia.protobuf.assertEncode as any)
                        .is_ipv4;
                    const $is_ipv6 = (typia.protobuf.assertEncode as any)
                        .is_ipv6;
                    const $is_date = (typia.protobuf.assertEncode as any)
                        .is_date;
                    const $is_datetime = (typia.protobuf.assertEncode as any)
                        .is_datetime;
                    return (
                        "object" === typeof input &&
                        null !== input &&
            ...
            const encode = (input: TagFormat): Uint8Array => {
                ...
                const $is_email = (typia.protobuf.assertEncode as any).is_email;
                const $is_url = (typia.protobuf.assertEncode as any).is_url;
                const $is_ipv4 = (typia.protobuf.assertEncode as any).is_ipv4;
                const $is_ipv6 = (typia.protobuf.assertEncode as any).is_ipv6;
                const $is_date = (typia.protobuf.assertEncode as any).is_date;
                const $is_datetime = (typia.protobuf.assertEncode as any)
                    .is_datetime;
