...
export const test_createAssertStringify_TagRange = _test_assertStringify("TagRange", TagRange.generate, (input: any): string => { const assert = (input: any): TagRange => {
...
}; return stringify(assert(input)); }, TagRange.SPOILERS);
