...
export const test_notation_validateCamel_ConstantIntersection =
  _test_notation_validateGeneral("ConstantIntersection")<ConstantIntersection>(
    ...
    convert: (input) =>
      ((
        input: any,
      ): typia.IValidation<typia.CamelCase<ConstantIntersection>> => {
        const validate = (
          input: any,
    ...
    assert: (input: any): typia.CamelCase<ConstantIntersection> => {
      const __is = (
        input: any,
      ): input is typia.CamelCase<ConstantIntersection> => {
        return (
          Array.isArray(input) &&
          input.length === 3 &&
          false === input[0] &&
