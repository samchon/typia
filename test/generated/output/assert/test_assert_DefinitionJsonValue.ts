...
export const test_assert_DefinitionJsonValue = _test_assert("DefinitionJsonValue", DefinitionJsonValue.generate, (input) => ((input: any): string | number | boolean | DefinitionJsonValue.JsonObject | DefinitionJsonValue.JsonArray | null => {
