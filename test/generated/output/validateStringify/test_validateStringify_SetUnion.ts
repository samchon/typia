...
export const test_validateStringify_SetUnion = _test_validateStringify("SetUnion", SetUnion.generate, (input) => ((input: Array<SetUnion.Union>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<SetUnion.Union>> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), SetUnion.SPOILERS);
