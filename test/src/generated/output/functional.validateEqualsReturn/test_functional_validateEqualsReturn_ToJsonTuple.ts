...
export const test_functional_validateEqualsReturn_ToJsonTuple =
  _test_functional_validateEqualsReturn("ToJsonTuple")(ToJsonTuple)(
    (p: (input: ToJsonTuple) => ToJsonTuple) =>
      (input: ToJsonTuple): import("typia").IValidation<ToJsonTuple> => {
        const result = ((input: any): typia.IValidation<ToJsonTuple> => {
          const errors = [] as any[];
          const __is = (
            input: any,
