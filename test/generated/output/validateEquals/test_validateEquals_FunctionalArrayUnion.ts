...
export const test_validateEquals_FunctionalArrayUnion = _test_validateEquals("FunctionalArrayUnion", FunctionalArrayUnion.generate, (input) => ((input: any): typia.IValidation<FunctionalArrayUnion> => {
    const errors = [] as any[];
