...
export const test_equals_ArrayAtomicAlias = _test_equals("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input) => ((input: any, _exceptionable: boolean): input is ArrayAtomicAlias => {
