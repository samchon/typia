...
export const test_assertStringify_ObjectUnionDouble = _test_assertStringify("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ObjectUnionDouble.Union> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Array<ObjectUnionDouble.Union> => {
            ...
            const $au0 = (input: any, _path: string, _exceptionable: boolean = true): any => $ao4(input, _path, false && _exceptionable) || $ao2(input, _path, false && _exceptionable) || $guard(_exceptionable, {
                path: _path,
                expected: "(ObjectUnionDouble.IAB | ObjectUnionDouble.IAA)",
                value: input
            });
            const $au1 = (input: any, _path: string, _exceptionable: boolean = true): any => $ao10(input, _path, false && _exceptionable) || $ao8(input, _path, false && _exceptionable) || $guard(_exceptionable, {
                path: _path,
                expected: "(ObjectUnionDouble.IBB | ObjectUnionDouble.IBA)",
                value: input
            });
            const $au2 = (input: any, _path: string, _exceptionable: boolean = true): any => $ao6(input, _path, false && _exceptionable) || $ao0(input, _path, false && _exceptionable) || $guard(_exceptionable, {
                path: _path,
...
}; return stringify(assert(input)); })(input), ObjectUnionDouble.SPOILERS);
