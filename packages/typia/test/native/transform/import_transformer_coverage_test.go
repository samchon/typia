...
func TestImportTransformerCoverage(t *testing.T) {
	file := shimparser.ParseSourceFile(
		shimast.SourceFileParseOptions{FileName: filepath.Join(t.TempDir(), "project", "src", "main.ts")},
...
`,
	...
	defaultOnly := shimparser.ParseSourceFile(
		shimast.SourceFileParseOptions{FileName: filepath.Join(t.TempDir(), "project", "src", "default.ts")},
		`import typia from "typia";
export const value = typia.is<string>("x");
`,
		shimcore.ScriptKindTS,
	...
	named := shimparser.ParseSourceFile(
		shimast.SourceFileParseOptions{FileName: filepath.Join(t.TempDir(), "project", "src", "named.ts")},
