...
export const test_createAssertStringify_TupleRestObject = _test_assertStringify("TupleRestObject", TupleRestObject.generate, (input: any): string => { const assert = (input: any): TupleRestObject => {
...
}; return stringify(assert(input)); }, TupleRestObject.SPOILERS);
