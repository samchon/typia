...
export const test_isClone_TupleRestAtomic = _test_isClone("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: any): typia.Primitive<[boolean, number, ...string[]]> | null => { const is = (input: any): input is [boolean, number, ...string[]] => {
