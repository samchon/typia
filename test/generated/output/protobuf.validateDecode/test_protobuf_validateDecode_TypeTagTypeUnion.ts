...
export const test_protobuf_validateDecode_TypeTagTypeUnion =
    _test_protobuf_validateDecode("TypeTagTypeUnion")<TypeTagTypeUnion>(
        ...
        validateDecode: (input) =>
            ((
                input: Uint8Array,
            ): typia.IValidation<typia.Resolved<TypeTagTypeUnion>> => {
                const validate = (
                    input: any,
                ): typia.IValidation<TypeTagTypeUnion> => {
                    const errors = [] as any[];
                    const __is = (input: any): input is TypeTagTypeUnion => {
                        const $io0 = (input: any): boolean =>
                            ...
                            ((Math.floor(input.int32_or_double) ===
                                ...
                                (Number.isFinite(input.int32_or_double) &&
                                    true)) &&
                            ...
                            ((-1.175494351e38 <= input.float_or_double &&
                                ...
                                (Number.isFinite(input.float_or_double) &&
                                    true)) &&
                            "number" === typeof input.everything &&
                            ((Math.floor(input.everything) ===
                                input.everything &&
                                ...
                                [
                                    ("number" ===
                                        ...
                                        ((Math.floor(input.int32_or_uint32) ===
                                            ...
                                            $report(_exceptionable, {
                                                path:
                                                    _path + ".int32_or_uint32",
                                                expected:
                                                    '(number & (Type<"int32"> | Type<"uint32">))',
                                    ...
                                    ("number" ===
                                        ...
                                        ((Math.floor(input.int32_or_uint64) ===
                                            ...
                                            $report(_exceptionable, {
                                                path:
                                                    _path + ".int32_or_uint64",
                                                expected:
                                                    '(number & (Type<"int32"> | Type<"uint64">))',
                                    ...
                                    ("number" ===
                                        ...
                                        ((Math.floor(input.int32_or_double) ===
                                            ...
                                            $report(_exceptionable, {
                                                path:
                                                    _path + ".int32_or_double",
                                                expected:
                                                    '(number & (Type<"int32"> | Type<"double">))',
                                    ...
                                    ("number" ===
                                        ...
                                        ((Math.floor(input.int64_or_uint64) ===
                                            ...
                                            $report(_exceptionable, {
                                                path:
                                                    _path + ".int64_or_uint64",
                                                expected:
                                                    '(number & (Type<"int64"> | Type<"uint64">))',
                                    ...
                                    ("number" ===
                                        ...
                                        ((Number.isFinite(
                                            ...
                                            $report(_exceptionable, {
                                                path:
                                                    _path + ".int64_or_double",
                                                expected:
                                                    '(number & (Type<"double"> | Type<"int64">))',
                                    ...
                                    ("number" ===
                                        typeof input.float_or_double &&
                                        ((-1.175494351e38 <=
                                            input.float_or_double &&
                                            input.float_or_double <=
                                                3.4028235e38) ||
                                            (Number.isFinite(
                                                input.float_or_double,
                                            ...
                                            $report(_exceptionable, {
                                                path:
                                                    _path + ".float_or_double",
                                                expected:
                                                    '(number & (Type<"float"> | Type<"double">))',
