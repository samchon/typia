...
export const test_validateClone_ArrayRecursiveUnionExplicit = _test_validateClone("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<ArrayRecursiveUnionExplicit.IBucket>>> => { const validate = (input: any): typia.IValidation<Array<ArrayRecursiveUnionExplicit.IBucket>> => {
...
}; const clone = (input: Array<ArrayRecursiveUnionExplicit.IBucket>): typia.Primitive<Array<ArrayRecursiveUnionExplicit.IBucket>> => {
    ...
    output.data = clone(input); return output; })(input), ArrayRecursiveUnionExplicit.SPOILERS);
