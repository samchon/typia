...
export const test_is_FunctionalPropertyUnion = _test_is("FunctionalPropertyUnion", FunctionalPropertyUnion.generate, (input) => ((input: any): input is Array<FunctionalPropertyUnion.IUnion> => {
