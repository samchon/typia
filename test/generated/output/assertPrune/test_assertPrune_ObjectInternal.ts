...
export const test_assertPrune_ObjectInternal = _test_assertPrune("ObjectInternal", ObjectInternal.generate, (input) => ((input: any): ObjectInternal => { const assert = (input: any) => {
