...
export const test_isPrune_DynamicUnion = _test_isPrune("DynamicUnion", DynamicUnion.generate, (input) => ((input: any): input is DynamicUnion => { const is = (input: any): input is DynamicUnion => {
    ...
    return false; prune(input); return true; })(input), DynamicUnion.SPOILERS);
