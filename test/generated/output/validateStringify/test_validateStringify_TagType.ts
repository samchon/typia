...
export const test_validateStringify_TagType = _test_validateStringify("TagType", TagType.generate, (input) => ((input: Array<TagType.Type>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<TagType.Type>> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), TagType.SPOILERS);
