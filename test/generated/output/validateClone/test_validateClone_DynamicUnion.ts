...
export const test_validateClone_DynamicUnion = _test_validateClone("DynamicUnion", DynamicUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<DynamicUnion>> => { const validate = (input: any): typia.IValidation<DynamicUnion> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; })(input), DynamicUnion.SPOILERS);
