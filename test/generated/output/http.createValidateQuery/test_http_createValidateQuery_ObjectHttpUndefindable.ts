    ...
    _test_http_validateQuery("ObjectHttpUndefindable")<ObjectHttpUndefindable>(
        ...
        (
            ...
            const validate = (
                ...
                if (false === __is(input)) {
                    const $report = (
                        typia.http.createValidateQuery as any
                    ).report(errors);
                    ((
                        input: any,
                        _path: string,
            ...
            const query = (
                ...
                const $boolean = (typia.http.createValidateQuery as any)
                    .boolean;
                ...
                const output = {
                    ...
                    constantBigint:
                        $bigint(input.get("constantBigint")) ?? undefined,
                    constantNumber:
                        $number(input.get("constantNumber")) ?? undefined,
                    constantString:
                        $string(input.get("constantString")) ?? undefined,
                };
