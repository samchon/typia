...
export const test_validatePrune_ConstantConstEnumeration = _test_validatePrune("ConstantConstEnumeration", ConstantConstEnumeration.generate, (input) => ((input: any): typia.IValidation<Array<ConstantConstEnumeration.Enumeration>> => { const validate = (input: any): typia.IValidation<Array<ConstantConstEnumeration.Enumeration>> => {
    const errors = [] as any[];
