...
export const test_createAssertClone_DynamicArray = _test_assertClone("DynamicArray", DynamicArray.generate, (input: any): typia.Primitive<DynamicArray> => { const assert = (input: any): DynamicArray => {
...
}; assert(input); const output = clone(input); return output; }, DynamicArray.SPOILERS);
