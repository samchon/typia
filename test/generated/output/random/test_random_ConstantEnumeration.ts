...
export const test_random_ConstantEnumeration = _test_random("ConstantEnumeration", () => ((generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ConstantEnumeration> => {
