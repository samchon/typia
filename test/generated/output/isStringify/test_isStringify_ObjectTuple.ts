...
export const test_isStringify_ObjectTuple = _test_isStringify("ObjectTuple", ObjectTuple.generate, (input) => ((input: [ObjectTuple.ISection, ObjectTuple.ICitizen]): string | null => { const is = (input: any): input is [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
...
}; return is(input) ? stringify(input) : null; })(input), ObjectTuple.SPOILERS);
