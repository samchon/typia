...
export const test_createAssertParse_ObjectUndefined = _test_assertParse("ObjectUndefined", ObjectUndefined.generate, (input: string): typia.Primitive<ObjectUndefined> => { const assert = (input: any): ObjectUndefined => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, ObjectUndefined.SPOILERS);
