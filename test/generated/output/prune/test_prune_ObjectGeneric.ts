...
export const test_prune_ObjectGeneric = _test_prune("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]): void => {
