...
export const test_isClone_TagType = _test_isClone("TagType", TagType.generate, (input) => ((input: any): typia.Primitive<Array<TagType.Type>> | null => { const is = (input: any): input is Array<TagType.Type> => {
    ...
    return null; const output = clone(input); return output; })(input), TagType.SPOILERS);
