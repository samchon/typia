...
export const test_assertPrune_ObjectUnionNonPredictable = _test_assertPrune("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input) => ((input: any): Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>> => { const assert = (input: any): Array<ObjectUnionNonPredictable.IWrapper<ObjectUnionNonPredictable.IUnion>> => {
    ...
    if (Array.isArray(input))
        $pp0(input);
}; assert(input); prune(input); return input; })(input), ObjectUnionNonPredictable.SPOILERS);
