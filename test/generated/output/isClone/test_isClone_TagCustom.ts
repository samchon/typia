...
export const test_isClone_TagCustom = _test_isClone("TagCustom", TagCustom.generate, (input) => ((input: any): typia.Primitive<TagCustom> | null => { const is = (input: any): input is TagCustom => {
    ...
    return null; const output = clone(input); return output; })(input), TagCustom.SPOILERS);
