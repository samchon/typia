...
export const test_createValidateClone_TagAtomicUnion = _test_validateClone("TagAtomicUnion", TagAtomicUnion.generate, (input: any): typia.IValidation<typia.Primitive<TagAtomicUnion>> => { const validate = (input: any): typia.IValidation<TagAtomicUnion> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, TagAtomicUnion.SPOILERS);
