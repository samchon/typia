...
export const test_createIsPrune_ObjectUnionDouble = _test_isPrune("ObjectUnionDouble", ObjectUnionDouble.generate, (input: any): input is ObjectUnionDouble => { const is = (input: any): input is ObjectUnionDouble => {
    ...
    return false; prune(input); return true; }, ObjectUnionDouble.SPOILERS);
