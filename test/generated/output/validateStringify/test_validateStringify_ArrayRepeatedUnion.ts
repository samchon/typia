...
export const test_validateStringify_ArrayRepeatedUnion = _test_validateStringify("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input) => ((input: number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D>> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ArrayRepeatedUnion.SPOILERS);
