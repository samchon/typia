...
export const test_assertStringify_DynamicConstant = _test_assertStringify("DynamicConstant", DynamicConstant.generate, (input) => ((input: DynamicConstant): string => { const assert = (input: any) => {
