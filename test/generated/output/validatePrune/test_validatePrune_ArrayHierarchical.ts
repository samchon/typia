...
export const test_validatePrune_ArrayHierarchical = _test_validatePrune("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: any): typia.IValidation<Array<ArrayHierarchical.ICompany>> => { const validate = (input: any): typia.IValidation<Array<ArrayHierarchical.ICompany>> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ArrayHierarchical.SPOILERS);
