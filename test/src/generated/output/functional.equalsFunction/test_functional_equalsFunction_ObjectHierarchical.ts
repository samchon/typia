...
export const test_functional_equalsFunction_ObjectHierarchical =
  _test_functional_equalsFunction("ObjectHierarchical")(ObjectHierarchical)(
    (p: (input: ObjectHierarchical) => ObjectHierarchical) =>
      (input: ObjectHierarchical): ObjectHierarchical | null => {
        if (
          false ===
          ((
            input: any,
