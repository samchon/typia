...
export const test_assertPrune_DynamicTemplate = _test_assertPrune("DynamicTemplate", DynamicTemplate.generate, (input) => ((input: any): DynamicTemplate => { const assert = (input: any): DynamicTemplate => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), DynamicTemplate.SPOILERS);
