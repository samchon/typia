...
export const test_createAssertStringify_ConstantAtomicUnion = _test_assertStringify("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input: any): string => { const assert = (input: any): ConstantAtomicUnion => {
...
}; return stringify(assert(input)); }, ConstantAtomicUnion.SPOILERS);
