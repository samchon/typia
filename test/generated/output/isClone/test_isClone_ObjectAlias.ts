...
export const test_isClone_ObjectAlias = _test_isClone("ObjectAlias", ObjectAlias.generate, (input) => ((input: any): typia.Primitive<Array<ObjectAlias.IMember>> | null => { const is = (input: any): input is Array<ObjectAlias.IMember> => {
