...
export const test_createRandom_DynamicTemplate = _test_random("DynamicTemplate", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    ...
    const $ro0 = (recursive = false, depth = 0) => {
        ...
        (generator.array ?? $generator.array)(() => output[`value_${(generator.number ?? $generator.number)(0, 100)}`] = (generator.number ?? $generator.number)(0, 100), (generator.integer ?? $generator.integer)(0, 3));
    ...
    return input as typia.Primitive<DynamicTemplate>;
});
