...
export const test_assertPrune_TupleRestArray = _test_assertPrune("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): [boolean, number, ...Array<string>[]] => { const assert = (input: any): [boolean, number, ...Array<string>[]] => {
    ...
    return input;
}; const prune = (input: [boolean, number, ...Array<string>[]]): void => {
}; assert(input); prune(input); return input; })(input), TupleRestArray.SPOILERS);
