...
export const test_createIsPrune_TagObjectUnion = _test_isPrune("TagObjectUnion", TagObjectUnion.generate, (input: any): input is TagObjectUnion => { const is = (input: any): input is TagObjectUnion => {
    ...
    return false; prune(input); return true; }, TagObjectUnion.SPOILERS);
