...
export const test_validateClone_DynamicTemplate = _test_validateClone("DynamicTemplate", DynamicTemplate.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<DynamicTemplate>> => { const validate = (input: any): typia.IValidation<DynamicTemplate> => {
    ...
    output.data = clone(input); return output; })(input), DynamicTemplate.SPOILERS);
