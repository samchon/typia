...
export const test_http_validateHeaders_ObjectHttpTypeTag =
    _test_http_validateHeaders("ObjectHttpTypeTag")<ObjectHttpTypeTag>(
        ...
        ((
            ...
            const validate = (
                ...
                if (false === __is(input)) {
                    const $report = (typia.http.validateHeaders as any).report(
                        errors,
                    );
                    ((
                        input: any,
            ...
            const headers = (
                ...
                const $string = (typia.http.validateHeaders as any).string;
                const output = {
