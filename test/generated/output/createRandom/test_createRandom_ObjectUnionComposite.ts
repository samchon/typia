...
export const test_createRandom_ObjectUnionComposite = _test_random("ObjectUnionComposite", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectUnionComposite> => {
    ...
    const $ro5 = (_recursive: boolean = false, _depth: number = 0): any => ({
        ...
        inner: (generator?.array ?? $generator.array)(() => $ro4(_recursive, _recursive ? 1 + _depth : _depth))
    });
    const $ro6 = (_recursive: boolean = false, _depth: number = 0): any => ({
        outer: (generator?.array ?? $generator.array)(() => $ro0(_recursive, _recursive ? 1 + _depth : _depth)),
    ...
    const __is = (input: any): input is typia.Primitive<ObjectUnionComposite> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectUnionComposite> => {
