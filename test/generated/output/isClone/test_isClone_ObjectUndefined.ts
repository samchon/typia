...
export const test_isClone_ObjectUndefined = _test_isClone("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): typia.Primitive<ObjectUndefined> | null => { const is = (input: any): input is ObjectUndefined => {
