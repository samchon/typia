...
export const test_validate_ObjectNullable = _test_validate("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): typia.IValidation<[ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct]> => {
