...
export const test_functional_validateReturn_CommentTagRangeBigInt =
  _test_functional_validateReturn("CommentTagRangeBigInt")(
    CommentTagRangeBigInt,
  )(
    (p: (input: CommentTagRangeBigInt) => CommentTagRangeBigInt) =>
      (
        input: CommentTagRangeBigInt,
      ): import("typia").IValidation<CommentTagRangeBigInt> => {
        const result = ((
          input: any,
