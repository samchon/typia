...
export const test_isStringify_NativeUnion = _test_isStringify("NativeUnion", NativeUnion.generate, (input) => ((input: Array<NativeUnion.Union>): string | null => { const is = (input: any): input is Array<NativeUnion.Union> => {
...
}; return is(input) ? stringify(input) : null; })(input), NativeUnion.SPOILERS);
