...
export const test_notation_validateSnake_ArrayHierarchicalPointer =
    ...
    >({
        convert: (input) =>
            ((
                input: any,
            ): typia.IValidation<typia.SnakeCase<ArrayHierarchicalPointer>> => {
                const validate = (
                    input: any,
