...
export const test_assertStringify_ConstantAtomicUnion = _test_assertStringify("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ConstantAtomicUnion.Union> => {
