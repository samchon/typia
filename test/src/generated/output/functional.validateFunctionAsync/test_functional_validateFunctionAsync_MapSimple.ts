...
export const test_functional_validateFunctionAsync_MapSimple =
  _test_functional_validateFunctionAsync("MapSimple")(MapSimple)(
    (p: (input: MapSimple) => Promise<MapSimple>) =>
      async (
        input: MapSimple,
      ): Promise<import("typia").IValidation<MapSimple>> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<MapSimple> => {
          const errors = [] as any[];
          const __is = (input: any): input is MapSimple => {
            const $io0 = (input: any): boolean =>
              input.boolean instanceof Map &&
