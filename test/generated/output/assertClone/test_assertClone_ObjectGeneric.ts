...
export const test_assertClone_ObjectGeneric = _test_assertClone("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): typia.Primitive<[ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]> => { const assert = (input: any): [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
    ...
    const $co0 = (input: any): any => ({
        ...
        elements: Array.isArray(input.elements) ? input.elements.map((elem: any) => "object" === typeof elem && null !== elem ? $co1(elem) : elem as any) : input.elements as any
    });
    ...
    const $co2 = (input: any): any => ({
        ...
        elements: Array.isArray(input.elements) ? input.elements.map((elem: any) => "object" === typeof elem && null !== elem ? $co3(elem) : elem as any) : input.elements as any
    });
    ...
    const $co4 = (input: any): any => ({
        ...
        elements: Array.isArray(input.elements) ? input.elements.map((elem: any) => "object" === typeof elem && null !== elem ? $co5(elem) : elem as any) : input.elements as any
    });
