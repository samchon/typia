...
export const test_createIsClone_ArrayRepeatedUnionWithTuple = _test_isClone("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input: any): typia.Primitive<ArrayRepeatedUnionWithTuple> | null => { const is = (input: any): input is ArrayRepeatedUnionWithTuple => {
    const $ip0 = (input: any) => {
        const array = input;
    ...
    return null; const output = clone(input); return output; }, ArrayRepeatedUnionWithTuple.SPOILERS);
