...
export const test_createRandom_ConstantAtomicWrapper = _test_random("ConstantAtomicWrapper", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
