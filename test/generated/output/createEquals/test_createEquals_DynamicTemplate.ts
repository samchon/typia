...
export const test_createEquals_DynamicTemplate = _test_equals("DynamicTemplate", DynamicTemplate.generate, (input: any, _exceptionable: boolean = true): input is DynamicTemplate => {
