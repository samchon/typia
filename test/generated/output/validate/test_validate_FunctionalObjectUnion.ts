...
export const test_validate_FunctionalObjectUnion = _test_validate("FunctionalObjectUnion", FunctionalObjectUnion.generate, (input) => ((input: any): typia.IValidation<Array<FunctionalObjectUnion.Union>> => {
