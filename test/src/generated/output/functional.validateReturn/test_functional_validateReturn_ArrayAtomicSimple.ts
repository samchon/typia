...
export const test_functional_validateReturn_ArrayAtomicSimple =
  _test_functional_validateReturn("ArrayAtomicSimple")(ArrayAtomicSimple)(
    (p: (input: ArrayAtomicSimple) => ArrayAtomicSimple) =>
      (
        input: ArrayAtomicSimple,
      ): import("typia").IValidation<ArrayAtomicSimple> => {
