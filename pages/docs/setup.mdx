...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
    <Tab>
```typescript filename="src/check.ts" showLineNumbers {3}
...
```
    ...
    <Tab>
```javascript filename="bin/check.js" showLineNumbers {2-12}
import typia from "typia";
...
<Tabs items={['TypeScript Source Code', 'Generated TypeScript File']}>
    <Tab>
```typescript filename="src/templates/check.ts" showLineNumbers {5}
import typia from "typia";
...
```
    ...
    <Tab>
```typescript filename="src/generated/check.ts" showLineNumbers {3-13}
import typia from "typia";
import { IMember } from "../structures/IMember";
