...
export const test_functional_isFunction_TypeTagRange =
  _test_functional_isFunction("TypeTagRange")(TypeTagRange)(
    (p: (input: TypeTagRange) => TypeTagRange) =>
      (input: TypeTagRange): TypeTagRange | null => {
        if (
          false ===
        ...
        return ((input: any): input is TypeTagRange => {
          const $io0 = (input: any): boolean =>
            Array.isArray(input.value) &&
            input.value.every(
              (elem: any) =>
