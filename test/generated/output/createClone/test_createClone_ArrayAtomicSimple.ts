...
export const test_createClone_ArrayAtomicSimple = _test_clone("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: ArrayAtomicSimple): typia.Primitive<ArrayAtomicSimple> => {
