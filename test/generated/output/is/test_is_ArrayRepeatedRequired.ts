...
export const test_is_ArrayRepeatedRequired = _test_is("ArrayRepeatedRequired", ArrayRepeatedRequired.generate, (input) => ((input: any): input is string | number | Array<ArrayRepeatedRequired> => {
