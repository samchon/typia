...
export const test_functional_isReturn_ObjectUnionDouble =
  _test_functional_isReturn("ObjectUnionDouble")(ObjectUnionDouble)(
    (p: (input: ObjectUnionDouble) => ObjectUnionDouble) =>
      (input: ObjectUnionDouble): ObjectUnionDouble | null => {
        const result = p(input);
        return ((input: any): input is ObjectUnionDouble => {
