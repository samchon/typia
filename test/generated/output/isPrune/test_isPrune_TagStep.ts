...
export const test_isPrune_TagStep = _test_isPrune("TagStep", TagStep.generate, (input) => ((input: any): input is TagStep => { const is = (input: any): input is TagStep => {
    ...
    return false; prune(input); return true; })(input), TagStep.SPOILERS);
