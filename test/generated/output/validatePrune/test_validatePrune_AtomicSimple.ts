...
export const test_validatePrune_AtomicSimple = _test_validatePrune("AtomicSimple", AtomicSimple.generate, (input) => ((input: any): typia.IValidation<[boolean, number, string]> => { const validate = (input: any): typia.IValidation<[boolean, number, string]> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), AtomicSimple.SPOILERS);
