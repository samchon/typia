...
export const test_createIsClone_TagLength = _test_isClone("TagLength", TagLength.generate, (input: any): typia.Primitive<TagLength> | null => { const is = (input: any): input is TagLength => {
    ...
    return null; const output = clone(input); return output; }, TagLength.SPOILERS);
