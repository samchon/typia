...
export const test_createAssertEquals_FunctionalArrayUnion = _test_assertEquals("FunctionalArrayUnion", FunctionalArrayUnion.generate, (input: any): FunctionalArrayUnion => {
        ...
        const $ip0 = (input: any, _exceptionable: boolean = true) => {
            ...
            const arrayPredicators = [
                ...
                [
                    ...
                    (entire: any[]): any => entire.every((elem: any, _index8: number) => "function" === typeof elem)
                ],
                [
        ...
        ((input: any, _path: string, _exceptionable: boolean = true): input is FunctionalArrayUnion => {
            ...
            const $ap0 = (input: any, _path: string, _exceptionable: boolean = true) => {
                ...
                const arrayPredicators = [
                    ...
                    [
                        (top: any): any => "function" === typeof top,
                        (entire: any[]): any => entire.every((elem: any, _index8: number) => "function" === typeof elem || $guard(_exceptionable, {
                            path: _path + "[" + _index8 + "]",
                            expected: "unknown",
                            value: elem
                        }))
                ...
                return $guard(_exceptionable, {
                    path: _path,
                    expected: "(Array<string> | Array<number> | Array<__type> | Array<null>)",
                    value: input
                });
            };
            return (Array.isArray(input) || $guard(true, {
                ...
                path: _path + "[" + _index1 + "]",
                expected: "(Array<__type> | Array<null> | Array<number> | Array<string>)",
                value: elem
