...
export const test_createRandom_DynamicArray = _test_random("DynamicArray", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    const $generator = (typia.createRandom as any).generator;
    const $ro0 = (recursive = false, depth = 0) => {
        const output = {};
        (generator.array ?? $generator.array)(() => output[(generator.string ?? $generator.string)()] = (generator.array ?? $generator.array)(() => (generator.string ?? $generator.string)()), (generator.integer ?? $generator.integer)(0, 3));
        return output;
    };
    return $ro0();
}, (input: any) => {
    ...
    return input as typia.Primitive<DynamicArray>;
});
