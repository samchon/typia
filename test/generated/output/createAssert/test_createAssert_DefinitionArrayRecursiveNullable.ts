...
export const test_createAssert_DefinitionArrayRecursiveNullable = _test_assert("DefinitionArrayRecursiveNullable", DefinitionArrayRecursiveNullable.generate, (input: any): DefinitionArrayRecursiveNullable => {
