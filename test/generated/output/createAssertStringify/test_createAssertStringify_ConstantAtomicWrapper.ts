...
export const test_createAssertStringify_ConstantAtomicWrapper = _test_assertStringify("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input: any): string => { const assert = (input: any): ConstantAtomicWrapper => {
...
}; return stringify(assert(input)); }, ConstantAtomicWrapper.SPOILERS);
