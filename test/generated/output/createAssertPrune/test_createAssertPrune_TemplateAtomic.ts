...
export const test_createAssertPrune_TemplateAtomic = _test_assertPrune("TemplateAtomic", TemplateAtomic.generate, (input: any): TemplateAtomic => { const assert = (input: any) => {
