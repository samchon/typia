...
export const test_assertClone_ArrayHierarchical = _test_assertClone("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: any): typia.Primitive<ArrayHierarchical> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as ArrayHierarchical; })(input), ArrayHierarchical.SPOILERS);
