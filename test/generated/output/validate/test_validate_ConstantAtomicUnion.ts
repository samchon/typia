...
export const test_validate_ConstantAtomicUnion = _test_validate("ConstantAtomicUnion", ConstantAtomicUnion.generate, (input) => ((input: any): typia.IValidation<Array<ConstantAtomicUnion.Union>> => {
