...
export const test_assertStringify_ConstantAtomicSimple = _test_assertStringify("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input) => ((input: ConstantAtomicSimple): string => { const assert = (input: any) => {
