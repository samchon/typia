...
export const test_assertStringify_AtomicUnion = _test_assertStringify("AtomicUnion", AtomicUnion.generate, (input) => ((input: AtomicUnion): string => { const assert = (input: any) => {
