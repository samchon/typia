...
export const test_llm_applicationEquals_chatgpt_ObjectUnionExplicitPointer = (): void =>
  _test_llm_applicationEquals({
    model: "chatgpt",
    name: "ObjectUnionExplicitPointer",
    factory: ObjectUnionExplicitPointer
  })(
    typia.llm.application<ObjectUnionExplicitPointerApplication, "chatgpt", { equals: true }>(),
  );
