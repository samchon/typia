...
// TypeName exposes the analyzer's human-readable type string so callers can
// conservatively gate rewrites before schema analysis succeeds.
func TypeName(checker *shimchecker.Checker, t *shimchecker.Type) string {
	return typeName(checker, t)
}
