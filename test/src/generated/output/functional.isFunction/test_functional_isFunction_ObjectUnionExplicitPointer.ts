...
export const test_functional_isFunction_ObjectUnionExplicitPointer =
  _test_functional_isFunction("ObjectUnionExplicitPointer")(
    ObjectUnionExplicitPointer,
  )(
    (p: (input: ObjectUnionExplicitPointer) => ObjectUnionExplicitPointer) =>
      (
        input: ObjectUnionExplicitPointer,
      ): ObjectUnionExplicitPointer | null => {
        if (
          false ===
        ...
        return ((input: any): input is ObjectUnionExplicitPointer => {
          const $io0 = (input: any): boolean =>
            Array.isArray(input.value) &&
            input.value.every(
              (elem: any) =>
