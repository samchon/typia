...
export const test_createValidateParse_ObjectPropertyNullable = _test_validateParse("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input: string): typia.IValidation<typia.Primitive<ObjectPropertyNullable>> => { const validate = (input: any): typia.IValidation<ObjectPropertyNullable> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, ObjectPropertyNullable.SPOILERS);
