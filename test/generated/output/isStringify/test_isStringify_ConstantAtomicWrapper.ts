...
export const test_isStringify_ConstantAtomicWrapper = _test_isStringify("ConstantAtomicWrapper", ConstantAtomicWrapper.generate, (input) => ((input: ConstantAtomicWrapper): string | null => { const is = (input: any): input is ConstantAtomicWrapper => {
