...
export const test_createValidateParse_ArrayRecursive = _test_validateParse("ArrayRecursive", ArrayRecursive.generate, (input: string): typia.IValidation<typia.Primitive<ArrayRecursive>> => { const validate = (input: any): typia.IValidation<ArrayRecursive> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; }, ArrayRecursive.SPOILERS);
