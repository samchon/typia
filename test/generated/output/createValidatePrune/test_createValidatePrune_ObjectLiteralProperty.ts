...
export const test_createValidatePrune_ObjectLiteralProperty = _test_validatePrune("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any): typia.IValidation<ISomething> => { const validate = (input: any): typia.IValidation<ISomething> => {
    const errors = [] as any[];
