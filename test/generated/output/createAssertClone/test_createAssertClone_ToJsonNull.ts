...
export const test_createAssertClone_ToJsonNull = _test_assertClone("ToJsonNull", ToJsonNull.generate, (input: any): typia.Primitive<ToJsonNull> => { const assert = (input: any): ToJsonNull => {
