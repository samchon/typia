...
export const test_createAssertStringify_ToJsonTuple = _test_assertStringify("ToJsonTuple", ToJsonTuple.generate, (input: ToJsonTuple): string => { const assert = (input: any) => {
