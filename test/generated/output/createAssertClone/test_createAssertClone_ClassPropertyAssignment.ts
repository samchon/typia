...
export const test_createAssertClone_ClassPropertyAssignment = _test_assertClone("ClassPropertyAssignment", ClassPropertyAssignment.generate, (input: any): typia.Primitive<ClassPropertyAssignment> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ClassPropertyAssignment */; return output as ClassPropertyAssignment; }, ClassPropertyAssignment.SPOILERS);
