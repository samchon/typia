...
export const test_validateEquals_ObjectUnionDouble = _test_validateEquals("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): typia.IValidation<ObjectUnionDouble> => {
    const errors = [] as any[];
