...
export const test_isClone_NativeAlias = _test_isClone("NativeAlias", NativeAlias.generate, (input) => ((input: any): typia.Primitive<NativeAlias> | null => { const is = (input: any): input is NativeAlias => {
