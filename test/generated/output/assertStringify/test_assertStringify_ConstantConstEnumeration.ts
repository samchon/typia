...
export const test_assertStringify_ConstantConstEnumeration = _test_assertStringify("ConstantConstEnumeration", ConstantConstEnumeration.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ConstantConstEnumeration.Enumeration> => {
