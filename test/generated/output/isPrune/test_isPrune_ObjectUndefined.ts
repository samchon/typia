...
export const test_isPrune_ObjectUndefined = _test_isPrune("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): input is ObjectUndefined => { const is = (input: any): input is ObjectUndefined => {
