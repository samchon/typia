...
export const test_createValidatePrune_DynamicTemplate = _test_validatePrune("DynamicTemplate", DynamicTemplate.generate, (input: any): typia.IValidation<DynamicTemplate> => { const validate = (input: any): typia.IValidation<DynamicTemplate> => {
    ...
    prune(input); return output; }, DynamicTemplate.SPOILERS);
