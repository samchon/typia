...
export const test_createIsClone_NativeSimple = _test_isClone("NativeSimple", NativeSimple.generate, (input: any): typia.Primitive<NativeSimple> | null => { const is = (input: any): input is NativeSimple => {
    ...
    return null; const output = clone(input); return output; }, NativeSimple.SPOILERS);
