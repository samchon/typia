...
export const test_assertPrune_TagLength = _test_assertPrune("TagLength", TagLength.generate, (input) => ((input: any): Array<TagLength.Type> => { const assert = (input: any): Array<TagLength.Type> => {
