...
export const test_createAssertStringify_ObjectUnionImplicit = _test_assertStringify("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: any): string => { const assert = (input: any): ObjectUnionImplicit => {
...
}; return stringify(assert(input)); }, ObjectUnionImplicit.SPOILERS);
