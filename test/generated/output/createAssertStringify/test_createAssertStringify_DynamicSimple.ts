...
export const test_createAssertStringify_DynamicSimple = _test_assertStringify("DynamicSimple", DynamicSimple.generate, (input: any): string => { const assert = (input: any): DynamicSimple => {
