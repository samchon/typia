...
export const test_createAssertPrune_ArrayHierarchical = _test_assertPrune("ArrayHierarchical", ArrayHierarchical.generate, (input: any): ArrayHierarchical => { const assert = (input: any) => {
