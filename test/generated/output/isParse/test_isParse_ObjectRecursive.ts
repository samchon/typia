...
export const test_isParse_ObjectRecursive = _test_isParse("ObjectRecursive", ObjectRecursive.generate, (input) => ((input: any): typia.Primitive<IDepartment> => { const is = (input: any): input is IDepartment => {
