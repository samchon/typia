...
export const test_isClone_ToJsonTuple = _test_isClone("ToJsonTuple", ToJsonTuple.generate, (input) => ((input: any): typia.Primitive<[ToJsonTuple.IToJson<string>, ToJsonTuple.IToJson<number>, ToJsonTuple.IToJson<boolean>, ToJsonTuple.IObject]> | null => { const is = (input: any): input is [ToJsonTuple.IToJson<string>, ToJsonTuple.IToJson<number>, ToJsonTuple.IToJson<boolean>, ToJsonTuple.IObject] => {
