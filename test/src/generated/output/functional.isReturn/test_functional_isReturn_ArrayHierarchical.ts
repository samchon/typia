...
export const test_functional_isReturn_ArrayHierarchical =
  _test_functional_isReturn("ArrayHierarchical")(ArrayHierarchical)(
    (p: (input: ArrayHierarchical) => ArrayHierarchical) =>
      (input: ArrayHierarchical): ArrayHierarchical | null => {
