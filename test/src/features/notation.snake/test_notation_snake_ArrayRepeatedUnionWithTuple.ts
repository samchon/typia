...
export const test_notation_validateSnake_ArrayRepeatedUnionWithTuple = (): void =>
    ...
    convert: (input) => typia.notations.validateSnake<ArrayRepeatedUnionWithTuple>(input),
