...
export const test_createAssertClone_ObjectUnionNonPredictable = _test_assertClone("ObjectUnionNonPredictable", ObjectUnionNonPredictable.generate, (input: any): typia.Primitive<ObjectUnionNonPredictable> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as ObjectUnionNonPredictable; }, ObjectUnionNonPredictable.SPOILERS);
