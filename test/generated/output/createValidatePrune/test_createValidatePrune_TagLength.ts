...
export const test_createValidatePrune_TagLength = _test_validatePrune("TagLength", TagLength.generate, (input: any): typia.IValidation<TagLength> => { const validate = (input: any): typia.IValidation<TagLength> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, TagLength.SPOILERS);
