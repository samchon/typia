...
export const test_assertClone_SetSimple = _test_assertClone("SetSimple", SetSimple.generate, (input) => ((input: any): typia.Primitive<SetSimple> => { const assert = (input: any): SetSimple => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is SetSimple => {
            const $guard = (typia.assertClone as any).guard;
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ((input.booleans instanceof Set || $guard(_exceptionable, {
                path: _path + ".booleans",
                expected: "Set<boolean>",
                value: input.booleans
            })) && (() => [...input.booleans].every((elem: any, _index1: number) => "boolean" === typeof elem || $guard(_exceptionable, {
                ...
                expected: "Set<boolean>",
                value: input.booleans
            })) && ((input.numbers instanceof Set || $guard(_exceptionable, {
                path: _path + ".numbers",
                expected: "Set<number>",
                value: input.numbers
            })) && (() => [...input.numbers].every((elem: any, _index2: number) => "number" === typeof elem && Number.isFinite(elem) || $guard(_exceptionable, {
                ...
                expected: "Set<number>",
                value: input.numbers
            })) && ((input.strings instanceof Set || $guard(_exceptionable, {
                path: _path + ".strings",
                expected: "Set<string>",
                value: input.strings
            })) && (() => [...input.strings].every((elem: any, _index3: number) => "string" === typeof elem || $guard(_exceptionable, {
                ...
                expected: "Set<string>",
                value: input.strings
            })) && ((input.arrays instanceof Set || $guard(_exceptionable, {
                path: _path + ".arrays",
                ...
                value: elem
            })) && elem.every((elem: any, _index5: number) => "number" === typeof elem && Number.isFinite(elem) || $guard(_exceptionable, {
                ...
                expected: "Set<Array<number>>",
                value: input.arrays
            })) && ((input.objects instanceof Set || $guard(_exceptionable, {
                path: _path + ".objects",
                expected: "Set<SetSimple.Person>",
                value: input.objects
            })) && (() => [...input.objects].every((elem: any, _index6: number) => ("object" === typeof elem && null !== elem || $guard(_exceptionable, {
                path: _path + ".objects[" + _index6 + "]",
                expected: "SetSimple.Person",
                value: elem
            })) && $ao1(elem, _path + ".objects[" + _index6 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".objects[" + _index6 + "]",
                expected: "SetSimple.Person",
                value: elem
            })))() || $guard(_exceptionable, {
...
}; assert(input); const output = clone(input); return output; })(input), SetSimple.SPOILERS);
