...
func TestJsonStringifyProgrammerCoverage(t *testing.T) {
	...
	if jsonStringifyProgrammer_decode_functional(nativeinternal.FeatureProgrammer_IExplore{From: "array"}, emit).Text() != "null" ||
		jsonStringifyProgrammer_decode_functional(explore, emit).Text() != "undefined" {
	...
	}{Context: nativecontext.ITypiaContext{}, Input: input, Metadata: functional, Explore: explore, Expression: value}) == nil {
	...
	if jsonStringifyProgrammer_wrap_required(struct {
		...
		Explore    nativeinternal.FeatureProgrammer_IExplore
		Expression *shimast.Node
	}{Context: nativecontext.ITypiaContext{}, Input: input, Metadata: stringMeta, Explore: explore, Expression: value}) != value ||
		jsonStringifyProgrammer_wrap_required(struct {
			...
			Explore    nativeinternal.FeatureProgrammer_IExplore
			Expression *shimast.Node
		}{Context: nativecontext.ITypiaContext{}, Input: input, Metadata: optional, Explore: nativeinternal.FeatureProgrammer_IExplore{From: "array"}, Expression: value}) == nil {
