...
export const test_validateClone_ObjectTuple = _test_validateClone("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectTuple>> => { const validate = (input: any): typia.IValidation<ObjectTuple> => {
    const errors = [] as any[];
