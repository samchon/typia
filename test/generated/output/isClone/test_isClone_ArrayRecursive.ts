...
export const test_isClone_ArrayRecursive = _test_isClone("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): typia.Primitive<ArrayRecursive.ICategory> | null => { const is = (input: any): input is ArrayRecursive.ICategory => {
