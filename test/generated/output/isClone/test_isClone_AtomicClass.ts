...
export const test_isClone_AtomicClass = _test_isClone("AtomicClass", AtomicClass.generate, (input) => ((input: any): typia.Primitive<AtomicClass> | null => { const is = (input: any): input is AtomicClass => {
