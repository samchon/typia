...
export const test_createAssertEquals_ObjectUnionExplicit = _test_assertEquals("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: any): ObjectUnionExplicit => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ObjectUnionExplicit => {
            ...
            })) && $ao2(input.centroid, _path + ".centroid", true && _exceptionable) && ("number" === typeof input.radius && Number.isFinite(input.radius) || $guard(_exceptionable, {
                path: _path + ".radius",
                expected: "number",
                value: input.radius
