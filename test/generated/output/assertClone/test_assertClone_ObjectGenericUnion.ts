...
export const test_assertClone_ObjectGenericUnion = _test_assertClone("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.Primitive<ISaleEntireArticle> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectGenericUnion.ISaleEntireArticle */; return output as ISaleEntireArticle; })(input), ObjectGenericUnion.SPOILERS);
