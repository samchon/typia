...
export type TagRangeBigInt = IPointer<TagRangeBigInt.Type[]>;
export namespace TagRangeBigInt {
    ...
    // prettier-ignore
    export function generate(): TagRangeBigInt {
        const value: Type[] = [];
    ...
    export const SPOILERS: Spoiler<TagRangeBigInt>[] = [
        (input) => {
