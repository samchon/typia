...
export const test_createValidateStringify_ArrayAtomicSimple = _test_validateStringify("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: ArrayAtomicSimple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayAtomicSimple> => {
    ...
    output.data = stringify(input); return output; }, ArrayAtomicSimple.SPOILERS);
