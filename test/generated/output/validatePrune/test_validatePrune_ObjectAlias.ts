...
export const test_validatePrune_ObjectAlias = _test_validatePrune("ObjectAlias", ObjectAlias.generate, (input) => ((input: any): typia.IValidation<Array<ObjectAlias.IMember>> => { const validate = (input: any): typia.IValidation<Array<ObjectAlias.IMember>> => {
    const errors = [] as any[];
