...
export const test_createAssertParse_ArrayAtomicSimple = _test_assertParse("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: string): typia.Primitive<ArrayAtomicSimple> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, ArrayAtomicSimple.SPOILERS);
