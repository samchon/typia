...
export const test_isStringify_ArrayRecursive = _test_isStringify("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: ICategory): string | null => { const is = (input: any): input is ICategory => {
