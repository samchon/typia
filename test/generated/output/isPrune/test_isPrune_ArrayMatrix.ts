...
export const test_isPrune_ArrayMatrix = _test_isPrune("ArrayMatrix", ArrayMatrix.generate, (input) => ((input: any): input is ArrayMatrix => { const is = (input: any): input is ArrayMatrix => {
