...
export const test_equals_ObjectUndefined = _test_equals("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any, _exceptionable: boolean = true): input is Array<ObjectUndefined.ILecture> => {
