...
export const test_createValidateEquals_ObjectGeneric = _test_validateEquals("ObjectGeneric", ObjectGeneric.generate, (input: any): typia.IValidation<ObjectGeneric> => {
    const errors = [] as any[];
