...
export const test_validateStringify_ArrayRecursive = _test_validateStringify("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: ArrayRecursive.ICategory): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayRecursive.ICategory> => {
    ...
    output.data = stringify(input); return output; })(input), ArrayRecursive.SPOILERS);
