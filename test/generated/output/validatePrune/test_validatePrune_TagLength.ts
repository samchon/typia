...
export const test_validatePrune_TagLength = _test_validatePrune("TagLength", TagLength.generate, (input) => ((input: any): typia.IValidation<Array<TagLength.Type>> => { const validate = (input: any): typia.IValidation<Array<TagLength.Type>> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), TagLength.SPOILERS);
