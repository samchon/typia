...
export const test_json_assertParse_TagCustom = _test_json_assertParse(
    "TagCustom",
)<TagCustom>(TagCustom)((input: string): typia.Primitive<TagCustom> => {
    const assert = (input: any): TagCustom => {
        const __is = (input: any): input is TagCustom => {
            const $is_uuid = (typia.json.createAssertParse as any).is_uuid;
            const $is_custom = (typia.json.createAssertParse as any).is_custom;
            return (
                "object" === typeof input &&
                null !== input &&
        ...
        if (false === __is(input))
            ((
                ...
                const $is_uuid = (typia.json.createAssertParse as any).is_uuid;
                const $is_custom = (typia.json.createAssertParse as any)
                    .is_custom;
                const $ao0 = (
                    input: any,
                    _path: string,
