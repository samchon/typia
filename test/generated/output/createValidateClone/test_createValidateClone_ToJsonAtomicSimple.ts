...
export const test_createValidateClone_ToJsonAtomicSimple = _test_validateClone("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input: any): typia.IValidation<typia.Primitive<ToJsonAtomicSimple>> => { const validate = (input: any): typia.IValidation<ToJsonAtomicSimple> => {
    const errors = [] as any[];
