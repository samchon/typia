...
export const test_validateClone_NativeUnion = _test_validateClone("NativeUnion", NativeUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<NativeUnion>> => { const validate = (input: any): typia.IValidation<NativeUnion> => {
    const errors = [] as any[];
