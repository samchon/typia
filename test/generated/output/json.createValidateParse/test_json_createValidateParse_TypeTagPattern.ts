...
export const test_json_createValidateParse_TypeTagPattern =
    _test_json_validateParse("TypeTagPattern")<TypeTagPattern>(TypeTagPattern)(
        (input: string): typia.IValidation<typia.Primitive<TypeTagPattern>> => {
            const validate = (
                input: any,
            ): typia.IValidation<TypeTagPattern> => {
                const errors = [] as any[];
