...
export const test_notation_createValidateSnake_ObjectDate =
  _test_notation_validateGeneral("ObjectDate")<ObjectDate>(ObjectDate)<
    typia.SnakeCase<ObjectDate>
  >({
    convert: (input: any): typia.IValidation<typia.SnakeCase<ObjectDate>> => {
      ...
      const general = (input: ObjectDate): typia.SnakeCase<ObjectDate> => {
