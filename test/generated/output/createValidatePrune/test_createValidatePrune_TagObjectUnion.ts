...
export const test_createValidatePrune_TagObjectUnion = _test_validatePrune("TagObjectUnion", TagObjectUnion.generate, (input: any): typia.IValidation<TagObjectUnion> => { const validate = (input: any): typia.IValidation<TagObjectUnion> => {
    ...
    prune(input); return output; }, TagObjectUnion.SPOILERS);
