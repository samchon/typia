...
export const test_notation_createValidateCamel_ObjectSimpleProtobufOptional = (): void =>
    ...
    convert: typia.notations.createValidateCamel<ObjectSimpleProtobufOptional>(),
