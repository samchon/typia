...
export const test_validatePrune_TagStep = _test_validatePrune("TagStep", TagStep.generate, (input) => ((input: any): typia.IValidation<Array<TagStep.Type>> => { const validate = (input: any): typia.IValidation<Array<TagStep.Type>> => {
    const errors = [] as any[];
