...
export const test_createIsParse_ObjectGeneric = _test_isParse("ObjectGeneric", ObjectGeneric.generate, (input: any): typia.Primitive<ObjectGeneric> => { const is = (input: any): input is ObjectGeneric => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; }, ObjectGeneric.SPOILERS);
