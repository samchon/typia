...
export const test_createAssertStringify_ObjectRecursive = _test_assertStringify("ObjectRecursive", ObjectRecursive.generate, (input: IDepartment): string => { const assert = (input: any) => {
