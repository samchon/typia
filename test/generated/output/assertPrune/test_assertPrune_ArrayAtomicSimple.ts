...
export const test_assertPrune_ArrayAtomicSimple = _test_assertPrune("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: any): [Array<boolean>, Array<number>, Array<string>] => { const assert = (input: any): [Array<boolean>, Array<number>, Array<string>] => {
...
}; assert(input); prune(input); return input; })(input), ArrayAtomicSimple.SPOILERS);
