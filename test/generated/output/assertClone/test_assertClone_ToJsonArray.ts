...
export const test_assertClone_ToJsonArray = _test_assertClone("ToJsonArray", ToJsonArray.generate, (input) => ((input: any): typia.Primitive<ToJsonArray> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ToJsonArray */; return output as ToJsonArray; })(input));
