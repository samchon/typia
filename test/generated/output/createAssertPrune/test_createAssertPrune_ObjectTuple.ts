...
export const test_createAssertPrune_ObjectTuple = _test_assertPrune("ObjectTuple", ObjectTuple.generate, (input: any): ObjectTuple => { const assert = (input: any): ObjectTuple => {
...
}; assert(input); prune(input); return input; }, ObjectTuple.SPOILERS);
