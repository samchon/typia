...
export const test_createRandom_ObjectOptional = _test_random("ObjectOptional", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectOptional> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectOptional> => {
