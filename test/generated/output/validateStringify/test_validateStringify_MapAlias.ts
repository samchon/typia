...
export const test_validateStringify_MapAlias = _test_validateStringify("MapAlias", MapAlias.generate, (input) => ((input: MapSimple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<MapSimple> => {
    const errors = [] as any[];
