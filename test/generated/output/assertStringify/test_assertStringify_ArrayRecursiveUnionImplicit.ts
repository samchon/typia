...
export const test_assertStringify_ArrayRecursiveUnionImplicit = _test_assertStringify("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: any): string => { const assert = (input: any): Array<ArrayRecursiveUnionImplicit.IBucket> => {
...
}; return stringify(assert(input)); })(input), ArrayRecursiveUnionImplicit.SPOILERS);
