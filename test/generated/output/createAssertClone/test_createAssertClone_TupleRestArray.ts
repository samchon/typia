...
export const test_createAssertClone_TupleRestArray = _test_assertClone("TupleRestArray", TupleRestArray.generate, (input: any): typia.Primitive<TupleRestArray> => { const assert = (input: any): TupleRestArray => {
...
}; assert(input); const output = clone(input); return output; }, TupleRestArray.SPOILERS);
