...
export const test_createAssertStringify_ArrayRecursiveUnionExplicit = _test_assertStringify("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input: any): string => { const assert = (input: any): ArrayRecursiveUnionExplicit => {
...
}; return stringify(assert(input)); }, ArrayRecursiveUnionExplicit.SPOILERS);
