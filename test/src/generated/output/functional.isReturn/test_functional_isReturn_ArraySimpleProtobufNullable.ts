...
export const test_functional_isReturn_ArraySimpleProtobufNullable =
  _test_functional_isReturn("ArraySimpleProtobufNullable")(
    ArraySimpleProtobufNullable,
  )(
    (p: (input: ArraySimpleProtobufNullable) => ArraySimpleProtobufNullable) =>
      (
        input: ArraySimpleProtobufNullable,
      ): ArraySimpleProtobufNullable | null => {
