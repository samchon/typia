...
export const test_validatePrune_TupleRestArray = _test_validatePrune("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): typia.IValidation<[boolean, number, ...Array<string>[]]> => { const validate = (input: any): typia.IValidation<[boolean, number, ...Array<string>[]]> => {
