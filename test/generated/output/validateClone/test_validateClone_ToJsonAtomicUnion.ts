...
export const test_validateClone_ToJsonAtomicUnion = _test_validateClone("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<ToJsonAtomicUnion.IToJson>>> => { const validate = (input: any): typia.IValidation<Array<ToJsonAtomicUnion.IToJson>> => {
    const errors = [] as any[];
