...
export const test_createValidatePrune_TemplateConstant = _test_validatePrune("TemplateConstant", TemplateConstant.generate, (input: any): typia.IValidation<TemplateConstant> => { const validate = (input: any): typia.IValidation<TemplateConstant> => {
    ...
    prune(input); return output; }, TemplateConstant.SPOILERS);
