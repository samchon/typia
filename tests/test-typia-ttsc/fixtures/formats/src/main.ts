...
export const email = (x: unknown) =>
  typia.is<string & tags.Format<"email">>(x);
...
export const ipv4 = (x: unknown) =>
  typia.is<string & tags.Format<"ipv4">>(x);
export const ipv6 = (x: unknown) =>
  typia.is<string & tags.Format<"ipv6">>(x);
export const uri = (x: unknown) =>
  typia.is<string & tags.Format<"uri">>(x);
...
export const iri = (x: unknown) =>
  typia.is<string & tags.Format<"iri">>(x);
export const iriRef = (x: unknown) =>
  typia.is<string & tags.Format<"iri-reference">>(x);
export const url = (x: unknown) =>
  typia.is<string & tags.Format<"url">>(x);
export const uuid = (x: unknown) =>
  typia.is<string & tags.Format<"uuid">>(x);
export const byte = (x: unknown) =>
  typia.is<string & tags.Format<"byte">>(x);
...
export const time = (x: unknown) =>
  typia.is<string & tags.Format<"time">>(x);
