...
export const test_createRandom_ObjectInternal = _test_random("ObjectInternal", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectInternal> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ObjectInternal> => {
