...
export const test_createAssertClone_TupleRestAtomic = _test_assertClone("TupleRestAtomic", TupleRestAtomic.generate, (input: any): typia.Primitive<TupleRestAtomic> => { const assert = (input: any): TupleRestAtomic => {
...
}; assert(input); const output = clone(input); return output; }, TupleRestAtomic.SPOILERS);
