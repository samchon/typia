...
export const test_createValidateClone_ObjectSimple = _test_validateClone("ObjectSimple", ObjectSimple.generate, (input: any): typia.IValidation<typia.Primitive<ObjectSimple>> => { const validate = (input: any): typia.IValidation<ObjectSimple> => {
    ...
    output.data = clone(input); return output; }, ObjectSimple.SPOILERS);
