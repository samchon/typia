...
export const test_llm_json_parse_lenient_findJsonStart_junk_prefix =
  (): void => {
    ...
    if (r7.success) TestValidator.equals("trail-arr-data", r7.data, [1, 2, 3]);
    ...
    if (r10.success)
      TestValidator.equals("simple-obj-prefix-data", r10.data, {
        name: "John",
      });
    ...
    if (r12.success)
      TestValidator.equals("decorative-prefix-data", r12.data, {
        key: "value",
      });
