...
export const test_validateParse_ObjectSimple = _test_validateParse("ObjectSimple", ObjectSimple.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ObjectSimple>> => { const validate = (input: any): typia.IValidation<ObjectSimple> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ObjectSimple.SPOILERS);
