...
export const test_createEquals_FunctionalArrayUnion = _test_equals("FunctionalArrayUnion", FunctionalArrayUnion.generate, (input: any, _exceptionable: boolean): input is FunctionalArrayUnion => {
