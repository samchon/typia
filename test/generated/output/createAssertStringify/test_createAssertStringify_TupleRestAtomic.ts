...
export const test_createAssertStringify_TupleRestAtomic = _test_assertStringify("TupleRestAtomic", TupleRestAtomic.generate, (input: TupleRestAtomic): string => { const assert = (input: any) => {
