...
export const test_createEquals_FunctionalPropertyUnion = _test_equals("FunctionalPropertyUnion", FunctionalPropertyUnion.generate, (input: any, _exceptionable: boolean): input is FunctionalPropertyUnion => {
