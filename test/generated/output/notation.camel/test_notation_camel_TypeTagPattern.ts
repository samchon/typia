...
export const test_notation_validateCamel_TypeTagPattern =
  _test_notation_validateGeneral("TypeTagPattern")<TypeTagPattern>(
    ...
    convert: (input) =>
      ((input: any): typia.IValidation<typia.CamelCase<TypeTagPattern>> => {
    ...
    assert: (input: any): typia.CamelCase<TypeTagPattern> => {
      const __is = (input: any): input is typia.CamelCase<TypeTagPattern> => {
        return (
          "object" === typeof input &&
          null !== input &&
          "string" === typeof (input as any).uuid &&
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.CamelCase<TypeTagPattern> => {
