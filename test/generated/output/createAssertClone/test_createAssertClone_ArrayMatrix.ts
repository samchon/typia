...
export const test_createAssertClone_ArrayMatrix = _test_assertClone("ArrayMatrix", ArrayMatrix.generate, (input: any): typia.Primitive<ArrayMatrix> => { const assert = (input: any): ArrayMatrix => {
...
}; assert(input); const output = clone(input); return output; }, ArrayMatrix.SPOILERS);
