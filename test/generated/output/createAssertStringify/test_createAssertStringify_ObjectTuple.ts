...
export const test_createAssertStringify_ObjectTuple = _test_assertStringify("ObjectTuple", ObjectTuple.generate, (input: any): string => { const assert = (input: any): ObjectTuple => {
...
}; return stringify(assert(input)); }, ObjectTuple.SPOILERS);
