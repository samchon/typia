...
export const test_validateClone_ObjectPrimitive = _test_validateClone("ObjectPrimitive", ObjectPrimitive.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectPrimitive.IArticle>> => { const validate = (input: any): typia.IValidation<ObjectPrimitive.IArticle> => {
...
}; const clone = (input: ObjectPrimitive.IArticle): typia.Primitive<ObjectPrimitive.IArticle> => {
    const $io1 = (input: any): boolean => "string" === typeof input.id && "string" === typeof input.name && "string" === typeof input.extension && "string" === typeof input.url && "string" === typeof input.created_at;
    const $co0 = (input: any): any => ({
        ...
        files: Array.isArray(input.files) ? input.files.map((elem: any) => "object" === typeof elem && null !== elem ? $co1(elem) : elem as any) : input.files as any,
    ...
    output.data = clone(input); return output; })(input), ObjectPrimitive.SPOILERS);
