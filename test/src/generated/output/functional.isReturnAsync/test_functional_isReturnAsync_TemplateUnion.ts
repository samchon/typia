...
export const test_functional_isReturnAsync_TemplateUnion =
  _test_functional_isReturnAsync("TemplateUnion")(TemplateUnion)(
    (p: (input: TemplateUnion) => Promise<TemplateUnion>) =>
      async (input: TemplateUnion): Promise<TemplateUnion | null> => {
        const result = await p(input);
        return ((input: any): input is TemplateUnion => {
