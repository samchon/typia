...
export const test_isClone_ToJsonAtomicUnion = _test_isClone("ToJsonAtomicUnion", ToJsonAtomicUnion.generate, (input) => ((input: any): typia.Primitive<ToJsonAtomicUnion> | null => { const is = (input: any): input is ToJsonAtomicUnion => {
