...
export const test_createAssertStringify_NativeAlias = _test_assertStringify("NativeAlias", NativeAlias.generate, (input: any): string => { const assert = (input: any): NativeAlias => {
