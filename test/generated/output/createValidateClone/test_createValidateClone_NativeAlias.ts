...
export const test_createValidateClone_NativeAlias = _test_validateClone("NativeAlias", NativeAlias.generate, (input: any): typia.IValidation<typia.Primitive<NativeAlias>> => { const validate = (input: any): typia.IValidation<NativeAlias> => {
    ...
    output.data = clone(input); return output; }, NativeAlias.SPOILERS);
