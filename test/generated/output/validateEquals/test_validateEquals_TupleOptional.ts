...
export const test_validateEquals_TupleOptional = _test_validateEquals("TupleOptional", TupleOptional.generate, (input) => ((input: any): typia.IValidation<Array<[number, boolean, string, (number | null | undefined)?, (string | null | undefined)?]>> => {
    const __is = (input: any, _exceptionable: boolean = true): input is Array<[number, boolean, string, (number | null | undefined)?, (string | null | undefined)?]> => {
