...
export const test_createIsClone_MapSimple = _test_isClone("MapSimple", MapSimple.generate, (input: any): typia.Primitive<MapSimple> | null => { const is = (input: any): input is MapSimple => {
    ...
    return null; const output = clone(input); return output; }, MapSimple.SPOILERS);
