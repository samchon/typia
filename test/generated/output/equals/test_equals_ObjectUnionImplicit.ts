...
export const test_equals_ObjectUnionImplicit = _test_equals("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: any, _exceptionable: boolean): input is ObjectUnionImplicit => {
