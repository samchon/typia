...
export const test_validateEquals_FunctionalArrayUnion = _test_validateEquals("FunctionalArrayUnion", FunctionalArrayUnion.generate, (input) => ((input: any): typia.IValidation<Array<FunctionalArrayUnion.Union>> => {
    const __is = (input: any, _exceptionable: boolean = true): input is Array<FunctionalArrayUnion.Union> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Array<FunctionalArrayUnion.Union> => {
