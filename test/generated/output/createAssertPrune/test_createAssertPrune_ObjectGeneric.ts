...
export const test_createAssertPrune_ObjectGeneric = _test_assertPrune("ObjectGeneric", ObjectGeneric.generate, (input: any): ObjectGeneric => { const assert = (input: any) => {
