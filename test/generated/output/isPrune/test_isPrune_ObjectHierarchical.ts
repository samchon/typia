...
export const test_isPrune_ObjectHierarchical = _test_isPrune("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): input is ICustomer => { const is = (input: any): input is ICustomer => {
