...
export const test_createAssertPrune_TagFormat = _test_assertPrune("TagFormat", TagFormat.generate, (input: any): TagFormat => { const assert = (input: any): TagFormat => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, TagFormat.SPOILERS);
