...
export const test_functional_validateFunction_ObjectPropertyNullable =
  _test_functional_validateFunction("ObjectPropertyNullable")(
    ObjectPropertyNullable,
  )(
    (p: (input: ObjectPropertyNullable) => ObjectPropertyNullable) =>
      (
        input: ObjectPropertyNullable,
      ): import("typia").IValidation<ObjectPropertyNullable> => {
        const paramResults = [
