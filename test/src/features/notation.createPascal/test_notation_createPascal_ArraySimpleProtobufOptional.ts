...
export const test_notation_createValidatePascal_ArraySimpleProtobufOptional = (): void =>
    ...
    convert: typia.notations.createValidatePascal<ArraySimpleProtobufOptional>(),
