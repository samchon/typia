...
export const test_createRandom_ConstantAtomicSimple = _test_random("ConstantAtomicSimple", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    return [
        false,
        true,
        2,
