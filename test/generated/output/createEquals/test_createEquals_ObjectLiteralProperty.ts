...
export const test_createEquals_ObjectLiteralProperty = _test_equals("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any, _exceptionable: boolean): input is ISomething => {
