...
export const test_notation_createValidatePascal_ArrayAtomicAlias =
    _test_notation_validateGeneral("ArrayAtomicAlias")<ArrayAtomicAlias>(
        ArrayAtomicAlias,
    )<typia.PascalCase<ArrayAtomicAlias>>({
        convert: (
            input: any,
        ): typia.IValidation<typia.PascalCase<ArrayAtomicAlias>> => {
            const validate = (
                input: any,
                ...
                if (false === __is(input)) {
                    const $report = (
                        typia.notations.createValidatePascal as any
                    ).report(errors);
                    ((
                        input: any,
                        _path: string,
        ...
        assert: (input: any): typia.PascalCase<ArrayAtomicAlias> => {
            const __is = (
                input: any,
