...
export interface SetAlias {
  ...
  objects: SetAlias_Person[];
}

export interface SetAlias_Person {
  id: string;
  name: string;
  age: number;
}
...
export const SetAlias = {
  encode(message: SetAlias, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.objects) {
      SetAlias_Person.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SetAlias {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.objects.push(SetAlias_Person.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromJSON(object: any): SetAlias {
    return {
      ...
      arrays: Array.isArray(object?.arrays)
        ...
        : [],
      objects: Array.isArray(object?.objects) ? object.objects.map((e: any) => SetAlias_Person.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: SetAlias): unknown {
    ...
    if (message.objects) {
      obj.objects = message.objects.map((e) => e ? SetAlias_Person.toJSON(e) : undefined);
    } else {
      obj.objects = [];
    }
    return obj;
  ...
  create<I extends Exact<DeepPartial<SetAlias>, I>>(base?: I): SetAlias {
    return SetAlias.fromPartial(base ?? {});
  },
  ...
  fromPartial<I extends Exact<DeepPartial<SetAlias>, I>>(object: I): SetAlias {
    ...
    message.objects = object.objects?.map((e) => SetAlias_Person.fromPartial(e)) || [];
    return message;
  },
};

function createBaseSetAlias_Person(): SetAlias_Person {
  return { id: "", name: "", age: 0 };
}

export const SetAlias_Person = {
  encode(message: SetAlias_Person, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SetAlias_Person {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSetAlias_Person();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): SetAlias_Person {
    return {
  ...
  toJSON(message: SetAlias_Person): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<SetAlias_Person>, I>>(base?: I): SetAlias_Person {
    return SetAlias_Person.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<SetAlias_Person>, I>>(object: I): SetAlias_Person {
    const message = createBaseSetAlias_Person();
