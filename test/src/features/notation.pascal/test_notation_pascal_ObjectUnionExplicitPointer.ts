...
export const test_notation_validatePascal_ObjectUnionExplicitPointer = (): void =>
    ...
    convert: (input) => typia.notations.validatePascal<ObjectUnionExplicitPointer>(input),
