...
export const test_assertParse_ArrayRepeatedUnionWithTuple = _test_assertParse("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input) => ((input: string): typia.Primitive<ArrayRepeatedUnionWithTuple> => { const assert = (input: any): ArrayRepeatedUnionWithTuple => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; })(input), ArrayRepeatedUnionWithTuple.SPOILERS);
