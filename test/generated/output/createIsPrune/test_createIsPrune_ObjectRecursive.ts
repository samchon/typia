...
export const test_createIsPrune_ObjectRecursive = _test_isPrune("ObjectRecursive", ObjectRecursive.generate, (input: any): input is IDepartment => { const is = (input: any): input is IDepartment => {
