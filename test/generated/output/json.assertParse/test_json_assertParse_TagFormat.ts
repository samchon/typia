        ...
        ((input: string): typia.Primitive<TagFormat> => {
            const assert = (input: any): TagFormat => {
                const __is = (input: any): input is TagFormat => {
                    const $is_uuid = (typia.json.assertParse as any).is_uuid;
                    const $is_email = (typia.json.assertParse as any).is_email;
                    const $is_url = (typia.json.assertParse as any).is_url;
                    const $is_ipv4 = (typia.json.assertParse as any).is_ipv4;
                    const $is_ipv6 = (typia.json.assertParse as any).is_ipv6;
                    const $is_date = (typia.json.assertParse as any).is_date;
                    const $is_datetime = (typia.json.assertParse as any)
                        .is_datetime;
                    return (
                        "object" === typeof input &&
                        null !== input &&
                ...
                if (false === __is(input))
                    ((
                        ...
                        const $is_uuid = (typia.json.assertParse as any)
                            .is_uuid;
                        const $is_email = (typia.json.assertParse as any)
                            .is_email;
                        const $is_url = (typia.json.assertParse as any).is_url;
                        const $is_ipv4 = (typia.json.assertParse as any)
                            .is_ipv4;
                        const $is_ipv6 = (typia.json.assertParse as any)
                            .is_ipv6;
                        const $is_date = (typia.json.assertParse as any)
                            .is_date;
                        const $is_datetime = (typia.json.assertParse as any)
                            .is_datetime;
                        const $ao0 = (
