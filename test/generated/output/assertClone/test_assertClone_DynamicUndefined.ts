...
export const test_assertClone_DynamicUndefined = _test_assertClone("DynamicUndefined", DynamicUndefined.generate, (input) => ((input: any): typia.Primitive<DynamicUndefined> => { const assert = (input: any): DynamicUndefined => {
...
}; assert(input); const output = clone(input); return output; })(input), DynamicUndefined.SPOILERS);
