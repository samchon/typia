...
export const test_validateEquals_AtomicAlias = _test_validateEquals("AtomicAlias", AtomicAlias.generate, (input) => ((input: any): typia.IValidation<[boolean, number, string]> => {
    const errors = [] as any[];
