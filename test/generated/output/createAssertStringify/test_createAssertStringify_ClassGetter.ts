...
export const test_createAssertStringify_ClassGetter = _test_assertStringify("ClassGetter", ClassGetter.generate, (input: any): string => { const assert = (input: any): ClassGetter => {
