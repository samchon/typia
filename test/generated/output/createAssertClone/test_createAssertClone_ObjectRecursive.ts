...
export const test_createAssertClone_ObjectRecursive = _test_assertClone("ObjectRecursive", ObjectRecursive.generate, (input: any): typia.Primitive<IDepartment> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectRecursive.IDepartment */; return output as IDepartment; }, ObjectRecursive.SPOILERS);
