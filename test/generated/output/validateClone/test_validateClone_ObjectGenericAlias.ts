...
export const test_validateClone_ObjectGenericAlias = _test_validateClone("ObjectGenericAlias", ObjectGenericAlias.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Alias>> => { const validate = (input: any): typia.IValidation<Alias> => {
    const errors = [] as any[];
