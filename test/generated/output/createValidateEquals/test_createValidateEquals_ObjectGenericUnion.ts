...
export const test_createValidateEquals_ObjectGenericUnion = _test_validateEquals("ObjectGenericUnion", ObjectGenericUnion.generate, (input: any): typia.IValidation<ISaleEntireArticle> => {
    const errors = [] as any[];
