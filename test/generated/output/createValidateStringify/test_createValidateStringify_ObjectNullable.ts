...
export const test_createValidateStringify_ObjectNullable = _test_validateStringify("ObjectNullable", ObjectNullable.generate, (input: ObjectNullable): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectNullable> => {
    ...
    output.data = stringify(input); return output; }, ObjectNullable.SPOILERS);
