...
export const test_validatePrune_TagType = _test_validatePrune("TagType", TagType.generate, (input) => ((input: any): typia.IValidation<TagType> => { const validate = (input: any): typia.IValidation<TagType> => {
    const errors = [] as any[];
