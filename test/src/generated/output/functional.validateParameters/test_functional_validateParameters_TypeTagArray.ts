...
export const test_functional_validateParameters_TypeTagArray =
  _test_functional_validateParameters("TypeTagArray")(TypeTagArray)(
    (p: (input: TypeTagArray) => TypeTagArray) =>
      (input: TypeTagArray): import("typia").IValidation<TypeTagArray> => {
        const paramResults = [
