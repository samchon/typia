...
export const test_notation_validateCamel_ObjectUnionComposite =
  _test_notation_validateGeneral("ObjectUnionComposite")<ObjectUnionComposite>(
    ...
    convert: (input) =>
      ((
        input: any,
      ): typia.IValidation<typia.CamelCase<ObjectUnionComposite>> => {
        const validate = (
          input: any,
    ...
    assert: (input: any): typia.CamelCase<ObjectUnionComposite> => {
      const __is = (
        input: any,
      ): input is typia.CamelCase<ObjectUnionComposite> => {
        const $io0 = (input: any): boolean =>
          "number" === typeof input.x &&
          Number.isFinite(input.x) &&
          "number" === typeof input.y &&
