...
export const test_createIsStringify_NativeUnion = _test_isStringify("NativeUnion", NativeUnion.generate, (input: NativeUnion): string | null => { const is = (input: any): input is NativeUnion => {
...
}; return is(input) ? stringify(input) : null; }, NativeUnion.SPOILERS);
