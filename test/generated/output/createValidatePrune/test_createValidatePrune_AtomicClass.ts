...
export const test_createValidatePrune_AtomicClass = _test_validatePrune("AtomicClass", AtomicClass.generate, (input: any): typia.IValidation<AtomicClass> => { const validate = (input: any): typia.IValidation<AtomicClass> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, AtomicClass.SPOILERS);
