...
export const test_createIsPrune_ObjectNullable = _test_isPrune("ObjectNullable", ObjectNullable.generate, (input: any): input is ObjectNullable => { const is = (input: any): input is ObjectNullable => {
    ...
    return false; prune(input); return true; }, ObjectNullable.SPOILERS);
