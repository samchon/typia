...
export const test_isStringify_TagArray = _test_isStringify("TagArray", TagArray.generate, (input) => ((input: Array<TagArray.Type>): string | null => { const is = (input: any): input is Array<TagArray.Type> => {
