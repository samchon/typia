...
export const test_assertClone_ObjectUnionDouble = _test_assertClone("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): typia.Primitive<Array<ObjectUnionDouble.Union>> => { const assert = (input: any): Array<ObjectUnionDouble.Union> => {
...
}; assert(input); const output = clone(input); return output; })(input), ObjectUnionDouble.SPOILERS);
