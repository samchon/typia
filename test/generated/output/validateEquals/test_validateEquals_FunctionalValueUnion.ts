...
export const test_validateEquals_FunctionalValueUnion = _test_validateEquals("FunctionalValueUnion", FunctionalValueUnion.generate, (input) => ((input: any): typia.IValidation<FunctionalValueUnion> => {
    const errors = [] as any[];
