...
export const test_isPrune_TagArray = _test_isPrune("TagArray", TagArray.generate, (input) => ((input: any): input is Array<TagArray.Type> => { const is = (input: any): input is Array<TagArray.Type> => {
    ...
    return false; prune(input); return true; })(input), TagArray.SPOILERS);
