...
export const test_assertEquals_ObjectTuple = _test_assertEquals("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
