...
export const test_createAssertPrune_ConstantAtomicSimple = _test_assertPrune("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input: any): ConstantAtomicSimple => { const assert = (input: any): ConstantAtomicSimple => {
...
}; assert(input); prune(input); return input; }, ConstantAtomicSimple.SPOILERS);
