...
export const test_createAssertParse_ObjectUndefined = _test_assertParse("ObjectUndefined", ObjectUndefined.generate, (input: string): typia.Primitive<ObjectUndefined> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, ObjectUndefined.SPOILERS);
