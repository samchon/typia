...
export const test_functional_validateEqualsReturn_ArrayRecursive =
  _test_functional_validateEqualsReturn("ArrayRecursive")(ArrayRecursive)(
    (p: (input: ArrayRecursive) => ArrayRecursive) =>
      (input: ArrayRecursive): import("typia").IValidation<ArrayRecursive> => {
        const result = ((
          input: any,
