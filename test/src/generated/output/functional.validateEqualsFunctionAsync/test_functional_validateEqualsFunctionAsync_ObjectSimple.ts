...
export const test_functional_validateEqualsFunctionAsync_ObjectSimple =
  _test_functional_validateEqualsFunctionAsync("ObjectSimple")(ObjectSimple)(
    (p: (input: ObjectSimple) => Promise<ObjectSimple>) =>
      async (
        input: ObjectSimple,
      ): Promise<import("typia").IValidation<ObjectSimple>> => {
        const paramResults = [
