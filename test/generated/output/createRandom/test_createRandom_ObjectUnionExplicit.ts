...
export const test_createRandom_ObjectUnionExplicit = _test_random("ObjectUnionExplicit", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    ...
    return input as typia.Primitive<ObjectUnionExplicit>;
});
