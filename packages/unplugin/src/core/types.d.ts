...
export declare function wrap<T extends Tagged<PropertyKey, any>>(value: UnwrapTagged<T>): T;
export declare function unwrap<T extends Tagged<PropertyKey, any>>(value: T): UnwrapTagged<T>;
