...
export const test_createValidateClone_ArrayAny = _test_validateClone("ArrayAny", ArrayAny.generate, (input: any): typia.IValidation<typia.Primitive<ArrayAny>> => { const validate = (input: any): typia.IValidation<ArrayAny> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; }, ArrayAny.SPOILERS);
