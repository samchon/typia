...
export const test_llm_json_parse_lenient_comments = (): void => {
  ...
  if (r1.success)
    TestValidator.equals("single-line-after-value-data", r1.data, {
      name: "test",
    });
  ...
  if (r2.success)
    TestValidator.equals("multi-line-between-data", r2.data, { name: "test" });
  ...
  if (r8.success)
    TestValidator.equals("comment-in-string-data", r8.data, {
  ...
  if (r9.success)
    TestValidator.equals("multiline-in-string-data", r9.data, {
