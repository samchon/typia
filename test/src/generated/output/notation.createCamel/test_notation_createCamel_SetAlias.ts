...
export const test_notation_createValidateCamel_SetAlias =
  ...
  >({
    convert: (input: any): typia.IValidation<typia.CamelCase<SetAlias>> => {
      ...
      const general = (input: SetAlias): typia.CamelCase<SetAlias> => {
        const $io1 = (input: any): boolean =>
          "string" === typeof input.id &&
          "string" === typeof input.name &&
          "number" === typeof input.age;
    ...
    assert: (input: any): typia.CamelCase<SetAlias> => {
      const __is = (input: any): input is typia.CamelCase<SetAlias> => {
        const $io0 = (input: any): boolean =>
          input.booleans instanceof Set &&
          (() =>
            [...input.booleans].every(
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.CamelCase<SetAlias> => {
          // @ts-ignore;
