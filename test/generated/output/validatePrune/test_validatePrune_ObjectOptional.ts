...
export const test_validatePrune_ObjectOptional = _test_validatePrune("ObjectOptional", ObjectOptional.generate, (input) => ((input: any): typia.IValidation<ObjectOptional> => { const validate = (input: any): typia.IValidation<ObjectOptional> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ObjectOptional.SPOILERS);
