...
export const test_createAssertClone_DynamicTree = _test_assertClone("DynamicTree", DynamicTree.generate, (input: any): typia.Primitive<DynamicTree> => { const assert = (input: any): DynamicTree => {
...
}; assert(input); const output = clone(input); return output; }, DynamicTree.SPOILERS);
