...
export const test_validateStringify_ArrayRecursiveUnionImplicit = _test_validateStringify("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input) => ((input: Array<ArrayRecursiveUnionImplicit.IBucket>): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Array<ArrayRecursiveUnionImplicit.IBucket>> => {
    const __is = (input: any): input is Array<ArrayRecursiveUnionImplicit.IBucket> => {
...
}; const stringify = (input: Array<ArrayRecursiveUnionImplicit.IBucket>): string => {
    ...
    const $so0 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"children":${`[${input.children.map((elem: any) => $su0(elem)).join(",")}]`}}`;
    const $so1 = (input: any): any => `{"access":${(() => {
    ...
    const $so2 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"width":${$number(input.width)},"height":${$number(input.height)},"url":${$string(input.url)},"size":${$number(input.size)}}`;
    const $so3 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"size":${$number(input.size)},"content":${$string(input.content)}}`;
    const $so4 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"size":${$number(input.size)},"count":${$number(input.count)}}`;
    const $so5 = (input: any): any => `{"id":${$number(input.id)},"name":${$string(input.name)},"path":${$string(input.path)},"target":${$su0(input.target)}}`;
