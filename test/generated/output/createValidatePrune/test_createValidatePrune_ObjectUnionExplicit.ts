...
export const test_createValidatePrune_ObjectUnionExplicit = _test_validatePrune("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: any): typia.IValidation<ObjectUnionExplicit> => { const validate = (input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ObjectUnionExplicit.SPOILERS);
