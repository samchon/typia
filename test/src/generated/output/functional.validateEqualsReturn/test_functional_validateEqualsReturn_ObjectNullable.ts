...
export const test_functional_validateEqualsReturn_ObjectNullable =
  _test_functional_validateEqualsReturn("ObjectNullable")(ObjectNullable)(
    (p: (input: ObjectNullable) => ObjectNullable) =>
      (input: ObjectNullable): import("typia").IValidation<ObjectNullable> => {
        const result = ((input: any): typia.IValidation<ObjectNullable> => {
          const errors = [] as any[];
          const __is = (
            input: any,
