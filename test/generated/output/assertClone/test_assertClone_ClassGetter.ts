...
export const test_assertClone_ClassGetter = _test_assertClone("ClassGetter", ClassGetter.generate, (input) => ((input: any): typia.Primitive<Person> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ClassGetter.Person */; return output as Person; })(input), ClassGetter.SPOILERS);
