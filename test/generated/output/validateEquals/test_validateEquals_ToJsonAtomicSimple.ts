...
export const test_validateEquals_ToJsonAtomicSimple = _test_validateEquals("ToJsonAtomicSimple", ToJsonAtomicSimple.generate, (input) => ((input: any): typia.IValidation<[ToJsonAtomicSimple.IToJson<boolean>, ToJsonAtomicSimple.IToJson<number>, ToJsonAtomicSimple.IToJson<string>]> => {
    const errors = [] as any[];
