...
export const test_createClone_DefinitionJsonValue = _test_clone("DefinitionJsonValue", DefinitionJsonValue.generate, (input: DefinitionJsonValue): typia.Primitive<DefinitionJsonValue> => {
