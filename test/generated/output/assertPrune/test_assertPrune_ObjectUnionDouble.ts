...
export const test_assertPrune_ObjectUnionDouble = _test_assertPrune("ObjectUnionDouble", ObjectUnionDouble.generate, (input) => ((input: any): Array<ObjectUnionDouble.Union> => { const assert = (input: any): Array<ObjectUnionDouble.Union> => {
...
}; assert(input); prune(input); return input; })(input), ObjectUnionDouble.SPOILERS);
