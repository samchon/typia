...
export const test_createAssertStringify_TagArray = _test_assertStringify("TagArray", TagArray.generate, (input: TagArray): string => { const assert = (input: any) => {
...
}; return stringify(assert(input)); }, TagArray.SPOILERS);
