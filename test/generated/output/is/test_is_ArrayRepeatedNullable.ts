...
export const test_is_ArrayRepeatedNullable = _test_is("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input) => ((input: any): input is string | number | Array<ArrayRepeatedNullable> | null => {
