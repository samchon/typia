...
export const test_isPrune_TagTuple = _test_isPrune("TagTuple", TagTuple.generate, (input) => ((input: any): input is TagTuple => { const is = (input: any): input is TagTuple => {
    ...
    return false; prune(input); return true; })(input), TagTuple.SPOILERS);
