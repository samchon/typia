...
export const test_validateStringify_TupleRestAtomic = _test_validateStringify("TupleRestAtomic", TupleRestAtomic.generate, (input) => ((input: [boolean, number, ...string[]]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[boolean, number, ...string[]]> => {
    const errors = [] as any[];
