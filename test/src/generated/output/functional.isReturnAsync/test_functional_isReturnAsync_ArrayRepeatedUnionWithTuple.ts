...
export const test_functional_isReturnAsync_ArrayRepeatedUnionWithTuple =
  _test_functional_isReturnAsync("ArrayRepeatedUnionWithTuple")(
    ...
    (
      ...
      async (
        ...
        return ((input: any): input is ArrayRepeatedUnionWithTuple => {
          const $ip0 = (input: any) => {
            const array = input;
