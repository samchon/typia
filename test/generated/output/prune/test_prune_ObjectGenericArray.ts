...
export const test_prune_ObjectGenericArray = _test_prune("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: ObjectGenericArray.IPage<ObjectGenericArray.IPerson>): void => {
