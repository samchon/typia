...
func EmitHttpParameterArrowFunction(schema *metadata.Schema) (string, error) {
	...
	// Union / nullable wiring simplified — Phase 0 accepts the first atomic.
...
//
// Phase 0 supports top-level object shapes with atomic or array-of-atomic
// property values — the common HTTP-query case.
