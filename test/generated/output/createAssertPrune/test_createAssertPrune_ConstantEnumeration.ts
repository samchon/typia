...
export const test_createAssertPrune_ConstantEnumeration = _test_assertPrune("ConstantEnumeration", ConstantEnumeration.generate, (input: any): ConstantEnumeration => { const assert = (input: any) => {
