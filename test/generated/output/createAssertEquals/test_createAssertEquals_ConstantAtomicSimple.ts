...
export const test_createAssertEquals_ConstantAtomicSimple = _test_assertEquals("ConstantAtomicSimple", ConstantAtomicSimple.generate, (input: any): ConstantAtomicSimple => {
