...
export const test_assertClone_DynamicUnion = _test_assertClone("DynamicUnion", DynamicUnion.generate, (input) => ((input: any): typia.Primitive<DynamicUnion> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* DynamicUnion */; return output as DynamicUnion; })(input), DynamicUnion.SPOILERS);
