...
export const test_validateStringify_SetAlias = _test_validateStringify("SetAlias", SetAlias.generate, (input) => ((input: SetAlias): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<SetAlias> => {
