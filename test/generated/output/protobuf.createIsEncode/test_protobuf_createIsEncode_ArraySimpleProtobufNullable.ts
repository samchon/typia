...
export const test_protobuf_isEncode_ArraySimpleProtobufNullable =
    _test_protobuf_isEncode(
        ...
        isEncode: (input: ArraySimpleProtobufNullable): Uint8Array | null => {
            ...
            const encode = (input: ArraySimpleProtobufNullable): Uint8Array => {
        ...
        decode: (input: Uint8Array): ArraySimpleProtobufNullable => {
