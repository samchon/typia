...
export const test_validate_ObjectIntersection = _test_validate("ObjectIntersection", ObjectIntersection.generate, (input) => ((input: any): typia.IValidation<ObjectIntersection.IEmail & ObjectIntersection.IName> => {
    const errors = [] as any[];
