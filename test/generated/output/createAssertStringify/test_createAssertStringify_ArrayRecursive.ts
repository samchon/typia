...
export const test_createAssertStringify_ArrayRecursive = _test_assertStringify("ArrayRecursive", ArrayRecursive.generate, (input: any): string => { const assert = (input: any): ArrayRecursive => {
    ...
    return $so0(input);
}; return stringify(assert(input)); }, ArrayRecursive.SPOILERS);
