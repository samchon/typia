...
export const test_createIsPrune_TemplateConstant = _test_isPrune("TemplateConstant", TemplateConstant.generate, (input: any): input is TemplateConstant => { const is = (input: any): input is TemplateConstant => {
    ...
    return false; prune(input); return true; }, TemplateConstant.SPOILERS);
