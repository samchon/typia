...
export const test_createValidateClone_ArrayRecursiveUnionExplicit = _test_validateClone("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input: any): typia.IValidation<typia.Primitive<ArrayRecursiveUnionExplicit>> => { const validate = (input: any): typia.IValidation<ArrayRecursiveUnionExplicit> => {
    ...
    output.data = clone(input); return output; }, ArrayRecursiveUnionExplicit.SPOILERS);
