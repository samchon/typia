...
export const test_assertStringify_AtomicClass = _test_assertStringify("AtomicClass", AtomicClass.generate, (input) => ((input: AtomicClass): string => { const assert = (input: any) => {
