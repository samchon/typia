...
export const test_createAssertPrune_TagAtomicUnion = _test_assertPrune("TagAtomicUnion", TagAtomicUnion.generate, (input: any): TagAtomicUnion => { const assert = (input: any) => {
