...
export const test_createAssertParse_ArraySimple = _test_assertParse("ArraySimple", ArraySimple.generate, (input: string): typia.Primitive<ArraySimple> => { const assert = (input: any): ArraySimple => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, ArraySimple.SPOILERS);
