...
export const test_protobuf_isDecode_TagFormat = _test_protobuf_isDecode(
    ...
    isDecode: (input: Uint8Array): typia.Resolved<TagFormat> | null => {
        const is = (input: any): input is TagFormat => {
            ...
            const $is_ipv6 = (typia.protobuf.createIsDecode as any).is_ipv6;
            const $is_date = (typia.protobuf.createIsDecode as any).is_date;
            const $is_datetime = (typia.protobuf.createIsDecode as any)
                .is_datetime;
            return (
                "object" === typeof input &&
                null !== input &&
