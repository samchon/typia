...
<Tabs items={["TypeScript Source Code", "Compiled JavaScript"]}>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/src/llm/parameters.ts"
      filename="example/src/llm/parameters.ts"
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <RemoteSource 
      url="https://raw.githubusercontent.com/samchon/typia/refs/heads/master/examples/bin/llm/parameters.js"
