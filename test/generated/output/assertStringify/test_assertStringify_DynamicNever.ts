...
export const test_assertStringify_DynamicNever = _test_assertStringify("DynamicNever", DynamicNever.generate, (input) => ((input: any): string => { const assert = (input: any): DynamicNever => {
