...
export const test_functional_validateReturn_TypeTagRange =
  _test_functional_validateReturn("TypeTagRange")(TypeTagRange)(
    (p: (input: TypeTagRange) => TypeTagRange) =>
      (input: TypeTagRange): import("typia").IValidation<TypeTagRange> => {
