...
export const test_assertClone_ClassPropertyAssignment = _test_assertClone("ClassPropertyAssignment", ClassPropertyAssignment.generate, (input) => ((input: any): typia.Primitive<ClassPropertyAssignment> => { const assert = (input: any): ClassPropertyAssignment => {
...
}; assert(input); const output = clone(input); return output; })(input), ClassPropertyAssignment.SPOILERS);
