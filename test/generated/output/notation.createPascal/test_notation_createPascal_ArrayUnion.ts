...
export const test_notation_createValidatePascal_ArrayUnion =
    _test_notation_validateGeneral("ArrayUnion")<ArrayUnion>(ArrayUnion)<
        typia.PascalCase<ArrayUnion>
    >({
        convert: (
            input: any,
        ): typia.IValidation<typia.PascalCase<ArrayUnion>> => {
            ...
            const general = (
                ...
                const $throws = (typia.notations.createValidatePascal as any)
                    .throws;
                const $cp0 = (input: any) => {
                    const array = input;
                    const top = input[0];
