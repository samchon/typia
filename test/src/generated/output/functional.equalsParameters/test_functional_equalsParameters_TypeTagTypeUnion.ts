...
export const test_functional_equalsParameters_TypeTagTypeUnion =
  _test_functional_equalsParameters("TypeTagTypeUnion")(TypeTagTypeUnion)(
    (p: (input: TypeTagTypeUnion) => TypeTagTypeUnion) =>
      (input: TypeTagTypeUnion): TypeTagTypeUnion | null => {
        if (
          false ===
          ((
            input: any,
