...
export const test_validateClone_ClassPropertyAssignment = _test_validateClone("ClassPropertyAssignment", ClassPropertyAssignment.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ClassPropertyAssignment>> => { const validate = (input: any): typia.IValidation<ClassPropertyAssignment> => {
    ...
    output.data = clone(input); return output; })(input), ClassPropertyAssignment.SPOILERS);
