...
export const test_validateStringify_ToJsonDouble = _test_validateStringify("ToJsonDouble", ToJsonDouble.generate, (input) => ((input: Parent): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<Parent> => {
    const errors = [] as any[];
