...
export const test_protobuf_encode_CommentTagFormat = _test_protobuf_encode(
  "CommentTagFormat",
)<CommentTagFormat>(CommentTagFormat)({
  encode: (input) =>
    ((input: CommentTagFormat): Uint8Array => {
  ...
  decode: (input: Uint8Array): import("typia").Resolved<CommentTagFormat> => {
