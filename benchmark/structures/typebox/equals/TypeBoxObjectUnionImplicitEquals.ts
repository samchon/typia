...
export const __TypeBoxObjectUnionImplicitEquals = Type.Array(Union);
export const TypeBoxObjectUnionImplicitEquals = TypeCompiler.Compile(
    __TypeBoxObjectUnionImplicitEquals,
);
