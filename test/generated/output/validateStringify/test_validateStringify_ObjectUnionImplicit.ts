...
export const test_validateStringify_ObjectUnionImplicit = _test_validateStringify("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: ObjectUnionImplicit): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ObjectUnionImplicit> => {
    const errors = [] as any[];
