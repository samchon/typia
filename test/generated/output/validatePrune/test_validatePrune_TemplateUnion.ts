...
export const test_validatePrune_TemplateUnion = _test_validatePrune("TemplateUnion", TemplateUnion.generate, (input) => ((input: any): typia.IValidation<Array<TemplateUnion.Type>> => { const validate = (input: any): typia.IValidation<Array<TemplateUnion.Type>> => {
    ...
    prune(input); return output; })(input), TemplateUnion.SPOILERS);
