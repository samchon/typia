...
export const test_notation_validateSnake_TupleRestArray =
  _test_notation_validateGeneral("TupleRestArray")<TupleRestArray>(
    ...
    convert: (input) =>
      ((input: any): typia.IValidation<typia.SnakeCase<TupleRestArray>> => {
    ...
    assert: (input: any): typia.SnakeCase<TupleRestArray> => {
      const __is = (input: any): input is typia.SnakeCase<TupleRestArray> => {
        return (
          Array.isArray(input) &&
          input.every(
            (elem: any) =>
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.SnakeCase<TupleRestArray> => {
