...
export const test_assertStringify_ObjectTuple = _test_assertStringify("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): string => { const assert = (input: any): [ObjectTuple.ISection, ObjectTuple.ICitizen] => {
    ...
    return input;
}; const stringify = (input: [ObjectTuple.ISection, ObjectTuple.ICitizen]): string => {
...
}; return stringify(assert(input)); })(input), ObjectTuple.SPOILERS);
