...
export const test_isClone_TagObjectUnion = _test_isClone("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): typia.Primitive<Array<TagObjectUnion.Type>> | null => { const is = (input: any): input is Array<TagObjectUnion.Type> => {
    ...
    return null; const output = clone(input); return output; })(input), TagObjectUnion.SPOILERS);
