...
export const test_functional_validateReturn_TypeTagFormat =
  _test_functional_validateReturn("TypeTagFormat")(TypeTagFormat)(
    (p: (input: TypeTagFormat) => TypeTagFormat) =>
      (input: TypeTagFormat): import("typia").IValidation<TypeTagFormat> => {
