...
export const test_validateClone_ObjectGenericArray = _test_validateClone("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>>> => { const validate = (input: any): typia.IValidation<ObjectGenericArray.IPage<ObjectGenericArray.IPerson>> => {
    const errors = [] as any[];
