...
export const test_createAssertClone_TagType = _test_assertClone("TagType", TagType.generate, (input: any): typia.Primitive<TagType> => { const assert = (input: any): TagType => {
...
}; assert(input); const output = clone(input); return output; }, TagType.SPOILERS);
