...
export const test_notation_validateSnake_MapAlias =
  _test_notation_validateGeneral("MapAlias")<MapAlias>(MapAlias)<
    typia.SnakeCase<MapAlias>
  >({
    convert: (input) =>
      ((input: any): typia.IValidation<typia.SnakeCase<MapAlias>> => {
        ...
        const general = (input: MapAlias): typia.SnakeCase<MapAlias> => {
          const $io1 = (input: any): boolean =>
            "string" === typeof input.id &&
            "string" === typeof input.name &&
            "number" === typeof input.age;
    ...
    assert: (input: any): typia.SnakeCase<MapAlias> => {
      const __is = (input: any): input is typia.SnakeCase<MapAlias> => {
        const $io0 = (input: any): boolean =>
          input.boolean instanceof Map &&
          (() =>
            [...input.boolean].every(
