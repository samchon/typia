...
export const test_notation_validatePascal_ArrayMatrix =
  _test_notation_validateGeneral("ArrayMatrix")<ArrayMatrix>(ArrayMatrix)<
    typia.PascalCase<ArrayMatrix>
  >({
    convert: (input) =>
      ((input: any): typia.IValidation<typia.PascalCase<ArrayMatrix>> => {
        ...
        const general = (input: ArrayMatrix): typia.PascalCase<ArrayMatrix> => {
