...
const Circle = t.type({
    ...
    radius: t.number,
    area: t.union([t.undefined, t.number]),
});
const Line = t.type({
    p1: Point,
    p2: Point,
    distance: t.union([t.undefined, t.number]),
});
const Triangle = t.type({
    p1: Point,
    p2: Point,
    p3: Point,
    width: t.union([t.undefined, t.number]),
    height: t.union([t.undefined, t.number]),
    area: t.union([t.undefined, t.number]),
});
...
const Polyline = t.type({
    ...
    length: t.union([t.undefined, t.number]),
});
