...
export const test_equals_TagDefault = _test_equals("TagDefault")<TagDefault>(
    TagDefault,
)((input: any, _exceptionable: boolean = true): input is TagDefault => {
    ...
    const $io0 = (input: any, _exceptionable: boolean = true): boolean =>
        ...
        (("string" === typeof input.union_but_number &&
            ...
            ("number" === typeof input.union_but_number &&
                ...
                $is_custom("default", "number", "1", input.union_but_number)) ||
            "boolean" === typeof input.union_but_number) &&
        (("string" === typeof input.union_but_string &&
            $is_custom("default", "string", "two", input.union_but_string)) ||
