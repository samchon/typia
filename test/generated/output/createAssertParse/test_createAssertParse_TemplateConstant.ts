...
export const test_createAssertParse_TemplateConstant = _test_assertParse("TemplateConstant", TemplateConstant.generate, (input: string): typia.Primitive<TemplateConstant> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, TemplateConstant.SPOILERS);
