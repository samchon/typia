...
export const test_createValidateClone_DynamicComposite = _test_validateClone("DynamicComposite", DynamicComposite.generate, (input: any): typia.IValidation<typia.Primitive<DynamicComposite>> => { const validate = (input: any): typia.IValidation<DynamicComposite> => {
    ...
    output.data = clone(input); return output; }, DynamicComposite.SPOILERS);
