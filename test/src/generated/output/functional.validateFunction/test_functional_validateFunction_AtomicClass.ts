...
export const test_functional_validateFunction_AtomicClass =
  _test_functional_validateFunction("AtomicClass")(AtomicClass)(
    (p: (input: AtomicClass) => AtomicClass) =>
      (input: AtomicClass): import("typia").IValidation<AtomicClass> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<AtomicClass> => {
          const errors = [] as any[];
          const __is = (input: any): input is AtomicClass => {
            return (
              Array.isArray(input) &&
