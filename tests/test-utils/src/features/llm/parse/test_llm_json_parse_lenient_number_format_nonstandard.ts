...
export const test_llm_json_parse_lenient_number_format_nonstandard =
  (): void => {
    ...
    TestEquality.equals("dot-five-success", r1.success, false);
    if (!r1.success)
      TestEquality.subset(
        "dot-five-errors",
    ...
    TestEquality.equals("plus-five-success", r2.success, false);
    if (!r2.success)
      TestEquality.subset(
        "plus-five-errors",
        [{ expected: "JSON value" }, { expected: "string key" }],
    ...
    TestEquality.equals("multi-dot-success", r3.success, false);
    if (!r3.success) {
      TestEquality.subset(
        "multi-dot-errors",
        [{ expected: "string key" }],
      ...
      TestEquality.equals("multi-dot-data", (r3.data as any).val, 1.2);
    }
    ...
    TestEquality.equals("multi-exp-success", r4.success, false);
    if (!r4.success) {
      TestEquality.subset("multi-exp-errors", [{ expected: "':'" }], r4.errors);
      TestEquality.equals("multi-exp-data", (r4.data as any).val, 100);
    }
    ...
    TestEquality.equals("hex-success", r5.success, false);
    if (!r5.success) {
      TestEquality.subset("hex-errors", [{ expected: "':'" }], r5.errors);
      TestEquality.equals("hex-data", (r5.data as any).val, 0);
    }

    // Octal: 0o77
    // Same as hex: reads "0", stops at "o"
    const r6 = LlmJson.parse('{"val": 0o77}');
    TestEquality.equals("octal-success", r6.success, false);
    if (!r6.success) {
      TestEquality.subset("octal-errors", [{ expected: "':'" }], r6.errors);
      TestEquality.equals("octal-data", (r6.data as any).val, 0);
    }

    // Binary: 0b11
    // Same: reads "0", stops at "b" → "b11" identifier → error
    const r7 = LlmJson.parse('{"val": 0b11}');
    TestEquality.equals("binary-success", r7.success, false);
    if (!r7.success) {
      TestEquality.subset("binary-errors", [{ expected: "':'" }], r7.errors);
      TestEquality.equals("binary-data", (r7.data as any).val, 0);
    }
    ...
    TestEquality.equals("num-trailing-text-success", r8.success, false);
    if (!r8.success) {
      TestEquality.subset(
      ...
      TestEquality.equals("num-trailing-text-data", (r8.data as any).val, 42);
    }
    ...
    TestEquality.equals("minus-then-alpha-success", r9.success, false);
    if (!r9.success) {
      TestEquality.subset(
      ...
      TestEquality.equals("minus-then-alpha-data", (r9.data as any).val, 0);
    }
    ...
    TestEquality.equals("double-sign-success", r10.success, false);
    if (!r10.success) {
      TestEquality.subset(
        "double-sign-errors",
        [{ expected: "string key" }],
      ...
      TestEquality.equals("double-sign-data", (r10.data as any).val, 0);
    }

    // Number MAX_SAFE_INTEGER + 1
    const big = "9007199254740992";
    const r11 = LlmJson.parse('{"val": ' + big + "}");
    TestEquality.equals("beyond-safe-success", r11.success, true);
    if (r11.success)
      TestEquality.equals(
        "beyond-safe-data",
        (r11.data as any).val,
    ...
    TestEquality.equals("large-exp-success", r12.success, true);
    if (r12.success)
      TestEquality.equals("large-exp-data", (r12.data as any).val, 1e308);

    // Number that becomes Infinity
    const r13 = LlmJson.parse('{"val": 1e999}');
    TestEquality.equals("infinity-exp-success", r13.success, true);
    if (r13.success)
      TestEquality.equals("infinity-exp-data", (r13.data as any).val, Infinity);
  };
