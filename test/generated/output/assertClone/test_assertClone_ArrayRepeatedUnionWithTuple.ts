...
export const test_assertClone_ArrayRepeatedUnionWithTuple = _test_assertClone("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input) => ((input: any): typia.Primitive<number | boolean | Array<string> | Array<ArrayRepeatedUnionWithTuple> | Array<ArrayRepeatedUnionWithTuple.IBox3D> | [string, number, boolean] | [ArrayRepeatedUnionWithTuple.IBox3D, ArrayRepeatedUnionWithTuple.IPoint3D]> => { const assert = (input: any): number | boolean | Array<string> | Array<ArrayRepeatedUnionWithTuple> | Array<ArrayRepeatedUnionWithTuple.IBox3D> | [string, number, boolean] | [ArrayRepeatedUnionWithTuple.IBox3D, ArrayRepeatedUnionWithTuple.IPoint3D] => {
                ...
                const tuplePredicators = [
                    [
                        ...
                        (entire: any[]): any => (entire.length === 3 || $guard(_exceptionable, {
                            ...
                            expected: "number",
                            value: entire[1]
                        })) && ("boolean" === typeof entire[2] || $guard(_exceptionable, {
                            path: _path + "[2]",
                            expected: "boolean",
                            value: entire[2]
                        }))
                    ...
                    [
                        (top: any[]): any => top.length === 2 && ("object" === typeof top[0] && null !== top[0] && $ao0(top[0], _path + "[0]", false && _exceptionable)) && ("object" === typeof top[1] && null !== top[1] && $ao1(top[1], _path + "[1]", false && _exceptionable)),
                        (entire: any[]): any => (entire.length === 2 || $guard(_exceptionable, {
                            ...
                            value: entire
                        })) && (("object" === typeof entire[0] && null !== entire[0] || $guard(_exceptionable, {
                            path: _path + "[0]",
                            expected: "ArrayRepeatedUnionWithTuple.IBox3D",
                            value: entire[0]
                        })) && $ao0(entire[0], _path + "[0]", true && _exceptionable) || $guard(_exceptionable, {
                            path: _path + "[0]",
                            expected: "ArrayRepeatedUnionWithTuple.IBox3D",
                            value: entire[0]
                        })) && (("object" === typeof entire[1] && null !== entire[1] || $guard(_exceptionable, {
                            path: _path + "[1]",
                            expected: "ArrayRepeatedUnionWithTuple.IPoint3D",
                            value: entire[1]
                        })) && $ao1(entire[1], _path + "[1]", true && _exceptionable) || $guard(_exceptionable, {
                            path: _path + "[1]",
                            expected: "ArrayRepeatedUnionWithTuple.IPoint3D",
                            value: entire[1]
                        }))
...
}; assert(input); const output = clone(input); return output; })(input), ArrayRepeatedUnionWithTuple.SPOILERS);
