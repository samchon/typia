...
export const test_createAssertStringify_AtomicAlias = _test_assertStringify("AtomicAlias", AtomicAlias.generate, (input: any): string => { const assert = (input: any): AtomicAlias => {
...
}; return stringify(assert(input)); }, AtomicAlias.SPOILERS);
