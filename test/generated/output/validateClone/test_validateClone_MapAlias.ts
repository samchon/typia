...
export const test_validateClone_MapAlias = _test_validateClone("MapAlias", MapAlias.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<MapAlias>> => { const validate = (input: any): typia.IValidation<MapAlias> => {
