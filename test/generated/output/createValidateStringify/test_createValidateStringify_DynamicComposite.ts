...
export const test_createValidateStringify_DynamicComposite = _test_validateStringify("DynamicComposite", DynamicComposite.generate, (input: DynamicComposite): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<DynamicComposite> => {
    ...
    output.data = stringify(input); return output; }, DynamicComposite.SPOILERS);
