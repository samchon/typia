...
export const test_notation_validateSnake_ObjectSimpleProtobufOptional = (): void =>
    ...
    convert: (input) => typia.notations.validateSnake<ObjectSimpleProtobufOptional>(input),
