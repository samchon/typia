...
export const test_createAssertPrune_TagMatrix = _test_assertPrune("TagMatrix", TagMatrix.generate, (input: any): TagMatrix => { const assert = (input: any): TagMatrix => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; }, TagMatrix.SPOILERS);
