...
export const test_createIsPrune_ObjectUnionExplicit = _test_isPrune("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input: any): input is ObjectUnionExplicit => { const is = (input: any): input is ObjectUnionExplicit => {
    ...
    return false; prune(input); return true; }, ObjectUnionExplicit.SPOILERS);
