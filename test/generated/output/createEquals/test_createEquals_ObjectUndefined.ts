...
export const test_createEquals_ObjectUndefined = _test_equals("ObjectUndefined", ObjectUndefined.generate, (input: any, _exceptionable: boolean = true): input is ObjectUndefined => {
