...
export const test_createAssertPrune_ObjectPrimitive = _test_assertPrune("ObjectPrimitive", ObjectPrimitive.generate, (input: any): ObjectPrimitive => { const assert = (input: any): ObjectPrimitive => {
