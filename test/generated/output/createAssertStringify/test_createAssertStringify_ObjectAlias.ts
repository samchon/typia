...
export const test_createAssertStringify_ObjectAlias = _test_assertStringify("ObjectAlias", ObjectAlias.generate, (input: any): string => { const assert = (input: any): ObjectAlias => {
...
}; return stringify(assert(input)); }, ObjectAlias.SPOILERS);
