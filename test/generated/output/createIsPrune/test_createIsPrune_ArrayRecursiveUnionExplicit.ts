...
export const test_createIsPrune_ArrayRecursiveUnionExplicit = _test_isPrune("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input: any): input is ArrayRecursiveUnionExplicit => { const is = (input: any): input is ArrayRecursiveUnionExplicit => {
    ...
    return false; prune(input); return true; }, ArrayRecursiveUnionExplicit.SPOILERS);
