...
export const test_validatePrune_ConstantEnumeration = _test_validatePrune("ConstantEnumeration", ConstantEnumeration.generate, (input) => ((input: any): typia.IValidation<Array<ConstantEnumeration.Enumeration>> => { const validate = (input: any): typia.IValidation<Array<ConstantEnumeration.Enumeration>> => {
...
}; const prune = (input: Array<ConstantEnumeration.Enumeration>): void => {
}; const output = validate(input); if (output.success)
    prune(input); return output; })(input), ConstantEnumeration.SPOILERS);
