...
export const test_createAssertStringify_ArrayRepeatedNullable = _test_assertStringify("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input: any): string => { const assert = (input: any): ArrayRepeatedNullable => {
...
}; return stringify(assert(input)); }, ArrayRepeatedNullable.SPOILERS);
