...
export const test_isStringify_ClassMethod = _test_isStringify("ClassMethod", ClassMethod.generate, (input) => ((input: Animal): string | null => { const is = (input: any): input is Animal => {
