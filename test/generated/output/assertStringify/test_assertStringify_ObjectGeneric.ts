...
export const test_assertStringify_ObjectGeneric = _test_assertStringify("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): string => { const assert = (input: any): [ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>] => {
...
}; return stringify(assert(input)); })(input), ObjectGeneric.SPOILERS);
