...
export const test_assertClone_ObjectUndefined = _test_assertClone("ObjectUndefined", ObjectUndefined.generate, (input) => ((input: any): typia.Primitive<Array<ObjectUndefined.ILecture>> => { const assert = (input: any): Array<ObjectUndefined.ILecture> => {
    ...
    return input;
}; const clone = (input: Array<ObjectUndefined.ILecture>): typia.Primitive<Array<ObjectUndefined.ILecture>> => {
    const $io1 = (input: any): boolean => "string" === typeof input.id && "string" === typeof input.name;
...
}; assert(input); const output = clone(input); return output; })(input), ObjectUndefined.SPOILERS);
