...
export const test_assertClone_DynamicArray = _test_assertClone("DynamicArray", DynamicArray.generate, (input) => ((input: any): typia.Primitive<DynamicArray> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* DynamicArray */; return output as DynamicArray; })(input), DynamicArray.SPOILERS);
