...
export const test_isParse_DefinitionJsonValue = _test_isParse("DefinitionJsonValue", DefinitionJsonValue.generate, (input) => ((input: any): typia.Primitive<DefinitionJsonValue> => { const is = (input: any): input is DefinitionJsonValue => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; })(input), DefinitionJsonValue.SPOILERS);
