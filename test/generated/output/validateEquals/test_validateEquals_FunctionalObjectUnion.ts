...
export const test_validateEquals_FunctionalObjectUnion = _test_validateEquals("FunctionalObjectUnion", FunctionalObjectUnion.generate, (input) => ((input: any): typia.IValidation<Array<FunctionalObjectUnion.Union>> => {
