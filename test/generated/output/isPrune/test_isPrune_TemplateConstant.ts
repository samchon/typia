...
export const test_isPrune_TemplateConstant = _test_isPrune("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): input is Array<TemplateConstant.Type> => { const is = (input: any): input is Array<TemplateConstant.Type> => {
    ...
    return false; prune(input); return true; })(input), TemplateConstant.SPOILERS);
