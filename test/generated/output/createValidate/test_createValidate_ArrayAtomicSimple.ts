...
export const test_createValidate_ArrayAtomicSimple = _test_validate("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: any): typia.IValidation<ArrayAtomicSimple> => {
