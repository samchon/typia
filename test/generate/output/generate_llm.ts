...
export const schema = ((
  $defs: Record<string, import("@samchon/openapi").ILlmSchema>,
) => {
  Object.assign($defs, {
    ICompany: {
      type: "object",
  ...
  } as Record<string, import("@samchon/openapi").ILlmSchema>);
  return {
    $ref: "#/$defs/ICompany",
  } as import("@samchon/openapi").ILlmSchema;
})({});
...
} as import("@samchon/openapi").ILlmSchema.IParameters;
export const application = (() => {
  ...
  } as import("@samchon/openapi").ILlmApplication<IApplication>;
  __typia_transform__llmApplicationFinalize._llmApplicationFinalize(
    application,
    {
      ...({
        ...
        Pick<
          import("@samchon/openapi").ILlmApplication.IConfig,
          "separate" | "validate"
        >
      >),
      equals: false,
  ...
  __typia_transform__llmApplicationFinalize._llmApplicationFinalize(
    application,
    {
      ...({
        ...
        Pick<ILlmApplication.IConfig, "separate">
      > satisfies Partial<
        Pick<
          import("@samchon/openapi").ILlmApplication.IConfig,
          "separate" | "validate"
