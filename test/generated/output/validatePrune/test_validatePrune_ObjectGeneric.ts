...
export const test_validatePrune_ObjectGeneric = _test_validatePrune("ObjectGeneric", ObjectGeneric.generate, (input) => ((input: any): typia.IValidation<[ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]> => { const validate = (input: any): typia.IValidation<[ObjectGeneric.ISomething<boolean>, ObjectGeneric.ISomething<number>, ObjectGeneric.ISomething<string>]> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ObjectGeneric.SPOILERS);
