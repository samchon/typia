...
export const test_functional_validateEqualsFunctionAsync_ArraySimple =
  _test_functional_validateEqualsFunctionAsync("ArraySimple")(ArraySimple)(
    (p: (input: ArraySimple) => Promise<ArraySimple>) =>
      async (
        input: ArraySimple,
      ): Promise<import("typia").IValidation<ArraySimple>> => {
        const paramResults = [
