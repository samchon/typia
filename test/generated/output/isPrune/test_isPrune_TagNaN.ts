...
export const test_isPrune_TagNaN = _test_isPrune("TagNaN", TagNaN.generate, (input) => ((input: any): input is TagNaN => { const is = (input: any): input is TagNaN => {
    ...
    return false; prune(input); return true; })(input), TagNaN.SPOILERS);
