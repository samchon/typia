...
export const test_createIsClone_ObjectNullable = _test_isClone("ObjectNullable", ObjectNullable.generate, (input: any): typia.Primitive<ObjectNullable> | null => { const is = (input: any): input is ObjectNullable => {
    ...
    return null; const output = clone(input); return output; }, ObjectNullable.SPOILERS);
