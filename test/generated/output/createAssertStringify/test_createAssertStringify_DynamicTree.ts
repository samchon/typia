...
export const test_createAssertStringify_DynamicTree = _test_assertStringify("DynamicTree", DynamicTree.generate, (input: DynamicTree): string => { const assert = (input: any) => {
