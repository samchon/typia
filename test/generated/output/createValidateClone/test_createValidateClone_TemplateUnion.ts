...
export const test_createValidateClone_TemplateUnion = _test_validateClone("TemplateUnion", TemplateUnion.generate, (input: any): typia.IValidation<typia.Primitive<TemplateUnion>> => { const validate = (input: any): typia.IValidation<TemplateUnion> => {
    ...
    output.data = clone(input); return output; }, TemplateUnion.SPOILERS);
