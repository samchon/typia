...
export const test_functional_validateParametersAsync_ObjectSimpleProtobufNullable =
  _test_functional_validateParametersAsync("ObjectSimpleProtobufNullable")(
