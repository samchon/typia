...
export const test_validateParse_ObjectTuple = _test_validateParse("ObjectTuple", ObjectTuple.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ObjectTuple>> => { const validate = (input: any): typia.IValidation<ObjectTuple> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ObjectTuple.SPOILERS);
