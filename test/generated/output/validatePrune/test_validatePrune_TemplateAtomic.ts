...
export const test_validatePrune_TemplateAtomic = _test_validatePrune("TemplateAtomic", TemplateAtomic.generate, (input) => ((input: any): typia.IValidation<TemplateAtomic> => { const validate = (input: any): typia.IValidation<TemplateAtomic> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), TemplateAtomic.SPOILERS);
