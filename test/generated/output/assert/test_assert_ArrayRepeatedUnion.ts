...
export const test_assert_ArrayRepeatedUnion = _test_assert("ArrayRepeatedUnion", ArrayRepeatedUnion.generate, (input) => ((input: any): number | boolean | Array<string> | Array<ArrayRepeatedUnion> | Array<ArrayRepeatedUnion.IBox3D> => {
