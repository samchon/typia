...
export const test_notation_createValidateCamel_ObjectSimpleProtobuf =
    ...
    >({
        convert: (
            input: any,
        ): typia.IValidation<typia.CamelCase<ObjectSimpleProtobuf>> => {
            const validate = (
                input: any,
        ...
        assert: (input: any): typia.CamelCase<ObjectSimpleProtobuf> => {
            const __is = (
                input: any,
            ): input is typia.CamelCase<ObjectSimpleProtobuf> => {
                const $io0 = (input: any): boolean =>
                    "boolean" === typeof input.bool &&
                    "number" === typeof input.int32 &&
                    Math.floor(input.int32) === input.int32 &&
