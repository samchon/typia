...
export const test_isPrune_ObjectGenericArray = _test_isPrune("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): input is ObjectGenericArray.IPage<ObjectGenericArray.IPerson> => { const is = (input: any): input is ObjectGenericArray.IPage<ObjectGenericArray.IPerson> => {
