...
export const test_isPrune_ObjectIntersection = _test_isPrune("ObjectIntersection", ObjectIntersection.generate, (input) => ((input: any): input is ObjectIntersection.IEmail & ObjectIntersection.IName => { const is = (input: any): input is ObjectIntersection.IEmail & ObjectIntersection.IName => {
