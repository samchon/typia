...
export const test_assertStringify_ObjectUnionImplicit = _test_assertStringify("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input) => ((input: ObjectUnionImplicit): string => { const assert = (input: any) => {
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is ObjectUnionImplicit => {
        const $ao0 = (input: any, _path: string, _exceptionable: boolean) => ("number" === typeof input.x && !Number.isNaN(input.x) || $guard(_exceptionable, {
            ...
            expected: "number",
            value: input.y
        })) && (undefined === input.slope || "number" === typeof input.slope && !Number.isNaN(input.slope) || $guard(_exceptionable, {
            path: _path + ".slope",
        ...
        const $ao1 = (input: any, _path: string, _exceptionable: boolean) => ("object" === typeof input.p1 && null !== input.p1 || $guard(_exceptionable, {
            ...
            expected: "Resolve<ObjectUnionImplicit.IPoint>",
            value: input.p2
        })) && $ao0(input.p2, _path + ".p2", true && _exceptionable)) && (undefined === input.width || "number" === typeof input.width && !Number.isNaN(input.width) || $guard(_exceptionable, {
            path: _path + ".width",
            expected: "(number | undefined)",
            value: input.width
        })) && (undefined === input.distance || "number" === typeof input.distance && !Number.isNaN(input.distance) || $guard(_exceptionable, {
            path: _path + ".distance",
            expected: "(number | undefined)",
        ...
        const $ao2 = (input: any, _path: string, _exceptionable: boolean) => ("object" === typeof input.p1 && null !== input.p1 || $guard(_exceptionable, {
            ...
            expected: "Resolve<ObjectUnionImplicit.IPoint>",
            value: input.p3
        })) && $ao0(input.p3, _path + ".p3", true && _exceptionable)) && (undefined === input.width || "number" === typeof input.width && !Number.isNaN(input.width) || $guard(_exceptionable, {
            path: _path + ".width",
            expected: "(number | undefined)",
            value: input.width
        })) && (undefined === input.height || "number" === typeof input.height && !Number.isNaN(input.height) || $guard(_exceptionable, {
            path: _path + ".height",
            expected: "(number | undefined)",
            value: input.height
        })) && (undefined === input.area || "number" === typeof input.area && !Number.isNaN(input.area) || $guard(_exceptionable, {
            path: _path + ".area",
            expected: "(number | undefined)",
            value: input.area
        }));
        const $ao3 = (input: any, _path: string, _exceptionable: boolean) => ("object" === typeof input.p1 && null !== input.p1 || $guard(_exceptionable, {
            ...
            expected: "Resolve<ObjectUnionImplicit.IPoint>",
            value: input.p4
        })) && $ao0(input.p4, _path + ".p4", true && _exceptionable)) && (undefined === input.width || "number" === typeof input.width && !Number.isNaN(input.width) || $guard(_exceptionable, {
            path: _path + ".width",
            expected: "(number | undefined)",
            value: input.width
        })) && (undefined === input.height || "number" === typeof input.height && !Number.isNaN(input.height) || $guard(_exceptionable, {
        ...
        const $ao4 = (input: any, _path: string, _exceptionable: boolean) => (Array.isArray(input.points) || $guard(_exceptionable, {
            ...
            expected: "Resolve<ObjectUnionImplicit.IPoint>",
            value: elem
        })) && $ao0(elem, _path + ".points[" + _index2 + "]", true && _exceptionable)) && (undefined === input.length || "number" === typeof input.length && !Number.isNaN(input.length) || $guard(_exceptionable, {
            path: _path + ".length",
            expected: "(number | undefined)",
            value: input.length
        }));
        const $ao5 = (input: any, _path: string, _exceptionable: boolean) => ("object" === typeof input.outer && null !== input.outer || $guard(_exceptionable, {
            ...
            expected: "Resolve<ObjectUnionImplicit.IPolyline>",
            value: elem
        })) && $ao4(elem, _path + ".inner[" + _index3 + "]", true && _exceptionable))) && (undefined === input.area || "number" === typeof input.area && !Number.isNaN(input.area) || $guard(_exceptionable, {
            path: _path + ".area",
            expected: "(number | undefined)",
            value: input.area
        }));
        ...
        })) && $ao0(input.centroid, _path + ".centroid", true && _exceptionable)) && ("number" === typeof input.radius && !Number.isNaN(input.radius) || $guard(_exceptionable, {
            path: _path + ".radius",
            expected: "number",
            value: input.radius
        })) && (undefined === input.area || "number" === typeof input.area && !Number.isNaN(input.area) || $guard(_exceptionable, {
