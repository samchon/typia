...
export const test_createValidateStringify_ArrayRecursiveUnionImplicit = _test_validateStringify("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input: ArrayRecursiveUnionImplicit): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayRecursiveUnionImplicit> => {
    ...
    output.data = stringify(input); return output; }, ArrayRecursiveUnionImplicit.SPOILERS);
