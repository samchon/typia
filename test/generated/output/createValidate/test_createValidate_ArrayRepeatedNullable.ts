...
export const test_createValidate_ArrayRepeatedNullable = _test_validate("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input: any): typia.IValidation<ArrayRepeatedNullable> => {
    const errors = [] as any[];
