...
export const test_validateClone_ObjectHierarchical = _test_validateClone("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ICustomer>> => { const validate = (input: any): typia.IValidation<ICustomer> => {
    const errors = [] as any[];
