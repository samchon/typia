...
export const test_functional_isParametersAsync_ObjectSimpleProtobufNullable =
  _test_functional_isParametersAsync("ObjectSimpleProtobufNullable")(
    ...
    (
      ...
      async (
        input: ObjectSimpleProtobufNullable,
      ): Promise<ObjectSimpleProtobufNullable | null> => {
        if (
          false ===
