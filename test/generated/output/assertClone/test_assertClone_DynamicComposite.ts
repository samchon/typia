...
export const test_assertClone_DynamicComposite = _test_assertClone("DynamicComposite", DynamicComposite.generate, (input) => ((input: any): typia.Primitive<DynamicComposite> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* DynamicComposite */; return output as DynamicComposite; })(input), DynamicComposite.SPOILERS);
