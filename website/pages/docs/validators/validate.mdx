...
If you want to know about such comment tags detaily, read below article:
  ...
  - [Comment Tags](/docs/validators/tags/)
    - [Outline](/docs/validators/tags/#outline)
    - [Supported Tags](/docs/validators/tags/#supported-tags)
    - [Customization](/docs/validators/tags/#customization)
