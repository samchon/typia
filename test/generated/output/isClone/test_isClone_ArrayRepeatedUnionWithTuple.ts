...
export const test_isClone_ArrayRepeatedUnionWithTuple = _test_isClone("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input) => ((input: any): typia.Primitive<number | boolean | Array<string> | Array<ArrayRepeatedUnionWithTuple> | Array<ArrayRepeatedUnionWithTuple.IBox3D> | [string, number, boolean] | [ArrayRepeatedUnionWithTuple.IBox3D, ArrayRepeatedUnionWithTuple.IPoint3D]> | null => { const is = (input: any): input is number | boolean | Array<string> | Array<ArrayRepeatedUnionWithTuple> | Array<ArrayRepeatedUnionWithTuple.IBox3D> | [string, number, boolean] | [ArrayRepeatedUnionWithTuple.IBox3D, ArrayRepeatedUnionWithTuple.IPoint3D] => {
    ...
    return null; const output = clone(input); return output; })(input), ArrayRepeatedUnionWithTuple.SPOILERS);
