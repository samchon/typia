...
export const test_stringify_ObjectGenericUnion = _test_stringify("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: ISaleQuestion | ISaleReview): string => {
