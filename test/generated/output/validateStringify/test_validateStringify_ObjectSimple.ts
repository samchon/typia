...
export const test_validateStringify_ObjectSimple = _test_validateStringify("ObjectSimple", ObjectSimple.generate, (input) => ((input: IBox3D): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<IBox3D> => {
    const errors = [] as any[];
