...
export const test_createAssertStringify_ObjectUnionImplicit = _test_assertStringify("ObjectUnionImplicit", ObjectUnionImplicit.generate, (input: ObjectUnionImplicit): string => { const assert = (input: any) => {
