...
export const test_createClone_ObjectUnionDouble = _test_clone("ObjectUnionDouble", ObjectUnionDouble.generate, (input: ObjectUnionDouble): typia.Primitive<ObjectUnionDouble> => {
