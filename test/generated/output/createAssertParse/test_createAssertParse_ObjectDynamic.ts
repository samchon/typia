...
export const test_createAssertParse_ObjectDynamic = _test_assertParse("ObjectDynamic", ObjectDynamic.generate, (input: string): typia.Primitive<ObjectDynamic> => { const assert = (input: any): ObjectDynamic => {
    ...
    return input;
}; input = JSON.parse(input); return assert(input) as any; }, ObjectDynamic.SPOILERS);
