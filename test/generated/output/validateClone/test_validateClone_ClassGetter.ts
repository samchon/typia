...
export const test_validateClone_ClassGetter = _test_validateClone("ClassGetter", ClassGetter.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Person>> => { const validate = (input: any): typia.IValidation<Person> => {
    const errors = [] as any[];
