...
export const test_assertClone_ToJsonNull = _test_assertClone("ToJsonNull", ToJsonNull.generate, (input) => ((input: any): typia.Primitive<ToJsonNull> => { const assert = (input: any): ToJsonNull => {
