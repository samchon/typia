...
export const test_createRandom_TagNaN = _test_random("TagNaN", (generator: typia.IRandomGenerator = (typia.createRandom as any).generator) => {
    ...
    return input as typia.Primitive<TagNaN>;
});
