...
export const test_createAssertPrune_TupleRestAtomic = _test_assertPrune("TupleRestAtomic", TupleRestAtomic.generate, (input: any): TupleRestAtomic => { const assert = (input: any): TupleRestAtomic => {
...
}; assert(input); prune(input); return input; }, TupleRestAtomic.SPOILERS);
