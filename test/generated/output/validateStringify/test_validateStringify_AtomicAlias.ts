...
export const test_validateStringify_AtomicAlias = _test_validateStringify("AtomicAlias", AtomicAlias.generate, (input) => ((input: [boolean, number, string]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[boolean, number, string]> => {
    ...
    output.data = stringify(input); return output; })(input), AtomicAlias.SPOILERS);
