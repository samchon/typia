...
export const test_createAssertStringify_ObjectDynamic = _test_assertStringify("ObjectDynamic", ObjectDynamic.generate, (input: any): string => { const assert = (input: any): ObjectDynamic => {
    ...
    return $so0(input);
}; return stringify(assert(input)); }, ObjectDynamic.SPOILERS);
