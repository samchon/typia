...
export const test_functional_isReturn_ObjectUnionNonPredictable =
  _test_functional_isReturn("ObjectUnionNonPredictable")(
    ObjectUnionNonPredictable,
  )(
    (p: (input: ObjectUnionNonPredictable) => ObjectUnionNonPredictable) =>
      (input: ObjectUnionNonPredictable): ObjectUnionNonPredictable | null => {
