...
export const test_notation_createValidateSnake_ArrayRecursiveUnionExplicitPointer = (): void =>
    ...
    convert: typia.notations.createValidateSnake<ArrayRecursiveUnionExplicitPointer>(),
