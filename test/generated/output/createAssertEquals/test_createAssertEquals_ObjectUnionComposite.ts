...
export const test_createAssertEquals_ObjectUnionComposite = _test_assertEquals("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any) => {
    ...
    return input as ObjectUnionComposite;
});
