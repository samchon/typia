...
export const test_validateStringify_ClassMethod = _test_validateStringify("ClassMethod", ClassMethod.generate, (input) => ((input: ClassMethod.Animal): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ClassMethod.Animal> => {
    const errors = [] as any[];
