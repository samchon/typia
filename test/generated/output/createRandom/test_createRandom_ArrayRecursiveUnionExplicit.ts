...
export const test_createRandom_ArrayRecursiveUnionExplicit = _test_random("ArrayRecursiveUnionExplicit", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ArrayRecursiveUnionExplicit> => {
    ...
    const $ro0 = (_recursive: boolean = true, _depth: number = 0): any => ({
        ...
        children: _recursive && 5 < _depth ? [] : (generator?.array ?? $generator.array)(() => $pick([
    ...
    const $ro1 = (_recursive: boolean = false, _depth: number = 0): any => ({
        ...
        name: (generator?.customs ?? $generator.customs)?.string?.([]) ?? (generator?.string ?? $generator.string)(),
        path: (generator?.customs ?? $generator.customs)?.string?.([]) ?? (generator?.string ?? $generator.string)(),
        width: (generator?.customs ?? $generator.customs)?.number?.([]) ?? (generator?.number ?? $generator.number)(0, 100),
        height: (generator?.customs ?? $generator.customs)?.number?.([]) ?? (generator?.number ?? $generator.number)(0, 100),
    ...
    const __is = (input: any): input is typia.Primitive<ArrayRecursiveUnionExplicit> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<ArrayRecursiveUnionExplicit> => {
