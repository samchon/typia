...
export const test_validateClone_TagObjectUnion = _test_validateClone("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<Array<TagObjectUnion.Type>>> => { const validate = (input: any): typia.IValidation<Array<TagObjectUnion.Type>> => {
...
}; const clone = (input: Array<TagObjectUnion.Type>): typia.Primitive<Array<TagObjectUnion.Type>> => {
    ...
    output.data = clone(input); return output; })(input), TagObjectUnion.SPOILERS);
