...
export const test_random_ObjectGenericArray = _test_random("ObjectGenericArray", () => ((generator?: Partial<typia.IRandomGenerator>): typia.Primitive<ObjectGenericArray> => {
