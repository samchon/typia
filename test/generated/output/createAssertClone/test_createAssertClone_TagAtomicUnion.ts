...
export const test_createAssertClone_TagAtomicUnion = _test_assertClone("TagAtomicUnion", TagAtomicUnion.generate, (input: any): typia.Primitive<TagAtomicUnion> => { const assert = (input: any): TagAtomicUnion => {
...
}; assert(input); const output = clone(input); return output; }, TagAtomicUnion.SPOILERS);
