...
export const test_createRandom_TagFormat = _test_random("TagFormat", (generator?: Partial<typia.IRandomGenerator>): typia.Primitive<TagFormat> => {
    ...
    const $ro0 = (_recursive: boolean = false, _depth: number = 0): any => ({
        ...
        url: (generator?.customs ?? $generator.customs)?.string?.([
            {
                name: "format",
                value: "url"
            }
        ...
        date: (generator?.customs ?? $generator.customs)?.string?.([
            {
                name: "format",
                value: "date"
            }
        ]) ?? (generator?.date ?? $generator.date)(),
        date_time: (generator?.customs ?? $generator.customs)?.string?.([
            {
                name: "format",
                value: "date-time"
            }
        ]) ?? (generator?.datetime ?? $generator.datetime)(),
        datetime: (generator?.customs ?? $generator.customs)?.string?.([
            {
                name: "format",
                value: "datetime"
            }
        ...
        custom: (generator?.customs ?? $generator.customs)?.string?.([
            {
                name: "format",
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is typia.Primitive<TagFormat> => {
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.uuid && ($is_uuid(input.uuid) || $guard(_exceptionable, {
                path: _path + ".uuid",
                ...
                expected: "string",
                value: input.url
            })) && ("string" === typeof input.ipv4 && ($is_ipv4(input.ipv4) || $guard(_exceptionable, {
                path: _path + ".ipv4",
                ...
                expected: "string",
                value: input.ipv4
            })) && ("string" === typeof input.ipv6 && ($is_ipv6(input.ipv6) || $guard(_exceptionable, {
                path: _path + ".ipv6",
                ...
                expected: "string",
                value: input.ipv6
            })) && ("string" === typeof input.date && ($is_date(input.date) || $guard(_exceptionable, {
                path: _path + ".date",
                ...
                expected: "string",
                value: input.date
            })) && ("string" === typeof input.date_time && ($is_datetime(input.date_time) || $guard(_exceptionable, {
                ...
                expected: "string",
                value: input.date_time
            })) && ("string" === typeof input.datetime && ($is_datetime(input.datetime) || $guard(_exceptionable, {
                path: _path + ".datetime",
                expected: "string (@format datetime)",
                ...
                expected: "string",
                value: input.dateTime
            })) && ("string" === typeof input.custom || $guard(_exceptionable, {
                path: _path + ".custom",
                expected: "string",
                value: input.custom
            }));
