...
export const test_createIsClone_ArrayRecursive = _test_isClone("ArrayRecursive", ArrayRecursive.generate, (input: any): typia.Primitive<ICategory> | null => { const is = (input: any): input is ICategory => {
