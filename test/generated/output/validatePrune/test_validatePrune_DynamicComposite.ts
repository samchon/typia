...
export const test_validatePrune_DynamicComposite = _test_validatePrune("DynamicComposite", DynamicComposite.generate, (input) => ((input: any): typia.IValidation<DynamicComposite> => { const validate = (input: any): typia.IValidation<DynamicComposite> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), DynamicComposite.SPOILERS);
