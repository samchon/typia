...
export const test_validateStringify_ClassPropertyAssignment = _test_validateStringify("ClassPropertyAssignment", ClassPropertyAssignment.generate, (input) => ((input: ClassPropertyAssignment): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ClassPropertyAssignment> => {
    ...
    output.data = stringify(input); return output; })(input), ClassPropertyAssignment.SPOILERS);
