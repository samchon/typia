...
export const test_createAssertPrune_AtomicSimple = _test_assertPrune("AtomicSimple", AtomicSimple.generate, (input: any): AtomicSimple => { const assert = (input: any): AtomicSimple => {
...
}; assert(input); prune(input); return input; }, AtomicSimple.SPOILERS);
