...
export const test_createIsPrune_ObjectUndefined = _test_isPrune("ObjectUndefined", ObjectUndefined.generate, (input: any): input is ObjectUndefined => { const is = (input: any): input is ObjectUndefined => {
    ...
    return false; prune(input); return true; }, ObjectUndefined.SPOILERS);
