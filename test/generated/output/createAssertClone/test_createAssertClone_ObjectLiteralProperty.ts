...
export const test_createAssertClone_ObjectLiteralProperty = _test_assertClone("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input: any): typia.Primitive<ObjectLiteralProperty> => { const assert = (input: any): ObjectLiteralProperty => {
...
}; assert(input); const output = clone(input); return output; }, ObjectLiteralProperty.SPOILERS);
