...
export const test_isClone_MapAlias = _test_isClone("MapAlias", MapAlias.generate, (input) => ((input: any): typia.Primitive<MapAlias> | null => { const is = (input: any): input is MapAlias => {
