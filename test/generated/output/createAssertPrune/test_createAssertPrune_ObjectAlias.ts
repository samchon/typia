...
export const test_createAssertPrune_ObjectAlias = _test_assertPrune("ObjectAlias", ObjectAlias.generate, (input: any): ObjectAlias => { const assert = (input: any): ObjectAlias => {
