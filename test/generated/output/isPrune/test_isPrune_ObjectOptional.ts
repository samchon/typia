...
export const test_isPrune_ObjectOptional = _test_isPrune("ObjectOptional", ObjectOptional.generate, (input) => ((input: any): input is ObjectOptional => { const is = (input: any): input is ObjectOptional => {
    ...
    return false; prune(input); return true; })(input), ObjectOptional.SPOILERS);
