...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/random/random.ts" 
      filename="examples/src/random/random.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/random/random.js" 
...
<Tabs items={[
  ...
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/random/random-tag.ts" 
      filename="examples/src/random/random-tag.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/random/random-comment-tag.ts" 
      filename="examples/src/random/random-comment-tag.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/random/random-tag.js" 
...
<Tabs items={['TypeScript Source Code', 'Compiled JavaScript File']}>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/src/random/random-custom.ts" 
      filename="examples/src/random/random-custom.ts" 
      showLineNumbers />
  </Tabs.Tab>
  <Tabs.Tab>
    <LocalSource 
      path="website/examples/bin/random/random-custom.js" 
