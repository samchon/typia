...
export const test_validateStringify_MapSimple = _test_validateStringify("MapSimple", MapSimple.generate, (input) => ((input: MapSimple): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<MapSimple> => {
    ...
    output.data = stringify(input); return output; })(input), MapSimple.SPOILERS);
