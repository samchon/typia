...
export const test_createAssertClone_TemplateUnion = _test_assertClone("TemplateUnion", TemplateUnion.generate, (input: any): typia.Primitive<TemplateUnion> => { const assert = (input: any): TemplateUnion => {
...
}; assert(input); const output = clone(input); return output; }, TemplateUnion.SPOILERS);
