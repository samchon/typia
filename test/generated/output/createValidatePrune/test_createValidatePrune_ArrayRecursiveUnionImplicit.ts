...
export const test_createValidatePrune_ArrayRecursiveUnionImplicit = _test_validatePrune("ArrayRecursiveUnionImplicit", ArrayRecursiveUnionImplicit.generate, (input: any): typia.IValidation<ArrayRecursiveUnionImplicit> => { const validate = (input: any): typia.IValidation<ArrayRecursiveUnionImplicit> => {
    ...
    prune(input); return output; }, ArrayRecursiveUnionImplicit.SPOILERS);
