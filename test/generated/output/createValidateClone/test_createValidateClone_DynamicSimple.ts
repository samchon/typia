...
export const test_createValidateClone_DynamicSimple = _test_validateClone("DynamicSimple", DynamicSimple.generate, (input: any): typia.IValidation<typia.Primitive<DynamicSimple>> => { const validate = (input: any): typia.IValidation<DynamicSimple> => {
    ...
    output.data = clone(input); return output; }, DynamicSimple.SPOILERS);
