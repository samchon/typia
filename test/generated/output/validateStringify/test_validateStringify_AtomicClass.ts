...
export const test_validateStringify_AtomicClass = _test_validateStringify("AtomicClass", AtomicClass.generate, (input) => ((input: [Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String]): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<[Boolean, false | Boolean, boolean | Boolean, Number, Number | 1, number | Number, String, String | 'characters', string | String]> => {
    ...
    output.data = stringify(input); return output; })(input), AtomicClass.SPOILERS);
