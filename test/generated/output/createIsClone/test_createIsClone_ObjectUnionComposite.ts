...
export const test_createIsClone_ObjectUnionComposite = _test_isClone("ObjectUnionComposite", ObjectUnionComposite.generate, (input: any): typia.Primitive<ObjectUnionComposite> | null => { const is = (input: any): input is ObjectUnionComposite => {
    ...
    return null; const output = clone(input); return output; }, ObjectUnionComposite.SPOILERS);
