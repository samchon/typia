...
export const test_functional_validateFunction_MapSimple =
  _test_functional_validateFunction("MapSimple")(MapSimple)(
    (p: (input: MapSimple) => MapSimple) =>
      (input: MapSimple): import("typia").IValidation<MapSimple> => {
        const paramResults = [
