...
export const test_createAssertClone_ObjectIntersection = _test_assertClone("ObjectIntersection", ObjectIntersection.generate, (input: any): typia.Primitive<ObjectIntersection> => { const assert = (input: any): ObjectIntersection => {
...
}; assert(input); const output = clone(input); return output; }, ObjectIntersection.SPOILERS);
