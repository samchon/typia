...
export const test_validatePrune_ObjectRecursive = _test_validatePrune("ObjectRecursive", ObjectRecursive.generate, (input) => ((input: any): typia.IValidation<IDepartment> => { const validate = (input: any): typia.IValidation<IDepartment> => {
    const errors = [] as any[];
