...
export const test_createAssertClone_DynamicConstant = _test_assertClone("DynamicConstant", DynamicConstant.generate, (input: any): typia.Primitive<DynamicConstant> => { const assert = (input: any): DynamicConstant => {
...
}; assert(input); const output = clone(input); return output; }, DynamicConstant.SPOILERS);
