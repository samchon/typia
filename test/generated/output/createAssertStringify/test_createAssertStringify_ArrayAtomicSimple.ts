...
export const test_createAssertStringify_ArrayAtomicSimple = _test_assertStringify("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: any): string => { const assert = (input: any): ArrayAtomicSimple => {
...
}; return stringify(assert(input)); }, ArrayAtomicSimple.SPOILERS);
