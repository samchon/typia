...
export const test_createAssertClone_MapSimple = _test_assertClone("MapSimple", MapSimple.generate, (input: any): typia.Primitive<MapSimple> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* MapSimple */; return output as MapSimple; }, MapSimple.SPOILERS);
