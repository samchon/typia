...
export const test_createAssertStringify_TagFormat = _test_assertStringify("TagFormat", TagFormat.generate, (input: any): string => { const assert = (input: any): TagFormat => {
    ...
    const $is_datetime = (typia.createAssertStringify as any).is_datetime;
    ...
    const $is_date = (typia.createAssertStringify as any).is_date;
    const $is_datetime = (typia.createAssertStringify as any).is_datetime;
    const $so0 = (input: any): any => `{"uuid":${"\"" + input.uuid + "\""},"email":${"\"" + input.email + "\""},"url":${"\"" + input.url + "\""},"ipv4":${"\"" + input.ipv4 + "\""},"ipv6":${"\"" + input.ipv6 + "\""},"date":${"\"" + input.date + "\""},"date_time":${"\"" + input.date_time + "\""},"datetime":${"\"" + input.datetime + "\""},"dateTime":${"\"" + input.dateTime + "\""},"custom":${$string(input.custom)}}`;
    return $so0(input);
}; return stringify(assert(input)); }, TagFormat.SPOILERS);
