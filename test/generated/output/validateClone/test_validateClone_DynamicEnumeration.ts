...
export const test_validateClone_DynamicEnumeration = _test_validateClone("DynamicEnumeration", DynamicEnumeration.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<DynamicEnumeration>> => { const validate = (input: any): typia.IValidation<DynamicEnumeration> => {
    const errors = [] as any[];
