...
export const test_createEquals_ObjectRecursive = _test_equals("ObjectRecursive", ObjectRecursive.generate, (input: any, _exceptionable: boolean): input is IDepartment => {
