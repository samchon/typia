...
export const test_assertStringify_ToJsonArray = _test_assertStringify("ToJsonArray", ToJsonArray.generate, (input) => ((input: ToJsonArray): string => { const assert = (input: any) => {
