...
export const test_validateParse_ObjectAlias = _test_validateParse("ObjectAlias", ObjectAlias.generate, (input) => ((input: string): typia.IValidation<typia.Primitive<ObjectAlias>> => { const validate = (input: any): typia.IValidation<ObjectAlias> => {
...
}; input = JSON.parse(input); const output = validate(input); return output as any; })(input), ObjectAlias.SPOILERS);
