...
export const test_validatePrune_ArraySimple = _test_validatePrune("ArraySimple", ArraySimple.generate, (input) => ((input: any): typia.IValidation<Array<ArraySimple.IPerson>> => { const validate = (input: any): typia.IValidation<Array<ArraySimple.IPerson>> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), ArraySimple.SPOILERS);
