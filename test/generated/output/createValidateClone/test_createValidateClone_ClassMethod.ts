...
export const test_createValidateClone_ClassMethod = _test_validateClone("ClassMethod", ClassMethod.generate, (input: any): typia.IValidation<typia.Primitive<ClassMethod>> => { const validate = (input: any): typia.IValidation<ClassMethod> => {
