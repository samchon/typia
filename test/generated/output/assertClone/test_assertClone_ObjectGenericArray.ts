...
export const test_assertClone_ObjectGenericArray = _test_assertClone("ObjectGenericArray", ObjectGenericArray.generate, (input) => ((input: any): typia.Primitive<ObjectGenericArray> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* ObjectGenericArray.IPage */; return output as ObjectGenericArray; })(input), ObjectGenericArray.SPOILERS);
