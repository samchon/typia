...
export const test_assertPrune_ArrayRecursive = _test_assertPrune("ArrayRecursive", ArrayRecursive.generate, (input) => ((input: any): ArrayRecursive.ICategory => { const assert = (input: any): ArrayRecursive.ICategory => {
    ...
    if ("object" === typeof input && null !== input)
        $po0(input);
}; assert(input); prune(input); return input; })(input), ArrayRecursive.SPOILERS);
