...
export const test_isClone_TemplateConstant = _test_isClone("TemplateConstant", TemplateConstant.generate, (input) => ((input: any): typia.Primitive<Array<TemplateConstant.Type>> | null => { const is = (input: any): input is Array<TemplateConstant.Type> => {
