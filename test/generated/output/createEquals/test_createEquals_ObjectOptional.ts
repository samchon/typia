...
export const test_createEquals_ObjectOptional = _test_equals("ObjectOptional", ObjectOptional.generate, (input: any, _exceptionable: boolean): input is ObjectOptional => {
