...
|---|---|---|---|
| typescript-go | https://github.com/microsoft/typescript-go | **Apache-2.0** | Upstream compiler and shim target |
...
| effect-tsgo | https://github.com/Effect-TS/tsgo | TBD | Upstream-patch + Go-hook model reference |
| typical | https://github.com/elliots/typical | TBD | MessagePack IPC prototype reference |
...
(None yet. Add rows here when derived files or adapted snippets land.)
...
Review this document whenever a new external reference or adapted file lands.
