...
export const test_validateStringify_ArrayRepeatedNullable = _test_validateStringify("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input) => ((input: string | number | Array<ArrayRepeatedNullable> | null): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<string | number | Array<ArrayRepeatedNullable> | null> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; })(input), ArrayRepeatedNullable.SPOILERS);
