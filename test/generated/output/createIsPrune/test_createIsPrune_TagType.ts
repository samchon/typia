...
export const test_createIsPrune_TagType = _test_isPrune("TagType", TagType.generate, (input: any): input is TagType => { const is = (input: any): input is TagType => {
    ...
    return false; prune(input); return true; }, TagType.SPOILERS);
