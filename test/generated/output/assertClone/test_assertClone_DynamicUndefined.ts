...
export const test_assertClone_DynamicUndefined = _test_assertClone("DynamicUndefined", DynamicUndefined.generate, (input) => ((input: any): typia.Primitive<DynamicUndefined> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* DynamicUndefined */; return output as DynamicUndefined; })(input), DynamicUndefined.SPOILERS);
