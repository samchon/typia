...
export const test_createAssertStringify_TupleRestArray = _test_assertStringify("TupleRestArray", TupleRestArray.generate, (input: any): string => { const assert = (input: any): TupleRestArray => {
...
}; return stringify(assert(input)); }, TupleRestArray.SPOILERS);
