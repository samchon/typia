...
export const test_createEquals_ArrayRecursive = _test_equals("ArrayRecursive", ArrayRecursive.generate, (input: any, _exceptionable: boolean = true): input is ArrayRecursive => {
