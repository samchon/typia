...
export const test_functional_validateFunctionAsync_TypeTagArray =
  _test_functional_validateFunctionAsync("TypeTagArray")(TypeTagArray)(
    (p: (input: TypeTagArray) => Promise<TypeTagArray>) =>
      async (
        input: TypeTagArray,
      ): Promise<import("typia").IValidation<TypeTagArray>> => {
        const paramResults = [
          ((input: any): typia.IValidation<TypeTagArray> => {
            const errors = [] as any[];
        ...
        const result = ((input: any): typia.IValidation<TypeTagArray> => {
          const errors = [] as any[];
          const __is = (input: any): input is TypeTagArray => {
            const $io0 = (input: any): boolean =>
              Array.isArray(input.value) &&
