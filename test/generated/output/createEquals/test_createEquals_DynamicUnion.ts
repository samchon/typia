...
export const test_createEquals_DynamicUnion = _test_equals("DynamicUnion", DynamicUnion.generate, (input: any, _exceptionable: boolean = true): input is DynamicUnion => {
