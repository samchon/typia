...
export const test_createAssertClone_NativeAlias = _test_assertClone("NativeAlias", NativeAlias.generate, (input: any): typia.Primitive<NativeAlias> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* NativeAlias */; return output as NativeAlias; }, NativeAlias.SPOILERS);
