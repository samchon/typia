...
export const test_createValidatePrune_ObjectGeneric = _test_validatePrune("ObjectGeneric", ObjectGeneric.generate, (input: any): typia.IValidation<ObjectGeneric> => { const validate = (input: any): typia.IValidation<ObjectGeneric> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, ObjectGeneric.SPOILERS);
