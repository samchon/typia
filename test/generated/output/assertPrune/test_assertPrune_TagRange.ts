...
export const test_assertPrune_TagRange = _test_assertPrune("TagRange", TagRange.generate, (input) => ((input: any): Array<TagRange.Type> => { const assert = (input: any): Array<TagRange.Type> => {
