...
export const test_functional_validateFunction_InstanceUnion =
  _test_functional_validateFunction("InstanceUnion")(InstanceUnion)(
    (p: (input: InstanceUnion) => InstanceUnion) =>
      (input: InstanceUnion): import("typia").IValidation<InstanceUnion> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<InstanceUnion> => {
          const errors = [] as any[];
          const __is = (input: any): input is InstanceUnion => {
            const $ip0 = (input: any) => {
              const array = input;
