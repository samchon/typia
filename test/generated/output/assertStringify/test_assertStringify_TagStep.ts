...
export const test_assertStringify_TagStep = _test_assertStringify("TagStep", TagStep.generate, (input) => ((input: any): string => { const assert = (input: any): Array<TagStep.Type> => {
...
}; return stringify(assert(input)); })(input), TagStep.SPOILERS);
