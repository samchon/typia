...
export const test_isClone_DynamicArray = _test_isClone("DynamicArray", DynamicArray.generate, (input) => ((input: any): typia.Primitive<DynamicArray> | null => { const is = (input: any): input is DynamicArray => {
    ...
    return null; const output = clone(input); return output; })(input), DynamicArray.SPOILERS);
