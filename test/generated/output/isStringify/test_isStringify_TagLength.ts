...
export const test_isStringify_TagLength = _test_isStringify("TagLength", TagLength.generate, (input) => ((input: TagLength): string | null => { const is = (input: any): input is TagLength => {
