...
export const test_createAssertStringify_ArrayRecursive = _test_assertStringify("ArrayRecursive", ArrayRecursive.generate, (input: ICategory): string => { const assert = (input: any) => {
