...
export const test_createAssertParse_ObjectGeneric = _test_assertParse("ObjectGeneric", ObjectGeneric.generate, (input: string): typia.Primitive<ObjectGeneric> => { const assert = (input: any) => {
...
}; input = JSON.parse(input); return assert(input); }, ObjectGeneric.SPOILERS);
