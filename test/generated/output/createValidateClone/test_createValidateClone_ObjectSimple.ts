...
export const test_createValidateClone_ObjectSimple = _test_validateClone("ObjectSimple", ObjectSimple.generate, (input: any): typia.IValidation<typia.Primitive<IBox3D>> => { const validate = (input: any): typia.IValidation<IBox3D> => {
    const errors = [] as any[];
