...
export const test_llm_applicationEquals_gemini_ClassPropertyAssignment = (): void =>
  _test_llm_applicationEquals({
    model: "gemini",
    name: "ClassPropertyAssignment",
    factory: ClassPropertyAssignment
  })(
    typia.llm.application<ClassPropertyAssignmentApplication, "gemini", { equals: true }>(),
  );
