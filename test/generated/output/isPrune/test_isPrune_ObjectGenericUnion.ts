...
export const test_isPrune_ObjectGenericUnion = _test_isPrune("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): input is ISaleQuestion | ISaleReview => { const is = (input: any): input is ISaleQuestion | ISaleReview => {
    ...
    return false; prune(input); return true; })(input), ObjectGenericUnion.SPOILERS);
