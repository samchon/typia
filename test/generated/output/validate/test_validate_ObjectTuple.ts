...
export const test_validate_ObjectTuple = _test_validate("ObjectTuple", ObjectTuple.generate, (input) => ((input: any): typia.IValidation<[ObjectTuple.ISection, ObjectTuple.ICitizen]> => {
