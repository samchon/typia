...
export const test_createAssertPrune_ObjectOptional = _test_assertPrune("ObjectOptional", ObjectOptional.generate, (input: any): ObjectOptional => { const assert = (input: any) => {
