...
export const test_validate_DefinitionArrayRecursiveRequired = _test_validate("DefinitionArrayRecursiveRequired", DefinitionArrayRecursiveRequired.generate, (input) => ((input: any): typia.IValidation<string | number | Array<DefinitionArrayRecursiveRequired>> => {
