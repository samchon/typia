...
export const test_validatePrune_TupleRestObject = _test_validatePrune("TupleRestObject", TupleRestObject.generate, (input) => ((input: any): typia.IValidation<[boolean, number, ...TupleRestObject.IObject[]]> => { const validate = (input: any): typia.IValidation<[boolean, number, ...TupleRestObject.IObject[]]> => {
    const errors = [] as any[];
    ...
    prune(input); return output; })(input), TupleRestObject.SPOILERS);
