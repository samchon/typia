...
export const test_createValidateEquals_ArrayHierarchical = _test_validateEquals("ArrayHierarchical", ArrayHierarchical.generate, (input: any): typia.IValidation<ArrayHierarchical> => {
    const errors = [] as any[];
