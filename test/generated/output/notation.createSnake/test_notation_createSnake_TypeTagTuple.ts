...
export const test_notation_createValidateSnake_TypeTagTuple =
  ...
  >({
    convert: (input: any): typia.IValidation<typia.SnakeCase<TypeTagTuple>> => {
      ...
      const general = (input: TypeTagTuple): typia.SnakeCase<TypeTagTuple> => {
    ...
    assert: (input: any): typia.SnakeCase<TypeTagTuple> => {
      const __is = (input: any): input is typia.SnakeCase<TypeTagTuple> => {
        const $io0 = (input: any): boolean =>
          Array.isArray(input.tuple) &&
          input.tuple.length === 4 &&
          "string" === typeof input.tuple[0] &&
      ...
      if (false === __is(input))
        ((
          ...
          _path: string,
          _exceptionable: boolean = true,
        ): input is typia.SnakeCase<TypeTagTuple> => {
