...
export const test_clone_ArrayAtomicSimple = _test_clone("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input) => ((input: ArrayAtomicSimple): typia.Primitive<ArrayAtomicSimple> => {
