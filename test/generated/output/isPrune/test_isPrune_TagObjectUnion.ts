...
export const test_isPrune_TagObjectUnion = _test_isPrune("TagObjectUnion", TagObjectUnion.generate, (input) => ((input: any): input is Array<TagObjectUnion.Type> => { const is = (input: any): input is Array<TagObjectUnion.Type> => {
