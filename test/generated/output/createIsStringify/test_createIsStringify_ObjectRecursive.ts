...
export const test_createIsStringify_ObjectRecursive = _test_isStringify("ObjectRecursive", ObjectRecursive.generate, (input: IDepartment): string | null => { const is = (input: any): input is IDepartment => {
