...
export const test_createAssertStringify_ArrayRepeatedUnionWithTuple = _test_assertStringify("ArrayRepeatedUnionWithTuple", ArrayRepeatedUnionWithTuple.generate, (input: any): string => { const assert = (input: any): ArrayRepeatedUnionWithTuple => {
...
}; return stringify(assert(input)); }, ArrayRepeatedUnionWithTuple.SPOILERS);
