...
export const test_assertEquals_ArrayRecursiveUnionExplicit = _test_assertEquals("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input) => ((input: any): Array<ArrayRecursiveUnionExplicit.IBucket> => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Array<ArrayRecursiveUnionExplicit.IBucket> => {
            ...
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.id && Number.isFinite(input.id) || $guard(_exceptionable, {
                ...
                expected: "Array<ArrayRecursiveUnionExplicit.IBucket>",
                value: input.children
            })) && ("directory" === input.type || $guard(_exceptionable, {
                path: _path + ".type",
                expected: "\"directory\"",
                value: input.type
