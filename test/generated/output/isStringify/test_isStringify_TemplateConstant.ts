...
export const test_isStringify_TemplateConstant = _test_isStringify("TemplateConstant", TemplateConstant.generate, (input) => ((input: TemplateConstant): string | null => { const is = (input: any): input is TemplateConstant => {
