...
export const test_createIsClone_ObjectGenericArray = _test_isClone("ObjectGenericArray", ObjectGenericArray.generate, (input: any): typia.Primitive<ObjectGenericArray> | null => { const is = (input: any): input is ObjectGenericArray => {
    ...
    return null; const output = clone(input); return output; }, ObjectGenericArray.SPOILERS);
