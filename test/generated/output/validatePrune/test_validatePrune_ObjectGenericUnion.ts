...
export const test_validatePrune_ObjectGenericUnion = _test_validatePrune("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): typia.IValidation<ISaleQuestion | ISaleReview> => { const validate = (input: any): typia.IValidation<ISaleQuestion | ISaleReview> => {
    ...
    prune(input); return output; })(input), ObjectGenericUnion.SPOILERS);
