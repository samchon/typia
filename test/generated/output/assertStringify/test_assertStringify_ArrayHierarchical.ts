...
export const test_assertStringify_ArrayHierarchical = _test_assertStringify("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: ArrayHierarchical): string => { const assert = (input: any) => {
    ...
    ((input: any, _path: string, _exceptionable: boolean): input is ArrayHierarchical => {
        const $ao0 = (input: any, _path: string, _exceptionable: boolean) => ("number" === typeof input.id && !Number.isNaN(input.id) || $guard(_exceptionable, {
            ...
            expected: "number",
            value: input.id
        })) && ("number" === typeof input.serial && !Number.isNaN(input.serial) || $guard(_exceptionable, {
            path: _path + ".serial",
            expected: "number",
            value: input.serial
        ...
        const $ao2 = (input: any, _path: string, _exceptionable: boolean) => ("number" === typeof input.id && !Number.isNaN(input.id) || $guard(_exceptionable, {
            ...
            expected: "string",
            value: input.code
        })) && ("number" === typeof input.sales && !Number.isNaN(input.sales) || $guard(_exceptionable, {
            path: _path + ".sales",
            expected: "number",
            value: input.sales
