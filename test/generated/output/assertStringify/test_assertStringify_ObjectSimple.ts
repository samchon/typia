...
export const test_assertStringify_ObjectSimple = _test_assertStringify("ObjectSimple", ObjectSimple.generate, (input) => ((input: IBox3D): string => { const assert = (input: any) => {
