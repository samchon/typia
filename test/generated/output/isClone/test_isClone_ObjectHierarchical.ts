...
export const test_isClone_ObjectHierarchical = _test_isClone("ObjectHierarchical", ObjectHierarchical.generate, (input) => ((input: any): typia.Primitive<ICustomer> | null => { const is = (input: any): input is ICustomer => {
