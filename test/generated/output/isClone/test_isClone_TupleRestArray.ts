...
export const test_isClone_TupleRestArray = _test_isClone("TupleRestArray", TupleRestArray.generate, (input) => ((input: any): typia.Primitive<TupleRestArray> | null => { const is = (input: any): input is TupleRestArray => {
