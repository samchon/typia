...
export const test_isPrune_AtomicUnion = _test_isPrune("AtomicUnion", AtomicUnion.generate, (input) => ((input: any): input is AtomicUnion => { const is = (input: any): input is AtomicUnion => {
