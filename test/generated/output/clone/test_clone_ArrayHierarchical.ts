...
export const test_clone_ArrayHierarchical = _test_clone("ArrayHierarchical", ArrayHierarchical.generate, (input) => ((input: Array<ArrayHierarchical.ICompany>): typia.Primitive<Array<ArrayHierarchical.ICompany>> => {
