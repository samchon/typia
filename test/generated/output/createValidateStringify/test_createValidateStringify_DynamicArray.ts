...
export const test_createValidateStringify_DynamicArray = _test_validateStringify("DynamicArray", DynamicArray.generate, (input: DynamicArray): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<DynamicArray> => {
    const errors = [] as any[];
    ...
    output.data = stringify(input); return output; }, DynamicArray.SPOILERS);
