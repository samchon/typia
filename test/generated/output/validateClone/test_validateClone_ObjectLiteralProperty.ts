...
export const test_validateClone_ObjectLiteralProperty = _test_validateClone("ObjectLiteralProperty", ObjectLiteralProperty.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<ISomething>> => { const validate = (input: any): typia.IValidation<ISomething> => {
    const errors = [] as any[];
