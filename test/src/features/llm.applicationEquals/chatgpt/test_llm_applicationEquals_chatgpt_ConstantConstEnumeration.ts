...
export const test_llm_applicationEquals_chatgpt_ConstantConstEnumeration = (): void =>
  _test_llm_applicationEquals({
    model: "chatgpt",
    name: "ConstantConstEnumeration",
    factory: ConstantConstEnumeration
  })(
    typia.llm.application<ConstantConstEnumerationApplication, "chatgpt", { equals: true }>(),
  );
