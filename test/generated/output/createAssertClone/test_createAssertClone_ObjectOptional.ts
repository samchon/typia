...
export const test_createAssertClone_ObjectOptional = _test_assertClone("ObjectOptional", ObjectOptional.generate, (input: any): typia.Primitive<ObjectOptional> => { const assert = (input: any): ObjectOptional => {
...
}; assert(input); const output = clone(input); return output; }, ObjectOptional.SPOILERS);
