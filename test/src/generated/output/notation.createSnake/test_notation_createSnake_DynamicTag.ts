...
export const test_notation_createValidateSnake_DynamicTag =
  ...
  >({
    convert: (input: any): typia.IValidation<typia.SnakeCase<DynamicTag>> => {
      ...
      const general = (input: DynamicTag): typia.SnakeCase<DynamicTag> => {
    ...
    assert: (input: any): typia.SnakeCase<DynamicTag> => {
