...
export const test_assertPrune_ObjectGenericUnion = _test_assertPrune("ObjectGenericUnion", ObjectGenericUnion.generate, (input) => ((input: any): ISaleEntireArticle => { const assert = (input: any) => {
