...
export const test_createValidateStringify_ObjectRecursive = _test_validateStringify("ObjectRecursive", ObjectRecursive.generate, (input: IDepartment): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<IDepartment> => {
    const errors = [] as any[];
