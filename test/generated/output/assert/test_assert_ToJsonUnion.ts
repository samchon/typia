...
export const test_assert_ToJsonUnion = _test_assert("ToJsonUnion", ToJsonUnion.generate, (input) => ((input: any): Array<string | number | ToJsonUnion.ICitizen | ToJsonUnion.IWrapper<boolean> | ToJsonUnion.IWrapper<ToJsonUnion.ICitizen> | ToJsonUnion.IWrapper<ToJsonUnion.IProduct>> => {
