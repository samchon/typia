...
export const test_llm_applicationEquals_claude_ObjectUnionNonPredictable = (): void =>
  _test_llm_applicationEquals({
    model: "claude",
    name: "ObjectUnionNonPredictable",
    factory: ObjectUnionNonPredictable
  })(
    typia.llm.application<ObjectUnionNonPredictableApplication, "claude", { equals: true }>(),
  );
