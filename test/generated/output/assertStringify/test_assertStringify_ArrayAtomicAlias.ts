...
export const test_assertStringify_ArrayAtomicAlias = _test_assertStringify("ArrayAtomicAlias", ArrayAtomicAlias.generate, (input) => ((input: any): string => { const assert = (input: any): [ArrayAtomicAlias.Alias<boolean>, ArrayAtomicAlias.Alias<number>, ArrayAtomicAlias.Alias<string>] => {
...
}; return stringify(assert(input)); })(input), ArrayAtomicAlias.SPOILERS);
