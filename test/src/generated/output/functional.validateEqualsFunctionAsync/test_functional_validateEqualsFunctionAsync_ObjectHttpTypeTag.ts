...
export const test_functional_validateEqualsFunctionAsync_ObjectHttpTypeTag =
  _test_functional_validateEqualsFunctionAsync("ObjectHttpTypeTag")(
    ObjectHttpTypeTag,
  )(
    (p: (input: ObjectHttpTypeTag) => Promise<ObjectHttpTypeTag>) =>
      async (
        input: ObjectHttpTypeTag,
      ): Promise<import("typia").IValidation<ObjectHttpTypeTag>> => {
        const paramResults = [
        ...
        const result = ((input: any): typia.IValidation<ObjectHttpTypeTag> => {
          const errors = [] as any[];
          const __is = (
            input: any,
            _exceptionable: boolean = true,
