...
export const test_createValidateStringify_ArrayRecursiveUnionExplicit = _test_validateStringify("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input: ArrayRecursiveUnionExplicit): typia.IValidation<string> => { const validate = (input: any): typia.IValidation<ArrayRecursiveUnionExplicit> => {
    ...
    output.data = stringify(input); return output; }, ArrayRecursiveUnionExplicit.SPOILERS);
