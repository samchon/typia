...
export const test_createAssertStringify_ConstantEnumeration = _test_assertStringify("ConstantEnumeration", ConstantEnumeration.generate, (input: any): string => { const assert = (input: any): ConstantEnumeration => {
...
}; return stringify(assert(input)); }, ConstantEnumeration.SPOILERS);
