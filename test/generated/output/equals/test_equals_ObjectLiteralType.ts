...
export const test_equals_ObjectLiteralType = _test_equals("ObjectLiteralType", ObjectLiteralType.generate, (input) => ((input: any, _exceptionable: boolean): input is { id: string; name: string; age: number; } => {
