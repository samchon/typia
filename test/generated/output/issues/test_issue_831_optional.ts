          ...
          (undefined === input["x-typia-typeTags"] ||
            (Array.isArray(input["x-typia-typeTags"]) &&
              input["x-typia-typeTags"].every(
                (elem: any) =>
                  "object" === typeof elem && null !== elem && $io8(elem),
              ))) &&
          (undefined === input["default"] ||
            "boolean" === typeof input["default"]) &&
          "boolean" === input.type &&
                ...
                input["x-typia-jsDocTags"].every(
                  (elem: any, _index2: number) =>
                    ((("object" === typeof elem && null !== elem) ||
                      $guard(_exceptionable, {
                        path: _path + '["x-typia-jsDocTags"][' + _index2 + "]",
                        expected: "IJsDocTagInfo",
                        value: elem,
                      })) &&
                      $ao3(
                        elem,
                        _path + '["x-typia-jsDocTags"][' + _index2 + "]",
                        true && _exceptionable,
                      )) ||
                    $guard(_exceptionable, {
                      path: _path + '["x-typia-jsDocTags"][' + _index2 + "]",
            ...
            (() => {
              if ("integer" === input.type)
                ...
                return (
                  ...
                  $ao17(input, _path, false && _exceptionable) ||
                  $guard(_exceptionable, {
                    path: _path,
                    expected:
