...
export const test_functional_equalsReturnAsync_ObjectHierarchical =
  _test_functional_equalsReturnAsync("ObjectHierarchical")(ObjectHierarchical)(
    (p: (input: ObjectHierarchical) => Promise<ObjectHierarchical>) =>
      async (input: ObjectHierarchical): Promise<ObjectHierarchical | null> => {
        ...
        return ((
          ...
          const $io4 = (input: any, _exceptionable: boolean = true): boolean =>
            ...
            (3 === Object.keys(input).length ||
              Object.keys(input).every((key: any) => {
                if (
                  ["id", "code", "created_at"].some((prop: any) => key === prop)
                )
                  return true;
                const value = input[key];
                if (undefined === value) return true;
