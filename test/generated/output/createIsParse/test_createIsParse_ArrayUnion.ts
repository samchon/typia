...
export const test_createIsParse_ArrayUnion = _test_isParse("ArrayUnion", ArrayUnion.generate, (input: any): typia.Primitive<ArrayUnion> => { const is = (input: any): input is ArrayUnion => {
...
}; input = JSON.parse(input); return is(input) ? input as any : null; }, ArrayUnion.SPOILERS);
