...
export const test_validateEquals_ToJsonArray = _test_validateEquals("ToJsonArray", ToJsonArray.generate, (input) => ((input: any): typia.IValidation<[ToJsonArray.IArray<boolean>, ToJsonArray.IArray<number>, ToJsonArray.IArray<string>, ToJsonArray.IArray<ToJsonArray.IObject>]> => {
    const errors = [] as any[];
