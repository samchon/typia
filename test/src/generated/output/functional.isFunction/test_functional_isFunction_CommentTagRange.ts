...
export const test_functional_isFunction_CommentTagRange =
  _test_functional_isFunction("CommentTagRange")(CommentTagRange)(
    (p: (input: CommentTagRange) => CommentTagRange) =>
      (input: CommentTagRange): CommentTagRange | null => {
        if (
          false ===
          ((input: any): input is CommentTagRange => {
        ...
        return ((input: any): input is CommentTagRange => {
          const $io0 = (input: any): boolean =>
            Array.isArray(input.value) &&
            input.value.every(
              (elem: any) =>
