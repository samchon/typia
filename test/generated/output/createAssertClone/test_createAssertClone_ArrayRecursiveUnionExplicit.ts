...
export const test_createAssertClone_ArrayRecursiveUnionExplicit = _test_assertClone("ArrayRecursiveUnionExplicit", ArrayRecursiveUnionExplicit.generate, (input: any): typia.Primitive<ArrayRecursiveUnionExplicit> => { const assert = (input: any) => {
...
}; assert(input); const output = clone(input); /* Array */; return output as ArrayRecursiveUnionExplicit; }, ArrayRecursiveUnionExplicit.SPOILERS);
