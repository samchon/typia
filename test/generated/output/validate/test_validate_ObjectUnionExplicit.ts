...
export const test_validate_ObjectUnionExplicit = _test_validate("ObjectUnionExplicit", ObjectUnionExplicit.generate, (input) => ((input: any): typia.IValidation<ObjectUnionExplicit> => {
    const errors = [] as any[];
