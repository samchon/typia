...
export const test_assertStringify_ObjectNullable = _test_assertStringify("ObjectNullable", ObjectNullable.generate, (input) => ((input: any): string => { const assert = (input: any): [ObjectNullable.IProduct, ObjectNullable.IProduct, ObjectNullable.IProduct] => {
...
}; return stringify(assert(input)); })(input), ObjectNullable.SPOILERS);
