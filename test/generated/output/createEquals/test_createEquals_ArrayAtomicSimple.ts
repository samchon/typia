...
export const test_createEquals_ArrayAtomicSimple = _test_equals("ArrayAtomicSimple", ArrayAtomicSimple.generate, (input: any, _exceptionable: boolean): input is ArrayAtomicSimple => {
