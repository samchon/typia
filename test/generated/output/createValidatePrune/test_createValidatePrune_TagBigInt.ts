...
export const test_createValidatePrune_TagBigInt = _test_validatePrune("TagBigInt", TagBigInt.generate, (input: any): typia.IValidation<TagBigInt> => { const validate = (input: any): typia.IValidation<TagBigInt> => {
    const errors = [] as any[];
    ...
    prune(input); return output; }, TagBigInt.SPOILERS);
