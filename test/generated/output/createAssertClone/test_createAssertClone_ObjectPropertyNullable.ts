...
export const test_createAssertClone_ObjectPropertyNullable = _test_assertClone("ObjectPropertyNullable", ObjectPropertyNullable.generate, (input: any): typia.Primitive<ObjectPropertyNullable> => { const assert = (input: any): ObjectPropertyNullable => {
...
}; assert(input); const output = clone(input); return output; }, ObjectPropertyNullable.SPOILERS);
