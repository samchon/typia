...
export const test_validateEquals_FunctionalTupleUnion = _test_validateEquals("FunctionalTupleUnion", FunctionalTupleUnion.generate, (input) => ((input: any): typia.IValidation<[FunctionalTupleUnion.Union, FunctionalTupleUnion.Union, FunctionalTupleUnion.Union, FunctionalTupleUnion.Union]> => {
