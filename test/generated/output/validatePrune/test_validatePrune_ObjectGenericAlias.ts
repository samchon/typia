...
export const test_validatePrune_ObjectGenericAlias = _test_validatePrune("ObjectGenericAlias", ObjectGenericAlias.generate, (input) => ((input: any): typia.IValidation<ObjectGenericAlias.ISomething<string>> => { const validate = (input: any): typia.IValidation<ObjectGenericAlias.ISomething<string>> => {
    const errors = [] as any[];
