...
export const test_validate_FunctionalValueUnion = _test_validate("FunctionalValueUnion", FunctionalValueUnion.generate, (input) => ((input: any): typia.IValidation<Array<FunctionalValueUnion.Union>> => {
