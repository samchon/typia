...
export const test_validateClone_ArrayRepeatedNullable = _test_validateClone("ArrayRepeatedNullable", ArrayRepeatedNullable.generate, (input) => ((input: any): typia.IValidation<typia.Primitive<string | number | Array<ArrayRepeatedNullable> | null>> => { const validate = (input: any): typia.IValidation<string | number | Array<ArrayRepeatedNullable> | null> => {
    const errors = [] as any[];
    ...
    output.data = clone(input); return output; })(input), ArrayRepeatedNullable.SPOILERS);
