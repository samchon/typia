...
export const test_notation_validateSnake_TypeTagAtomicUnion =
  _test_notation_validateGeneral("TypeTagAtomicUnion")<TypeTagAtomicUnion>(
    ...
    convert: (input) =>
      ((input: any): typia.IValidation<typia.SnakeCase<TypeTagAtomicUnion>> => {
        const validate = (
          input: any,
    ...
    assert: (input: any): typia.SnakeCase<TypeTagAtomicUnion> => {
      const __is = (
        input: any,
      ): input is typia.SnakeCase<TypeTagAtomicUnion> => {
        const $io0 = (input: any): boolean =>
          Array.isArray(input.value) &&
          input.value.every(
            (elem: any) =>
